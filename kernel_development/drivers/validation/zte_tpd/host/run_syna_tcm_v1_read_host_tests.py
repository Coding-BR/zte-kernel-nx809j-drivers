#!/usr/bin/env python3
"""Run the TouchComm v1 read oracle in the project Docker image."""
...
def main() -> int:
    ...
    compile_command = (
        ...
        "syna_tcm_v1_read_host_test.c "
        "-o /out/tcm_v1_read_host_test && /out/tcm_v1_read_host_test"
    )
    cycles = []
    for cycle in (1, 2):
        output_dir = build_root / f"cycle{cycle}"
        output_dir.mkdir(parents=True, exist_ok=True)
        binary = output_dir / "tcm_v1_read_host_test"
    ...
    report = {
        "schema_version": 1,
        "target": "syna_tcm_v1_read",
        "mode": "direct_source_asan_ubsan_host_oracle",
        "stock_contract": "Ghidra Assembly 00120eec",
        "expected_cases": 9,
        "cycles": cycles,
