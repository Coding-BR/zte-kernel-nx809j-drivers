#!/usr/bin/env python3
"""Run the syna_tcm_identify host contract twice with sanitizers."""
...
def main() -> int:
    ...
    compile_command = (
        ...
        "syna_tcm_identify_host_test.c "
        "-o /out/identify_host_test && /out/identify_host_test"
    )
    cycles = []
    for cycle in (1, 2):
        output_dir = build_root / f"cycle{cycle}"
        output_dir.mkdir(parents=True, exist_ok=True)
        binary = output_dir / "identify_host_test"
