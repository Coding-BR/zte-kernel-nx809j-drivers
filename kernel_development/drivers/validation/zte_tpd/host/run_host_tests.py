#!/usr/bin/env python3
"""Build and run the zte_tpd production-test harness twice with sanitizers."""
...
EXPECTED_STDOUT = "PASS syna_tcm_run_production_test host tests (9 cases)\n"
...
def main() -> int:
    ...
    parser.add_argument(
        ...
        default=pathlib.Path(__file__).with_name(
            "syna_tcm_run_production_test_host_test.c"
        ),
    )
    ...
    report = {
        ...
        "mode": "offline_direct_source_next18_production_asan_ubsan",
        ...
        "inputs": [
            ...
            },
            {
                ...
                "size": driver_source.stat().st_size,
                "sha256": sha256(driver_source),
            },
        ],
        ...
        "limitations": [
            "The harness stubs printk, write_message and the local buffer-copy helper.",
            "It proves branch, argument, return and log behavior, not transport or hardware integration.",
