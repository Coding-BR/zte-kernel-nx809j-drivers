#!/usr/bin/env python3
"""Run the 0100 byte checker host contract under ASan and UBSan."""
...
HOST_SOURCE = Path("kernel_development/drivers/validation/zte_tpd/host/syna_tcm_testing_0100_check_data_host_test.c")
DRIVER_SOURCE = Path("kernel_development/drivers/reconstructed/zte_tpd/syna_tcm_testing_0100_check_data.c")
...
EXPECTED = "PASS syna_tcm_testing_0100_check_data host tests (4 cases)\n"
...
def main() -> int:
    ...
    for cycle in range(1, 3):
        ...
        compile_command = [
            ...
            "-frandom-seed=zte-tpd-next536-syna-tcm-testing-0100-check-data",
    ...
    report = {
        ...
        "mode": "offline_direct_source_next536_syna_tcm_testing_0100_check_data_asan_ubsan",
        "driver": "zte_tpd", "target": "syna_tcm_testing_0100_check_data",
        "covered_functions": ["syna_tcm_testing_0100_check_data"],
        ...
        "limitations": [
            "The harness exercises the reconstructed C contract with a deterministic printk stub.",
