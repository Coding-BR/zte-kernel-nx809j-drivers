#!/usr/bin/env python3
"""Run the bounded play-game setter in the project Docker image."""
...
def main() -> int:
    ...
    compile_command = (
        ...
        "tpd_set_play_game_host_test.c "
        "-o /out/tpd_set_play_game_host_test && /out/tpd_set_play_game_host_test"
    )
    cycles = []
    for cycle in (1, 2):
        output_dir = build_root / f"cycle{cycle}"
        output_dir.mkdir(parents=True, exist_ok=True)
        binary = output_dir / "tpd_set_play_game_host_test"
    ...
    report = {
        ...
        "stock_contract": "Ghidra Assembly 0012c6e8",
        "expected_cases": 6,
        "cycles": cycles,
