#!/usr/bin/env python3
"""Build and run the tpd_test_cmd_store contract harness twice."""
...
def main() -> int:
    ...
    report = {
        "schema_version": 1,
        "driver": "zte_tpd",
        "target": "tpd_test_cmd_store",
        "mode": "offline_contract_model_asan_ubsan",
        "source": str(ROOT / "kernel_development/drivers/validation/zte_tpd/host/tpd_test_cmd_store_contract_test.c"),
        "source_sha256": sha256(ROOT / "kernel_development/drivers/reconstructed/zte_tpd/tpd_test_cmd_store.c"),
        "expected_output": EXPECTED,
        "cycles": cycles,
        "reproducible_binary": passed,
        "passed": passed,
        "status": "PASS" if passed else "FAIL",
        "limitations": ["Stubbed test routines and hardware reset; real hardware execution is a separate gate.", "AArch64, KCFI, Joern and canonical build are separate gates."],
    }
