#!/usr/bin/env python3
"""Run the trim host oracle twice in the project Docker image."""
...
def main() -> int:
    ...
    compile_command = (
        ...
        "/drivers/kernel_development/drivers/validation/zte_tpd/host/trim_host_test.c "
        "-I/drivers/kernel_development/drivers/validation/zte_tpd/host/trim_host_compat "
        "-o /out/trim_host_test && /out/trim_host_test"
    )
    for cycle in (1, 2):
        output_dir = args.build_root / f"cycle{cycle}"
        output_dir.mkdir(parents=True, exist_ok=True)
        binary = output_dir / "trim_host_test"
    ...
    report = {
        ...
        "stock_contract": "Ghidra Assembly 0012b4dc",
        "expected_cases": 8,
        "cycles": cycles,
