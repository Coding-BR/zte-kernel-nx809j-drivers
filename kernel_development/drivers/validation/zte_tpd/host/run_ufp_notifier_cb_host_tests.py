#!/usr/bin/env python3
"""Run the isolated ufp_notifier_cb host contract under sanitizers."""
...
HOST_SOURCE = Path("kernel_development/drivers/validation/zte_tpd/host/ufp_notifier_cb_host_test.c")
DRIVER_SOURCE = Path("kernel_development/drivers/reconstructed/zte_tpd/ufp_notifier_cb.c")
...
EXPECTED = "PASS ufp_notifier_cb host tests (4 cases)\n"
...
def main() -> int:
    ...
    for cycle in range(1, 3):
        ...
        compile_command = [
            ...
            "-frandom-seed=zte-tpd-next91-ufp-notifier",
    ...
    report = {
        ...
        "mode": "offline_direct_source_next91_ufp_notifier_cb_asan_ubsan",
        "driver": "zte_tpd",
        "target": "ufp_notifier_cb",
        "covered_functions": ["ufp_notifier_cb"],
        "source": str(source),
        ...
        "limitations": [
            "The harness proves the scalar zero/non-zero mapping and exactly one direct helper call.",
            "Module assembly, KCFI, Ghidra and Joern remain independent gates.",
            "No smartphone, touch hardware or display notification path is used.",
        ],
    }
