#!/usr/bin/env python3
"""Run the full-raw testing contract under ASan and UBSan."""
...
HOST_SOURCE = Path("kernel_development/drivers/validation/zte_tpd/host/syna_tcm_testing_full_raw_host_test.c")
DRIVER_SOURCE = Path("kernel_development/drivers/reconstructed/zte_tpd/syna_tcm_testing_full_raw.c")
...
EXPECTED = "PASS syna_tcm_testing_full_raw host tests (4 cases)\n"
...
def main() -> int:
    ...
    for cycle in range(1, 3):
        ...
        compile_command = [
            ...
            "-Wno-unused-but-set-variable", "-Wno-unused-function", "-Wno-error=uninitialized",
            "-fno-omit-frame-pointer", "-fno-pie", "-no-pie",
            "-frandom-seed=zte-tpd-next538-syna-tcm-testing-full-raw",
    ...
    report = {
        ...
        "mode": "offline_direct_source_next538_syna_tcm_testing_full_raw_asan_ubsan",
        "driver": "zte_tpd", "target": "syna_tcm_testing_full_raw",
        "covered_functions": ["syna_tcm_testing_full_raw"],
        ...
        "limitations": [
            "The harness exercises the reconstructed C contract with deterministic production, checker and device-memory stubs.",
