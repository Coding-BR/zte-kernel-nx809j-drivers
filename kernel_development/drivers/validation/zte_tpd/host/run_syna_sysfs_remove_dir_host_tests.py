#!/usr/bin/env python3
"""Build and run the syna_sysfs_remove_dir harness twice with sanitizers."""
...
EXPECTED_STDOUT = "PASS syna_sysfs_remove_dir host tests (4 cases)\n"
...
def main() -> int:
    ...
    parser.add_argument(
        ...
        default=pathlib.Path(__file__).with_name(
            "syna_sysfs_remove_dir_host_test.c"
        ),
    )
    ...
    report = {
        ...
        "mode": "offline_direct_source_next26_sysfs_remove_asan_ubsan",
        "driver": "zte_tpd",
        "target": "syna_sysfs_remove_dir",
        "source": str(source),
        ...
        "limitations": [
            "The harness stubs kobject, sysfs, testing-directory and printk APIs.",
            "It proves offsets, branches, call order, arguments, logs and pointer retention.",
