#!/usr/bin/env python3
"""Build and run the direct zlog_register_work_init contract in Docker twice."""
...
EXPECTED_STDOUT = "PASS zlog_register_work_init host tests (4 cases)\n"
DRIVER_SOURCE_C = pathlib.Path(
    "kernel_development/drivers/reconstructed/zte_tpd/zlog_register_work_init.c"
)
...
def main() -> int:
    ...
    parser.add_argument("--source", type=pathlib.Path,
                        default=pathlib.Path(__file__).with_name(
                            "zlog_register_work_init_contract_test.c"))
    ...
    report = {"schema_version": 1,
              ...
              "mode": "offline_direct_source_zlog_register_work_init_asan_ubsan",
              "driver": "zte_tpd", "target": "zlog_register_work_init",
              ...
              "limitations": [
                  "tpd_zlog_device, printk and INIT_DELAYED_WORK are contract stubs.",
                  "The harness verifies the direct function's format, device selection, work address and callback.",
