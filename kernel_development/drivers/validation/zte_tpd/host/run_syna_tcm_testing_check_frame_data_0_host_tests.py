...
HOST_SOURCE = Path("kernel_development/drivers/validation/zte_tpd/host/syna_tcm_testing_check_frame_data_0_host_test.c")
DRIVER_SOURCE = Path("kernel_development/drivers/reconstructed/zte_tpd/syna_tcm_testing_check_frame_data_0.c")
...
EXPECTED = "PASS syna_tcm_testing_check_frame_data_0 host tests (5 cases)\n"
...
def main() -> int:
    ...
    for cycle in range(1, 3):
        ...
        compile_command = [
            ...
            "-Wno-unused-function", "-Wno-int-conversion", "-Wno-cast-function-type", "-Wno-sign-compare",
            "-Wno-error=uninitialized", "-fno-omit-frame-pointer", "-fno-pie", "-no-pie",
            "-frandom-seed=zte-tpd-next540-syna-tcm-testing-check-frame-data-0",
    ...
    report = {
        ...
        "mode": "offline_direct_source_next540_syna_tcm_testing_check_frame_data_0_asan_ubsan",
        "driver": "zte_tpd", "target": "syna_tcm_testing_check_frame_data_0",
        "covered_functions": ["syna_tcm_testing_check_frame_data_0"],
