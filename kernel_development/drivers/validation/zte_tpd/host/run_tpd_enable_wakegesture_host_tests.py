#!/usr/bin/env python3
"""Run the tpd_enable_wakegesture contract twice with sanitizers in Docker."""
...
HOST_SOURCE = Path(
    ...
    "tpd_enable_wakegesture_contract_test.c"
)
...
def main() -> int:
    ...
    for cycle in (1, 2):
        ...
        binary = "/out/tpd_enable_wakegesture_contract_asan_ubsan"
        compile_command = [
            "docker", "run", "--rm",
        ...
        binary_path = cycle_root / "tpd_enable_wakegesture_contract_asan_ubsan"
        passed = (
