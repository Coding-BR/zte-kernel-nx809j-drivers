#!/usr/bin/env python3
"""Run the set_display_rotation host contract twice with ASan/UBSan."""
...
EXPECTED = "PASS set_display_rotation host tests (4 cases)\n"
...
def main() -> int:
    ...
    harness = drivers / "validation/zte_tpd/host/set_display_rotation_host_test.c"
    source = drivers / "reconstructed/zte_tpd/set_display_rotation.c"
    ...
    for cycle in (1, 2):
        ...
        command = [
            ...
            "-frandom-seed=zte-tpd-set-display-rotation",
            "-ffile-prefix-map=/drivers=<drivers>",
            "-fsanitize=address,undefined", "-Wl,--build-id=none",
            "/drivers/validation/zte_tpd/host/set_display_rotation_host_test.c",
