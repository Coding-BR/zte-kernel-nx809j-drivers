#!/usr/bin/env python3
"""Run the tpd_set_singlegamegesture contract twice with sanitizers in Docker."""
...
HOST_SOURCE = Path(
    ...
    "tpd_set_singlegamegesture_contract_test.c"
)
...
def main() -> int:
    ...
    for cycle in (1, 2):
        ...
        binary = "/out/tpd_set_singlegamegesture_contract_asan_ubsan"
        compile_command = [
            "docker", "run", "--rm",
        ...
        binary_path = cycle_root / "tpd_set_singlegamegesture_contract_asan_ubsan"
        passed = (
    ...
    report = {
        ...
        "limitations": [
            "The harness validates active, inactive, positive, zero and negative branches with fake memory.",
