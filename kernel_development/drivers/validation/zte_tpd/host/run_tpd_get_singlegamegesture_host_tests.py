#!/usr/bin/env python3
"""Run the tpd_get_singlegamegesture contract twice with sanitizers in Docker."""
...
HOST_SOURCE = Path(
    ...
    "tpd_get_singlegamegesture_contract_test.c"
)
...
def main() -> int:
    ...
    for cycle in (1, 2):
        ...
        binary = "/out/tpd_get_singlegamegesture_contract_asan_ubsan"
        compile_command = [
            "docker", "run", "--rm",
        ...
        binary_path = cycle_root / "tpd_get_singlegamegesture_contract_asan_ubsan"
        passed = (
    ...
    report = {
        ...
        "limitations": [
            "The harness validates the observed root, state and output offsets with fake memory.",
