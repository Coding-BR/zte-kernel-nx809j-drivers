#!/usr/bin/env python3
"""Run the isolated syna_tcm_get_testing_0001 host contract under sanitizers."""
...
HOST_SOURCE = Path("kernel_development/drivers/validation/zte_tpd/host/syna_tcm_get_testing_0001_host_test.c")
DRIVER_SOURCE = Path("kernel_development/drivers/reconstructed/zte_tpd/syna_tcm_get_testing_0001.c")
...
EXPECTED = "PASS syna_tcm_get_testing_0001 host tests (3 cases)\n"
...
def main() -> int:
    ...
    for cycle in range(1, 3):
        ...
        compile_command = [
            ...
            "-frandom-seed=zte-tpd-next83-syna-tcm-get-testing-0001",
    ...
    report = {
        ...
        "mode": "offline_direct_source_next83_syna_tcm_get_testing_0001_asan_ubsan",
        "driver": "zte_tpd",
        "target": "syna_tcm_get_testing_0001",
        "covered_functions": ["syna_tcm_get_testing_0001"],
        "source": str(source),
        ...
        "limitations": [
            "The harness proves exact test_0001 pointer identity and reads through that object.",
