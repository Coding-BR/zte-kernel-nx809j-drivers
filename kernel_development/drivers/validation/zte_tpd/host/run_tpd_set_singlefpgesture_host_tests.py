#!/usr/bin/env python3
"""Build and run the tpd_set_singlefpgesture contract harness twice."""
...
def main() -> int:
    ...
    report = {
        "schema_version": 1,
        "driver": "zte_tpd",
        "target": "tpd_set_singlefpgesture",
        "mode": "offline_contract_model_asan_ubsan",
        "source": str(ROOT / "kernel_development/drivers/validation/zte_tpd/host/tpd_set_singlefpgesture_contract_test.c"),
        "source_sha256": sha256(ROOT / "kernel_development/drivers/reconstructed/zte_tpd/tpd_set_singlefpgesture.c"),
