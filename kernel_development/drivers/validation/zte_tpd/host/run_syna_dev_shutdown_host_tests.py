...
EXPECTED_STDOUT = "PASS syna_dev_shutdown host tests (3 cases)\n"
...
def main() -> int:
	...
	driver_source = drivers / "reconstructed" / "zte_tpd" / "syna_dev_shutdown.c"
	...
	for cycle in (1, 2):
		...
		compile_command = [
			...
			"-fno-pie",
			"-no-pie",
			"-frandom-seed=zte-tpd-next79-syna-dev-shutdown",
	...
	report = {
		...
		"mode": "offline_direct_source_next79_syna_dev_shutdown_asan_ubsan",
		"driver": "zte_tpd",
		"target": "syna_dev_shutdown",
		"covered_functions": ["syna_dev_shutdown"],
		"source": str(source),
		...
		"limitations": [
			"The harness proves exact forwarding to syna_dev_remove for null and distinct platform_device pointers.",
			"Module assembly, KCFI, Ghidra and Joern remain independent gates.",
			"No smartphone, platform driver core or touch-controller interaction is used.",
		],
	}
