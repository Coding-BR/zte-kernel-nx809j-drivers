#!/usr/bin/env python3
"""Build and run the testing-directory removal harness twice with sanitizers."""
...
EXPECTED_STDOUT = "PASS syna_testing_remove_dir host tests (3 cases)\n"
...
def main() -> int:
	...
	parser.add_argument(
		...
		default=pathlib.Path(__file__).with_name(
			"syna_testing_remove_dir_host_test.c"
		),
	)
	...
	for cycle in (1, 2):
		...
		command = [
			...
			"-fno-pie",
			"-no-pie",
			"-frandom-seed=zte-tpd-next51-testing-remove",
	...
	report = {
		...
		"mode": "offline_direct_source_next51_testing_remove_asan_ubsan",
		"driver": "zte_tpd",
		"target": "syna_testing_remove_dir",
		"covered_functions": ["syna_testing_remove_dir"],
		"source": str(source),
		...
		"limitations": [
			"The harness stubs kobject and sysfs APIs.",
			"It proves the null branch, offset, call order and post-call reload.",
