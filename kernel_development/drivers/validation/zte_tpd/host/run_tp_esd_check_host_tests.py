#!/usr/bin/env python3
"""Run the isolated tp_esd_check host contract under ASan/UBSan."""
...
HOST_SOURCE = Path("kernel_development/drivers/validation/zte_tpd/host/tp_esd_check_host_test.c")
DRIVER_SOURCE = Path("kernel_development/drivers/reconstructed/zte_tpd/tp_esd_check.c")
...
EXPECTED = "PASS tp_esd_check host tests (3 cases)\n"
...
def main() -> int:
    ...
    for cycle in range(1, 3):
        ...
        compile_command = [
            ...
            "-frandom-seed=zte-tpd-target120-esd-check",
    ...
    report = {
        ...
        "mode": "offline_direct_source_tp_esd_check_asan_ubsan",
        "driver": "zte_tpd",
        "target": "tp_esd_check",
        "covered_functions": ["tp_esd_check"],
        "source": str(source),
        ...
        "limitations": [
            "The harness proves the null-callback, callback invocation and boolean propagation contract.",
            "Module assembly, KCFI, Ghidra and Joern remain independent gates.",
            "No smartphone, touch hardware or ESD recovery path is exercised.",
        ],
    }
