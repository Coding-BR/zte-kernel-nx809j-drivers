#!/usr/bin/env python3
"""Run the isolated syna_tcm_get_testing_0002 host contract under sanitizers."""
...
HOST_SOURCE = Path("kernel_development/drivers/validation/zte_tpd/host/syna_tcm_get_testing_0002_host_test.c")
DRIVER_SOURCE = Path("kernel_development/drivers/reconstructed/zte_tpd/syna_tcm_get_testing_0002.c")
...
EXPECTED = "PASS syna_tcm_get_testing_0002 host tests (3 cases)\n"
...
def main() -> int:
    ...
    for cycle in range(1, 3):
        ...
        compile_command = [
            ...
            "-frandom-seed=zte-tpd-next84-syna-tcm-get-testing-0002",
    ...
    report = {
        ...
        "mode": "offline_direct_source_next84_syna_tcm_get_testing_0002_asan_ubsan",
        "driver": "zte_tpd",
        "target": "syna_tcm_get_testing_0002",
        "covered_functions": ["syna_tcm_get_testing_0002"],
        "source": str(source),
        ...
        "limitations": [
            "The harness proves exact test_0002 pointer identity and reads through that object.",
