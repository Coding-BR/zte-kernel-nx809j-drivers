#!/usr/bin/env python3
"""Run the max read/write size setup oracle in the project Docker image."""
...
def main() -> int:
    ...
    compile_command = (
        ...
        "-o /out/set_up_max_rw_size_host_test && /out/set_up_max_rw_size_host_test"
    )
    cycles = []
    for cycle in (1, 2):
        output_dir = build_root / f"cycle{cycle}"
        output_dir.mkdir(parents=True, exist_ok=True)
        binary = output_dir / "set_up_max_rw_size_host_test"
