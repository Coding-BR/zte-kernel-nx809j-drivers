#!/usr/bin/env python3
"""Build and run the clear-data-duplicator host oracle twice in Docker."""
...
EXPECTED = "PASS syna_tcm_clear_data_duplicator host tests (2 cases)\n"
...
def main() -> int:
    ...
    test_source = source.with_name("syna_tcm_clear_data_duplicator_host_test.c")
    driver_source = drivers / "reconstructed" / "zte_tpd" / "syna_tcm_clear_data_duplicator.c"
    ...
    report = {
        ...
        "mode": "offline_direct_source_syna_tcm_clear_data_duplicator_docker_asan_ubsan",
        "driver": "zte_tpd",
        ...
        "limitations": [
            "The harness stubs printk and validates the bounded data_duplicators clear contract.",
