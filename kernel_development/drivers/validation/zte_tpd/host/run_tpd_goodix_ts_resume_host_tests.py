#!/usr/bin/env python3
"""Run the isolated tpd_goodix_ts_resume host contract under sanitizers."""
...
HOST_SOURCE = Path("kernel_development/drivers/validation/zte_tpd/host/tpd_goodix_ts_resume_host_test.c")
DRIVER_SOURCE = Path("kernel_development/drivers/reconstructed/zte_tpd/tpd_goodix_ts_resume.c")
...
EXPECTED = "PASS tpd_goodix_ts_resume host tests (2 cases)\n"
...
def main() -> int:
    ...
    for cycle in range(1, 3):
        ...
        compile_command = [
            ...
            "-frandom-seed=zte-tpd-next89-goodix-resume",
    ...
    report = {
        ...
        "mode": "offline_direct_source_next89_tpd_goodix_ts_resume_asan_ubsan",
        "driver": "zte_tpd",
        "target": "tpd_goodix_ts_resume",
        "covered_functions": ["tpd_goodix_ts_resume"],
        "source": str(source),
