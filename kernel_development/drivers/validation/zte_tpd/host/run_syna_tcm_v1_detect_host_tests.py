#!/usr/bin/env python3
"""Run the v1-detect contract under ASan and UBSan."""
...
HOST_SOURCE = Path("kernel_development/drivers/validation/zte_tpd/host/syna_tcm_v1_detect_host_test.c")
DRIVER_SOURCE = Path("kernel_development/drivers/reconstructed/zte_tpd/syna_tcm_v1_detect.c")
...
def main() -> int:
    ...
    for cycle in range(1, 3):
        ...
        compile_command = [
            ...
            "-Wno-unused-function", "-Wno-unused-but-set-variable", "-Wno-int-conversion", "-Wno-cast-function-type",
            "-Wno-sign-compare", "-Wno-error=uninitialized", "-fno-omit-frame-pointer",
            "-fno-pie", "-no-pie", "-frandom-seed=zte-tpd-next541-syna-tcm-v1-detect",
    ...
    report = {
        ...
        "mode": "offline_direct_source_next541_syna_tcm_v1_detect_asan_ubsan",
        "driver": "zte_tpd", "target": "syna_tcm_v1_detect",
        "covered_functions": ["syna_tcm_v1_detect"],
        ...
        "limitations": [
            "The harness covers null-handle, fast-path registration, managed-allocation failure and a successful startup callback with deterministic stubs.",
            "Module assembly, KCFI, Ghidra and Joern remain independent gates.",
            "No smartphone, firmware, bus or touch hardware interaction is used.",
        ],
    }
