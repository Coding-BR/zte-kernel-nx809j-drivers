#!/usr/bin/env python3
"""Run the syna_tcm_enable_report host contract twice with sanitizers."""
...
def main() -> int:
    ...
    compile_command = (
        ...
        "syna_tcm_enable_report_host_test.c "
        "-o /out/enable_report_host_test && /out/enable_report_host_test"
    )
    cycles = []
    for cycle in (1, 2):
        output_dir = build_root / f"cycle{cycle}"
        output_dir.mkdir(parents=True, exist_ok=True)
        binary = output_dir / "enable_report_host_test"
