#!/usr/bin/env python3
"""Run the isolated trx-short host contract under ASan and UBSan."""
...
HOST_SOURCE = Path("kernel_development/drivers/validation/zte_tpd/host/syna_tcm_testing_trx_trx_short_host_test.c")
DRIVER_SOURCE = Path("kernel_development/drivers/reconstructed/zte_tpd/syna_tcm_testing_trx_trx_short.c")
...
EXPECTED = "PASS syna_tcm_testing_trx_trx_short host tests (7 cases)\n"
...
def main() -> int:
    ...
    for cycle in range(1, 3):
        ...
        compile_command = [
            ...
            "-frandom-seed=zte-tpd-next533-syna-tcm-testing-trx-trx-short",
    ...
    report = {
        ...
        "mode": "offline_direct_source_next533_syna_tcm_testing_trx_trx_short_asan_ubsan",
        "driver": "zte_tpd", "target": "syna_tcm_testing_trx_trx_short",
        "covered_functions": ["syna_tcm_testing_trx_trx_short"],
        ...
        "limitations": [
            "The harness exercises the reconstructed C contract with deterministic stubs.",
