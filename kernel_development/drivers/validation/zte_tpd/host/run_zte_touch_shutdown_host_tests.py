#!/usr/bin/env python3
"""Build and run the zte_touch_shutdown host harness twice in Docker."""
...
EXPECTED_STDOUT = "PASS zte_touch_shutdown host tests (2 cases)\n"
...
def main() -> int:
	...
	parser.add_argument("--source", type=pathlib.Path,
		default=pathlib.Path(__file__).with_name("zte_touch_shutdown_host_test.c"))
	...
	driver_source = drivers / "reconstructed" / "zte_tpd" / "zte_touch_shutdown.c"
	...
	report = {"schema_version": 1,
		...
		"mode": "offline_direct_source_next78_zte_touch_shutdown_asan_ubsan",
		"driver": "zte_tpd", "target": "zte_touch_shutdown",
		"covered_functions": ["zte_touch_shutdown"], "source": str(source),
		...
		"limitations": [
			"The harness proves observed callback dispatch, cleanup order, pointer clear and logging contracts.",
