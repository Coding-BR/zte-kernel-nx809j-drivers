#!/usr/bin/env python3
"""Run the syna_tcm_buf_copy_2 host contract twice with sanitizers."""
...
def main() -> int:
    ...
    compile_command = (
        ...
        "syna_tcm_buf_copy_2_host_test.c "
        "-o /out/buf_copy_2_host_test && /out/buf_copy_2_host_test"
    )
    cycles = []
    for cycle in (1, 2):
        output_dir = build_root / f"cycle{cycle}"
        output_dir.mkdir(parents=True, exist_ok=True)
        binary = output_dir / "buf_copy_2_host_test"
