#!/usr/bin/env python3
"""Build and run the production-test host oracle twice in the canonical Docker image."""
...
EXPECTED = "PASS syna_tcm_run_production_test host tests (9 cases)\n"
...
def main() -> int:
    ...
    test_source = source.with_name("syna_tcm_run_production_test_host_test.c")
    driver_source = drivers / "reconstructed" / "zte_tpd" / "syna_tcm_run_production_test.c"
    ...
    for number in (1, 2):
        ...
        compile_command = [
            ...
            "/drivers/validation/zte_tpd/host/syna_tcm_run_production_test_host_test.c",
    ...
    report = {
        ...
        "mode": "offline_direct_source_syna_tcm_run_production_test_docker_asan_ubsan",
        "driver": "zte_tpd",
