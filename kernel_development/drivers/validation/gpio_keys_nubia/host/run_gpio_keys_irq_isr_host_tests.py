#!/usr/bin/env python3
"""Build and run the gpio_keys_irq_isr host harness twice in Docker."""
...
EXPECTED_STDOUT = "PASS gpio_keys_irq_isr host tests (4 scenarios)\n"
...
def main() -> int:
    ...
    for cycle in (1, 2):
        ...
        command = [
            ...
            "-frandom-seed=gpio-keys-nubia-irq-isr",
    ...
    report = {
        ...
        "mode": "offline_direct_source_gpio_keys_irq_isr_asan_ubsan",
        "driver": "gpio_keys_nubia",
        "target": "gpio_keys_irq_isr",
        "covered_functions": ["gpio_keys_irq_isr"],
        "source": str(source),
