#!/usr/bin/env python3
"""Build and run the zte_fingerprint host harness twice."""
...
def main() -> int:
    ...
    output = engineering / "validation" / "zte_fingerprint" / "host"
    ...
    passed = (
        ...
        and all("PASS zte_fingerprint host tests" in report["stdout"]
    ...
    payload = {
        ...
        "source": str(driver / "zte_fingerprint.c"),
    ...
    report = engineering / "validation" / "zte_fingerprint" / "host_test_report.json"
