ssize_t set_one_key(struct file *file, const char __user *buffer, size_t count, loff_t *offset)
{
  ...
  else
  {
    v6 = v9;
    v9 = v9;
    printk(unk_374F7, "set_one_key", v6);
    v7 = *(void (__fastcall **)(__int64, _BOOL8))(v4 + 3392);
    if ( v7 )
    {
      v8 = v9;
      /* CFI check removed */
