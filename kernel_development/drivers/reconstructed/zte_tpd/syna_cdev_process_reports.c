int syna_cdev_process_reports(unsigned char a1, const unsigned char *payload,
                              unsigned int a3, void *context)
{
  const void *a2 = payload;
  __int64 *a4 = (__int64 *)context;
  unsigned int v4; // w19
  _QWORD *v5; // x26
  __int64 v6; // x22
  signed int v7; // w20
  ...
  if ( !a4 )
  {
    printk(unk_38D56, "syna_cdev_process_reports");
  ...
  if ( !a2 )
  {
    printk(unk_35B39, "syna_cdev_update_fifo");
    v38 = -22;
    goto LABEL_70;
  }
  v6 = *a4;
...
LABEL_64:
  ...
  {
LABEL_65:
    printk(unk_35592, "syna_cdev_update_fifo", (unsigned int)v10, v4);
LABEL_69:
    v38 = -12;
    goto LABEL_70;
  }
...
LABEL_33:
        ...
        if ( v24 < 0x4B0 )
        {
          ...
          {
            printk(unk_37E9C, "syna_cdev_push_data_to_fifo");
        ...
        else
        {
          if ( v24 != syna_cdev_push_data_to_fifo_pre_remaining_frames )
            printk(unk_341DE, "syna_cdev_push_data_to_fifo");
          v25 = (_QWORD *)a4[159];
          v26 = (_QWORD *)v25[1];
...
LABEL_78:
        ...
        {
          printk(unk_35B63, "syna_cdev_push_data_to_fifo");
          printk(unk_3B1BE, "syna_cdev_push_data_to_fifo", 48);
        }
        mutex_unlock(&qword_316D0);
        v36 = printk(unk_34D82, "syna_cdev_update_fifo");
        v38 = -12;
        v37 = 1;
        goto LABEL_54;
      }
LABEL_81:
    ...
    printk(unk_3944E, "syna_pal_mem_cpy", (unsigned int)v15,
           (unsigned int)v9, (unsigned int)v15);
  }
...
LABEL_58:
  ...
  {
LABEL_70:
    printk(unk_39968, "syna_cdev_process_reports", v50, v4);
    return v38;
  }
  return 0;
}
