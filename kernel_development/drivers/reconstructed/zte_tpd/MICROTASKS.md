...
| 015_tpd_proc_deinit | tpd_proc_deinit | 00107fa4 | lifecycle | tpd_proc_deinit.c:tpd_proc_deinit | PROMOTED_OFFLINE_EXACT |
| 016_zte_touch_pdev_register | zte_touch_pdev_register | 001081c8 | core_logic | zte_touch_pdev_register.c:zte_touch_pdev_register | PROMOTED_OFFLINE_EXACT |
...
| 054_tp_edge_report_limit_write | tp_edge_report_limit_write | 0010b690 | user_abi | tp_edge_report_limit_write.c:tp_edge_report_limit_write | PROMOTED_OFFLINE_EXACT |
...
| 057_get_play_game | get_play_game | 0010bc14 | core_logic | get_play_game.c:get_play_game | PROMOTED_OFFLINE_EXACT |
...
| 061_get_follow_hand_level | get_follow_hand_level | 0010bf8c | core_logic | get_follow_hand_level.c:get_follow_hand_level | PROMOTED_OFFLINE_EXACT |
| 062_set_follow_hand_level | set_follow_hand_level | 0010c080 | core_logic | set_follow_hand_level.c:set_follow_hand_level | PROMOTED_OFFLINE_EXACT |
...
| 092_tp_frame_data_write | tp_frame_data_write | 0010de08 | user_abi | tp_frame_data_write.c:tp_frame_data_write | PASS (offline-exact v2) |
| 093_tpd_sysfs_fwimage_show | tpd_sysfs_fwimage_show | 0010dedc | user_abi | tpd_sysfs_fwimage_show.c:tpd_sysfs_fwimage_show | PASS (offline-exact v2) |
| 094_tpd_sysfs_fwimage_store | tpd_sysfs_fwimage_store | 0010dff0 | user_abi | tpd_sysfs_fwimage_store.c:tpd_sysfs_fwimage_store | PASS (offline-exact v2) |
...
| 101_tp_ghost_check | tp_ghost_check | 0010f400 | core_logic | tp_ghost_check_exact.S:tp_ghost_check | PASS |
...
| 109_tpd_id4_report_work | tpd_id4_report_work | 0010fd58 | async_or_irq | tpd_id4_report_work_exact.S:tpd_id4_report_work | PROMOTED_OFFLINE_EXACT |
| 110_tpd_id5_report_work | tpd_id5_report_work | 0010fd84 | async_or_irq | tpd_id5_report_work_exact.S:tpd_id5_report_work | PROMOTED_OFFLINE_EXACT |
...
| 115_tpd_report_work_deinit | tpd_report_work_deinit | 0010fe60 | lifecycle | tpd_report_work_deinit_exact.S:tpd_report_work_deinit | PROMOTED_OFFLINE_EXACT |
...
| 124_ufp_report_lcd_state_delayed_work | ufp_report_lcd_state_delayed_work | 00110624 | async_or_irq | ufp_report_lcd_state_delayed_work.c:ufp_report_lcd_state_delayed_work | PROMOTED_OFFLINE_EXACT |
...
| 130_tpd_resume_work_deinit | tpd_resume_work_deinit | 00110810 | lifecycle | tpd_resume_work_deinit.c:tpd_resume_work_deinit | PROMOTED_OFFLINE_EXACT |
...
| 136_ufp_report_lcd_state | ufp_report_lcd_state | 00110ee0 | core_logic | ufp_report_lcd_state.c:ufp_report_lcd_state | PROMOTED_OFFLINE_EXACT |
| 137_ufp_notifier_cb | ufp_notifier_cb | 00110f84 | async_or_irq | ufp_notifier_cb.c:ufp_notifier_cb | PASS (offline-exact v2) |
| 138_ufp_mac_init | ufp_mac_init | 00110fb0 | lifecycle | ufp_mac_init.c:ufp_mac_init | PROMOTED_OFFLINE_EXACT |
...
| 144_syna_dev_do_reflash | syna_dev_do_reflash | 001113fc | core_logic | syna_dev_do_reflash.c:syna_dev_do_reflash | PROMOTED_OFFLINE_EXACT |
...
| 147_syna_dev_set_follow_hand_level | syna_dev_set_follow_hand_level | 00111718 | core_logic | syna_dev_set_follow_hand_level.c:syna_dev_set_follow_hand_level | PASS (offline-exact v2) |
| 148_syna_dev_set_stability_level | syna_dev_set_stability_level | 001118a4 | core_logic | syna_dev_set_stability_level.c:syna_dev_set_stability_level | PASS (offline-exact v2) |
| 149_syna_dev_set_display_rotation | syna_dev_set_display_rotation | 00111a30 | core_logic | syna_dev_set_display_rotation.c:syna_dev_set_display_rotation | PASS (offline-exact v2) |
| 150_syna_dev_set_play_game | syna_dev_set_play_game | 00111b38 | core_logic | syna_dev_set_play_game.c:syna_dev_set_play_game | PASS (offline-exact v2) |
| 151_syna_recovery_game_mode_after_reset | syna_recovery_game_mode_after_reset | 00111bac | core_logic | syna_recovery_game_mode_after_reset.c:syna_recovery_game_mode_after_reset | PASS (offline-exact v2) |
| 152_syna_dev_get_frame_data | syna_dev_get_frame_data | 00111d48 | core_logic | syna_dev_get_frame_data.c:syna_dev_get_frame_data | PASS (offline-exact v2) |
| 153_syna_ts_check_dt | syna_ts_check_dt | 00111dc4 | core_logic | syna_ts_check_dt.c:syna_ts_check_dt | PASS (offline-exact v2) |
| 154_zte_reset_frame_list | zte_reset_frame_list | 00111f64 | core_logic | zte_reset_frame_list.c:zte_reset_frame_list | PASS (offline-exact v2) |
...
| 174_syna_poll | syna_poll | 00114510 | core_logic | syna_poll.c:syna_poll | PASS (offline-exact v2) |
| 175_syna_ioctl | syna_ioctl | 00114580 | user_abi | syna_ioctl.c:syna_ioctl | PASS (offline-exact v2) |
...
| 178_syna_release | syna_release | 001148e0 | user_abi | syna_release.c:syna_release | PASS (offline-exact v2) |
...
| 180_tpd_goodix_ts_resume | tpd_goodix_ts_resume | 00114a44 | binding | tpd_goodix_ts_resume.c:tpd_goodix_ts_resume | PASS (offline-exact v2) |
| 181_tpd_goodix_ts_suspend | tpd_goodix_ts_suspend | 00114a6c | binding | tpd_goodix_ts_suspend.c:tpd_goodix_ts_suspend | PASS (offline-exact v2) |
| 182_syna_pm_suspend | syna_pm_suspend | 00114a94 | binding | syna_pm_suspend.c:syna_pm_suspend | PASS (offline-exact v2) |
| 183_syna_pm_resume | syna_pm_resume | 00114ae0 | binding | syna_pm_resume.c:syna_pm_resume | PASS (offline-exact v2) |
| 184_syna_cdev_create | syna_cdev_create | 00114b3c | core_logic | syna_cdev_create.c:syna_cdev_create | PASS (offline-exact v2) |
| 185_syna_cdev_devnode | syna_cdev_devnode | 00114db8 | core_logic | syna_cdev_devnode.c:syna_cdev_devnode | PASS (offline-exact v2) |
| 186_syna_cdev_remove | syna_cdev_remove | 00114e04 | binding | syna_cdev_remove.c:syna_cdev_remove | PASS (offline-exact v2) |
| 187_syna_cdev_llseek | syna_cdev_llseek | 00114f98 | core_logic | syna_cdev_llseek.c:syna_cdev_llseek | PASS (offline-exact v2) |
...
| 195_syna_cdev_process_reports | syna_cdev_process_reports | 00117c90 | core_logic | syna_cdev_process_reports_exact.S:syna_cdev_process_reports | PROMOTED_OFFLINE_EXACT |
...
| 201_syna_spi_probe | syna_spi_probe | 00118544 | binding | syna_spi_probe_exact.S:syna_spi_probe | PROMOTED_OFFLINE_EXACT |
| 202_syna_spi_remove | syna_spi_remove | 00119670 | binding | syna_spi_remove_exact.S:syna_spi_remove | PROMOTED_OFFLINE_EXACT |
| 203_syna_spi_read | syna_spi_read | 00119800 | user_abi | syna_spi_read_exact.S:syna_spi_read | PROMOTED_OFFLINE_EXACT |
...
| 213_syna_sysfs_get_delta_show | syna_sysfs_get_delta_show | 0011aadc | user_abi | syna_sysfs_get_delta_show_exact.S:syna_sysfs_get_delta_show | PROMOTED_OFFLINE_EXACT |
...
| 215_syna_sysfs_irq_en_store | syna_sysfs_irq_en_store | 0011b12c | user_abi | syna_sysfs_irq_en_store_exact.S:syna_sysfs_irq_en_store | PROMOTED_OFFLINE_EXACT |
...
| 225_syna_testing_pt01_show | syna_testing_pt01_show | 0011c410 | user_abi | syna_testing_pt01_show_exact.S:syna_testing_pt01_show | PROMOTED_OFFLINE_EXACT |
...
| 235_syna_tcm_testing_build_id | syna_tcm_testing_build_id | 0011d33c | core_logic | syna_tcm_testing_build_id_exact.S:syna_tcm_testing_build_id | PROMOTED_OFFLINE_EXACT |
...
| 244_syna_tcm_get_testing_0100 | syna_tcm_get_testing_0100 | 0011daec | core_logic | syna_tcm_get_testing_0100.c:syna_tcm_get_testing_0100 | PROMOTED_OFFLINE_EXACT |
| 245_syna_tcm_testing_trx_trx_short | syna_tcm_testing_trx_trx_short | 0011dafc | core_logic | syna_tcm_testing_trx_trx_short.c:syna_tcm_testing_trx_trx_short | PROMOTED_OFFLINE_EXACT |
...
| 266_syna_tcm_allocate_device | syna_tcm_allocate_device | 00121124 | core_logic | syna_tcm_allocate_device.c:syna_tcm_allocate_device | PASS |
...
| 270_syna_tcm_buf_copy | syna_tcm_buf_copy | 00121c10 | core_logic | syna_tcm_buf_copy_2.c:syna_tcm_buf_copy_2 | PROMOTED_OFFLINE_EXACT |
| 271_syna_tcm_identify | syna_tcm_identify | 00121f54 | core_logic | syna_tcm_identify.c:syna_tcm_identify | PROMOTED_OFFLINE_EXACT |
...
| 278_syna_tcm_get_app_info | syna_tcm_get_app_info | 00122c08 | core_logic | syna_tcm_get_app_info.c:syna_tcm_get_app_info | PROMOTED_OFFLINE_EXACT |
...
| 285_syna_tcm_sleep | syna_tcm_sleep | 001238fc | core_logic | syna_tcm_sleep.c:syna_tcm_sleep | PROMOTED_OFFLINE_EXACT |
| 286_syna_tcm_get_features | syna_tcm_get_features | 00123a08 | core_logic | syna_tcm_get_features.c:syna_tcm_get_features | PROMOTED_OFFLINE_EXACT |
...
| 288_syna_tcm_send_command | syna_tcm_send_command | 00123dc0 | core_logic | syna_tcm_send_command.c:syna_tcm_send_command | PROMOTED_OFFLINE_EXACT |
...
| 298_syna_tcm_read_flash_area | syna_tcm_read_flash_area | 00124ab4 | user_abi | syna_tcm_read_flash_area.c:syna_tcm_read_flash_area | PASS |
...
| 325_string_change | string_change | 0012aecc | core_logic | string_change.c:string_change | PASS |
