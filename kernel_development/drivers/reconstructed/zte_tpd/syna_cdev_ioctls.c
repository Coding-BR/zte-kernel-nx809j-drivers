...
#define v282 u_v282.v282
#define v283 u_v282.v283
...
LABEL_356:
  ...
  v20 = _arch_copy_from_user(&u_v282, a3 & 0xFF7FFFFFFFFFFFFFLL, 16);
...
LABEL_269:
    ...
    {
      v186 = v20;
      memset((char *)&u_v282 - v20 + 16, 0, v20);
      v183 = unk_34178;
...
LABEL_381:
      ...
      else
      {
        ...
        if ( *(_QWORD *)(v29 + 64) )
        {
          ...
          _check_object_size(&u_src, HIDWORD(v282), 0);
          ...
          if ( 0x8000000000LL - v25 >= v30 )
          {
            ...
            v6 = _arch_copy_from_user(&u_src, v27 & 0xFF7FFFFFFFFFFFFFLL, v25);
...
LABEL_354:
                        ...
                        else
                        {
                          ...
                          v185 = _arch_copy_to_user(a3 & 0xFF7FFFFFFFFFFFFFLL, &u_v282, 16);
        ...
        if ( !v20 )
        {
          ...
          if ( (_QWORD *)v5[159] == v5 + 159 )
          {
            ...
            if ( !v92 && v91 )
            {
              ...
              {
LABEL_145:
                finish_wait(v5 + 161, (struct wait_queue_entry *)&u_src);
                LODWORD(v91) = v94;
              }
              else
              {
...
LABEL_453:
    ...
    case 6:
      ...
      _check_object_size(&u_src, (unsigned int)v282, 0);
      ...
      if ( 0x8000000000LL - v6 >= v164 )
      {
        ...
        v165 = _arch_copy_from_user(&u_src, v27 & 0xFF7FFFFFFFFFFFFFLL, v6);
...
LABEL_466:
    ...
    case 10:
      ...
      else
      {
        ...
        v20 = _arch_copy_from_user(&u_src, v27 & 0xFF7FFFFFFFFFFFFFLL, 5);
        ...
        if ( !v20 )
        {
          v147 = *(unsigned __int16 *)((char *)&u_src + 3);
          if ( *(_WORD *)((char *)&u_src + 1) )
            *(_DWORD *)(v5[78] + 252LL) = *(unsigned __int16 *)((char *)&u_src + 1);
          if ( v147 )
          ...
          *(_DWORD *)(v5[78] + 248LL) = v6;
          ...
          {
            if ( (*(_BYTE *)(v5[78] + 188LL) & 1) == 0 )
              syna_tcm_get_event_data(*v5, (unsigned __int8 *)&v284, 0);
            if ( *(_BYTE *)(*v5 + 9LL) == 1 )
            {
