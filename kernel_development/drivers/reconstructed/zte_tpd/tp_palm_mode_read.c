ssize_t tp_palm_mode_read(struct file *file, char __user *buffer, size_t count, loff_t *offset)
{
  ...
  *(_QWORD *)s = 0;
  ...
  {
    v8 = tpd_cdev;
    v10 = *(void (__fastcall **)(_QWORD))(tpd_cdev + 3568);
    if ( v10 )
    {
      v11 = tpd_cdev;
      /* CFI check removed */
    ...
    printk(unk_34061, "tp_palm_mode_read", *(unsigned int *)(v8 + 1144));
