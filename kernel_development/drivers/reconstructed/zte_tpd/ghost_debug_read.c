...
ssize_t ghost_debug_read(struct file *file, char __user *buffer, size_t count, loff_t *offset)
{
  ...
  {
    v12 = (char *)v9;
    printk(unk_333B9, *(unsigned __int8 *)(v7 + 1169));
    printk(unk_35E38, *(unsigned __int8 *)(v7 + 1170));
    printk(unk_333DE, *(unsigned __int8 *)(v7 + 1171));
    printk(unk_33A77, *(unsigned __int8 *)(v7 + 1172));
    printk(unk_396F5, *(unsigned __int8 *)(v7 + 1173));
    printk(unk_38C31, *(unsigned int *)(v7 + 1176));
    printk(unk_364EF, *(unsigned int *)(v7 + 1180));
    printk(unk_31D70, *(unsigned int *)(v7 + 1184));
    printk(unk_33A9C, *(unsigned int *)(v7 + 1188));
    strcpy(
      v12 + 41,
