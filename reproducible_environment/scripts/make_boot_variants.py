...
def main() -> None:
    ...
    make_boot(kernel.read_bytes(), stock_header["cmdline"] + b" androidboot.selinux=permissive", out)
    ...
    make_boot(kernel.read_bytes(), stock_header["cmdline"] + b" androidboot.selinux=permissive", raw_out)
