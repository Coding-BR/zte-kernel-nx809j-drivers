...
- [`zte_tpd`: candidato estatico, KMI 152/152, mapa 367/367, KCFI 311/322 e 247/367 microtarefas PASS](./kernel_development/drivers/reconstructed/zte_tpd/STATUS.md)
...
- [Esteira dual Ghidra + Joern para consistencia estrutural e fluxo](./reverse_engineering/docs/PIPELINE_DUAL_GHIDRA_JOERN.md)
- [Atestacao de microtarefas com Ghidra, KCFI, Joern e harness](./reverse_engineering/docs/JOERN_MICROTASK_ATTESTATION.md)
- [Decomposição por função: pseudocódigo C, P-Code e Assembly](./reverse_engineering/docs/DECOMPOSICAO_MODULOS_STOCK.md)
- [Protocolo para equivalencia binaria sensivel ao compilador](./reverse_engineering/docs/PROTOCOLO_EQUIVALENCIA_BINARIA_COMPILADOR.md)
...
- [Delegacao por capacidade e microprovas para pessoas e LLMs menores](./reverse_engineering/docs/PIPELINE_DELEGACAO_LLM_E_MICROPROVAS.md)
...
- [`zte_tpd`: static candidate, exact 152/152 KMI, 367/367 map, 311/322 KCFI, and 247/367 PASS microtasks](./kernel_development/drivers/reconstructed/zte_tpd/STATUS.md)
...
- [Dual Ghidra + Joern pipeline for structural and data-flow consistency](./reverse_engineering/docs/PIPELINE_DUAL_GHIDRA_JOERN.md)
- [Microtask attestation with Ghidra, KCFI, Joern, and a harness](./reverse_engineering/docs/JOERN_MICROTASK_ATTESTATION.md)
- [Per-function decomposition: C pseudocode, P-Code, and assembly](./reverse_engineering/docs/DECOMPOSICAO_MODULOS_STOCK.md)
- [Protocol for compiler-sensitive binary equivalence](./reverse_engineering/docs/PROTOCOLO_EQUIVALENCIA_BINARIA_COMPILADOR.md)
...
- [Capability-based delegation and microproof workflow (Portuguese)](./reverse_engineering/docs/PIPELINE_DELEGACAO_LLM_E_MICROPROVAS.md)
