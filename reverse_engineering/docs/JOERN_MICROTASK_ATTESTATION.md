...
## Checkpoint aplicado: `tpd_goodix_ts_resume`

`zte_tpd:tpd_goodix_ts_resume` foi confirmado como leitura de `pdev + 8`,
ajuste em `+0x10` e encaminhamento para `syna_dev_resume`, preservando seu
