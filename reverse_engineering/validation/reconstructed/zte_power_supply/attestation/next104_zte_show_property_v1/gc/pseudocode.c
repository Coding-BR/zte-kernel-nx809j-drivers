/* 001010ac zte_power_supply_get_property */
...

{
  ...
  if (*(int *)(*(code **)(*param_1 + 0x30) + -4) != -0x7a95136b) {
    ...
    pcVar1 = (code *)SoftwareBreakpoint(0x8228,0x1010e4);
    (*pcVar1)();
  }
...
/* 00101110 zte_power_supply_set_property */
...

{
  ...
  if ((0 < (int)param_1[0x8b]) && (pcVar2 = *(code **)(*param_1 + 0x38), pcVar2 != (code *)0x0)) {
    if (*(int *)(pcVar2 + -4) != 0x1c0179c9) {
                    /* WARNING: Does not return */
      pcVar2 = (code *)SoftwareBreakpoint(0x8228,0x10114c);
      (*pcVar2)();
    }
    uVar1 = (*pcVar2)();
    return uVar1;
...
/* 00101168 zte_power_supply_property_is_writeable */
...

{
  ...
  if ((0 < (int)param_1[0x8b]) && (pcVar2 = *(code **)(*param_1 + 0x40), pcVar2 != (code *)0x0)) {
    if (*(int *)(pcVar2 + -4) != 0x3f091c91) {
                    /* WARNING: Does not return */
      pcVar2 = (code *)SoftwareBreakpoint(0x8228,0x1011a4);
      (*pcVar2)();
    }
    uVar1 = (*pcVar2)();
    return uVar1;
...
/* 001011c0 zte_power_supply_init_attrs */
...

{
  ...
  *(undefined ***)(param_1 + 8) = &zte_power_supply_attr_groups;
  uVar7 = _printk(&DAT_0010382c,0x13);
  lVar9 = 0;
  uVar8 = 0;
  do {
    lVar3 = uVar8 * 0x58;
    if ((&zte_power_supply_attrs)[uVar8 * 0xb] == (undefined *)0x0) {
      _printk(&DAT_00103462,"zte_power_supply_init_attrs",uVar8 & 0xffffffff);
      uVar6 = sprintf(&DAT_00100288 + lVar3,"_err_%d",uVar8 & 0xffffffff);
      uVar7 = (ulong)uVar6;
    }
    else {
      bVar2 = (&DAT_00100288)[lVar3];
      lVar4 = lVar9;
      while (bVar2 != 0) {
        if ((0x687 < lVar4 + 8U) ||
           ((&DAT_00100288)[lVar4] = ((&_ctype)[bVar2] & 1) * ' ' + bVar2, lVar4 == 0x67f)) {
                    /* WARNING: Does not return */
          pcVar5 = (code *)SoftwareBreakpoint(1,0x101300);
          (*pcVar5)();
        }
        bVar2 = (&DAT_00100289)[lVar4];
        lVar4 = lVar4 + 1;
      }
    }
    lVar9 = lVar9 + 0x58;
    (&DAT_001002a8)[uVar8 * 0xb] = &DAT_00100288 + lVar3;
    (&__zte_power_supply_attrs)[uVar8] = &DAT_001002a8 + uVar8 * 0xb;
    uVar1 = uVar8 + 1;
    (&DAT_001002b8)[uVar8 * 0xb] = zte_power_supply_show_property;
    (&DAT_001002c0)[uVar8 * 0xb] = zte_power_supply_store_property;
    uVar8 = uVar1;
    if (uVar1 == 0x13) {
      return uVar7;
    }
...
/* 00101304 zte_power_supply_show_property */
...

{
  ...
  local_40 = 0;
  iVar3 = (int)((ulong)(param_2 + -0x20055) >> 3) * -0x45d1745d;
  if (iVar3 == 0x40) {
...
/* 00101470 zte_power_supply_store_property */
...

{
  ...
  iVar2 = zte_power_supply_set_property
                    (uVar4,(int)(param_2 - 0x1002a8U >> 3) * -0x45d1745d,&local_40);
  lVar3 = (long)iVar2;
  if (-1 < iVar2) {
    lVar3 = param_4;
  }
...
/* 00101554 zte_power_supply_reg_notifier */
...
/* 00101580 zte_power_supply_unreg_notifier */
...
/* 001015ac zte_power_supply_changed */
...
/* 00101610 __zte_power_supply_find_supply_from_node */
...
/* 00101628 zte_power_supply_register */
...
/* 00101648 __zte_power_supply_register */
...

{
  ...
  if (param_1 == 0) {
    _printk(&DAT_00103614,"__zte_power_supply_register",*param_2);
  }
...
LAB_00101798:
    ...
    if (plVar6 == (long *)0x0) {
      ...
      *plVar6 = (long)param_2;
      ...
      iVar5 = dev_set_name(plVar6 + 7,&DAT_001035bc,*param_2);
      if (iVar5 == 0) {
...
/* 00101940 zte_power_supply_register_no_ws */
...
/* 00101964 zte_power_supply_unregister */
...

{
  ...
  if (iVar2 + -1 != 0) {
                    /* WARNING: Does not return */
    pcVar5 = (code *)SoftwareBreakpoint(0x800,0x101a0c);
    (*pcVar5)();
  }
...
/* 00101a14 zte_devm_power_supply_register */
...
/* 00101abc zte_devm_power_supply_release */
...
/* 00101ae0 zte_devm_power_supply_register_no_ws */
...
/* 00101b88 zte_power_supply_get_by_name */
...
/* 00101c4c zte_power_supply_get_by_phandle */
...
/* 00101d1c zte_power_supply_match_device_node */
...
/* 00101d40 zte_power_supply_get_by_phandle_array */
...
/* 00101e10 zte_power_supply_match_device_node_array */
...
/* 00101e9c zte_power_supply_get_drvdata */
...
/* 00101ea8 zte_power_supply_uevent */
      ...
      if (__s == (char *)0x0) {
        ...
        if (*(long *)(lVar6 + 0x28) != 0) {
          ...
          do {
            ...
            if (0x12 < uVar1) {
                    /* WARNING: Does not return */
              pcVar2 = (code *)SoftwareBreakpoint(0x800,0x101ff8);
              (*pcVar2)();
            }
            uVar4 = zte_power_supply_show_property(param_1,&DAT_001002a8 + (ulong)uVar1 * 0xb,__s);
            iVar3 = (int)uVar4;
            if (iVar3 != -0x3d && iVar3 != -0x13) {
              if (iVar3 < 0) goto LAB_00101fdc;
              ...
              if ((int)uVar4 != 0) goto LAB_00101fdc;
            }
            lVar6 = *plVar8;
            uVar7 = (ulong)iVar9;
            iVar9 = iVar9 + 1;
...
/* 0010202c zte_power_supply_external_power_changed */
...

{
  ...
  if ((0 < (int)param_1[0x8b]) && (pcVar1 = *(code **)(*param_1 + 0x48), pcVar1 != (code *)0x0)) {
    if (*(int *)(pcVar1 + -4) != 0x6f39adef) {
                    /* WARNING: Does not return */
      pcVar1 = (code *)SoftwareBreakpoint(0x8228,0x102068);
      (*pcVar1)();
    }
    (*pcVar1)();
  }
...
/* 0010207c zte_power_supply_set_battery_charged */
...

{
  ...
  if (((-1 < (int)param_1[0x8b]) && (*(int *)(*param_1 + 8) == 1)) &&
    ...
    if (*(int *)(pcVar1 + -4) != 0x6f39adef) {
                    /* WARNING: Does not return */
      pcVar1 = (code *)SoftwareBreakpoint(0x8228,0x1020c0);
      (*pcVar1)();
    }
    (*pcVar1)();
    return 0;
...
/* 001020e0 zte_power_supply_powers */
...
/* 0010210c zte_power_supply_put_battery_info */
...
/* 0010217c zte_power_supply_find_ocv2cap_table */
  ...
  if ((uVar4 & 0xff) < 0x14) {
    *param_3 = *(undefined4 *)(param_1 + (ulong)(byte)uVar4 * 4 + 0x168);
    return ((long *)(param_1 + 200))[uVar5 & 0xff];
                    ...
                    /* WARNING: Does not return */
  pcVar3 = (code *)SoftwareBreakpoint(0x5512,0x1021ec);
  (*pcVar3)();
}



/* 001021f0 zte_devm_power_supply_get_by_phandle */
...
/* 00102350 zte_devm_power_supply_put */
...
/* 001023a8 power_supply_attr_is_visible */
...

{
  ...
  if (0x12 < (int)param_3) {
                    /* WARNING: Does not return */
    pcVar4 = (code *)SoftwareBreakpoint(0x800,0x102478);
    (*pcVar4)();
  }
  if (0x12 < param_3) {
                    /* WARNING: Does not return */
    pcVar4 = (code *)SoftwareBreakpoint(0x5512,0x102474);
    (*pcVar4)();
  }
      ...
      do {
        if (*(uint *)(*(long *)(lVar3 + 0x20) + uVar5 * 4) == param_3) {
          ...
          if (*(int *)(pcVar4 + -4) != 0x3f091c91) {
                    /* WARNING: Does not return */
            pcVar4 = (code *)SoftwareBreakpoint(0x8228,0x102450);
            (*pcVar4)();
          }
...
/* 0010247c zte_power_supply_dev_release */
...
/* 001024a0 zte_power_supply_changed_work */
...
/* 00102560 zte_power_supply_deferred_register_work */
...
/* 00102658 zte_power_supply_check_supplies */
...
/* 00102808 __zte_power_supply_changed_work */
...
LAB_001028b8:
          ...
          if (*(int *)(pcVar3 + -4) == 0x6f39adef) {
            ...
            return 0;
                    ...
                    /* WARNING: Does not return */
          pcVar3 = (code *)SoftwareBreakpoint(0x8228,0x1028dc);
          (*pcVar3)();
        }
        uVar2 = (ulong)iVar9;
        iVar9 = iVar9 + 1;
...
/* 00102900 __zte_power_supply_populate_supplied_from */
...

{
  ...
  do {
    ...
    if ((iVar2 != 0) || (local_88[0] == 0)) goto LAB_001029c0;
    iVar3 = iVar3 + 1;
...
/* 001029f8 zte_power_supply_get_battery_info */
...
joined_r0x00102fb0:
                ...
                if (uVar14 == 0x14) {
                    /* WARNING: Does not return */
                  pcVar6 = (code *)SoftwareBreakpoint(0x5512,0x10302c);
                  (*pcVar6)();
                }
                uVar2 = (uint)local_b8;
...
/* 00103030 zte_power_supply_match_device_by_name */
...
/* 00103064 zte_power_supply_temp2resist_simple */
...
/* 001030d0 zte_power_supply_ocv2cap_simple */
...
/* 0010313c zte_power_supply_batinfo_ocv2cap */
...

{
  ...
  if (*(long *)(param_1 + 200) != 0) {
    ...
    if (0x13 < (uVar4 & 0xff)) {
                    /* WARNING: Does not return */
      pcVar3 = (code *)SoftwareBreakpoint(0x5512,0x10320c);
      (*pcVar3)();
    }
