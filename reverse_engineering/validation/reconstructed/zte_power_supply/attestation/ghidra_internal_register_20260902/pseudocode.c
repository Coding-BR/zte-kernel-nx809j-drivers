/* 00101134 zte_power_supply_get_property */
...

{
  ...
  if (*(int *)(*(code **)(*param_1 + 0x30) + -4) != -0x7a95136b) {
    ...
    pcVar1 = (code *)SoftwareBreakpoint(0x8228,0x10116c);
    (*pcVar1)();
  }
...
/* 00101198 zte_power_supply_set_property */
...

{
  ...
  if ((0 < (int)param_1[0x8b]) && (pcVar2 = *(code **)(*param_1 + 0x38), pcVar2 != (code *)0x0)) {
    if (*(int *)(pcVar2 + -4) != 0x1c0179c9) {
                    /* WARNING: Does not return */
      pcVar2 = (code *)SoftwareBreakpoint(0x8228,0x1011d4);
      (*pcVar2)();
    }
    uVar1 = (*pcVar2)();
    return uVar1;
...
/* 001011f0 zte_power_supply_property_is_writeable */
...

{
  ...
  if ((0 < (int)param_1[0x8b]) && (pcVar2 = *(code **)(*param_1 + 0x40), pcVar2 != (code *)0x0)) {
    if (*(int *)(pcVar2 + -4) != 0x3f091c91) {
                    /* WARNING: Does not return */
      pcVar2 = (code *)SoftwareBreakpoint(0x8228,0x10122c);
      (*pcVar2)();
    }
    uVar1 = (*pcVar2)();
    return uVar1;
...
/* 00101248 zte_power_supply_init_attrs */
...

{
  ...
  *(undefined ***)(param_1 + 8) = &zte_power_supply_groups;
  uVar7 = _printk(&DAT_0010366f,0x13);
  lVar9 = 0;
  uVar8 = 0;
  do {
    lVar3 = uVar8 * 0x58;
    if ((&zte_power_supply_attrs)[uVar8 * 0xb] == (undefined *)0x0) {
      _printk(&DAT_0010353b,"zte_power_supply_init_attrs",uVar8 & 0xffffffff);
      ...
      while (bVar2 != 0) {
        if ((0x687 < lVar4 + 8U) ||
           (s_STATUS_00100260[lVar4] = ((&_ctype)[bVar2] & 1) * ' ' + bVar2, lVar4 == 0x67f)) {
                    /* WARNING: Does not return */
          pcVar5 = (code *)SoftwareBreakpoint(1,0x101388);
          (*pcVar5)();
        }
...
/* 0010138c zte_power_supply_show_property */
...
/* 001014fc zte_power_supply_store_property */
...
/* 001015e0 zte_power_supply_reg_notifier */
...
/* 0010160c zte_power_supply_unreg_notifier */
...
/* 00101638 zte_power_supply_changed */
...
/* 0010169c zte_power_supply_register */
...
/* 001016bc __zte_power_supply_register */
...

{
  ...
  if (param_1 == 0) {
    _printk(&DAT_00103743,"__zte_power_supply_register",*param_2);
  }
...
LAB_0010180c:
    ...
    if (plVar6 == (long *)0x0) {
      ...
      *plVar6 = (long)param_2;
      ...
      iVar5 = dev_set_name(plVar6 + 7,&DAT_001036e1,*param_2);
      if (iVar5 == 0) {
...
/* 001019b4 zte_power_supply_register_no_ws */
...
/* 001019d8 zte_power_supply_unregister */
...

{
  ...
  if (iVar2 + -1 != 0) {
                    /* WARNING: Does not return */
    pcVar5 = (code *)SoftwareBreakpoint(0x800,0x101a80);
    (*pcVar5)();
  }
...
/* 00101a88 zte_devm_power_supply_register */
...
/* 00101b30 zte_devm_power_supply_release */
...
/* 00101b54 zte_devm_power_supply_register_no_ws */
...
/* 00101bfc zte_power_supply_get_by_name */
...
/* 00101cc0 zte_power_supply_get_by_phandle */
...
/* 00101d90 zte_power_supply_match_device_node */
...
/* 00101db4 zte_power_supply_get_by_phandle_array */
...
/* 00101e84 zte_power_supply_match_device_node_array */
...
/* 00101f10 zte_power_supply_get_drvdata */
...
/* 00101f1c zte_power_supply_uevent */
        ...
        if (*(long *)(lVar6 + 0x28) != 0) {
          ...
          do {
            ...
            if (iVar3 != -0x3d && iVar3 != -0x13) {
              ...
              if ((int)uVar4 != 0) goto LAB_00102050;
            }
            lVar6 = *plVar8;
            uVar7 = (ulong)iVar9;
            iVar9 = iVar9 + 1;
...
/* 001020a0 zte_power_supply_external_power_changed */
...

{
  ...
  if ((0 < (int)param_1[0x8b]) && (pcVar1 = *(code **)(*param_1 + 0x48), pcVar1 != (code *)0x0)) {
    if (*(int *)(pcVar1 + -4) != 0x6f39adef) {
                    /* WARNING: Does not return */
      pcVar1 = (code *)SoftwareBreakpoint(0x8228,0x1020dc);
      (*pcVar1)();
    }
    (*pcVar1)();
  }
...
/* 001020f0 zte_power_supply_set_battery_charged */
...

{
  ...
  if (((-1 < (int)param_1[0x8b]) && (*(int *)(*param_1 + 8) == 1)) &&
    ...
    if (*(int *)(pcVar1 + -4) != 0x6f39adef) {
                    /* WARNING: Does not return */
      pcVar1 = (code *)SoftwareBreakpoint(0x8228,0x102134);
      (*pcVar1)();
    }
    (*pcVar1)();
    return 0;
...
/* 00102154 zte_power_supply_powers */
...
/* 00102180 zte_power_supply_put_battery_info */
...
/* 001021f0 zte_power_supply_find_ocv2cap_table */
  ...
  if ((uVar4 & 0xff) < 0x14) {
    *param_3 = *(undefined4 *)(param_1 + (ulong)(byte)uVar4 * 4 + 0x168);
    return ((long *)(param_1 + 200))[uVar5 & 0xff];
                    ...
                    /* WARNING: Does not return */
  pcVar3 = (code *)SoftwareBreakpoint(0x5512,0x102260);
  (*pcVar3)();
}



/* 00102264 zte_devm_power_supply_get_by_phandle */
...
/* 001023c4 zte_devm_power_supply_put */
...
/* 0010241c power_supply_attr_is_visible */
...

{
  ...
  if (0x12 < (int)param_3) {
                    /* WARNING: Does not return */
    pcVar4 = (code *)SoftwareBreakpoint(0x800,0x1024ec);
    (*pcVar4)();
  }
  if (0x12 < param_3) {
                    /* WARNING: Does not return */
    pcVar4 = (code *)SoftwareBreakpoint(0x5512,0x1024e8);
    (*pcVar4)();
  }
      ...
      do {
        if (*(uint *)(*(long *)(lVar3 + 0x20) + uVar5 * 4) == param_3) {
          ...
          if (*(int *)(pcVar4 + -4) != 0x3f091c91) {
                    /* WARNING: Does not return */
            pcVar4 = (code *)SoftwareBreakpoint(0x8228,0x1024c4);
            (*pcVar4)();
          }
...
/* 001024f0 zte_power_supply_dev_release */
...
/* 00102514 zte_power_supply_changed_work */
...
/* 001025d4 zte_power_supply_deferred_register_work */
...
/* 0010267c zte_power_supply_check_supplies */
...
/* 0010286c __zte_power_supply_changed_work */
...
LAB_0010291c:
          ...
          if (*(int *)(pcVar3 + -4) == 0x6f39adef) {
            ...
            return 0;
                    ...
                    /* WARNING: Does not return */
          pcVar3 = (code *)SoftwareBreakpoint(0x8228,0x102940);
          (*pcVar3)();
        }
        uVar2 = (ulong)iVar9;
        iVar9 = iVar9 + 1;
...
/* 00102964 __zte_power_supply_find_supply_from_node */
...
/* 0010297c __zte_power_supply_populate_supplied_from */
...

{
  ...
  do {
    ...
    if ((iVar2 != 0) || (local_88[0] == 0)) goto LAB_00102a3c;
...
/* 00102a74 zte_power_supply_get_battery_info */
...
joined_r0x0010302c:
                ...
                if (uVar14 == 0x14) {
                    /* WARNING: Does not return */
                  pcVar6 = (code *)SoftwareBreakpoint(0x5512,0x1030a8);
                  (*pcVar6)();
                }
                uVar2 = (uint)local_b8;
...
/* 001030ac zte_power_supply_match_device_by_name */
...
/* 001030e0 zte_power_supply_temp2resist_simple */
...
/* 0010314c zte_power_supply_ocv2cap_simple */
...
/* 001031b8 zte_power_supply_batinfo_ocv2cap */
...

{
  ...
  if (*(long *)(param_1 + 200) != 0) {
    ...
    if (0x13 < (uVar4 & 0xff)) {
                    /* WARNING: Does not return */
      pcVar3 = (code *)SoftwareBreakpoint(0x5512,0x103288);
      (*pcVar3)();
    }
