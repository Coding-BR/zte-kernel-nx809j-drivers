/* 0010118c zte_power_supply_get_property */
...

{
  ...
  if (*(int *)(*(code **)(*param_1 + 0x30) + -4) != -0x7a95136b) {
    ...
    pcVar1 = (code *)SoftwareBreakpoint(0x8228,0x1011c4);
    (*pcVar1)();
  }
...
/* 001011f0 zte_power_supply_set_property */
...
/* 00101248 zte_power_supply_property_is_writeable */
...

{
  ...
  if ((0 < (int)param_1[0x8b]) && (pcVar2 = *(code **)(*param_1 + 0x40), pcVar2 != (code *)0x0)) {
    if (*(int *)(pcVar2 + -4) != 0x3f091c91) {
                    /* WARNING: Does not return */
      pcVar2 = (code *)SoftwareBreakpoint(0x8228,0x101284);
      (*pcVar2)();
    }
    uVar1 = (*pcVar2)();
    return uVar1;
...
/* 001012a0 zte_power_supply_init_attrs */
...

{
  ...
  *(undefined ***)(param_1 + 8) = &zte_power_supply_groups;
  uVar7 = _printk(&DAT_0010369f,0x13);
  lVar9 = 0;
  uVar8 = 0;
  do {
    lVar3 = uVar8 * 0x58;
    if ((&zte_power_supply_attrs)[uVar8 * 0xb] == (undefined *)0x0) {
      _printk(&DAT_0010356b,"zte_power_supply_init_attrs",uVar8 & 0xffffffff);
      ...
      while (bVar2 != 0) {
        if ((0x687 < lVar4 + 8U) ||
           (s_STATUS_00100260[lVar4] = ((&_ctype)[bVar2] & 1) * ' ' + bVar2, lVar4 == 0x67f)) {
                    /* WARNING: Does not return */
          pcVar5 = (code *)SoftwareBreakpoint(1,0x1013e0);
          (*pcVar5)();
        }
...
/* 001013e4 zte_power_supply_show_property */
...
/* 00101554 zte_power_supply_store_property */
...
/* 00101638 zte_power_supply_reg_notifier */
...
/* 00101664 zte_power_supply_unreg_notifier */
...
/* 00101690 zte_power_supply_changed */
...
/* 001016f4 zte_power_supply_register */
...
/* 00101714 __zte_power_supply_register */
...

{
  ...
  if (param_1 == 0) {
    ...
    _printk(&DAT_00103773,"__zte_power_supply_register",lVar8);
  }
...
LAB_00101960:
    ...
    if (plVar7 == (long *)0x0) {
      ...
      *plVar7 = (long)param_2;
      ...
      iVar6 = dev_set_name(plVar7 + 7,&DAT_00103711,*param_2);
      if (iVar6 == 0) {
...
/* 001019f8 zte_power_supply_register_no_ws */
...
/* 00101a1c zte_power_supply_unregister */
...

{
  ...
  if (iVar2 + -1 != 0) {
                    /* WARNING: Does not return */
    pcVar5 = (code *)SoftwareBreakpoint(0x800,0x101ac4);
    (*pcVar5)();
  }
...
/* 00101acc zte_devm_power_supply_register */
...
/* 00101b74 zte_devm_power_supply_release */
...
/* 00101b98 zte_devm_power_supply_register_no_ws */
...
/* 00101c40 zte_power_supply_get_by_name */
...
/* 00101d04 zte_power_supply_get_by_phandle */
...
/* 00101dd4 zte_power_supply_match_device_node */
...
/* 00101df8 zte_power_supply_get_by_phandle_array */
...
/* 00101ec8 zte_power_supply_match_device_node_array */
...
/* 00101f54 zte_power_supply_get_drvdata */
...
/* 00101f60 zte_power_supply_uevent */
        ...
        if (*(long *)(lVar6 + 0x28) != 0) {
          ...
          do {
            ...
            if (iVar3 != -0x3d && iVar3 != -0x13) {
              ...
              if ((int)uVar4 != 0) goto LAB_00102094;
            }
            lVar6 = *plVar8;
            uVar7 = (ulong)iVar9;
            iVar9 = iVar9 + 1;
...
/* 001020e4 zte_power_supply_external_power_changed */
...

{
  ...
  if ((0 < (int)param_1[0x8b]) && (pcVar1 = *(code **)(*param_1 + 0x48), pcVar1 != (code *)0x0)) {
    if (*(int *)(pcVar1 + -4) != 0x6f39adef) {
                    /* WARNING: Does not return */
      pcVar1 = (code *)SoftwareBreakpoint(0x8228,0x102120);
      (*pcVar1)();
    }
    (*pcVar1)();
  }
...
/* 00102134 zte_power_supply_set_battery_charged */
...

{
  ...
  if (((-1 < (int)param_1[0x8b]) && (*(int *)(*param_1 + 8) == 1)) &&
    ...
    if (*(int *)(pcVar1 + -4) != 0x6f39adef) {
                    /* WARNING: Does not return */
      pcVar1 = (code *)SoftwareBreakpoint(0x8228,0x102178);
      (*pcVar1)();
    }
    (*pcVar1)();
    return 0;
...
/* 00102198 zte_power_supply_powers */
...
/* 001021c4 zte_power_supply_ocv2cap_simple */
...
/* 00102244 zte_power_supply_put_battery_info */
...
/* 001022b4 zte_power_supply_find_ocv2cap_table */
...

{
  ...
  if (0x13 < uVar5) {
                    /* WARNING: Does not return */
    pcVar4 = (code *)SoftwareBreakpoint(0x5512,0x10231c);
    (*pcVar4)();
  }
...
/* 00102320 zte_power_supply_batinfo_ocv2cap */
...

{
  ...
  if (*(long *)(param_1 + 200) != 0) {
    ...
    if (0x13 < uVar6) {
                    /* WARNING: Does not return */
      pcVar5 = (code *)SoftwareBreakpoint(0x5512,0x1023fc);
      (*pcVar5)();
    }
...
/* 00102400 zte_devm_power_supply_get_by_phandle */
...
/* 00102560 zte_devm_power_supply_put */
...
/* 001025b8 power_supply_attr_is_visible */
...

{
  ...
  if (0x12 < (int)param_3) {
                    /* WARNING: Does not return */
    pcVar4 = (code *)SoftwareBreakpoint(0x800,0x102688);
    (*pcVar4)();
  }
  if (0x12 < param_3) {
                    /* WARNING: Does not return */
    pcVar4 = (code *)SoftwareBreakpoint(0x5512,0x102684);
    (*pcVar4)();
  }
      ...
      do {
        if (*(uint *)(*(long *)(lVar3 + 0x20) + uVar5 * 4) == param_3) {
          ...
          if (*(int *)(pcVar4 + -4) != 0x3f091c91) {
                    /* WARNING: Does not return */
            pcVar4 = (code *)SoftwareBreakpoint(0x8228,0x102660);
            (*pcVar4)();
          }
...
/* 0010268c zte_power_supply_changed_work */
...
/* 0010274c zte_power_supply_deferred_register_work */
...
/* 001027f4 zte_power_supply_check_supplies */
...
/* 001029e4 zte_power_supply_dev_release */
...
/* 00102a08 __zte_power_supply_changed_work */
...
/* 00102b00 __zte_power_supply_find_supply_from_node */
...
/* 00102b18 __zte_power_supply_populate_supplied_from */
...

{
  ...
  do {
    ...
    if ((iVar2 != 0) || (local_88[0] == 0)) goto LAB_00102bd8;
...
/* 00102c10 zte_power_supply_get_battery_info */
...
joined_r0x001031c8:
                ...
                if (uVar14 == 0x14) {
                    /* WARNING: Does not return */
                  pcVar6 = (code *)SoftwareBreakpoint(0x5512,0x103244);
                  (*pcVar6)();
                }
                uVar2 = (uint)local_b8;
...
/* 00103248 zte_power_supply_match_device_by_name */
...
/* 0010327c zte_power_supply_temp2resist_simple */
