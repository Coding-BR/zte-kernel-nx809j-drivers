/* 001011cc zte_power_supply_get_property */
...

{
  ...
  if (*(int *)(*(code **)(*param_1 + 0x30) + -4) != -0x7a95136b) {
    ...
    pcVar1 = (code *)SoftwareBreakpoint(0x8228,0x101204);
    (*pcVar1)();
  }
...
/* 00101230 zte_power_supply_set_property */
...

{
  ...
  if ((0 < (int)param_1[0x8b]) && (pcVar2 = *(code **)(*param_1 + 0x38), pcVar2 != (code *)0x0)) {
    if (*(int *)(pcVar2 + -4) != 0x1c0179c9) {
                    /* WARNING: Does not return */
      pcVar2 = (code *)SoftwareBreakpoint(0x8228,0x10126c);
      (*pcVar2)();
    }
    uVar1 = (*pcVar2)();
    return uVar1;
...
/* 00101288 zte_power_supply_property_is_writeable */
...

{
  ...
  if ((0 < (int)param_1[0x8b]) && (pcVar2 = *(code **)(*param_1 + 0x40), pcVar2 != (code *)0x0)) {
    if (*(int *)(pcVar2 + -4) != 0x3f091c91) {
                    /* WARNING: Does not return */
      pcVar2 = (code *)SoftwareBreakpoint(0x8228,0x1012c4);
      (*pcVar2)();
    }
    uVar1 = (*pcVar2)();
    return uVar1;
...
/* 001012e0 zte_power_supply_init_attrs */
...
/* 00101424 zte_power_supply_show_property */
...
/* 00101594 zte_power_supply_store_property */
...
/* 00101678 zte_power_supply_reg_notifier */
...
/* 001016a4 zte_power_supply_unreg_notifier */
...
/* 001016d0 zte_power_supply_changed */
...

{
  ...
  if (param_1 == 0) {
    ...
    _printk(&DAT_001037d3,"__zte_power_supply_register",lVar8);
  }
...
LAB_001019a0:
    ...
    if (plVar7 == (long *)0x0) {
      ...
      *plVar7 = (long)param_2;
      ...
      iVar6 = dev_set_name(plVar7 + 7,&DAT_00103771,*param_2);
      if (iVar6 == 0) {
...
/* 00101a38 zte_power_supply_register_no_ws */
...
/* 00101a5c zte_power_supply_unregister */
...

{
  ...
  if (iVar2 + -1 != 0) {
                    /* WARNING: Does not return */
    pcVar5 = (code *)SoftwareBreakpoint(0x800,0x101b04);
    (*pcVar5)();
  }
...
/* 00101b0c zte_devm_power_supply_register */
...
/* 00101bb4 zte_devm_power_supply_release */
...
/* 00101bd8 zte_devm_power_supply_register_no_ws */
...
/* 00101c80 zte_power_supply_get_by_name */
...
/* 00101cf0 zte_power_supply_match_device_by_name */
...
/* 00101d7c zte_power_supply_get_by_phandle */
...
/* 00101e4c zte_power_supply_match_device_node */
...
/* 00101e70 zte_power_supply_get_by_phandle_array */
...
/* 00101f40 zte_power_supply_match_device_node_array */
...
/* 00101fd0 zte_power_supply_get_drvdata */
...
/* 00101fdc zte_power_supply_uevent */
        ...
        if (*(long *)(lVar6 + 0x28) != 0) {
          ...
          do {
            ...
            if (iVar3 != -0x3d && iVar3 != -0x13) {
              ...
              if ((int)uVar4 != 0) goto LAB_00102110;
            }
            lVar6 = *plVar8;
            uVar7 = (ulong)iVar9;
            iVar9 = iVar9 + 1;
...
/* 00102160 zte_power_supply_external_power_changed */
...

{
  ...
  if ((0 < (int)param_1[0x8b]) && (pcVar1 = *(code **)(*param_1 + 0x48), pcVar1 != (code *)0x0)) {
    if (*(int *)(pcVar1 + -4) != 0x6f39adef) {
                    /* WARNING: Does not return */
      pcVar1 = (code *)SoftwareBreakpoint(0x8228,0x10219c);
      (*pcVar1)();
    }
    (*pcVar1)();
  }
...
/* 001021b0 zte_power_supply_set_battery_charged */
...

{
  ...
  if (((-1 < (int)param_1[0x8b]) && (*(int *)(*param_1 + 8) == 1)) &&
    ...
    if (*(int *)(pcVar1 + -4) != 0x6f39adef) {
                    /* WARNING: Does not return */
      pcVar1 = (code *)SoftwareBreakpoint(0x8228,0x1021f4);
      (*pcVar1)();
    }
    (*pcVar1)();
    return 0;
...
/* 00102214 zte_power_supply_powers */
...
/* 00102240 zte_power_supply_ocv2cap_simple */
...
/* 001022c0 zte_power_supply_temp2resist_simple */
...
/* 00102340 zte_power_supply_put_battery_info */
...
/* 001023b0 zte_power_supply_find_ocv2cap_table */
...

{
  ...
  if (0x13 < uVar5) {
                    /* WARNING: Does not return */
    pcVar4 = (code *)SoftwareBreakpoint(0x5512,0x102418);
    (*pcVar4)();
  }
...
/* 0010241c zte_power_supply_batinfo_ocv2cap */
...
/* 001024fc zte_devm_power_supply_get_by_phandle */
...
/* 00102660 zte_devm_power_supply_put */
...
/* 001026b8 power_supply_attr_is_visible */
...

{
  ...
  if (0x12 < (int)param_3) {
                    /* WARNING: Does not return */
    pcVar4 = (code *)SoftwareBreakpoint(0x800,0x102788);
    (*pcVar4)();
  }
  if (0x12 < param_3) {
                    /* WARNING: Does not return */
    pcVar4 = (code *)SoftwareBreakpoint(0x5512,0x102784);
    (*pcVar4)();
  }
      ...
      do {
        if (*(uint *)(*(long *)(lVar3 + 0x20) + uVar5 * 4) == param_3) {
          ...
          if (*(int *)(pcVar4 + -4) != 0x3f091c91) {
                    /* WARNING: Does not return */
            pcVar4 = (code *)SoftwareBreakpoint(0x8228,0x102760);
            (*pcVar4)();
          }
...
/* 0010278c zte_power_supply_changed_work */
...
/* 0010284c zte_power_supply_deferred_register_work */
...
/* 001028f4 zte_power_supply_check_supplies */
...
/* 00102ae4 zte_power_supply_dev_release */
...
/* 00102b08 __zte_power_supply_changed_work */
...
LAB_00102bb8:
          ...
          if (*(int *)(pcVar3 + -4) == 0x6f39adef) {
            ...
            return 0;
                    ...
                    /* WARNING: Does not return */
          pcVar3 = (code *)SoftwareBreakpoint(0x8228,0x102bdc);
          (*pcVar3)();
        }
        uVar2 = (ulong)iVar9;
        iVar9 = iVar9 + 1;
...
/* 00102c00 __zte_power_supply_find_supply_from_node */
...
/* 00102c18 __zte_power_supply_populate_supplied_from */
...

{
  ...
  do {
    ...
    if ((iVar2 != 0) || (local_88[0] == 0)) goto LAB_00102cd8;
...
/* 00102d10 zte_power_supply_get_battery_info */
...
joined_r0x001032c8:
                ...
                if (uVar14 == 0x14) {
                    /* WARNING: Does not return */
                  pcVar6 = (code *)SoftwareBreakpoint(0x5512,0x103344);
                  (*pcVar6)();
                }
                uVar2 = (uint)local_b8;
