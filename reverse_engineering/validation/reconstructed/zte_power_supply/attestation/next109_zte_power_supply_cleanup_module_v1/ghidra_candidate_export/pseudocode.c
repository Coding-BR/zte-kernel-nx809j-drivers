/* 00100fd4 zte_power_supply_get_property */
...

{
  ...
  if (*(int *)(*(code **)(*param_1 + 0x30) + -4) != -0x7a95136b) {
    ...
    pcVar1 = (code *)SoftwareBreakpoint(0x8228,0x10100c);
    (*pcVar1)();
  }
...
/* 00101038 zte_power_supply_set_property */
...

{
  ...
  if ((0 < (int)param_1[0x8b]) && (pcVar2 = *(code **)(*param_1 + 0x38), pcVar2 != (code *)0x0)) {
    if (*(int *)(pcVar2 + -4) != 0x1c0179c9) {
                    /* WARNING: Does not return */
      pcVar2 = (code *)SoftwareBreakpoint(0x8228,0x101074);
      (*pcVar2)();
    }
    uVar1 = (*pcVar2)();
    return uVar1;
...
/* 00101090 zte_power_supply_property_is_writeable */
...

{
  ...
  if ((0 < (int)param_1[0x8b]) && (pcVar2 = *(code **)(*param_1 + 0x40), pcVar2 != (code *)0x0)) {
    if (*(int *)(pcVar2 + -4) != 0x3f091c91) {
                    /* WARNING: Does not return */
      pcVar2 = (code *)SoftwareBreakpoint(0x8228,0x1010cc);
      (*pcVar2)();
    }
    uVar1 = (*pcVar2)();
    return uVar1;
...
/* 001010e8 zte_power_supply_show_property */
...

{
  ...
  local_40 = 0;
  iVar3 = (int)((ulong)(param_2 + -0x20049) >> 3) * -0x45d1745d;
  if (iVar3 == 0x40) {
...
/* 00101254 zte_power_supply_init_attrs */
...

{
  ...
  *(undefined1 **)(param_1 + 8) = zte_power_supply_attr_groups;
  uVar7 = _printk(&DAT_00103756,0x13);
  lVar9 = 0;
  uVar8 = 0;
  do {
    lVar3 = uVar8 * 0x58;
    if ((&zte_power_supply_attrs)[uVar8 * 0xb] == (undefined *)0x0) {
      _printk(&DAT_0010338a,"zte_power_supply_init_attrs",uVar8 & 0xffffffff);
      uVar6 = sprintf(&DAT_00100228 + lVar3,"_err_%d",uVar8 & 0xffffffff);
      uVar7 = (ulong)uVar6;
    }
    else {
      bVar2 = (&DAT_00100228)[lVar3];
      lVar4 = lVar9;
      while (bVar2 != 0) {
        if ((0x687 < lVar4 + 8U) ||
           ((&DAT_00100228)[lVar4] = ((&_ctype)[bVar2] & 1) * ' ' + bVar2, lVar4 == 0x67f)) {
                    /* WARNING: Does not return */
          pcVar5 = (code *)SoftwareBreakpoint(1,0x101394);
          (*pcVar5)();
        }
        bVar2 = (&DAT_00100229)[lVar4];
        lVar4 = lVar4 + 1;
      }
    }
    lVar9 = lVar9 + 0x58;
    (&DAT_00100248)[uVar8 * 0xb] = &DAT_00100228 + lVar3;
    (&__zte_power_supply_attrs)[uVar8] = &DAT_00100248 + uVar8 * 0xb;
    uVar1 = uVar8 + 1;
    (&DAT_00100258)[uVar8 * 0xb] = zte_power_supply_show_property;
    (&DAT_00100260)[uVar8 * 0xb] = zte_power_supply_store_property;
    uVar8 = uVar1;
    if (uVar1 == 0x13) {
      return uVar7;
    }
...
/* 00101398 zte_power_supply_reg_notifier */
...
/* 001013c4 zte_power_supply_unreg_notifier */
...
/* 001013f0 zte_power_supply_changed */
...
/* 00101454 __zte_power_supply_find_supply_from_node */
...
/* 0010146c zte_power_supply_register */
...
/* 0010148c __zte_power_supply_register */
...

{
  ...
  if (param_1 == 0) {
    _printk(&DAT_0010353c,"__zte_power_supply_register",*param_2);
  }
...
LAB_001015dc:
    ...
    if (plVar6 == (long *)0x0) {
      ...
      *plVar6 = (long)param_2;
      ...
      iVar5 = dev_set_name(plVar6 + 7,&DAT_001034e4,*param_2);
      if (iVar5 == 0) {
...
/* 00101784 zte_power_supply_register_no_ws */
...
/* 001017a8 zte_power_supply_unregister */
...

{
  ...
  if (iVar2 + -1 != 0) {
                    /* WARNING: Does not return */
    pcVar5 = (code *)SoftwareBreakpoint(0x800,0x101850);
    (*pcVar5)();
  }
...
/* 00101858 zte_devm_power_supply_register */
...
/* 00101900 zte_devm_power_supply_release */
...
/* 00101924 zte_devm_power_supply_register_no_ws */
...
/* 001019cc zte_power_supply_get_by_name */
...
/* 00101a90 zte_power_supply_get_by_phandle */
...
/* 00101b60 zte_power_supply_match_device_node */
...
/* 00101b84 zte_power_supply_get_by_phandle_array */
...
/* 00101c54 zte_power_supply_match_device_node_array */
...
/* 00101ce0 zte_power_supply_get_drvdata */
...
/* 00101cec zte_power_supply_external_power_changed */
...

{
  ...
  if ((0 < (int)param_1[0x8b]) && (pcVar1 = *(code **)(*param_1 + 0x48), pcVar1 != (code *)0x0)) {
    if (*(int *)(pcVar1 + -4) != 0x6f39adef) {
                    /* WARNING: Does not return */
      pcVar1 = (code *)SoftwareBreakpoint(0x8228,0x101d28);
      (*pcVar1)();
    }
    (*pcVar1)();
  }
...
/* 00101d3c zte_power_supply_set_battery_charged */
...

{
  ...
  if (((-1 < (int)param_1[0x8b]) && (*(int *)(*param_1 + 8) == 1)) &&
    ...
    if (*(int *)(pcVar1 + -4) != 0x6f39adef) {
                    /* WARNING: Does not return */
      pcVar1 = (code *)SoftwareBreakpoint(0x8228,0x101d80);
      (*pcVar1)();
    }
    (*pcVar1)();
    return 0;
...
/* 00101da0 zte_power_supply_powers */
...
/* 00101dcc zte_power_supply_put_battery_info */
...
/* 00101e3c zte_power_supply_find_ocv2cap_table */
  ...
  if ((uVar4 & 0xff) < 0x14) {
    *param_3 = *(undefined4 *)(param_1 + (ulong)(byte)uVar4 * 4 + 0x168);
    return ((long *)(param_1 + 200))[uVar5 & 0xff];
                    ...
                    /* WARNING: Does not return */
  pcVar3 = (code *)SoftwareBreakpoint(0x5512,0x101eac);
  (*pcVar3)();
}



/* 00101eb0 zte_devm_power_supply_get_by_phandle */
...
/* 00102010 zte_devm_power_supply_put */
...
/* 00102068 zte_power_supply_dev_release */
...
/* 0010208c zte_power_supply_changed_work */
...
/* 0010214c zte_power_supply_deferred_register_work */
...
/* 00102248 zte_power_supply_store_property */
...

{
  ...
  iVar3 = zte_power_supply_set_property
                    (uVar6,(int)(param_2 - 0x100248U >> 3) * -0x45d1745d,&local_40);
  lVar4 = (long)iVar3;
  if (-1 < iVar3) {
    lVar4 = param_4;
  }
...
/* 00102338 zte_power_supply_uevent */
      ...
      if (__s == (char *)0x0) {
        ...
        if (*(long *)(lVar6 + 0x28) != 0) {
          ...
          do {
            ...
            if (0x13 < uVar1) {
                    /* WARNING: Does not return */
              pcVar2 = (code *)SoftwareBreakpoint(0x5512,0x102490);
              (*pcVar2)();
            }
            uVar4 = zte_power_supply_show_property(param_1,&DAT_00100248 + (ulong)uVar1 * 0xb,__s);
            iVar3 = (int)uVar4;
            if (iVar3 != -0x3d && iVar3 != -0x13) {
              if (iVar3 < 0) goto LAB_00102474;
...
/* 001024c8 power_supply_attr_is_visible */
...

{
  ...
  if (0x12 < param_3) {
                    /* WARNING: Does not return */
    pcVar3 = (code *)SoftwareBreakpoint(0x5512,0x102584);
    (*pcVar3)();
  }
        ...
        if (*(uint *)(*(long *)(lVar2 + 0x20) + uVar4 * 4) == param_3) {
          ...
          if (*(int *)(pcVar3 + -4) == 0x3f091c91) {
            ...
            return 0x124;
                    ...
                    /* WARNING: Does not return */
          pcVar3 = (code *)SoftwareBreakpoint(0x8228,0x102560);
          (*pcVar3)();
        }
        uVar4 = (ulong)iVar1;
        iVar1 = iVar1 + 1;
...
/* 00102584 zte_power_supply_check_supplies */
...
/* 00102734 __zte_power_supply_changed_work */
...
LAB_001027e4:
          ...
          if (*(int *)(pcVar3 + -4) == 0x6f39adef) {
            ...
            return 0;
                    ...
                    /* WARNING: Does not return */
          pcVar3 = (code *)SoftwareBreakpoint(0x8228,0x102808);
          (*pcVar3)();
        }
        uVar2 = (ulong)iVar9;
        iVar9 = iVar9 + 1;
...
/* 0010282c __zte_power_supply_populate_supplied_from */
...

{
  ...
  do {
    ...
    if ((iVar2 != 0) || (local_88[0] == 0)) goto LAB_001028ec;
    iVar3 = iVar3 + 1;
...
/* 00102924 zte_power_supply_get_battery_info */
...
joined_r0x00102edc:
                ...
                if (uVar14 == 0x14) {
                    /* WARNING: Does not return */
                  pcVar6 = (code *)SoftwareBreakpoint(0x5512,0x102f58);
                  (*pcVar6)();
                }
                uVar2 = (uint)local_b8;
...
/* 00102f5c zte_power_supply_match_device_by_name */
...
/* 00102f90 zte_power_supply_temp2resist_simple */
...
/* 00102ffc zte_power_supply_ocv2cap_simple */
...
/* 00103068 zte_power_supply_batinfo_ocv2cap */
...

{
  ...
  if (*(long *)(param_1 + 200) != 0) {
    ...
    if (0x13 < (uVar4 & 0xff)) {
                    /* WARNING: Does not return */
      pcVar3 = (code *)SoftwareBreakpoint(0x5512,0x103138);
      (*pcVar3)();
    }
