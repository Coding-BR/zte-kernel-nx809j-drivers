/* 0010106c zte_power_supply_get_property */
...

{
  ...
  if (*(int *)(*(code **)(*param_1 + 0x30) + -4) != -0x7a95136b) {
    ...
    pcVar1 = (code *)SoftwareBreakpoint(0x8228,0x1010a4);
    (*pcVar1)();
  }
...
/* 001010d0 zte_power_supply_set_property */
...

{
  ...
  if ((0 < (int)param_1[0x8b]) && (pcVar2 = *(code **)(*param_1 + 0x38), pcVar2 != (code *)0x0)) {
    if (*(int *)(pcVar2 + -4) != 0x1c0179c9) {
                    /* WARNING: Does not return */
      pcVar2 = (code *)SoftwareBreakpoint(0x8228,0x10110c);
      (*pcVar2)();
    }
    uVar1 = (*pcVar2)();
    return uVar1;
...
/* 00101128 zte_power_supply_property_is_writeable */
...

{
  ...
  if ((0 < (int)param_1[0x8b]) && (pcVar2 = *(code **)(*param_1 + 0x40), pcVar2 != (code *)0x0)) {
    if (*(int *)(pcVar2 + -4) != 0x3f091c91) {
                    /* WARNING: Does not return */
      pcVar2 = (code *)SoftwareBreakpoint(0x8228,0x101164);
      (*pcVar2)();
    }
    uVar1 = (*pcVar2)();
    return uVar1;
...
/* 00101180 zte_power_supply_init_attrs */
...

{
  ...
  *(undefined1 **)(param_1 + 8) = zte_power_supply_attr_groups;
  uVar7 = _printk(&DAT_0010380e,0x13);
  lVar9 = 0;
  uVar8 = 0;
  do {
    lVar3 = uVar8 * 0x58;
    if ((&zte_power_supply_attrs)[uVar8 * 0xb] == (undefined *)0x0) {
      _printk(&DAT_0010342a,"zte_power_supply_init_attrs",uVar8 & 0xffffffff);
      uVar6 = sprintf(&DAT_00100250 + lVar3,"_err_%d",uVar8 & 0xffffffff);
      uVar7 = (ulong)uVar6;
    }
    else {
      bVar2 = (&DAT_00100250)[lVar3];
      lVar4 = lVar9;
      while (bVar2 != 0) {
        if ((0x687 < lVar4 + 8U) ||
           ((&DAT_00100250)[lVar4] = ((&_ctype)[bVar2] & 1) * ' ' + bVar2, lVar4 == 0x67f)) {
                    /* WARNING: Does not return */
          pcVar5 = (code *)SoftwareBreakpoint(1,0x1012c0);
          (*pcVar5)();
        }
        bVar2 = (&DAT_00100251)[lVar4];
        lVar4 = lVar4 + 1;
      }
    }
    lVar9 = lVar9 + 0x58;
    (&DAT_00100270)[uVar8 * 0xb] = &DAT_00100250 + lVar3;
    (&__zte_power_supply_attrs)[uVar8] = &DAT_00100270 + uVar8 * 0xb;
    uVar1 = uVar8 + 1;
    (&DAT_00100280)[uVar8 * 0xb] = zte_power_supply_show_property;
    (&DAT_00100288)[uVar8 * 0xb] = zte_power_supply_store_property;
    uVar8 = uVar1;
    if (uVar1 == 0x13) {
      return uVar7;
    }
...
/* 001012c4 zte_power_supply_show_property */
...

{
  ...
  local_40 = 0;
  iVar3 = (int)((ulong)(param_2 + -0x2004e) >> 3) * -0x45d1745d;
  if (iVar3 == 0x40) {
...
/* 00101430 zte_power_supply_reg_notifier */
...
/* 0010145c zte_power_supply_unreg_notifier */
...
/* 00101488 zte_power_supply_changed */
...
/* 001014ec __zte_power_supply_find_supply_from_node */
...
/* 00101504 zte_power_supply_register */
...
/* 00101524 __zte_power_supply_register */
...

{
  ...
  if (param_1 == 0) {
    _printk(&DAT_001035dc,"__zte_power_supply_register",*param_2);
  }
...
LAB_00101674:
    ...
    if (plVar6 == (long *)0x0) {
      ...
      *plVar6 = (long)param_2;
      ...
      iVar5 = dev_set_name(plVar6 + 7,&DAT_00103584,*param_2);
      if (iVar5 == 0) {
...
/* 0010181c zte_power_supply_register_no_ws */
...
/* 00101840 zte_power_supply_unregister */
...

{
  ...
  if (iVar2 + -1 != 0) {
                    /* WARNING: Does not return */
    pcVar5 = (code *)SoftwareBreakpoint(0x800,0x1018e8);
    (*pcVar5)();
  }
...
/* 001018f0 zte_devm_power_supply_register */
...
/* 00101998 zte_devm_power_supply_release */
...
/* 001019bc zte_devm_power_supply_register_no_ws */
...
/* 00101a64 zte_power_supply_get_by_name */
...
/* 00101b28 zte_power_supply_get_by_phandle */
...
/* 00101bf8 zte_power_supply_match_device_node */
...
/* 00101c1c zte_power_supply_get_by_phandle_array */
...
/* 00101cec zte_power_supply_match_device_node_array */
...
/* 00101d78 zte_power_supply_get_drvdata */
...
/* 00101d84 zte_power_supply_uevent */
      ...
      if (__s == (char *)0x0) {
        ...
        if (*(long *)(lVar6 + 0x28) != 0) {
          ...
          do {
            ...
            if (0x12 < uVar1) {
                    /* WARNING: Does not return */
              pcVar2 = (code *)SoftwareBreakpoint(0x800,0x101ed4);
              (*pcVar2)();
            }
            uVar4 = zte_power_supply_show_property(param_1,&DAT_00100270 + (ulong)uVar1 * 0xb,__s);
            iVar3 = (int)uVar4;
            if (iVar3 != -0x3d && iVar3 != -0x13) {
              if (iVar3 < 0) goto LAB_00101eb8;
              ...
              if ((int)uVar4 != 0) goto LAB_00101eb8;
            }
            lVar6 = *plVar8;
            uVar7 = (ulong)iVar9;
            iVar9 = iVar9 + 1;
...
/* 00101f08 zte_power_supply_external_power_changed */
...

{
  ...
  if ((0 < (int)param_1[0x8b]) && (pcVar1 = *(code **)(*param_1 + 0x48), pcVar1 != (code *)0x0)) {
    if (*(int *)(pcVar1 + -4) != 0x6f39adef) {
                    /* WARNING: Does not return */
      pcVar1 = (code *)SoftwareBreakpoint(0x8228,0x101f44);
      (*pcVar1)();
    }
    (*pcVar1)();
  }
...
/* 00101f58 zte_power_supply_set_battery_charged */
...

{
  ...
  if (((-1 < (int)param_1[0x8b]) && (*(int *)(*param_1 + 8) == 1)) &&
    ...
    if (*(int *)(pcVar1 + -4) != 0x6f39adef) {
                    /* WARNING: Does not return */
      pcVar1 = (code *)SoftwareBreakpoint(0x8228,0x101f9c);
      (*pcVar1)();
    }
    (*pcVar1)();
    return 0;
...
/* 00101fbc zte_power_supply_powers */
...
/* 00101fe8 zte_power_supply_put_battery_info */
...
/* 00102058 zte_power_supply_find_ocv2cap_table */
  ...
  if ((uVar4 & 0xff) < 0x14) {
    *param_3 = *(undefined4 *)(param_1 + (ulong)(byte)uVar4 * 4 + 0x168);
    return ((long *)(param_1 + 200))[uVar5 & 0xff];
                    ...
                    /* WARNING: Does not return */
  pcVar3 = (code *)SoftwareBreakpoint(0x5512,0x1020c8);
  (*pcVar3)();
}



/* 001020cc zte_devm_power_supply_get_by_phandle */
...
/* 0010222c zte_devm_power_supply_put */
...
/* 00102284 power_supply_attr_is_visible */
...

{
  ...
  if (0x12 < (int)param_3) {
                    /* WARNING: Does not return */
    pcVar4 = (code *)SoftwareBreakpoint(0x800,0x102354);
    (*pcVar4)();
  }
  if (0x12 < param_3) {
                    /* WARNING: Does not return */
    pcVar4 = (code *)SoftwareBreakpoint(0x5512,0x102350);
    (*pcVar4)();
  }
      ...
      do {
        if (*(uint *)(*(long *)(lVar3 + 0x20) + uVar5 * 4) == param_3) {
          ...
          if (*(int *)(pcVar4 + -4) != 0x3f091c91) {
                    /* WARNING: Does not return */
            pcVar4 = (code *)SoftwareBreakpoint(0x8228,0x10232c);
            (*pcVar4)();
          }
...
/* 00102358 zte_power_supply_dev_release */
...
/* 0010237c zte_power_supply_changed_work */
...
/* 0010243c zte_power_supply_deferred_register_work */
...
/* 00102538 zte_power_supply_store_property */
...

{
  ...
  iVar3 = zte_power_supply_set_property
                    (uVar6,(int)(param_2 - 0x100270U >> 3) * -0x45d1745d,&local_40);
  lVar4 = (long)iVar3;
  if (-1 < iVar3) {
    lVar4 = param_4;
  }
...
/* 00102624 zte_power_supply_check_supplies */
...
/* 001027d4 __zte_power_supply_changed_work */
...
LAB_00102884:
          ...
          if (*(int *)(pcVar3 + -4) == 0x6f39adef) {
            ...
            return 0;
                    ...
                    /* WARNING: Does not return */
          pcVar3 = (code *)SoftwareBreakpoint(0x8228,0x1028a8);
          (*pcVar3)();
        }
        uVar2 = (ulong)iVar9;
        iVar9 = iVar9 + 1;
...
/* 001028cc __zte_power_supply_populate_supplied_from */
...

{
  ...
  do {
    ...
    if ((iVar2 != 0) || (local_88[0] == 0)) goto LAB_0010298c;
    iVar3 = iVar3 + 1;
...
/* 001029c4 zte_power_supply_get_battery_info */
...
joined_r0x00102f7c:
                ...
                if (uVar14 == 0x14) {
                    /* WARNING: Does not return */
                  pcVar6 = (code *)SoftwareBreakpoint(0x5512,0x102ff8);
                  (*pcVar6)();
                }
                uVar2 = (uint)local_b8;
...
/* 00102ffc zte_power_supply_match_device_by_name */
...
/* 00103030 zte_power_supply_temp2resist_simple */
...
/* 0010309c zte_power_supply_ocv2cap_simple */
...
/* 00103108 zte_power_supply_batinfo_ocv2cap */
...

{
  ...
  if (*(long *)(param_1 + 200) != 0) {
    ...
    if (0x13 < (uVar4 & 0xff)) {
                    /* WARNING: Does not return */
      pcVar3 = (code *)SoftwareBreakpoint(0x5512,0x1031d8);
      (*pcVar3)();
    }
