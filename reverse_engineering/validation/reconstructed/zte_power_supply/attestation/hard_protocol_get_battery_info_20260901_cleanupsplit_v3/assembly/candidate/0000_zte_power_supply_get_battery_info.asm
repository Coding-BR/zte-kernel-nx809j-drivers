...
00000000000011e8 <zte_power_supply_get_battery_info>:
    ...
    1528: 90000018     	adrp	x24, 0x1000 <zte_power_supply_set_battery_charged+0x18>
		0000000000001528:  R_AARCH64_ADR_PREL_PG_HI21	.rodata.str1.1
    152c: 91000318     	add	x24, x24, #0x0
    ...
    156c: b40011e0     	cbz	x0, 0x17a8 <zte_power_supply_get_battery_info+0x5c0>
    1570: b9403be8     	ldr	w8, [sp, #0x38]
    1574: 340011a8     	cbz	w8, 0x17a8 <zte_power_supply_get_battery_info+0x5c0>
    1578: aa0003f4     	mov	x20, x0
    ...
    1588: 54000d20     	b.eq	0x172c <zte_power_supply_get_battery_info+0x544>
    158c: b9403bfc     	ldr	w28, [sp, #0x38]
    1590: 13037f9b     	asr	w27, w28, #3
    1594: b8367b5b     	str	w27, [x26, x22, lsl #2]
    1598: 37f80cdb     	tbnz	w27, #0x1f, 0x1730 <zte_power_supply_get_battery_info+0x548>
    ...
    15b8: b4000c00     	cbz	x0, 0x1738 <zte_power_supply_get_battery_info+0x550>
    ...
    16d0: 5400068b     	b.lt	0x17a0 <zte_power_supply_get_battery_info+0x5b8>
    ...
    1728: 54000069     	b.ls	0x1734 <zte_power_supply_get_battery_info+0x54c>
    172c: d42aa240     	brk	#0x5512
    1730: f8367a7f     	str	xzr, [x19, x22, lsl #3]
    1734: f8365a7f     	str	xzr, [x19, w22, uxtw #3]
    1738: f9400ff5     	ldr	x21, [sp, #0x18]
    173c: aa1f03f4     	mov	x20, xzr
    1740: 14000004     	b	0x1750 <zte_power_supply_get_battery_info+0x568>
    1744: 91002294     	add	x20, x20, #0x8
    1748: f102829f     	cmp	x20, #0xa0
    174c: 540000c0     	b.eq	0x1764 <zte_power_supply_get_battery_info+0x57c>
    1750: f8746a61     	ldr	x1, [x19, x20]
    1754: b4ffff81     	cbz	x1, 0x1744 <zte_power_supply_get_battery_info+0x55c>
    1758: 9100e2a0     	add	x0, x21, #0x38
    175c: 94000000     	bl	0x175c <zte_power_supply_get_battery_info+0x574>
		000000000000175c:  R_AARCH64_CALL26	devm_kfree
    1760: 17fffff9     	b	0x1744 <zte_power_supply_get_battery_info+0x55c>
    1764: 12800174     	mov	w20, #-0xc              // =-12
    1768: f94013e8     	ldr	x8, [sp, #0x20]
    176c: f940dd01     	ldr	x1, [x8, #0x1b8]
    1770: b4fff621     	cbz	x1, 0x1634 <zte_power_supply_get_battery_info+0x44c>
    1774: f9400fe8     	ldr	x8, [sp, #0x18]
    1778: 9100e100     	add	x0, x8, #0x38
    177c: 94000000     	bl	0x177c <zte_power_supply_get_battery_info+0x594>
		000000000000177c:  R_AARCH64_CALL26	devm_kfree
    ...
    17a0: 2a1f03f4     	mov	w20, wzr
    17a4: 17ffffa4     	b	0x1634 <zte_power_supply_get_battery_info+0x44c>
    17a8: f9400fe8     	ldr	x8, [sp, #0x18]
    17ac: 90000001     	adrp	x1, 0x1000 <zte_power_supply_set_battery_charged+0x18>
		00000000000017ac:  R_AARCH64_ADR_PREL_PG_HI21	.rodata.str1.1+0x3dd
    17b0: 91000021     	add	x1, x1, #0x0
		00000000000017b0:  R_AARCH64_ADD_ABS_LO12_NC	.rodata.str1.1+0x3dd
    17b4: aa1903e2     	mov	x2, x25
    17b8: 9100e100     	add	x0, x8, #0x38
    17bc: 94000000     	bl	0x17bc <zte_power_supply_get_battery_info+0x5d4>
		00000000000017bc:  R_AARCH64_CALL26	_dev_err
    17c0: aa1903e0     	mov	x0, x25
    17c4: 94000000     	bl	0x17c4 <zte_power_supply_get_battery_info+0x5dc>
		00000000000017c4:  R_AARCH64_CALL26	kfree
    17c8: aa1f03f5     	mov	x21, xzr
    17cc: 128002b4     	mov	w20, #-0x16             // =-22
    17d0: 14000004     	b	0x17e0 <zte_power_supply_get_battery_info+0x5f8>
    17d4: 910022b5     	add	x21, x21, #0x8
    17d8: f10282bf     	cmp	x21, #0xa0
    17dc: 54fffc60     	b.eq	0x1768 <zte_power_supply_get_battery_info+0x580>
    17e0: f8756a61     	ldr	x1, [x19, x21]
    17e4: b4ffff81     	cbz	x1, 0x17d4 <zte_power_supply_get_battery_info+0x5ec>
    17e8: f9400fe8     	ldr	x8, [sp, #0x18]
    17ec: 9100e100     	add	x0, x8, #0x38
    17f0: 94000000     	bl	0x17f0 <zte_power_supply_get_battery_info+0x608>
		00000000000017f0:  R_AARCH64_CALL26	devm_kfree
    17f4: 17fffff8     	b	0x17d4 <zte_power_supply_get_battery_info+0x5ec>
