/* 001011a4 zte_power_supply_get_property */
...

{
  ...
  if (*(int *)(*(code **)(*param_1 + 0x30) + -4) != -0x7a95136b) {
    ...
    pcVar1 = (code *)SoftwareBreakpoint(0x8228,0x1011dc);
    (*pcVar1)();
  }
...
/* 00101208 zte_power_supply_set_property */
...

{
  ...
  if ((0 < (int)param_1[0x8b]) && (pcVar2 = *(code **)(*param_1 + 0x38), pcVar2 != (code *)0x0)) {
    if (*(int *)(pcVar2 + -4) != 0x1c0179c9) {
                    /* WARNING: Does not return */
      pcVar2 = (code *)SoftwareBreakpoint(0x8228,0x101244);
      (*pcVar2)();
    }
    uVar1 = (*pcVar2)();
    return uVar1;
...
/* 00101260 zte_power_supply_property_is_writeable */
...

{
  ...
  if ((0 < (int)param_1[0x8b]) && (pcVar2 = *(code **)(*param_1 + 0x40), pcVar2 != (code *)0x0)) {
    if (*(int *)(pcVar2 + -4) != 0x3f091c91) {
                    /* WARNING: Does not return */
      pcVar2 = (code *)SoftwareBreakpoint(0x8228,0x10129c);
      (*pcVar2)();
    }
    uVar1 = (*pcVar2)();
    return uVar1;
...
/* 001012b8 zte_power_supply_init_attrs */
...

{
  ...
  *(undefined ***)(param_1 + 8) = &zte_power_supply_groups;
  uVar7 = _printk(&DAT_001036cf,0x13);
  lVar9 = 0;
  uVar8 = 0;
  do {
    lVar3 = uVar8 * 0x58;
    if ((&zte_power_supply_attrs)[uVar8 * 0xb] == (undefined *)0x0) {
      _printk(&DAT_0010359b,"zte_power_supply_init_attrs",uVar8 & 0xffffffff);
      ...
      while (bVar2 != 0) {
        if ((0x687 < lVar4 + 8U) ||
           (s_STATUS_00100260[lVar4] = ((&_ctype)[bVar2] & 1) * ' ' + bVar2, lVar4 == 0x67f)) {
                    /* WARNING: Does not return */
          pcVar5 = (code *)SoftwareBreakpoint(1,0x1013f8);
          (*pcVar5)();
        }
...
/* 001013fc zte_power_supply_show_property */
...
/* 0010156c zte_power_supply_store_property */
...
/* 00101650 zte_power_supply_reg_notifier */
...
/* 0010167c zte_power_supply_unreg_notifier */
...
/* 001016a8 zte_power_supply_changed */
...
/* 0010170c zte_power_supply_register */
...
/* 0010172c __zte_power_supply_register */
...

{
  ...
  if (param_1 == 0) {
    ...
    _printk(&DAT_001037a3,"__zte_power_supply_register",lVar8);
  }
...
LAB_00101978:
    ...
    if (plVar7 == (long *)0x0) {
      ...
      *plVar7 = (long)param_2;
      ...
      iVar6 = dev_set_name(plVar7 + 7,&DAT_00103741,*param_2);
      if (iVar6 == 0) {
...
/* 00101a10 zte_power_supply_register_no_ws */
...
/* 00101a34 zte_power_supply_unregister */
...

{
  ...
  if (iVar2 + -1 != 0) {
                    /* WARNING: Does not return */
    pcVar5 = (code *)SoftwareBreakpoint(0x800,0x101adc);
    (*pcVar5)();
  }
...
/* 00101ae4 zte_devm_power_supply_register */
...
/* 00101b8c zte_devm_power_supply_release */
...
/* 00101bb0 zte_devm_power_supply_register_no_ws */
...
/* 00101c58 zte_power_supply_get_by_name */
...
/* 00101d1c zte_power_supply_get_by_phandle */
...
/* 00101dec zte_power_supply_match_device_node */
...
/* 00101e10 zte_power_supply_get_by_phandle_array */
...
/* 00101ee0 zte_power_supply_match_device_node_array */
...
/* 00101f70 zte_power_supply_get_drvdata */
...
/* 00101f7c zte_power_supply_uevent */
        ...
        if (*(long *)(lVar6 + 0x28) != 0) {
          ...
          do {
            ...
            if (iVar3 != -0x3d && iVar3 != -0x13) {
              ...
              if ((int)uVar4 != 0) goto LAB_001020b0;
            }
            lVar6 = *plVar8;
            uVar7 = (ulong)iVar9;
            iVar9 = iVar9 + 1;
...
/* 00102100 zte_power_supply_external_power_changed */
...

{
  ...
  if ((0 < (int)param_1[0x8b]) && (pcVar1 = *(code **)(*param_1 + 0x48), pcVar1 != (code *)0x0)) {
    if (*(int *)(pcVar1 + -4) != 0x6f39adef) {
                    /* WARNING: Does not return */
      pcVar1 = (code *)SoftwareBreakpoint(0x8228,0x10213c);
      (*pcVar1)();
    }
    (*pcVar1)();
  }
...
/* 00102150 zte_power_supply_set_battery_charged */
...

{
  ...
  if (((-1 < (int)param_1[0x8b]) && (*(int *)(*param_1 + 8) == 1)) &&
    ...
    if (*(int *)(pcVar1 + -4) != 0x6f39adef) {
                    /* WARNING: Does not return */
      pcVar1 = (code *)SoftwareBreakpoint(0x8228,0x102194);
      (*pcVar1)();
    }
    (*pcVar1)();
    return 0;
...
/* 001021b4 zte_power_supply_powers */
...
/* 001021e0 zte_power_supply_ocv2cap_simple */
...
/* 00102260 zte_power_supply_temp2resist_simple */
...
/* 001022e0 zte_power_supply_put_battery_info */
...
/* 00102350 zte_power_supply_find_ocv2cap_table */
...

{
  ...
  if (0x13 < uVar5) {
                    /* WARNING: Does not return */
    pcVar4 = (code *)SoftwareBreakpoint(0x5512,0x1023b8);
    (*pcVar4)();
  }
...
/* 001023bc zte_power_supply_batinfo_ocv2cap */
...

{
  ...
  if (*(long *)(param_1 + 200) != 0) {
    ...
    if (0x13 < uVar6) {
                    /* WARNING: Does not return */
      pcVar5 = (code *)SoftwareBreakpoint(0x5512,0x102498);
      (*pcVar5)();
    }
...
/* 0010249c zte_devm_power_supply_get_by_phandle */
...
/* 00102600 zte_devm_power_supply_put */
...
/* 00102658 power_supply_attr_is_visible */
...

{
  ...
  if (0x12 < (int)param_3) {
                    /* WARNING: Does not return */
    pcVar4 = (code *)SoftwareBreakpoint(0x800,0x102728);
    (*pcVar4)();
  }
  if (0x12 < param_3) {
                    /* WARNING: Does not return */
    pcVar4 = (code *)SoftwareBreakpoint(0x5512,0x102724);
    (*pcVar4)();
  }
      ...
      do {
        if (*(uint *)(*(long *)(lVar3 + 0x20) + uVar5 * 4) == param_3) {
          ...
          if (*(int *)(pcVar4 + -4) != 0x3f091c91) {
                    /* WARNING: Does not return */
            pcVar4 = (code *)SoftwareBreakpoint(0x8228,0x102700);
            (*pcVar4)();
          }
...
/* 0010272c zte_power_supply_changed_work */
...
/* 001027ec zte_power_supply_deferred_register_work */
...
/* 00102894 zte_power_supply_check_supplies */
...
/* 00102a84 zte_power_supply_dev_release */
...
/* 00102aa8 __zte_power_supply_changed_work */
...
LAB_00102b58:
          ...
          if (*(int *)(pcVar3 + -4) == 0x6f39adef) {
            ...
            return 0;
                    ...
                    /* WARNING: Does not return */
          pcVar3 = (code *)SoftwareBreakpoint(0x8228,0x102b7c);
          (*pcVar3)();
        }
        uVar2 = (ulong)iVar9;
        iVar9 = iVar9 + 1;
...
/* 00102ba0 __zte_power_supply_find_supply_from_node */
...
/* 00102bb8 __zte_power_supply_populate_supplied_from */
...

{
  ...
  do {
    ...
    if ((iVar2 != 0) || (local_88[0] == 0)) goto LAB_00102c78;
...
/* 00102cb0 zte_power_supply_get_battery_info */
...
joined_r0x00103268:
                ...
                if (uVar14 == 0x14) {
                    /* WARNING: Does not return */
                  pcVar6 = (code *)SoftwareBreakpoint(0x5512,0x1032e4);
                  (*pcVar6)();
                }
                uVar2 = (uint)local_b8;
...
/* 001032e8 zte_power_supply_match_device_by_name */
