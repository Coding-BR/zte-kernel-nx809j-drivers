/* 0010107c zte_power_supply_get_property */
...

{
  ...
  if (*(int *)(*(code **)(*param_1 + 0x30) + -4) != -0x7a95136b) {
    ...
    pcVar1 = (code *)SoftwareBreakpoint(0x8228,0x1010b4);
    (*pcVar1)();
  }
...
/* 001010e0 zte_power_supply_set_property */
...

{
  ...
  if ((0 < (int)param_1[0x8b]) && (pcVar2 = *(code **)(*param_1 + 0x38), pcVar2 != (code *)0x0)) {
    if (*(int *)(pcVar2 + -4) != 0x1c0179c9) {
                    /* WARNING: Does not return */
      pcVar2 = (code *)SoftwareBreakpoint(0x8228,0x10111c);
      (*pcVar2)();
    }
    uVar1 = (*pcVar2)();
    return uVar1;
...
/* 00101138 zte_power_supply_property_is_writeable */
...

{
  ...
  if ((0 < (int)param_1[0x8b]) && (pcVar2 = *(code **)(*param_1 + 0x40), pcVar2 != (code *)0x0)) {
    if (*(int *)(pcVar2 + -4) != 0x3f091c91) {
                    /* WARNING: Does not return */
      pcVar2 = (code *)SoftwareBreakpoint(0x8228,0x101174);
      (*pcVar2)();
    }
    uVar1 = (*pcVar2)();
    return uVar1;
...
/* 00101190 zte_power_supply_init_attrs */
...

{
  ...
  *(undefined ***)(param_1 + 8) = &zte_power_supply_groups;
  uVar7 = _printk(&DAT_001035d8,0x13);
  lVar9 = 0;
  uVar8 = 0;
  do {
    lVar3 = uVar8 * 0x58;
    if ((&zte_power_supply_attrs)[uVar8 * 0xb] == (undefined *)0x0) {
      _printk(&DAT_0010349a,"zte_power_supply_init_attrs",uVar8 & 0xffffffff);
      ...
      while (bVar2 != 0) {
        if ((0x687 < lVar4 + 8U) ||
           (s_STATUS_00100260[lVar4] = ((&_ctype)[bVar2] & 1) * ' ' + bVar2, lVar4 == 0x67f)) {
                    /* WARNING: Does not return */
          pcVar5 = (code *)SoftwareBreakpoint(1,0x1012d0);
          (*pcVar5)();
        }
...
/* 001012d4 zte_power_supply_show_property */
...
/* 00101444 zte_power_supply_store_property */
...
/* 00101528 zte_power_supply_reg_notifier */
...
/* 00101554 zte_power_supply_unreg_notifier */
...
/* 00101580 zte_power_supply_changed */
...
/* 001015e4 __zte_power_supply_find_supply_from_node */
...
/* 001015fc zte_power_supply_register */
...
/* 0010161c __zte_power_supply_register */
...

{
  ...
  if (param_1 == 0) {
    _printk(&DAT_001036b8,"__zte_power_supply_register",*param_2);
  }
...
LAB_0010176c:
    ...
    if (plVar6 == (long *)0x0) {
      ...
      *plVar6 = (long)param_2;
      ...
      iVar5 = dev_set_name(plVar6 + 7,&DAT_0010364e,*param_2);
      if (iVar5 == 0) {
...
/* 00101914 zte_power_supply_register_no_ws */
...
/* 00101938 zte_power_supply_unregister */
...

{
  ...
  if (iVar2 + -1 != 0) {
                    /* WARNING: Does not return */
    pcVar5 = (code *)SoftwareBreakpoint(0x800,0x1019e0);
    (*pcVar5)();
  }
...
/* 001019e8 zte_devm_power_supply_register */
...
/* 00101a90 zte_devm_power_supply_release */
...
/* 00101ab4 zte_devm_power_supply_register_no_ws */
...
/* 00101b5c zte_power_supply_get_by_name */
...
/* 00101c20 zte_power_supply_get_by_phandle */
...
/* 00101cf0 zte_power_supply_match_device_node */
...
/* 00101d14 zte_power_supply_get_by_phandle_array */
...
/* 00101de4 zte_power_supply_match_device_node_array */
...
/* 00101e70 zte_power_supply_get_drvdata */
...
/* 00101e7c zte_power_supply_uevent */
        ...
        if (*(long *)(lVar6 + 0x28) != 0) {
          ...
          do {
            ...
            if (iVar3 != -0x3d && iVar3 != -0x13) {
              ...
              if ((int)uVar4 != 0) goto LAB_00101fb0;
            }
            lVar6 = *plVar8;
            uVar7 = (ulong)iVar9;
            iVar9 = iVar9 + 1;
...
/* 00102000 zte_power_supply_external_power_changed */
...

{
  ...
  if ((0 < (int)param_1[0x8b]) && (pcVar1 = *(code **)(*param_1 + 0x48), pcVar1 != (code *)0x0)) {
    if (*(int *)(pcVar1 + -4) != 0x6f39adef) {
                    /* WARNING: Does not return */
      pcVar1 = (code *)SoftwareBreakpoint(0x8228,0x10203c);
      (*pcVar1)();
    }
    (*pcVar1)();
  }
...
/* 00102050 zte_power_supply_set_battery_charged */
...

{
  ...
  if (((-1 < (int)param_1[0x8b]) && (*(int *)(*param_1 + 8) == 1)) &&
    ...
    if (*(int *)(pcVar1 + -4) != 0x6f39adef) {
                    /* WARNING: Does not return */
      pcVar1 = (code *)SoftwareBreakpoint(0x8228,0x102094);
      (*pcVar1)();
    }
    (*pcVar1)();
    return 0;
...
/* 001020b4 zte_power_supply_powers */
...
/* 001020e0 zte_power_supply_put_battery_info */
...
/* 00102150 zte_power_supply_find_ocv2cap_table */
  ...
  if ((uVar4 & 0xff) < 0x14) {
    *param_3 = *(undefined4 *)(param_1 + (ulong)(byte)uVar4 * 4 + 0x168);
    return ((long *)(param_1 + 200))[uVar5 & 0xff];
                    ...
                    /* WARNING: Does not return */
  pcVar3 = (code *)SoftwareBreakpoint(0x5512,0x1021c0);
  (*pcVar3)();
}



/* 001021c4 zte_devm_power_supply_get_by_phandle */
...
/* 00102324 zte_devm_power_supply_put */
...
/* 0010237c power_supply_attr_is_visible */
...
/* 00102450 zte_power_supply_dev_release */
...
/* 00102474 zte_power_supply_changed_work */
...
/* 00102534 zte_power_supply_deferred_register_work */
...
/* 0010262c zte_power_supply_check_supplies */
...
/* 001027dc __zte_power_supply_changed_work */
...
LAB_0010288c:
          ...
          if (*(int *)(pcVar3 + -4) == 0x6f39adef) {
            ...
            return 0;
                    ...
                    /* WARNING: Does not return */
          pcVar3 = (code *)SoftwareBreakpoint(0x8228,0x1028b0);
          (*pcVar3)();
        }
        uVar2 = (ulong)iVar9;
        iVar9 = iVar9 + 1;
...
/* 001028d4 __zte_power_supply_populate_supplied_from */
...

{
  ...
  do {
    ...
    if ((iVar2 != 0) || (local_88[0] == 0)) goto LAB_00102994;
    iVar3 = iVar3 + 1;
...
/* 001029cc zte_power_supply_get_battery_info */
...
joined_r0x00102f84:
                ...
                if (uVar14 == 0x14) {
                    /* WARNING: Does not return */
                  pcVar6 = (code *)SoftwareBreakpoint(0x5512,0x103000);
                  (*pcVar6)();
                }
                uVar2 = (uint)local_b8;
...
/* 00103004 zte_power_supply_match_device_by_name */
...
/* 00103038 zte_power_supply_temp2resist_simple */
...
/* 001030a4 zte_power_supply_ocv2cap_simple */
...
/* 00103110 zte_power_supply_batinfo_ocv2cap */
...

{
  ...
  if (*(long *)(param_1 + 200) != 0) {
    ...
    if (0x13 < (uVar4 & 0xff)) {
                    /* WARNING: Does not return */
      pcVar3 = (code *)SoftwareBreakpoint(0x5512,0x1031e0);
      (*pcVar3)();
    }
