...
/* 001022a8 zte_power_supply_batinfo_ocv2cap */
...
/* 00102338 zte_devm_power_supply_get_by_phandle */
...
/* 00102498 zte_devm_power_supply_put */
...
/* 001024f0 power_supply_attr_is_visible */
...

{
  ...
  if (0x12 < (int)param_3) {
                    /* WARNING: Does not return */
    pcVar4 = (code *)SoftwareBreakpoint(0x800,0x1025c0);
    (*pcVar4)();
  }
  if (0x12 < param_3) {
                    /* WARNING: Does not return */
    pcVar4 = (code *)SoftwareBreakpoint(0x5512,0x1025bc);
    (*pcVar4)();
  }
      ...
      do {
        if (*(uint *)(*(long *)(lVar3 + 0x20) + uVar5 * 4) == param_3) {
          ...
          if (*(int *)(pcVar4 + -4) != 0x3f091c91) {
                    /* WARNING: Does not return */
            pcVar4 = (code *)SoftwareBreakpoint(0x8228,0x102598);
            (*pcVar4)();
          }
...
/* 001025c4 zte_power_supply_changed_work */
...
/* 00102684 zte_power_supply_deferred_register_work */
...
/* 0010272c zte_power_supply_check_supplies */
...
/* 0010291c zte_power_supply_dev_release */
...
/* 00102940 __zte_power_supply_changed_work */
...
LAB_001029f0:
          ...
          if (*(int *)(pcVar3 + -4) == 0x6f39adef) {
            ...
            return 0;
                    ...
                    /* WARNING: Does not return */
          pcVar3 = (code *)SoftwareBreakpoint(0x8228,0x102a14);
          (*pcVar3)();
        }
        uVar2 = (ulong)iVar9;
        iVar9 = iVar9 + 1;
...
/* 00102a38 __zte_power_supply_find_supply_from_node */
...
/* 00102a50 __zte_power_supply_populate_supplied_from */
...

{
  ...
  do {
    ...
    if ((iVar2 != 0) || (local_88[0] == 0)) goto LAB_00102b10;
...
/* 00102b48 zte_power_supply_get_battery_info */
...
joined_r0x00103100:
                ...
                if (uVar14 == 0x14) {
                    /* WARNING: Does not return */
                  pcVar6 = (code *)SoftwareBreakpoint(0x5512,0x10317c);
                  (*pcVar6)();
                }
                uVar2 = (uint)local_b8;
...
/* 00103180 zte_power_supply_match_device_by_name */
...
/* 001031b4 zte_power_supply_temp2resist_simple */
...
/* 00103220 zte_power_supply_ocv2cap_simple */
