/* 00101164 zte_power_supply_get_property */
...

{
  ...
  if (*(int *)(*(code **)(*param_1 + 0x30) + -4) != -0x7a95136b) {
    ...
    pcVar1 = (code *)SoftwareBreakpoint(0x8228,0x10119c);
    (*pcVar1)();
  }
...
/* 001011c8 zte_power_supply_set_property */
...

{
  ...
  if ((0 < (int)param_1[0x8b]) && (pcVar2 = *(code **)(*param_1 + 0x38), pcVar2 != (code *)0x0)) {
    if (*(int *)(pcVar2 + -4) != 0x1c0179c9) {
                    /* WARNING: Does not return */
      pcVar2 = (code *)SoftwareBreakpoint(0x8228,0x101204);
      (*pcVar2)();
    }
    uVar1 = (*pcVar2)();
    return uVar1;
...
/* 00101220 zte_power_supply_property_is_writeable */
...

{
  ...
  if ((0 < (int)param_1[0x8b]) && (pcVar2 = *(code **)(*param_1 + 0x40), pcVar2 != (code *)0x0)) {
    if (*(int *)(pcVar2 + -4) != 0x3f091c91) {
                    /* WARNING: Does not return */
      pcVar2 = (code *)SoftwareBreakpoint(0x8228,0x10125c);
      (*pcVar2)();
    }
    uVar1 = (*pcVar2)();
    return uVar1;
...
/* 00101278 zte_power_supply_init_attrs */
...

{
  ...
  *(undefined ***)(param_1 + 8) = &zte_power_supply_groups;
  uVar7 = _printk(&DAT_0010365f,0x13);
  lVar9 = 0;
  uVar8 = 0;
  do {
    lVar3 = uVar8 * 0x58;
    if ((&zte_power_supply_attrs)[uVar8 * 0xb] == (undefined *)0x0) {
      _printk(&DAT_0010352b,"zte_power_supply_init_attrs",uVar8 & 0xffffffff);
      ...
      while (bVar2 != 0) {
        if ((0x687 < lVar4 + 8U) ||
           (s_STATUS_00100260[lVar4] = ((&_ctype)[bVar2] & 1) * ' ' + bVar2, lVar4 == 0x67f)) {
                    /* WARNING: Does not return */
          pcVar5 = (code *)SoftwareBreakpoint(1,0x1013b8);
          (*pcVar5)();
        }
...
/* 001013bc zte_power_supply_show_property */
...
/* 0010152c zte_power_supply_store_property */
...
/* 00101610 zte_power_supply_reg_notifier */
...
/* 0010163c zte_power_supply_unreg_notifier */
...
/* 00101668 zte_power_supply_changed */
...
/* 001016cc zte_power_supply_register */
...
/* 001016ec __zte_power_supply_register */
...

{
  ...
  if (param_1 == 0) {
    ...
    _printk(&DAT_00103733,"__zte_power_supply_register",lVar8);
  }
...
LAB_00101938:
    ...
    if (plVar7 == (long *)0x0) {
      ...
      *plVar7 = (long)param_2;
      ...
      iVar6 = dev_set_name(plVar7 + 7,&DAT_001036d1,*param_2);
      if (iVar6 == 0) {
...
/* 001019d0 zte_power_supply_register_no_ws */
...
/* 001019f4 zte_power_supply_unregister */
...

{
  ...
  if (iVar2 + -1 != 0) {
                    /* WARNING: Does not return */
    pcVar5 = (code *)SoftwareBreakpoint(0x800,0x101a9c);
    (*pcVar5)();
  }
...
/* 00101aa4 zte_devm_power_supply_register */
...
/* 00101b4c zte_devm_power_supply_release */
...
/* 00101b70 zte_devm_power_supply_register_no_ws */
...
/* 00101c18 zte_power_supply_get_by_name */
...
/* 00101cdc zte_power_supply_get_by_phandle */
...
/* 00101dac zte_power_supply_match_device_node */
...
/* 00101dd0 zte_power_supply_get_by_phandle_array */
...
/* 00101ea0 zte_power_supply_match_device_node_array */
...
/* 00101f2c zte_power_supply_get_drvdata */
...
/* 00101f38 zte_power_supply_uevent */
        ...
        if (*(long *)(lVar6 + 0x28) != 0) {
          ...
          do {
            ...
            if (iVar3 != -0x3d && iVar3 != -0x13) {
              ...
              if ((int)uVar4 != 0) goto LAB_0010206c;
            }
            lVar6 = *plVar8;
            uVar7 = (ulong)iVar9;
            iVar9 = iVar9 + 1;
...
/* 001020bc zte_power_supply_external_power_changed */
...

{
  ...
  if ((0 < (int)param_1[0x8b]) && (pcVar1 = *(code **)(*param_1 + 0x48), pcVar1 != (code *)0x0)) {
    if (*(int *)(pcVar1 + -4) != 0x6f39adef) {
                    /* WARNING: Does not return */
      pcVar1 = (code *)SoftwareBreakpoint(0x8228,0x1020f8);
      (*pcVar1)();
    }
    (*pcVar1)();
  }
...
/* 0010210c zte_power_supply_set_battery_charged */
...

{
  ...
  if (((-1 < (int)param_1[0x8b]) && (*(int *)(*param_1 + 8) == 1)) &&
    ...
    if (*(int *)(pcVar1 + -4) != 0x6f39adef) {
                    /* WARNING: Does not return */
      pcVar1 = (code *)SoftwareBreakpoint(0x8228,0x102150);
      (*pcVar1)();
    }
    (*pcVar1)();
    return 0;
...
/* 00102170 zte_power_supply_powers */
...
/* 0010219c zte_power_supply_put_battery_info */
...
/* 0010220c zte_power_supply_find_ocv2cap_table */
  ...
  if ((uVar4 & 0xff) < 0x14) {
    *param_3 = *(undefined4 *)(param_1 + (ulong)(byte)uVar4 * 4 + 0x168);
    return ((long *)(param_1 + 200))[uVar5 & 0xff];
                    ...
                    /* WARNING: Does not return */
  pcVar3 = (code *)SoftwareBreakpoint(0x5512,0x10227c);
  (*pcVar3)();
}



/* 00102280 zte_devm_power_supply_get_by_phandle */
...
/* 001023e0 zte_devm_power_supply_put */
...
/* 00102438 power_supply_attr_is_visible */
...

{
  ...
  if (0x12 < (int)param_3) {
                    /* WARNING: Does not return */
    pcVar4 = (code *)SoftwareBreakpoint(0x800,0x102508);
    (*pcVar4)();
  }
  if (0x12 < param_3) {
                    /* WARNING: Does not return */
    pcVar4 = (code *)SoftwareBreakpoint(0x5512,0x102504);
    (*pcVar4)();
  }
      ...
      do {
        if (*(uint *)(*(long *)(lVar3 + 0x20) + uVar5 * 4) == param_3) {
          ...
          if (*(int *)(pcVar4 + -4) != 0x3f091c91) {
                    /* WARNING: Does not return */
            pcVar4 = (code *)SoftwareBreakpoint(0x8228,0x1024e0);
            (*pcVar4)();
          }
...
/* 0010250c zte_power_supply_changed_work */
...
/* 001025cc zte_power_supply_deferred_register_work */
...
/* 00102674 zte_power_supply_check_supplies */
...
/* 00102864 zte_power_supply_dev_release */
...
/* 00102888 __zte_power_supply_changed_work */
...
LAB_00102938:
          ...
          if (*(int *)(pcVar3 + -4) == 0x6f39adef) {
            ...
            return 0;
                    ...
                    /* WARNING: Does not return */
          pcVar3 = (code *)SoftwareBreakpoint(0x8228,0x10295c);
          (*pcVar3)();
        }
        uVar2 = (ulong)iVar9;
        iVar9 = iVar9 + 1;
...
/* 00102980 __zte_power_supply_find_supply_from_node */
...
/* 00102998 __zte_power_supply_populate_supplied_from */
...

{
  ...
  do {
    ...
    if ((iVar2 != 0) || (local_88[0] == 0)) goto LAB_00102a58;
...
/* 00102a90 zte_power_supply_get_battery_info */
...
joined_r0x00103048:
                ...
                if (uVar14 == 0x14) {
                    /* WARNING: Does not return */
                  pcVar6 = (code *)SoftwareBreakpoint(0x5512,0x1030c4);
                  (*pcVar6)();
                }
                uVar2 = (uint)local_b8;
...
/* 001030c8 zte_power_supply_match_device_by_name */
...
/* 001030fc zte_power_supply_temp2resist_simple */
...
/* 00103168 zte_power_supply_ocv2cap_simple */
...
/* 001031d4 zte_power_supply_batinfo_ocv2cap */
...

{
  ...
  if (*(long *)(param_1 + 200) != 0) {
    ...
    if (0x13 < (uVar4 & 0xff)) {
                    /* WARNING: Does not return */
      pcVar3 = (code *)SoftwareBreakpoint(0x5512,0x1032a4);
      (*pcVar3)();
    }
