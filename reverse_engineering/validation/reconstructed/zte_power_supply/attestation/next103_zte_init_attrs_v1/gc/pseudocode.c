...

{
  ...
  iVar3 = (int)(param_2 - 0x1002a8U >> 3) * -0x45d1745d;
  local_40 = 0;
  if (iVar3 == 0x40) {
...
/* 00101474 zte_power_supply_store_property */
...
/* 00101558 zte_power_supply_reg_notifier */
...
/* 00101584 zte_power_supply_unreg_notifier */
...
/* 001015b0 zte_power_supply_changed */
...
/* 00101614 __zte_power_supply_find_supply_from_node */
...
/* 0010162c zte_power_supply_register */
...
/* 0010164c __zte_power_supply_register */
...
/* 00101944 zte_power_supply_register_no_ws */
...
/* 00101968 zte_power_supply_unregister */
...

{
  ...
  if (iVar2 + -1 != 0) {
                    /* WARNING: Does not return */
    pcVar5 = (code *)SoftwareBreakpoint(0x800,0x101a10);
    (*pcVar5)();
  }
...
/* 00101a18 zte_devm_power_supply_register */
...
/* 00101ac0 zte_devm_power_supply_release */
...
/* 00101ae4 zte_devm_power_supply_register_no_ws */
...
/* 00101b8c zte_power_supply_get_by_name */
...
/* 00101c50 zte_power_supply_get_by_phandle */
...
/* 00101d20 zte_power_supply_match_device_node */
...
/* 00101d44 zte_power_supply_get_by_phandle_array */
...
/* 00101e14 zte_power_supply_match_device_node_array */
...
/* 00101ea0 zte_power_supply_get_drvdata */
...
/* 00101eac zte_power_supply_uevent */
        ...
        if (*(long *)(lVar6 + 0x28) != 0) {
          ...
          do {
            ...
            if (iVar3 != -0x3d && iVar3 != -0x13) {
              ...
              if ((int)uVar4 != 0) goto LAB_00101fe0;
            }
            lVar6 = *plVar8;
            uVar7 = (ulong)iVar9;
            iVar9 = iVar9 + 1;
...
/* 00102030 zte_power_supply_external_power_changed */
...

{
  ...
  if ((0 < (int)param_1[0x8b]) && (pcVar1 = *(code **)(*param_1 + 0x48), pcVar1 != (code *)0x0)) {
    if (*(int *)(pcVar1 + -4) != 0x6f39adef) {
                    /* WARNING: Does not return */
      pcVar1 = (code *)SoftwareBreakpoint(0x8228,0x10206c);
      (*pcVar1)();
    }
    (*pcVar1)();
  }
...
/* 00102080 zte_power_supply_set_battery_charged */
...

{
  ...
  if (((-1 < (int)param_1[0x8b]) && (*(int *)(*param_1 + 8) == 1)) &&
    ...
    if (*(int *)(pcVar1 + -4) != 0x6f39adef) {
                    /* WARNING: Does not return */
      pcVar1 = (code *)SoftwareBreakpoint(0x8228,0x1020c4);
      (*pcVar1)();
    }
    (*pcVar1)();
    return 0;
...
/* 001020e4 zte_power_supply_powers */
...
/* 00102110 zte_power_supply_put_battery_info */
...
/* 00102180 zte_power_supply_find_ocv2cap_table */
  ...
  if ((uVar4 & 0xff) < 0x14) {
    *param_3 = *(undefined4 *)(param_1 + (ulong)(byte)uVar4 * 4 + 0x168);
    return ((long *)(param_1 + 200))[uVar5 & 0xff];
                    ...
                    /* WARNING: Does not return */
  pcVar3 = (code *)SoftwareBreakpoint(0x5512,0x1021f0);
  (*pcVar3)();
}



/* 001021f4 zte_devm_power_supply_get_by_phandle */
...
/* 00102354 zte_devm_power_supply_put */
...
/* 001023ac power_supply_attr_is_visible */
...

{
  ...
  if (0x12 < (int)param_3) {
                    /* WARNING: Does not return */
    pcVar4 = (code *)SoftwareBreakpoint(0x800,0x10247c);
    (*pcVar4)();
  }
  if (0x12 < param_3) {
                    /* WARNING: Does not return */
    pcVar4 = (code *)SoftwareBreakpoint(0x5512,0x102478);
    (*pcVar4)();
  }
      ...
      do {
        if (*(uint *)(*(long *)(lVar3 + 0x20) + uVar5 * 4) == param_3) {
          ...
          if (*(int *)(pcVar4 + -4) != 0x3f091c91) {
                    /* WARNING: Does not return */
            pcVar4 = (code *)SoftwareBreakpoint(0x8228,0x102454);
            (*pcVar4)();
          }
...
/* 00102480 zte_power_supply_dev_release */
...
/* 001024a4 zte_power_supply_changed_work */
...
/* 00102564 zte_power_supply_deferred_register_work */
...
/* 0010265c zte_power_supply_check_supplies */
...
/* 0010280c __zte_power_supply_changed_work */
...
LAB_001028bc:
          ...
          if (*(int *)(pcVar3 + -4) == 0x6f39adef) {
            ...
            return 0;
                    ...
                    /* WARNING: Does not return */
          pcVar3 = (code *)SoftwareBreakpoint(0x8228,0x1028e0);
          (*pcVar3)();
        }
        uVar2 = (ulong)iVar9;
        iVar9 = iVar9 + 1;
...
/* 00102904 __zte_power_supply_populate_supplied_from */
...

{
  ...
  do {
    ...
    if ((iVar2 != 0) || (local_88[0] == 0)) goto LAB_001029c4;
    iVar3 = iVar3 + 1;
...
/* 001029fc zte_power_supply_get_battery_info */
...
joined_r0x00102fb4:
                ...
                if (uVar14 == 0x14) {
                    /* WARNING: Does not return */
                  pcVar6 = (code *)SoftwareBreakpoint(0x5512,0x103030);
                  (*pcVar6)();
                }
                uVar2 = (uint)local_b8;
...
/* 00103034 zte_power_supply_match_device_by_name */
...
/* 00103068 zte_power_supply_temp2resist_simple */
...
/* 001030d4 zte_power_supply_ocv2cap_simple */
...
/* 00103140 zte_power_supply_batinfo_ocv2cap */
...

{
  ...
  if (*(long *)(param_1 + 200) != 0) {
    ...
    if (0x13 < (uVar4 & 0xff)) {
                    /* WARNING: Does not return */
      pcVar3 = (code *)SoftwareBreakpoint(0x5512,0x103210);
      (*pcVar3)();
    }
