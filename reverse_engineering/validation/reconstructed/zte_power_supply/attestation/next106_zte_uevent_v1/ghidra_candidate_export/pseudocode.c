/* 00101004 zte_power_supply_get_property */
...

{
  ...
  if (*(int *)(*(code **)(*param_1 + 0x30) + -4) != -0x7a95136b) {
    ...
    pcVar1 = (code *)SoftwareBreakpoint(0x8228,0x10103c);
    (*pcVar1)();
  }
...
/* 00101068 zte_power_supply_set_property */
...

{
  ...
  if ((0 < (int)param_1[0x8b]) && (pcVar2 = *(code **)(*param_1 + 0x38), pcVar2 != (code *)0x0)) {
    if (*(int *)(pcVar2 + -4) != 0x1c0179c9) {
                    /* WARNING: Does not return */
      pcVar2 = (code *)SoftwareBreakpoint(0x8228,0x1010a4);
      (*pcVar2)();
    }
    uVar1 = (*pcVar2)();
    return uVar1;
...
/* 001010c0 zte_power_supply_property_is_writeable */
...

{
  ...
  if ((0 < (int)param_1[0x8b]) && (pcVar2 = *(code **)(*param_1 + 0x40), pcVar2 != (code *)0x0)) {
    if (*(int *)(pcVar2 + -4) != 0x3f091c91) {
                    /* WARNING: Does not return */
      pcVar2 = (code *)SoftwareBreakpoint(0x8228,0x1010fc);
      (*pcVar2)();
    }
    uVar1 = (*pcVar2)();
    return uVar1;
...
/* 00101118 zte_power_supply_show_property */
...

{
  ...
  local_40 = 0;
  iVar3 = (int)((ulong)(param_2 + -0x2004a) >> 3) * -0x45d1745d;
  if (iVar3 == 0x40) {
...
/* 00101284 zte_power_supply_init_attrs */
...

{
  ...
  *(undefined1 **)(param_1 + 8) = zte_power_supply_attr_groups;
  uVar7 = _printk(&DAT_0010379e,0x13);
  lVar9 = 0;
  uVar8 = 0;
  do {
    lVar3 = uVar8 * 0x58;
    if ((&zte_power_supply_attrs)[uVar8 * 0xb] == (undefined *)0x0) {
      _printk(&DAT_001033d2,"zte_power_supply_init_attrs",uVar8 & 0xffffffff);
      uVar6 = sprintf(&DAT_00100230 + lVar3,"_err_%d",uVar8 & 0xffffffff);
      uVar7 = (ulong)uVar6;
    }
    else {
      bVar2 = (&DAT_00100230)[lVar3];
      lVar4 = lVar9;
      while (bVar2 != 0) {
        if ((0x687 < lVar4 + 8U) ||
           ((&DAT_00100230)[lVar4] = ((&_ctype)[bVar2] & 1) * ' ' + bVar2, lVar4 == 0x67f)) {
                    /* WARNING: Does not return */
          pcVar5 = (code *)SoftwareBreakpoint(1,0x1013c4);
          (*pcVar5)();
        }
        bVar2 = (&DAT_00100231)[lVar4];
        lVar4 = lVar4 + 1;
      }
    }
    lVar9 = lVar9 + 0x58;
    (&DAT_00100250)[uVar8 * 0xb] = &DAT_00100230 + lVar3;
    (&__zte_power_supply_attrs)[uVar8] = &DAT_00100250 + uVar8 * 0xb;
    uVar1 = uVar8 + 1;
    (&DAT_00100260)[uVar8 * 0xb] = zte_power_supply_show_property;
    (&DAT_00100268)[uVar8 * 0xb] = zte_power_supply_store_property;
    uVar8 = uVar1;
    if (uVar1 == 0x13) {
      return uVar7;
    }
...
/* 001013c8 zte_power_supply_reg_notifier */
...
/* 001013f4 zte_power_supply_unreg_notifier */
...
/* 00101420 zte_power_supply_changed */
...
/* 00101484 __zte_power_supply_find_supply_from_node */
...
/* 0010149c zte_power_supply_register */
...
/* 001014bc __zte_power_supply_register */
...

{
  ...
  if (param_1 == 0) {
    _printk(&DAT_00103584,"__zte_power_supply_register",*param_2);
  }
...
LAB_0010160c:
    ...
    if (plVar6 == (long *)0x0) {
      ...
      *plVar6 = (long)param_2;
      ...
      iVar5 = dev_set_name(plVar6 + 7,&DAT_0010352c,*param_2);
      if (iVar5 == 0) {
...
/* 001017b4 zte_power_supply_register_no_ws */
...
/* 001017d8 zte_power_supply_unregister */
...

{
  ...
  if (iVar2 + -1 != 0) {
                    /* WARNING: Does not return */
    pcVar5 = (code *)SoftwareBreakpoint(0x800,0x101880);
    (*pcVar5)();
  }
...
/* 00101888 zte_devm_power_supply_register */
...
/* 00101930 zte_devm_power_supply_release */
...
/* 00101954 zte_devm_power_supply_register_no_ws */
...
/* 001019fc zte_power_supply_get_by_name */
...
/* 00101ac0 zte_power_supply_get_by_phandle */
...
/* 00101b90 zte_power_supply_match_device_node */
...
/* 00101bb4 zte_power_supply_get_by_phandle_array */
...
/* 00101c84 zte_power_supply_match_device_node_array */
...
/* 00101d10 zte_power_supply_get_drvdata */
...
/* 00101d1c zte_power_supply_external_power_changed */
...

{
  ...
  if ((0 < (int)param_1[0x8b]) && (pcVar1 = *(code **)(*param_1 + 0x48), pcVar1 != (code *)0x0)) {
    if (*(int *)(pcVar1 + -4) != 0x6f39adef) {
                    /* WARNING: Does not return */
      pcVar1 = (code *)SoftwareBreakpoint(0x8228,0x101d58);
      (*pcVar1)();
    }
    (*pcVar1)();
  }
...
/* 00101d6c zte_power_supply_set_battery_charged */
...

{
  ...
  if (((-1 < (int)param_1[0x8b]) && (*(int *)(*param_1 + 8) == 1)) &&
    ...
    if (*(int *)(pcVar1 + -4) != 0x6f39adef) {
                    /* WARNING: Does not return */
      pcVar1 = (code *)SoftwareBreakpoint(0x8228,0x101db0);
      (*pcVar1)();
    }
    (*pcVar1)();
    return 0;
...
/* 00101dd0 zte_power_supply_powers */
...
/* 00101dfc zte_power_supply_put_battery_info */
...
/* 00101e6c zte_power_supply_find_ocv2cap_table */
  ...
  if ((uVar4 & 0xff) < 0x14) {
    *param_3 = *(undefined4 *)(param_1 + (ulong)(byte)uVar4 * 4 + 0x168);
    return ((long *)(param_1 + 200))[uVar5 & 0xff];
                    ...
                    /* WARNING: Does not return */
  pcVar3 = (code *)SoftwareBreakpoint(0x5512,0x101edc);
  (*pcVar3)();
}



/* 00101ee0 zte_devm_power_supply_get_by_phandle */
...
/* 00102040 zte_devm_power_supply_put */
...
/* 00102098 power_supply_attr_is_visible */
...

{
  ...
  if (0x12 < (int)param_3) {
                    /* WARNING: Does not return */
    pcVar4 = (code *)SoftwareBreakpoint(0x800,0x102168);
    (*pcVar4)();
  }
  if (0x12 < param_3) {
                    /* WARNING: Does not return */
    pcVar4 = (code *)SoftwareBreakpoint(0x5512,0x102164);
    (*pcVar4)();
  }
      ...
      do {
        if (*(uint *)(*(long *)(lVar3 + 0x20) + uVar5 * 4) == param_3) {
          ...
          if (*(int *)(pcVar4 + -4) != 0x3f091c91) {
                    /* WARNING: Does not return */
            pcVar4 = (code *)SoftwareBreakpoint(0x8228,0x102140);
            (*pcVar4)();
          }
...
/* 0010216c zte_power_supply_dev_release */
...
/* 00102190 zte_power_supply_changed_work */
...
/* 00102250 zte_power_supply_deferred_register_work */
...
/* 0010234c zte_power_supply_store_property */
...

{
  ...
  iVar3 = zte_power_supply_set_property
                    (uVar6,(int)(param_2 - 0x100250U >> 3) * -0x45d1745d,&local_40);
  lVar4 = (long)iVar3;
  if (-1 < iVar3) {
    lVar4 = param_4;
  }
...
/* 0010243c zte_power_supply_uevent */
      ...
      if (__s == (char *)0x0) {
        ...
        if (*(long *)(lVar6 + 0x28) != 0) {
          ...
          do {
            ...
            if (0x13 < uVar1) {
                    /* WARNING: Does not return */
              pcVar2 = (code *)SoftwareBreakpoint(0x5512,0x102594);
              (*pcVar2)();
            }
            uVar4 = zte_power_supply_show_property(param_1,&DAT_00100250 + (ulong)uVar1 * 0xb,__s);
            iVar3 = (int)uVar4;
            if (iVar3 != -0x3d && iVar3 != -0x13) {
              if (iVar3 < 0) goto LAB_00102578;
...
/* 001025c8 zte_power_supply_check_supplies */
...
/* 00102778 __zte_power_supply_changed_work */
...
LAB_00102828:
          ...
          if (*(int *)(pcVar3 + -4) == 0x6f39adef) {
            ...
            return 0;
                    ...
                    /* WARNING: Does not return */
          pcVar3 = (code *)SoftwareBreakpoint(0x8228,0x10284c);
          (*pcVar3)();
        }
        uVar2 = (ulong)iVar9;
        iVar9 = iVar9 + 1;
...
/* 00102870 __zte_power_supply_populate_supplied_from */
...

{
  ...
  do {
    ...
    if ((iVar2 != 0) || (local_88[0] == 0)) goto LAB_00102930;
    iVar3 = iVar3 + 1;
...
/* 00102968 zte_power_supply_get_battery_info */
...
joined_r0x00102f20:
                ...
                if (uVar14 == 0x14) {
                    /* WARNING: Does not return */
                  pcVar6 = (code *)SoftwareBreakpoint(0x5512,0x102f9c);
                  (*pcVar6)();
                }
                uVar2 = (uint)local_b8;
...
/* 00102fa0 zte_power_supply_match_device_by_name */
...
/* 00102fd4 zte_power_supply_temp2resist_simple */
...
/* 00103040 zte_power_supply_ocv2cap_simple */
...
/* 001030ac zte_power_supply_batinfo_ocv2cap */
...

{
  ...
  if (*(long *)(param_1 + 200) != 0) {
    ...
    if (0x13 < (uVar4 & 0xff)) {
                    /* WARNING: Does not return */
      pcVar3 = (code *)SoftwareBreakpoint(0x5512,0x10317c);
      (*pcVar3)();
    }
