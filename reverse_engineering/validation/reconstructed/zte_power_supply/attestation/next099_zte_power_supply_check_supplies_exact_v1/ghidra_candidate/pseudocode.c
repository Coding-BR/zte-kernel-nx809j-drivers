/* 001010f4 zte_power_supply_get_property */
...

{
  ...
  if (*(int *)(*(code **)(*param_1 + 0x30) + -4) != -0x7a95136b) {
    ...
    pcVar1 = (code *)SoftwareBreakpoint(0x8228,0x10112c);
    (*pcVar1)();
  }
...
/* 00101158 zte_power_supply_set_property */
...

{
  ...
  if ((0 < (int)param_1[0x8b]) && (pcVar2 = *(code **)(*param_1 + 0x38), pcVar2 != (code *)0x0)) {
    if (*(int *)(pcVar2 + -4) != 0x1c0179c9) {
                    /* WARNING: Does not return */
      pcVar2 = (code *)SoftwareBreakpoint(0x8228,0x101194);
      (*pcVar2)();
    }
    uVar1 = (*pcVar2)();
    return uVar1;
...
/* 001011b0 zte_power_supply_property_is_writeable */
...

{
  ...
  if ((0 < (int)param_1[0x8b]) && (pcVar2 = *(code **)(*param_1 + 0x40), pcVar2 != (code *)0x0)) {
    if (*(int *)(pcVar2 + -4) != 0x3f091c91) {
                    /* WARNING: Does not return */
      pcVar2 = (code *)SoftwareBreakpoint(0x8228,0x1011ec);
      (*pcVar2)();
    }
    uVar1 = (*pcVar2)();
    return uVar1;
...
/* 00101208 zte_power_supply_init_attrs */
...

{
  ...
  *(undefined ***)(param_1 + 8) = &zte_power_supply_groups;
  uVar7 = _printk(&DAT_0010363f,0x13);
  lVar9 = 0;
  uVar8 = 0;
  do {
    lVar3 = uVar8 * 0x58;
    if ((&zte_power_supply_attrs)[uVar8 * 0xb] == (undefined *)0x0) {
      _printk(&DAT_0010350b,"zte_power_supply_init_attrs",uVar8 & 0xffffffff);
      ...
      while (bVar2 != 0) {
        if ((0x687 < lVar4 + 8U) ||
           (s_STATUS_00100260[lVar4] = ((&_ctype)[bVar2] & 1) * ' ' + bVar2, lVar4 == 0x67f)) {
                    /* WARNING: Does not return */
          pcVar5 = (code *)SoftwareBreakpoint(1,0x101348);
          (*pcVar5)();
        }
    ...
    (&__zte_power_supply_attrs)[uVar8] = &DAT_00100280 + uVar8 * 0xb;
    uVar1 = uVar8 + 1;
...
/* 0010134c zte_power_supply_show_property */
...
/* 001014bc zte_power_supply_store_property */
...
/* 001015a0 zte_power_supply_reg_notifier */
...
/* 001015cc zte_power_supply_unreg_notifier */
...
/* 001015f8 zte_power_supply_changed */
...
/* 0010165c __zte_power_supply_find_supply_from_node */
...
/* 00101674 __zte_power_supply_populate_supplied_from */
...

{
  ...
  do {
    ...
    if ((iVar2 != 0) || (local_88[0] == 0)) goto LAB_00101734;
...
/* 0010176c zte_power_supply_register */
...
/* 0010178c __zte_power_supply_register */
...

{
  ...
  if (param_1 == 0) {
    _printk(&DAT_00103713,"__zte_power_supply_register",*param_2);
  }
...
LAB_001018dc:
    ...
    plVar6 = (long *)__kmalloc_cache_noprof(_put_device,0xdc0,0x4c0);
    if (plVar6 == (long *)0x0) {
      ...
      *plVar6 = (long)param_2;
      ...
      iVar5 = dev_set_name(plVar6 + 7,&DAT_001036c0,*param_2);
      if (iVar5 == 0) {
...
/* 00101a84 zte_power_supply_register_no_ws */
...
/* 00101aa8 zte_power_supply_unregister */
...

{
  ...
  if (iVar2 + -1 != 0) {
                    /* WARNING: Does not return */
    pcVar5 = (code *)SoftwareBreakpoint(0x800,0x101b50);
    (*pcVar5)();
  }
...
/* 00101b58 zte_devm_power_supply_register */
...
/* 00101c00 zte_devm_power_supply_release */
...
/* 00101c24 zte_devm_power_supply_register_no_ws */
...
/* 00101ccc zte_power_supply_get_by_name */
...
/* 00101d90 zte_power_supply_get_by_phandle */
...
/* 00101e60 zte_power_supply_match_device_node */
...
/* 00101e84 zte_power_supply_get_by_phandle_array */
...
/* 00101f54 zte_power_supply_match_device_node_array */
...
/* 00101fe0 zte_power_supply_get_drvdata */
...
/* 00101fec zte_power_supply_uevent */
        ...
        if (*(long *)(lVar6 + 0x28) != 0) {
          ...
          do {
            ...
            if (iVar3 != -0x3d && iVar3 != -0x13) {
              ...
              if ((int)uVar4 != 0) goto LAB_00102120;
            }
            lVar6 = *plVar8;
            uVar7 = (ulong)iVar9;
            iVar9 = iVar9 + 1;
...
/* 00102170 zte_power_supply_external_power_changed */
...

{
  ...
  if ((0 < (int)param_1[0x8b]) && (pcVar1 = *(code **)(*param_1 + 0x48), pcVar1 != (code *)0x0)) {
    if (*(int *)(pcVar1 + -4) != 0x6f39adef) {
                    /* WARNING: Does not return */
      pcVar1 = (code *)SoftwareBreakpoint(0x8228,0x1021ac);
      (*pcVar1)();
    }
    (*pcVar1)();
  }
...
/* 001021c0 zte_power_supply_set_battery_charged */
...

{
  ...
  if (((-1 < (int)param_1[0x8b]) && (*(int *)(*param_1 + 8) == 1)) &&
    ...
    if (*(int *)(pcVar1 + -4) != 0x6f39adef) {
                    /* WARNING: Does not return */
      pcVar1 = (code *)SoftwareBreakpoint(0x8228,0x102204);
      (*pcVar1)();
    }
    (*pcVar1)();
    return 0;
...
/* 00102224 zte_power_supply_powers */
...
/* 00102250 zte_power_supply_put_battery_info */
...
/* 001022c0 zte_power_supply_find_ocv2cap_table */
  ...
  if ((uVar4 & 0xff) < 0x14) {
    *param_3 = *(undefined4 *)(param_1 + (ulong)(byte)uVar4 * 4 + 0x168);
    return ((long *)(param_1 + 200))[uVar5 & 0xff];
                    ...
                    /* WARNING: Does not return */
  pcVar3 = (code *)SoftwareBreakpoint(0x5512,0x102330);
  (*pcVar3)();
}



/* 00102334 zte_devm_power_supply_get_by_phandle */
...
/* 00102494 zte_devm_power_supply_put */
...
/* 001024ec power_supply_attr_is_visible */
...

{
  ...
  if (0x12 < (int)param_3) {
                    /* WARNING: Does not return */
    pcVar4 = (code *)SoftwareBreakpoint(0x800,0x1025bc);
    (*pcVar4)();
  }
  if (0x12 < param_3) {
                    /* WARNING: Does not return */
    pcVar4 = (code *)SoftwareBreakpoint(0x5512,0x1025b8);
    (*pcVar4)();
  }
      ...
      do {
        if (*(uint *)(*(long *)(lVar3 + 0x20) + uVar5 * 4) == param_3) {
          ...
          if (*(int *)(pcVar4 + -4) != 0x3f091c91) {
                    /* WARNING: Does not return */
            pcVar4 = (code *)SoftwareBreakpoint(0x8228,0x102594);
            (*pcVar4)();
          }
...
/* 001025c0 zte_power_supply_dev_release */
...
/* 001025e4 zte_power_supply_changed_work */
...
/* 001026a4 zte_power_supply_deferred_register_work */
...
/* 001027a0 __zte_power_supply_changed_work */
...
LAB_00102850:
          ...
          if (*(int *)(pcVar3 + -4) == 0x6f39adef) {
            ...
            return 0;
                    ...
                    /* WARNING: Does not return */
          pcVar3 = (code *)SoftwareBreakpoint(0x8228,0x102874);
          (*pcVar3)();
        }
        uVar2 = (ulong)iVar9;
        iVar9 = iVar9 + 1;
...
/* 00102a44 zte_power_supply_get_battery_info */
...
joined_r0x00102ffc:
                ...
                if (uVar14 == 0x14) {
                    /* WARNING: Does not return */
                  pcVar6 = (code *)SoftwareBreakpoint(0x5512,0x103078);
                  (*pcVar6)();
                }
                uVar2 = (uint)local_b8;
...
/* 0010307c zte_power_supply_match_device_by_name */
...
/* 001030b0 zte_power_supply_temp2resist_simple */
...
/* 0010311c zte_power_supply_ocv2cap_simple */
...
/* 00103188 zte_power_supply_batinfo_ocv2cap */
...

{
  ...
  if (*(long *)(param_1 + 200) != 0) {
    ...
    if (0x13 < (uVar4 & 0xff)) {
                    /* WARNING: Does not return */
      pcVar3 = (code *)SoftwareBreakpoint(0x5512,0x103258);
      (*pcVar3)();
    }
