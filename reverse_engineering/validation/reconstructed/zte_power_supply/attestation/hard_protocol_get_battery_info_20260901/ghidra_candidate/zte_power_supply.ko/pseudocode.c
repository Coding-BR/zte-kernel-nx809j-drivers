...

{
  ...
  *(undefined ***)(param_1 + 8) = &zte_power_supply_groups;
  uVar7 = _printk(&DAT_0010374f,0x13);
  lVar9 = 0;
  uVar8 = 0;
  do {
    lVar3 = uVar8 * 0x58;
    if ((&zte_power_supply_attrs)[uVar8 * 0xb] == (undefined *)0x0) {
      _printk(&DAT_0010361b,"zte_power_supply_init_attrs",uVar8 & 0xffffffff);
...

{
  ...
  if (param_1 == 0) {
    ...
    _printk(&DAT_0010384a,"__zte_power_supply_register",lVar8);
  }
...
LAB_00101a00:
    ...
    if (plVar7 == (long *)0x0) {
      ...
      *plVar7 = (long)param_2;
      ...
      iVar6 = dev_set_name(plVar7 + 7,&DAT_001037f5,*param_2);
      if (iVar6 == 0) {
