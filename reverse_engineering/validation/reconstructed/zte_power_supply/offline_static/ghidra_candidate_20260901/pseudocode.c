/* 0010122c zte_power_supply_get_property */
...

{
  ...
  if (*(int *)(*(code **)(*param_1 + 0x30) + -4) != -0x7a95136b) {
    ...
    pcVar1 = (code *)SoftwareBreakpoint(0x8228,0x101264);
    (*pcVar1)();
  }
...
/* 00101290 zte_power_supply_set_property */
...

{
  ...
  if ((0 < (int)param_1[0x8b]) && (pcVar2 = *(code **)(*param_1 + 0x38), pcVar2 != (code *)0x0)) {
    if (*(int *)(pcVar2 + -4) != 0x1c0179c9) {
                    /* WARNING: Does not return */
      pcVar2 = (code *)SoftwareBreakpoint(0x8228,0x1012cc);
      (*pcVar2)();
    }
    uVar1 = (*pcVar2)();
    return uVar1;
...
/* 001012e8 zte_power_supply_property_is_writeable */
...

{
  ...
  if ((0 < (int)param_1[0x8b]) && (pcVar2 = *(code **)(*param_1 + 0x40), pcVar2 != (code *)0x0)) {
    if (*(int *)(pcVar2 + -4) != 0x3f091c91) {
                    /* WARNING: Does not return */
      pcVar2 = (code *)SoftwareBreakpoint(0x8228,0x101324);
      (*pcVar2)();
    }
    uVar1 = (*pcVar2)();
    return uVar1;
...
/* 00101340 zte_power_supply_init_attrs */
...

{
  ...
  *(undefined ***)(param_1 + 8) = &zte_power_supply_groups;
  uVar7 = _printk(&DAT_001037d5,0x13);
  lVar9 = 0;
  uVar8 = 0;
  do {
    lVar3 = uVar8 * 0x58;
    if ((&zte_power_supply_attrs)[uVar8 * 0xb] == (undefined *)0x0) {
      _printk(&DAT_001036a1,"zte_power_supply_init_attrs",uVar8 & 0xffffffff);
      uVar6 = sprintf(s_STATUS_00100270 + lVar3,"_err_%d",uVar8 & 0xffffffff);
      uVar7 = (ulong)uVar6;
    }
    else {
      bVar2 = s_STATUS_00100270[lVar3];
      lVar4 = lVar9;
      while (bVar2 != 0) {
        if ((0x687 < lVar4 + 8U) ||
           (s_STATUS_00100270[lVar4] = ((&_ctype)[bVar2] & 1) * ' ' + bVar2, lVar4 == 0x67f)) {
                    /* WARNING: Does not return */
          pcVar5 = (code *)SoftwareBreakpoint(1,0x101480);
          (*pcVar5)();
        }
        bVar2 = s_STATUS_00100270[lVar4 + 1];
        lVar4 = lVar4 + 1;
      }
    }
    lVar9 = lVar9 + 0x58;
    (&DAT_00100290)[uVar8 * 0xb] = s_STATUS_00100270 + lVar3;
    (&zte_power_supply_dev_attrs)[uVar8] = &DAT_00100290 + uVar8 * 0xb;
    uVar1 = uVar8 + 1;
    (&DAT_001002a0)[uVar8 * 0xb] = zte_power_supply_show_property;
    (&DAT_001002a8)[uVar8 * 0xb] = zte_power_supply_store_property;
    uVar8 = uVar1;
    if (uVar1 == 0x13) {
      return uVar7;
    }
...
/* 00101484 zte_power_supply_show_property */
...

{
  ...
  iVar3 = (int)(param_2 - 0x100290U >> 3) * -0x45d1745d;
  local_40 = 0;
  if (iVar3 == 0x40) {
...
/* 001015f4 zte_power_supply_store_property */
...

{
  ...
  iVar2 = zte_power_supply_set_property
                    (uVar4,(int)(param_2 - 0x100290U >> 3) * -0x45d1745d,&local_40);
  lVar3 = (long)iVar2;
  if (-1 < iVar2) {
    lVar3 = param_4;
  }
...
/* 001016d8 zte_power_supply_reg_notifier */
...
/* 00101704 zte_power_supply_unreg_notifier */
...
/* 00101730 zte_power_supply_changed */
...
/* 00101794 zte_power_supply_register */
...
/* 001017b4 __zte_power_supply_register */
...

{
  ...
  if (param_1 == 0) {
    ...
    _printk(&DAT_001038d0,"__zte_power_supply_register",lVar8);
  }
...
LAB_00101a00:
    ...
    if (plVar7 == (long *)0x0) {
      ...
      *plVar7 = (long)param_2;
      ...
      iVar6 = dev_set_name(plVar7 + 7,&DAT_0010387b,*param_2);
      if (iVar6 == 0) {
...
/* 00101a98 zte_power_supply_register_no_ws */
...
/* 00101abc zte_power_supply_unregister */
...

{
  ...
  if (iVar2 + -1 != 0) {
                    /* WARNING: Does not return */
    pcVar5 = (code *)SoftwareBreakpoint(0x800,0x101b64);
    (*pcVar5)();
  }
...
/* 00101b6c zte_devm_power_supply_register */
...
/* 00101c14 zte_devm_power_supply_release */
...
/* 00101c38 zte_devm_power_supply_register_no_ws */
...
/* 00101ce0 zte_power_supply_get_by_name */
...
/* 00101d50 zte_power_supply_match_device_by_name */
...
/* 00101ddc zte_power_supply_get_by_phandle */
...
/* 00101eac zte_power_supply_match_device_node */
...
/* 00101ed0 zte_power_supply_get_by_phandle_array */
...
/* 00101fa0 zte_power_supply_match_device_node_array */
...

{
  ...
  if ((*(long *)(param_1 + 0x60) != 0) && (*(long *)(*(long *)(param_1 + 0x60) + 0x2e8) == *param_2)
    ...
    if (param_2[3] < param_2[2]) {
      *(undefined8 *)(param_2[1] + param_2[3] * 8) = *(undefined8 *)(param_1 + 0x98);
      piVar1 = (int *)(*(long *)(param_2[1] + param_2[3] * 8) + 0x458);
      Hint_Prefetch(piVar1,2,0,1);
      do {
        cVar2 = '\x01';
        bVar3 = (bool)ExclusiveMonitorPass(piVar1,0x10);
...
/* 00102030 zte_power_supply_get_drvdata */
...
/* 0010203c zte_power_supply_uevent */
      ...
      if (__s == (char *)0x0) {
        ...
        if (*(long *)(lVar6 + 0x28) != 0) {
          ...
          do {
            ...
            if (0x12 < uVar1) {
                    /* WARNING: Does not return */
              pcVar2 = (code *)SoftwareBreakpoint(0x800,0x10218c);
              (*pcVar2)();
            }
            uVar4 = zte_power_supply_show_property(param_1,&DAT_00100290 + (ulong)uVar1 * 0xb,__s);
            iVar3 = (int)uVar4;
            if (iVar3 != -0x3d && iVar3 != -0x13) {
              if (iVar3 < 0) goto LAB_00102170;
              ...
              if ((int)uVar4 != 0) goto LAB_00102170;
            }
            lVar6 = *plVar8;
            uVar7 = (ulong)iVar9;
            iVar9 = iVar9 + 1;
...
/* 001021c0 zte_power_supply_external_power_changed */
...

{
  ...
  if ((0 < (int)param_1[0x8b]) && (pcVar1 = *(code **)(*param_1 + 0x48), pcVar1 != (code *)0x0)) {
    if (*(int *)(pcVar1 + -4) != 0x6f39adef) {
                    /* WARNING: Does not return */
      pcVar1 = (code *)SoftwareBreakpoint(0x8228,0x1021fc);
      (*pcVar1)();
    }
    (*pcVar1)();
  }
...
/* 00102210 zte_power_supply_set_battery_charged */
...

{
  ...
  if (((-1 < (int)param_1[0x8b]) && (*(int *)(*param_1 + 8) == 1)) &&
    ...
    if (*(int *)(pcVar1 + -4) != 0x6f39adef) {
                    /* WARNING: Does not return */
      pcVar1 = (code *)SoftwareBreakpoint(0x8228,0x102254);
      (*pcVar1)();
    }
    (*pcVar1)();
    return 0;
...
/* 00102274 zte_power_supply_powers */
...
/* 001022a0 zte_power_supply_ocv2cap_simple */

int zte_power_supply_ocv2cap_simple(long param_1,uint param_2,int param_3)
...
/* 00102320 zte_power_supply_temp2resist_simple */
...
/* 001023a0 zte_power_supply_put_battery_info */
...
/* 00102410 zte_power_supply_get_battery_info */
...
LAB_00102a34:
                    /* WARNING: Does not return */
                      pcVar6 = (code *)SoftwareBreakpoint(0x5512,0x102a38);
                      (*pcVar6)();
                    }
                    goto LAB_00102954;
                  }
                  lVar10 = of_get_property(uVar5,lVar9,local_b8);
                  if ((lVar10 == 0) || ((int)local_b8[0] == 0)) {
...
LAB_00102984:
                  ...
                  kfree(lVar9);
                  if (uVar13 == 0x14) goto LAB_00102a34;
                  uVar8 = (int)local_b8[0] >> 3;
...
/* 00102a3c zte_power_supply_find_ocv2cap_table */
...

{
  ...
  if (0x13 < uVar5) {
                    /* WARNING: Does not return */
    pcVar4 = (code *)SoftwareBreakpoint(0x5512,0x102aa4);
    (*pcVar4)();
  }
...
/* 00102aa8 zte_power_supply_batinfo_ocv2cap */
...

{
  ...
  if (*(long *)(param_1 + 200) != 0) {
    ...
    if (0x13 < uVar6) {
                    /* WARNING: Does not return */
      pcVar5 = (code *)SoftwareBreakpoint(0x5512,0x102b84);
      (*pcVar5)();
    }
...
/* 00102b88 zte_devm_power_supply_get_by_phandle */
...

{
  ...
  if (lVar6 == 0) {
    ...
    if (puVar5 == (ulong *)0x0) {
      ...
      local_88[0] = 0;
      local_88[1] = 0;
      iVar4 = __of_parse_phandle_with_args(lVar6,param_2,0,0,0,local_88);
      uVar7 = 0xffffffffffffffed;
...
/* 00102cec zte_devm_power_supply_put */
...
/* 00102d44 power_supply_attr_is_visible */
...

{
  ...
  if (0x12 < (int)param_3) {
                    /* WARNING: Does not return */
    pcVar4 = (code *)SoftwareBreakpoint(0x800,0x102e14);
    (*pcVar4)();
  }
  if (0x12 < param_3) {
                    /* WARNING: Does not return */
    pcVar4 = (code *)SoftwareBreakpoint(0x5512,0x102e10);
    (*pcVar4)();
  }
      ...
      do {
        if (*(uint *)(*(long *)(lVar3 + 0x20) + uVar5 * 4) == param_3) {
          ...
          if (*(int *)(pcVar4 + -4) != 0x3f091c91) {
                    /* WARNING: Does not return */
            pcVar4 = (code *)SoftwareBreakpoint(0x8228,0x102dec);
            (*pcVar4)();
          }
...
/* 00102e18 zte_power_supply_changed_work */
...
/* 00102ed8 zte_power_supply_deferred_register_work */
...
/* 00102f80 zte_power_supply_check_supplies */
...
/* 00103170 zte_power_supply_dev_release */
...
/* 00103194 __zte_power_supply_changed_work */
...
LAB_00103244:
          ...
          if (*(int *)(pcVar3 + -4) == 0x6f39adef) {
            ...
            return 0;
                    ...
                    /* WARNING: Does not return */
          pcVar3 = (code *)SoftwareBreakpoint(0x8228,0x103268);
          (*pcVar3)();
        }
        uVar2 = (ulong)iVar9;
        iVar9 = iVar9 + 1;
...
/* 0010328c __zte_power_supply_find_supply_from_node */
...
/* 001032a4 __zte_power_supply_populate_supplied_from */
...

{
  ...
  do {
    ...
    if ((iVar2 != 0) || (local_88[0] == 0)) goto LAB_00103364;
