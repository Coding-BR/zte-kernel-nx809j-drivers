# Exact attestation: gyro_y_axial_show

Target: `gyro_y_axial_show@0x001013bc`, stock body 128 bytes.

The promoted implementation preserves the 32-instruction AArch64 callback,
including gyro Y offset `0x58`, logging and sprintf behavior, and KCFI type ID
`0xae84bcd4`.
