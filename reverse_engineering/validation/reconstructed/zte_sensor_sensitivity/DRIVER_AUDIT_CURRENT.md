...
- Gerado em: `2026-07-12T20:47:19.300035+00:00`
...
|---|---|---|---|
| `zte_sensor_sensitivity` | `incomplete_or_failed` | `não executado` | module parity check failed: candidate_matches_fresh |
