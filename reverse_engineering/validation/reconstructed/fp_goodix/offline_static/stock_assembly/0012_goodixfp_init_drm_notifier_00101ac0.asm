...
00000000000012a0 <goodixfp_init_drm_notifier>:
    ...
    12b8: 90000014     	adrp	x20, 0x1000 <gf_probe+0x2cc>
		00000000000012b8:  R_AARCH64_ADR_PREL_PG_HI21	.rodata.str1.1+0x409
    12bc: 91000294     	add	x20, x20, #0x0
		00000000000012bc:  R_AARCH64_ADD_ABS_LO12_NC	.rodata.str1.1+0x409
    12c0: aa0003f3     	mov	x19, x0
    12c4: 52884816     	mov	w22, #0x4240            // =16960
    12c8: 90000000     	adrp	x0, 0x1000 <gf_probe+0x2cc>
		00000000000012c8:  R_AARCH64_ADR_PREL_PG_HI21	.rodata.str1.1+0xee2
    12cc: 91000000     	add	x0, x0, #0x0
		00000000000012cc:  R_AARCH64_ADD_ABS_LO12_NC	.rodata.str1.1+0xee2
    ...
    12ec: 90000015     	adrp	x21, 0x1000 <gf_probe+0x2cc>
		00000000000012ec:  R_AARCH64_ADR_PREL_PG_HI21	.rodata.str1.1+0xe42
    12f0: 910002b5     	add	x21, x21, #0x0
		00000000000012f0:  R_AARCH64_ADD_ABS_LO12_NC	.rodata.str1.1+0xe42
    ...
    1368: 90000000     	adrp	x0, 0x1000 <gf_probe+0x2cc>
		0000000000001368:  R_AARCH64_ADR_PREL_PG_HI21	.rodata.str1.1+0xefb
    136c: 91000000     	add	x0, x0, #0x0
		000000000000136c:  R_AARCH64_ADD_ABS_LO12_NC	.rodata.str1.1+0xefb
    1370: 90000001     	adrp	x1, 0x1000 <gf_probe+0x2cc>
		0000000000001370:  R_AARCH64_ADR_PREL_PG_HI21	.rodata.str1.1+0x409
    1374: 91000021     	add	x1, x1, #0x0
		0000000000001374:  R_AARCH64_ADD_ABS_LO12_NC	.rodata.str1.1+0x409
    ...
    1380: 90000000     	adrp	x0, 0x1000 <gf_probe+0x2cc>
		0000000000001380:  R_AARCH64_ADR_PREL_PG_HI21	.rodata.str1.1+0x10ea
    1384: 91000000     	add	x0, x0, #0x0
		0000000000001384:  R_AARCH64_ADD_ABS_LO12_NC	.rodata.str1.1+0x10ea
    1388: 90000001     	adrp	x1, 0x1000 <gf_probe+0x2cc>
		0000000000001388:  R_AARCH64_ADR_PREL_PG_HI21	.rodata.str1.1+0x409
    138c: 91000021     	add	x1, x1, #0x0
		000000000000138c:  R_AARCH64_ADD_ABS_LO12_NC	.rodata.str1.1+0x409
    ...
    13c0: 90000000     	adrp	x0, 0x1000 <gf_probe+0x2cc>
		00000000000013c0:  R_AARCH64_ADR_PREL_PG_HI21	.rodata.str1.1+0x4d7
    13c4: 91000000     	add	x0, x0, #0x0
		00000000000013c4:  R_AARCH64_ADD_ABS_LO12_NC	.rodata.str1.1+0x4d7
    13c8: 90000001     	adrp	x1, 0x1000 <gf_probe+0x2cc>
		00000000000013c8:  R_AARCH64_ADR_PREL_PG_HI21	.rodata.str1.1+0x409
    13cc: 91000021     	add	x1, x1, #0x0
		00000000000013cc:  R_AARCH64_ADD_ABS_LO12_NC	.rodata.str1.1+0x409
