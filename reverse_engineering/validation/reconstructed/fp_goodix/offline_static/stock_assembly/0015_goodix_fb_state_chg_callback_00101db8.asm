...
0000000000001598 <goodix_fb_state_chg_callback>:
    ...
    15d0: 90000000     	adrp	x0, 0x1000 <gf_probe+0x2cc>
		00000000000015d0:  R_AARCH64_ADR_PREL_PG_HI21	.rodata.str1.1+0x656
    15d4: 91000000     	add	x0, x0, #0x0
		00000000000015d4:  R_AARCH64_ADD_ABS_LO12_NC	.rodata.str1.1+0x656
    15d8: 14000003     	b	0x15e4 <goodix_fb_state_chg_callback+0x4c>
    15dc: 90000000     	adrp	x0, 0x1000 <gf_probe+0x2cc>
		00000000000015dc:  R_AARCH64_ADR_PREL_PG_HI21	.rodata.str1.1+0x132c
    15e0: 91000000     	add	x0, x0, #0x0
		00000000000015e0:  R_AARCH64_ADD_ABS_LO12_NC	.rodata.str1.1+0x132c
    15e4: 90000001     	adrp	x1, 0x1000 <gf_probe+0x2cc>
		00000000000015e4:  R_AARCH64_ADR_PREL_PG_HI21	.rodata.str1.1+0x7e5
    15e8: 91000021     	add	x1, x1, #0x0
		00000000000015e8:  R_AARCH64_ADD_ABS_LO12_NC	.rodata.str1.1+0x7e5
    ...
    15f4: 90000008     	adrp	x8, 0x1000 <gf_probe+0x2cc>
		00000000000015f4:  R_AARCH64_ADR_PREL_PG_HI21	.rodata.str1.1+0x5b5
    15f8: 91000108     	add	x8, x8, #0x0
		00000000000015f8:  R_AARCH64_ADD_ABS_LO12_NC	.rodata.str1.1+0x5b5
    15fc: aa0103f3     	mov	x19, x1
    1600: 90000001     	adrp	x1, 0x1000 <gf_probe+0x2cc>
		0000000000001600:  R_AARCH64_ADR_PREL_PG_HI21	.rodata.str1.1+0x7e5
    1604: 91000021     	add	x1, x1, #0x0
		0000000000001604:  R_AARCH64_ADD_ABS_LO12_NC	.rodata.str1.1+0x7e5
    ...
    1660: 90000013     	adrp	x19, 0x1000 <gf_probe+0x2cc>
		0000000000001660:  R_AARCH64_ADR_PREL_PG_HI21	.rodata.str1.1+0x7e5
    1664: 91000273     	add	x19, x19, #0x0
		0000000000001664:  R_AARCH64_ADD_ABS_LO12_NC	.rodata.str1.1+0x7e5
    1668: 90000000     	adrp	x0, 0x1000 <gf_probe+0x2cc>
		0000000000001668:  R_AARCH64_ADR_PREL_PG_HI21	.rodata.str1.1+0x424
    166c: 91000000     	add	x0, x0, #0x0
		000000000000166c:  R_AARCH64_ADD_ABS_LO12_NC	.rodata.str1.1+0x424
    ...
    1678: 90000000     	adrp	x0, 0x1000 <gf_probe+0x2cc>
		0000000000001678:  R_AARCH64_ADR_PREL_PG_HI21	.rodata.str1.1+0x50c
    167c: 91000000     	add	x0, x0, #0x0
		000000000000167c:  R_AARCH64_ADD_ABS_LO12_NC	.rodata.str1.1+0x50c
    ...
    1694: 90000013     	adrp	x19, 0x1000 <gf_probe+0x2cc>
		0000000000001694:  R_AARCH64_ADR_PREL_PG_HI21	.rodata.str1.1+0x7e5
    1698: 91000273     	add	x19, x19, #0x0
		0000000000001698:  R_AARCH64_ADD_ABS_LO12_NC	.rodata.str1.1+0x7e5
    169c: 90000000     	adrp	x0, 0x1000 <gf_probe+0x2cc>
		000000000000169c:  R_AARCH64_ADR_PREL_PG_HI21	.rodata.str1.1+0xf69
    16a0: 91000000     	add	x0, x0, #0x0
		00000000000016a0:  R_AARCH64_ADD_ABS_LO12_NC	.rodata.str1.1+0xf69
    ...
    16b0: 90000000     	adrp	x0, 0x1000 <gf_probe+0x2cc>
		00000000000016b0:  R_AARCH64_ADR_PREL_PG_HI21	.rodata.str1.1+0xa7b
    16b4: 91000000     	add	x0, x0, #0x0
		00000000000016b4:  R_AARCH64_ADD_ABS_LO12_NC	.rodata.str1.1+0xa7b
    ...
    16d8: 90000000     	adrp	x0, 0x1000 <gf_probe+0x2cc>
		00000000000016d8:  R_AARCH64_ADR_PREL_PG_HI21	.rodata.str1.1+0x11dc
    16dc: 91000000     	add	x0, x0, #0x0
		00000000000016dc:  R_AARCH64_ADD_ABS_LO12_NC	.rodata.str1.1+0x11dc
