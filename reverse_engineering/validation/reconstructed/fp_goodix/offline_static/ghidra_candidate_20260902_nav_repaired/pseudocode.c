...
LAB_00100af8:
      ...
      _printk(&DAT_00103304,"irq_setup");
      uVar4 = gf_irq_num(ppuVar5);
      *(int *)(ppuVar6 + 8) = (int)uVar4;
      iVar2 = request_threaded_irq(uVar4,0,gf_irq,0x2001,&DAT_001038fb,ppuVar5);
      if (iVar2 != 0) {
        _printk(&DAT_00102b68);
        gf_cleanup(ppuVar5);
        goto LAB_00100af8;
      }
...

{
  ...
  _printk(&DAT_00102a1c,"gf_release");
  mutex_lock(device_list_lock);
  ...
  *(int *)(lVar2 + 0x38) = iVar1;
  if (iVar1 == 0) {
    _printk(&DAT_00103893,*(undefined4 *)(lVar2 + 0x48));
  ...
  if (lVar2 != 0) {
    ...
    _printk(&DAT_0010331b,"gf_release");
  }
  mutex_unlock(device_list_lock);
  return 0;
}
...
/* 00101294 goodixfp_init_drm_notifier */
...

{
  ...
  _printk(&DAT_001038fe,"goodixfp_init_drm_notifier");
  iVar1 = goodixfp_drm_get_pannel(*(undefined8 *)(*(long *)(param_1 + -0x90) + 0x2f8));
  iVar2 = 0;
  do {
    while (iVar1 == 0) {
      iVar2 = iVar2 + 1;
      if (iVar2 == 0x19) goto LAB_00101334;
    }
    _printk(&DAT_001037e8,"goodixfp_init_drm_notifier");
    usleep_range_state(1000000,0xf4628,2);
    iVar1 = goodixfp_drm_get_pannel(*(undefined8 *)(*(long *)(param_1 + -0x90) + 0x2f8));
    iVar2 = iVar2 + 1;
  } while (iVar2 != 0x19);
  if (iVar1 != 0) {
    _printk(&DAT_00103917,"goodixfp_init_drm_notifier");
  }
LAB_00101334:
  if (goodixfp_active_panel != 0) {
    _printk(&DAT_00103ac5,"goodixfp_init_drm_notifier");
    cookie = panel_event_notifier_register
                       (1,3,goodixfp_active_panel,goodix_fb_state_chg_callback,param_1 + -0xa8);
    if (cookie == 0) {
      _printk(&DAT_00102e84,"goodixfp_init_drm_notifier");
    }
  }
  return;
}
...
/* 00101438 goodixfp_drm_get_pannel */
    ...
    if (iVar3 < 1) {
      ...
      do {
        ...
        if (uVar5 < 0xfffffffffffff001) {
          _printk(&DAT_001032ae,"goodixfp_drm_get_pannel");
          goodixfp_active_panel = uVar5;
          _printk(&DAT_00103bc3,"goodixfp_drm_get_pannel");
          iVar3 = 0;
          goto LAB_00101554;
        }
        iVar7 = iVar7 + 1;
...
/* 0010158c goodix_fb_state_chg_callback */
  ...
  if (((param_1 != (undefined1 *)0x0) && (nl_sk != 0)) && (pid != 0)) {
    ...
    if (lVar2 == 0) {
      ...
      *(undefined1 *)(lVar3 + 0x10) = *param_1;
      _printk(&DAT_00103a6d);
      uVar1 = netlink_unicast(nl_sk,lVar2,pid,0x40);
      _printk(&DAT_00103a93,pid,uVar1);
...

{
  ...
  if (uVar2 == 0) {
    ...
    if (-1 < (int)(uVar2 + 1 | uVar2)) goto LAB_001018bc;
    uVar5 = 1;
  }
...
LAB_001018bc:
  if (0xf < *(uint *)(param_1 + 0x70)) {
    ...
    _printk(&DAT_00103a03,"nl_data_ready");
    sk_skb_reason_drop(0,param_1,2);
  }
  _printk(&DAT_001030be,"nl_data_ready",pid);
  return;
}



/* 0010196c netlink_exit */
...

{
  ...
  _printk(&DAT_00103797);
  return;
}



/* 001019b0 zte_goodix_pinctrl_init */
...

{
  ...
  _printk(&DAT_0010321e,"zte_goodix_pinctrl_init");
...
/* 00101a84 zte_goodix_pinctrl_select */
...

{
  ...
  _printk(&fp_goodix_exact_rodata_01ee,"zte_goodix_pinctrl_select",param_2 & 1);
...
/* 001027bc _inline_copy_from_user */
...
/* 00102a00 FUN_00102a00 */

void FUN_00102a00(long param_1,undefined8 param_2,undefined8 param_3)

{
  __unregister_chrdev(*(undefined4 *)(param_1 + 0xed0),param_3,0x100);
  return;
}
