...
- Gerado em: `2026-09-04T19:07:49.141429+00:00`
...
|---|---|---|---|
| `fp_goodix` | `incomplete_or_failed` | `não executado` | two clean builds are not reproducible<br>module parity check failed: candidate_matches_fresh |
