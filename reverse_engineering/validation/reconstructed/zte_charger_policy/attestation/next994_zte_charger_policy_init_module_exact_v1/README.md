...
- Stock identity: `init_module@0x00103774` in `.init.text`.
- Stock body: 44 bytes / 11 AArch64 instructions.
- Stock KCFI type ID: `0x6fbb3035`; candidate KCFI and symbol size match.
- The exact body preserves the `.data+0x178` driver-object relocation, `__this_module` relocation and `__platform_driver_register` call.
