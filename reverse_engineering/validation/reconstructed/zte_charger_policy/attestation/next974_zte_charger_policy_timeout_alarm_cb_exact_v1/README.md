# zte_charger_policy — charger_policy_timeout_alarm_cb
...
- Function: \`charger_policy_timeout_alarm_cb\`
- Stock entry: \`0x00101208\`
- Stock body: 88 bytes / 22 AArch64 instructions
...
This target passed without an assembly island: the reconstructed C model produced exact stock assembly, relocations, symbol size, and KCFI metadata under the pinned Docker toolchain.
