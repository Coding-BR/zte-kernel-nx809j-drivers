...
- Gerado em: `2026-09-05T13:45:31.517927+00:00`
- Run de evidência: `C:\Users\adria\Desktop\drivers\kernel-docker-workspace\engenharia\runs\zte_charger_policy_policy_external_power_changed_protocol_20260905`
- Rebuild limpo: `sim`
...
|---|---|---|---|
| `zte_charger_policy` | `incomplete_or_failed` | `não executado` | acquired stock module is missing from the selected evidence source<br>Ghidra export missing: manifest.json<br>Ghidra export missing: functions.jsonl |
