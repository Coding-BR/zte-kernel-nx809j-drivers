...
0000000000000004 <init_module>:
      ...
      18: 90000014     	adrp	x20, 0x0 <.init.text>
		0000000000000018:  R_AARCH64_ADR_PREL_PG_HI21	.bss+0x8
      1c: 90000003     	adrp	x3, 0x0 <.init.text>
		000000000000001c:  R_AARCH64_ADR_PREL_PG_HI21	.rodata.str1.1+0x1547
      20: 91000063     	add	x3, x3, #0x0
		0000000000000020:  R_AARCH64_ADD_ABS_LO12_NC	.rodata.str1.1+0x1547
      24: b9400280     	ldr	w0, [x20]
		0000000000000024:  R_AARCH64_LDST32_ABS_LO12_NC	.bss+0x8
      ...
      44: 90000000     	adrp	x0, 0x0 <.init.text>
		0000000000000044:  R_AARCH64_ADR_PREL_PG_HI21	.rodata.str1.1+0x5a3
      48: 91000000     	add	x0, x0, #0x0
		0000000000000048:  R_AARCH64_ADD_ABS_LO12_NC	.rodata.str1.1+0x5a3
      ...
      54: 90000000     	adrp	x0, 0x0 <.init.text>
		0000000000000054:  R_AARCH64_ADR_PREL_PG_HI21	.rodata.str1.1+0x99c
      58: 91000000     	add	x0, x0, #0x0
		0000000000000058:  R_AARCH64_ADD_ABS_LO12_NC	.rodata.str1.1+0x99c
      5c: b9000293     	str	w19, [x20]
		000000000000005c:  R_AARCH64_LDST32_ABS_LO12_NC	.bss+0x8
      60: 94000000     	bl	0x60 <init_module+0x5c>
		0000000000000060:  R_AARCH64_CALL26	class_create
      64: 90000015     	adrp	x21, 0x0 <.init.text>
		0000000000000064:  R_AARCH64_ADR_PREL_PG_HI21	.bss+0x10
      68: b13ffc1f     	cmn	x0, #0xfff
      6c: f90002a0     	str	x0, [x21]
		000000000000006c:  R_AARCH64_LDST64_ABS_LO12_NC	.bss+0x10
      70: 54000183     	b.lo	0xa0 <init_module+0x9c>
      74: 90000008     	adrp	x8, 0x0 <.init.text>
		0000000000000074:  R_AARCH64_ADR_PREL_PG_HI21	.data+0x1d0
      78: b9400280     	ldr	w0, [x20]
		0000000000000078:  R_AARCH64_LDST32_ABS_LO12_NC	.bss+0x8
      7c: 2a1f03e1     	mov	w1, wzr
      80: f9400103     	ldr	x3, [x8]
		0000000000000080:  R_AARCH64_LDST64_ABS_LO12_NC	.data+0x1d0
      ...
      8c: 90000000     	adrp	x0, 0x0 <.init.text>
		000000000000008c:  R_AARCH64_ADR_PREL_PG_HI21	.rodata.str1.1+0x16b6
      90: 91000000     	add	x0, x0, #0x0
		0000000000000090:  R_AARCH64_ADD_ABS_LO12_NC	.rodata.str1.1+0x16b6
      94: 94000000     	bl	0x94 <init_module+0x90>
		0000000000000094:  R_AARCH64_CALL26	_printk
      98: b94002b3     	ldr	w19, [x21]
		0000000000000098:  R_AARCH64_LDST32_ABS_LO12_NC	.bss+0x10
      9c: 14000019     	b	0x100 <init_module+0xfc>
      a0: 90000000     	adrp	x0, 0x0 <.init.text>
		00000000000000a0:  R_AARCH64_ADR_PREL_PG_HI21	.data+0x1a8
      a4: 91000000     	add	x0, x0, #0x0
		00000000000000a4:  R_AARCH64_ADD_ABS_LO12_NC	.data+0x1a8
      ...
      bc: f94002a0     	ldr	x0, [x21]
		00000000000000bc:  R_AARCH64_LDST64_ABS_LO12_NC	.bss+0x10
      c0: 94000000     	bl	0xc0 <init_module+0xbc>
		00000000000000c0:  R_AARCH64_CALL26	class_destroy
      c4: 90000008     	adrp	x8, 0x0 <.init.text>
		00000000000000c4:  R_AARCH64_ADR_PREL_PG_HI21	.data+0x1d0
      c8: b9400280     	ldr	w0, [x20]
		00000000000000c8:  R_AARCH64_LDST32_ABS_LO12_NC	.bss+0x8
      cc: 2a1f03e1     	mov	w1, wzr
      d0: f9400103     	ldr	x3, [x8]
		00000000000000d0:  R_AARCH64_LDST64_ABS_LO12_NC	.data+0x1d0
      ...
      dc: 90000000     	adrp	x0, 0x0 <.init.text>
		00000000000000dc:  R_AARCH64_ADR_PREL_PG_HI21	.rodata.str1.1+0x7cb
      e0: 91000000     	add	x0, x0, #0x0
		00000000000000e0:  R_AARCH64_ADD_ABS_LO12_NC	.rodata.str1.1+0x7cb
      ...
      ec: 90000000     	adrp	x0, 0x0 <.init.text>
		00000000000000ec:  R_AARCH64_ADR_PREL_PG_HI21	.rodata.str1.1+0xda4
      f0: 91000000     	add	x0, x0, #0x0
		00000000000000f0:  R_AARCH64_ADD_ABS_LO12_NC	.rodata.str1.1+0xda4
