...
#define KEY_CHAT 216
#define EV_KEY 1
#define DRM_PANEL_EVENT_UNBLANK 1
#define DRM_PANEL_EVENT_BLANK 2
...
struct nlmsghdr { unsigned int payload_len; unsigned char data[64]; };
struct sk_buff {
	unsigned int len;
	u32 portid;
...
#define list_add(entry, head) host_list_add_tail(entry, head)
#define gf_dev_static gf
