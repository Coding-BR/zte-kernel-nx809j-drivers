...
- Gerado em: `2026-07-12T21:15:12.787355+00:00`
...
|---|---|---|---|
| `zte_fingerprint` | `incomplete_or_failed` | `não executado` | module parity check failed: alias_match<br>module parity check failed: undefined_symbols_match<br>module parity check failed: candidate_matches_fresh |
