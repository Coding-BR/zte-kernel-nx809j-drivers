...

{
  ...
  _printk(&DAT_00103c7c,"gf_probe");
  DAT_001041e0 = &DAT_001041e0;
  DAT_001041e8 = (undefined **)&DAT_001041e0;
  _DAT_00104214 = 0xffffffeaffffffea;
  _DAT_0010421c = 0xffffffea;
  _DAT_00104248 = 0;
  _DAT_001041f0 = param_1;
  DAT_00104278 = alloc_workqueue(&DAT_0010358e,0x6000a,1,"screen_state_wq");
  if (DAT_00104278 != 0) {
    _DAT_00104280 = 0xfffffffe00000;
    _DAT_00104288 = &DAT_00104288;
    _DAT_00104290 = &DAT_00104288;
    _DAT_00104298 = goodixfp_init_drm_notifier;
    init_timer_key(&DAT_001042a0,&delayed_work_timer_fn,0x200000,0,0);
    queue_delayed_work_on(0x20,DAT_00104278,&DAT_00104280,0x4e2);
  }
  mutex_lock(device_list_lock);
  if ((minors | 0xffffffff00000000) == 0xffffffffffffffff) {
    ...
    uVar4 = device_create(gf_class,_DAT_001041f0 + 0x10,gf,&gf,"goodix_fp");
    if ((uVar4 < 0xfffffffffffff001) || ((int)uVar4 == 0)) {
      Hint_Prefetch(0x1043a8,2,0,1);
      do {
        cVar2 = '\x01';
        bVar3 = (bool)ExclusiveMonitorPass(0x1043a8,0x10);
        if (bVar3) {
      ...
      if ((*(undefined ***)(device_list + 8) == &device_list) &&
         ((undefined8 **)device_list != &DAT_001041e0)) {
        *(undefined8 ***)(device_list + 8) = &DAT_001041e0;
        DAT_001041e0 = (undefined8 *)device_list;
        DAT_001041e8 = &device_list;
        device_list = (undefined *)&DAT_001041e0;
      }
      else {
        __list_add_valid_or_report(&DAT_001041e0,&device_list);
      }
      mutex_unlock(device_list_lock);
      DAT_00104208 = (undefined8 *)input_allocate_device();
      if (DAT_00104208 == (undefined8 *)0x0) {
        _printk(&DAT_00103d71,"gf_probe");
        uVar4 = 0xfffffff4;
      }
      else {
        input_set_capability(DAT_00104208,1,0x66);
        input_set_capability(DAT_00104208,1,0x8b);
        input_set_capability(DAT_00104208,1,0x9e);
        input_set_capability(DAT_00104208,1,0x74);
        input_set_capability(DAT_00104208,1,0x67);
        input_set_capability(DAT_00104208,1,0x6c);
        input_set_capability(DAT_00104208,1,0x6a);
        input_set_capability(DAT_00104208,1,0x69);
        input_set_capability(DAT_00104208,1,0xd4);
        input_set_capability(DAT_00104208,1,0x72);
        input_set_capability(DAT_00104208,1,0x73);
        input_set_capability(DAT_00104208,1,0xd9);
        input_set_capability(DAT_00104208,1,0xd8);
        *DAT_00104208 = "goodix_fp";
        uVar5 = input_register_device(DAT_00104208);
        uVar4 = uVar5 & 0xffffffff;
        if ((int)uVar5 == 0) {
          wakeup_source_add(fp_wakelock);
          _printk(&DAT_0010303b,1,2,4,2);
          goto LAB_001016d4;
        }
        _printk(&DAT_00103117);
        if (DAT_00104208 != (undefined8 *)0x0) {
          input_free_device();
        }
      }
      if (gf != 0) {
        _printk(&DAT_001037da,uVar4);
        mutex_lock(device_list_lock);
        list_del();
  ...
  gf_cleanup(&gf);
  _DAT_00104248 = _DAT_00104248 & 0xff00;
LAB_001016d4:
...

{
  ...
  _printk(&DAT_0010359c,"goodixfp_init_drm_notifier");
  ...
  do {
    ...
    _printk(&DAT_00102f45,"goodixfp_init_drm_notifier");
    usleep_range_state(1000000,0xf4628,2);
    iVar1 = goodixfp_drm_get_pannel(*(undefined8 *)(*(long *)(param_1 + -0x90) + 0x2f8));
    iVar2 = iVar2 + 1;
  } while (iVar2 != 0x19);
  if (iVar1 != 0) {
    _printk(&DAT_00103b60,"goodixfp_init_drm_notifier");
  }
LAB_00101b60:
  if (goodixfp_active_panel != 0) {
    _printk(&DAT_001036ba,"goodixfp_init_drm_notifier");
    cookie = panel_event_notifier_register
                       (1,3,goodixfp_active_panel,goodix_fb_state_chg_callback,param_1 + -0xa8);
    if (cookie == 0) {
      _printk(&DAT_00103da9,"goodixfp_init_drm_notifier");
    }
  }
  return;
}
