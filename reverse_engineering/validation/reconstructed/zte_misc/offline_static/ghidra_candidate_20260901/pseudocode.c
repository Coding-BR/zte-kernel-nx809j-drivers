/* 00100a54 zte_misc_register_callback */
  ...
  if (__s != (char *)0x0) {
    ...
    do {
      ...
      if (iVar1 == 0) {
        ...
        sVar3 = strlen(__s);
        if (sVar2 == sVar3) {
          _printk(&DAT_001020b5,"zte_misc_register_callback",uVar5 & 0xffffffff,__s1);
          if ((((*plVar6 == 0) && (plVar6[-1] == 0)) && (plVar6[1] == 0)) && (plVar6[2] == 0)) {
            *plVar6 = param_1[2];
            ...
            _printk(&DAT_00101f3f,"zte_misc_register_callback",uVar5 & 0xffffffff,plVar6[-2]);
            uVar4 = 0xfffffff2;
          }
          if (0x23 < (uint)uVar5) {
            return 0xffffffea;
...
/* 00100ba0 zte_misc_get_node_val */
      ...
      if (iVar1 == 0) {
        ...
        if ((sVar3 == sVar4) &&
          ...
          if (*(int *)(pcVar6 + -4) != 0x2990b6e9) {
            ...
            pcVar6 = (code *)SoftwareBreakpoint(0x8228,0x100c74);
            (*pcVar6)();
          }
          iVar1 = (*pcVar6)(local_88,*(undefined8 *)((long)&DAT_00100098 + lVar7));
          if (iVar1 < 0) goto LAB_00100cac;
          iVar1 = sscanf(local_88,"%d",&local_8c);
          uVar2 = local_8c;
          if (iVar1 == 1) goto LAB_00100cb0;
          puVar5 = &DAT_00102137;
          goto LAB_00100ca8;
        }
      }
...
/* 00100cf4 zte_misc_common_callback_get */
...
LAB_00100e50:
      ...
      if (iVar2 == 0) {
        sVar3 = strlen(__s1);
        __n = strnlen(local_88,0x40);
        if (0x40 < __n) goto LAB_00100e6c;
        if (__n == 0x40) goto LAB_00100e50;
        if ((sVar3 == __n) &&
           (pcVar4 = *(code **)((long)&DAT_00100088 + lVar5), pcVar4 != (code *)0x0)) {
          if (*(int *)(pcVar4 + -4) != 0x2990b6e9) {
                    /* WARNING: Does not return */
            pcVar4 = (code *)SoftwareBreakpoint(0x8228,0x100dfc);
            (*pcVar4)();
          }
...
/* 00100e80 zte_misc_common_callback_set */
...
LAB_00100fdc:
      ...
      if (iVar2 == 0) {
        sVar3 = strlen(__s1);
        __n = strnlen(local_88,0x40);
        if (0x40 < __n) goto LAB_00100ff8;
        if (__n == 0x40) goto LAB_00100fdc;
        if ((sVar3 == __n) &&
           (pcVar4 = *(code **)((long)&DAT_00100080 + lVar5), pcVar4 != (code *)0x0)) {
          if (*(int *)(pcVar4 + -4) != 0x4cf999cb) {
                    /* WARNING: Does not return */
            pcVar4 = (code *)SoftwareBreakpoint(0x8228,0x100f88);
            (*pcVar4)();
          }
          iVar1 = (*pcVar4)(param_1,*(undefined8 *)((long)&DAT_00100098 + lVar5));
          if (iVar1 < 0) break;
...
/* 0010100c battery_module_pack_vendor_get */
...
LAB_00101148:
        ...
        _printk(&DAT_00101f66,local_3c,uVar3);
        iVar1 = snprintf(param_1,0x1000,"%2d",(ulong)uVar3);
        goto LAB_00101054;
      }
    }
    _printk(&DAT_00102047);
  }
  iVar1 = -1;
LAB_00101054:
  lVar2 = sp_el0;
...
/* 001013e8 zte_misc_get_design_capacity */
...
/* 001014dc zte_poweroff_charging_status */
...

{
  ...
  lVar2 = 0;
  while ((*(char **)((long)&DAT_00102178 + lVar2) == (char *)0x0 ||
         (iVar1 = strcmp(*(char **)((long)&DAT_00102178 + lVar2),param_1), iVar1 != 0))) {
    lVar2 = lVar2 + 0x10;
    if (lVar2 == 0x100) {
      return 0;
    }
...

{
  ...
  _printk(&DAT_0010214f,"zte_misc_probe");
  local_f0 = (char *)0x0;
  local_e8 = 0;
  local_78 = 0;
  uStack_70 = 0;
