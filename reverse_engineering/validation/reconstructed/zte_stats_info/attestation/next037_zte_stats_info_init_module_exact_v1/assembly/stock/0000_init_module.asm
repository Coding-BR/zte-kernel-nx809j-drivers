...
0000000000000004 <init_module>:
      ...
      2c: 90000016     	adrp	x22, 0x0 <.init.text>
		000000000000002c:  R_AARCH64_ADR_PREL_PG_HI21	.data..percpu
      30: 910002d6     	add	x22, x22, #0x0
		0000000000000030:  R_AARCH64_ADD_ABS_LO12_NC	.data..percpu
      ...
      38: 90000013     	adrp	x19, 0x0 <.init.text>
		0000000000000038:  R_AARCH64_ADR_PREL_PG_HI21	.rodata.str1.1+0x40
      3c: 91000273     	add	x19, x19, #0x0
		000000000000003c:  R_AARCH64_ADD_ABS_LO12_NC	.rodata.str1.1+0x40
