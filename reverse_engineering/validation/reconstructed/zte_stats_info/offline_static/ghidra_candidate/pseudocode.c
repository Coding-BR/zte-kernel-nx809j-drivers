  ...
  if ((-1 < iVar4) && (psVar1 = (short *)(lVar8 + (ulong)uVar2), psVar1 != (short *)0x0)) {
    ...
    if (iVar4 < 0) {
      ...
      if (psVar1 < psVar7) {
        ...
        pcVar3 = (code *)SoftwareBreakpoint(0x800,0x10050c);
        (*pcVar3)();
      }
    }
    else {
      ...
      if (psVar1 < psVar7) {
                    /* WARNING: Does not return */
        pcVar3 = (code *)SoftwareBreakpoint(0x800,0x10055c);
        (*pcVar3)();
      }
    }
...
/* 0010056c zte_taskstats_user_cmd */
...

{
  ...
  if (*(long *)(lVar15 + 8) == 0) {
    ...
    lVar15 = local_68;
    if ((int)uVar9 < 0) goto LAB_00100c88;
...
LAB_001008bc:
  ...
  if (puVar10 == (undefined2 *)0x0) goto LAB_001008a4;
  __rcu_read_lock();
  lVar11 = find_task_by_vpid(uVar7);
  if (lVar11 == 0) {
    __rcu_read_unlock();
...
/* 00100cd4 zte_cgroupstats_user_cmd */
