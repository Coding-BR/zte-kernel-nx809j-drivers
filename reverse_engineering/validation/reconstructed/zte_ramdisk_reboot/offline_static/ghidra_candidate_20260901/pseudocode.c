...

{
  ...
  if (pcVar2 != (char *)0x0) {
    ...
    if (pcVar1 <= pcVar3) {
      if (((__n < pcVar3) && (pcVar3 != pcVar1)) && (__n < param_4)) {
...
/* 001005fc zte_check_xbl_log_lines */
...
/* 001007bc zte_ramdisk_reboot_write */
...
/* 00100854 zte_ramdisk_reboot_probe */
...

{
  ...
  plVar9 = plVar4 + 1;
  *plVar4 = param_1 + 0x10;
  iVar3 = kobject_init_and_add(plVar9,ramdisk_reboot_ktype,uVar2,"ramdiskboot");
  if (iVar3 != 0) {
    _printk(&DAT_00100e45,"zte_ramdisk_reboot_probe");
    kobject_put(plVar9);
    goto LAB_001008e8;
  }
  iVar3 = sysfs_create_group(plVar9,ramdisk_reboot_attr_group);
  if (iVar3 != 0) {
    _printk(&DAT_001011f3,"zte_ramdisk_reboot_probe");
    kobject_del(plVar9);
    goto LAB_001008e8;
  }
  ...
  if (uVar5 < 0xfffffffffffff001) {
    ...
    if ((undefined1 *)0xfffffffffffff000 < puVar6) {
      puVar8 = &DAT_0010114c;
      uVar5 = (ulong)puVar6 & 0xffffffff;
      goto LAB_00100a04;
    }
    if (local_158[0] == 0) {
      _printk(&DAT_0010123e,1,0);
    }
    else {
      _printk(&DAT_00100edb,*puVar6);
    }
    kfree(puVar6);
  }
  else {
    puVar8 = &DAT_0010117c;
LAB_00100a04:
    _printk(puVar8,uVar5);
  }
  iVar3 = zte_get_xbl_log_memory_region(plVar4);
  if (iVar3 == 0) {
    zte_check_xbl_log_lines(plVar4,&PTR_s_OCP_Occured__001014b8,2,&local_50,local_158 + 1);
    if ((int)local_50 < 1) {
...
LAB_00100b78:
      ...
      if (sVar7 == 0x80) goto LAB_00100b78;
...
/* 00100b8c zte_ramdisk_reboot_remove */
...
/* 00100b90 zte_get_xbl_log_memory_region */
...

{
  ...
  if (*(int *)(pcVar2 + -4) != 0x618e6a55) {
    ...
    pcVar2 = (code *)SoftwareBreakpoint(0x8228,0x100ccc);
    (*pcVar2)();
  }
  uVar1 = (*pcVar2)();
  return uVar1;
...

{
  ...
  if (*(int *)(pcVar2 + -4) != 0x7a5b5d2f) {
                    /* WARNING: Does not return */
    pcVar2 = (code *)SoftwareBreakpoint(0x8228,0x100d14);
    (*pcVar2)();
  }
  uVar1 = (*pcVar2)();
  return uVar1;
...
/* 00100d6c ramdisk_nvmem_store */

undefined8 ramdisk_nvmem_store(void)

{
  _printk(&DAT_00101063);
  return 0xffffffffffffffea;
}



/* 00100d98 init_module */
