...
0000000000000ba0 <nubia_hw_pcb_version_show>:
     ...
     bc0: 90000008     	adrp	x8, 0x0 <.text>
		0000000000000bc0:  R_AARCH64_ADR_PREL_PG_HI21	.bss+0x18
     bc4: b9400108     	ldr	w8, [x8]
		0000000000000bc4:  R_AARCH64_LDST32_ABS_LO12_NC	.bss+0x18
     bc8: 7100051f     	cmp	w8, #0x1
     bcc: 540001c0     	b.eq	0xc04 <nubia_hw_pcb_version_show+0x64>
     bd0: 90000002     	adrp	x2, 0x0 <.text>
		0000000000000bd0:  R_AARCH64_ADR_PREL_PG_HI21	.rodata.str1.1+0x2f2
     bd4: 91000042     	add	x2, x2, #0x0
		0000000000000bd4:  R_AARCH64_ADD_ABS_LO12_NC	.rodata.str1.1+0x2f2
