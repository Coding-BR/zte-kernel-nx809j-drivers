...
0000000000000004 <nubia_hw_version_init>:
      ...
      14: 90000014     	adrp	x20, 0x0 <.init.text>
		0000000000000014:  R_AARCH64_ADR_PREL_PG_HI21	.bss+0x18
      18: b9400288     	ldr	w8, [x20]
		0000000000000018:  R_AARCH64_LDST32_ABS_LO12_NC	.bss+0x18
      1c: 7100051f     	cmp	w8, #0x1
      20: 54000340     	b.eq	0x88 <nubia_hw_version_init+0x84>
      24: 90000000     	adrp	x0, 0x0 <.init.text>
		0000000000000024:  R_AARCH64_ADR_PREL_PG_HI21	.data+0x28
      28: 91000000     	add	x0, x0, #0x0
		0000000000000028:  R_AARCH64_ADD_ABS_LO12_NC	.data+0x28
      ...
      38: 90000000     	adrp	x0, 0x0 <.init.text>
		0000000000000038:  R_AARCH64_ADR_PREL_PG_HI21	.rodata.str1.1+0x598
      3c: 91000000     	add	x0, x0, #0x0
		000000000000003c:  R_AARCH64_ADD_ABS_LO12_NC	.rodata.str1.1+0x598
      ...
      54: 90000001     	adrp	x1, 0x0 <.init.text>
		0000000000000054:  R_AARCH64_ADR_PREL_PG_HI21	.data
      58: 91000021     	add	x1, x1, #0x0
		0000000000000058:  R_AARCH64_ADD_ABS_LO12_NC	.data
      ...
      68: b9400288     	ldr	w8, [x20]
		0000000000000068:  R_AARCH64_LDST32_ABS_LO12_NC	.bss+0x18
      ...
      88: 90000000     	adrp	x0, 0x0 <.init.text>
		0000000000000088:  R_AARCH64_ADR_PREL_PG_HI21	.rodata.str1.1+0x425
      8c: 91000000     	add	x0, x0, #0x0
		000000000000008c:  R_AARCH64_ADD_ABS_LO12_NC	.rodata.str1.1+0x425
      ...
      b4: 90000000     	adrp	x0, 0x0 <.init.text>
		00000000000000b4:  R_AARCH64_ADR_PREL_PG_HI21	.rodata.str1.1+0x4a2
      b8: 91000000     	add	x0, x0, #0x0
		00000000000000b8:  R_AARCH64_ADD_ABS_LO12_NC	.rodata.str1.1+0x4a2
      ...
      cc: 90000000     	adrp	x0, 0x0 <.init.text>
		00000000000000cc:  R_AARCH64_ADR_PREL_PG_HI21	.rodata.str1.1+0x2f5
      d0: 91000000     	add	x0, x0, #0x0
		00000000000000d0:  R_AARCH64_ADD_ABS_LO12_NC	.rodata.str1.1+0x2f5
