...
switchD_001003ac_caseD_a:
    ...
    uVar1 = *vendor_imem_info_addr;
    _printk(&DAT_001008eb,"qcom,msm-imem-ddr_memory_manufacture",uVar1);
    pcVar6 = "SAMSUNG";
    switch(uVar1) {
    case 1:
      break;
...
LAB_00100310:
    ...
    uVar1 = *vendor_imem_info_addr;
    _printk(&DAT_001008eb,"qcom,msm-imem-ddr_memory_type",uVar1);
  ...
  if (lVar3 == 0) {
    ...
    if (vendor_imem_info_addr != (uint *)0x0) {
      ...
      _printk(&DAT_001008eb,"qcom,msm-imem-ddr_memory_size",uVar2);
      uVar1 = uVar2 + 0x3ff;
      if (-1 < (int)uVar2) {
        uVar1 = uVar2;
      }
...

{
  ...
  if (lVar1 == 0) {
    ...
    if (vendor_imem_info_addr != (undefined4 *)0x0) {
      ...
      _printk(&DAT_001008eb,"qcom,msm-imem-board-id",uVar3);
      goto LAB_001005b4;
    }
    puVar2 = &DAT_001008fb;
  }
  ...
  uVar3 = 0xffffffff;
LAB_001005b4:
  seq_printf(param_1,&DAT_0010087c,uVar3);
  return 0;
}



/* 001005f0 init_module */
