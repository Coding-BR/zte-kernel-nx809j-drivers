# zlog_exception — zlog_open

Function-level offline exact attestation for `zlog_open` at `0x00100bb0`.
...
- The dedicated host harness passed reproducibly, including the direct atomic `use_count` increment test.

This is static/offline evidence only. It does not claim hardware execution or prove live file-open and concurrent lifetime behavior.
