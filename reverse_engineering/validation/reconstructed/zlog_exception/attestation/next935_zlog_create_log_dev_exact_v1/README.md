# `zlog_create_log_dev` — atestação offline exact v1

Esta unidade registra `zlog_exception:zlog_create_log_dev@00100d3c` contra
...
reproduzível, assembly/relocations, KCFI não aplicável, Joern scoped e Joern
slice. O módulo candidato versionado tem SHA-256
...
P-Code fresco; a unidade permanece respaldada por ELF/AArch64, relocations e
