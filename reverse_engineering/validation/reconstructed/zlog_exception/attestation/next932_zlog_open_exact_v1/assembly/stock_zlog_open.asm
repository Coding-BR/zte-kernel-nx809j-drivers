...
0000000000000850 <zlog_open>:
     ...
     874: 90000000     	adrp	x0, 0x0 <.text>
		0000000000000874:  R_AARCH64_ADR_PREL_PG_HI21	.rodata.str1.1+0x1d0
     878: 91000000     	add	x0, x0, #0x0
		0000000000000878:  R_AARCH64_ADD_ABS_LO12_NC	.rodata.str1.1+0x1d0
     87c: b9400102     	ldr	w2, [x8]
		000000000000087c:  R_AARCH64_LDST32_ABS_LO12_NC	g_zlog_info+0x90
     880: 90000001     	adrp	x1, 0x0 <.text>
		0000000000000880:  R_AARCH64_ADR_PREL_PG_HI21	.rodata.str1.1+0x293
     884: 91000021     	add	x1, x1, #0x0
		0000000000000884:  R_AARCH64_ADD_ABS_LO12_NC	.rodata.str1.1+0x293
