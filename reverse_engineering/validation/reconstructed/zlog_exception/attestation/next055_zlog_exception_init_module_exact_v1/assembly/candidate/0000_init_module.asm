...
0000000000000004 <init_module>:
      ...
      5c: 90000000     	adrp	x0, 0x0 <.init.text>
		000000000000005c:  R_AARCH64_ADR_PREL_PG_HI21	.rodata.str1.1+0x2ba
      60: 91000000     	add	x0, x0, #0x0
		0000000000000060:  R_AARCH64_ADD_ABS_LO12_NC	.rodata.str1.1+0x2ba
      64: f9001a88     	str	x8, [x20, #0x30]
      68: f9001e88     	str	x8, [x20, #0x38]
      6c: b900929f     	str	wzr, [x20, #0x90]
      70: 90000001     	adrp	x1, 0x0 <.init.text>
		0000000000000070:  R_AARCH64_ADR_PREL_PG_HI21	.rodata.str1.1+0x242
      74: 91000021     	add	x1, x1, #0x0
		0000000000000074:  R_AARCH64_ADD_ABS_LO12_NC	.rodata.str1.1+0x242
      ...
      90: 90000000     	adrp	x0, 0x0 <.init.text>
		0000000000000090:  R_AARCH64_ADR_PREL_PG_HI21	.rodata.str1.1+0x270
      94: 91000000     	add	x0, x0, #0x0
		0000000000000094:  R_AARCH64_ADD_ABS_LO12_NC	.rodata.str1.1+0x270
