  ...
  if (DAT_00100eec < 0x401) {
    ...
    while (puVar2 != (undefined8 *)0x0) {
      *(int *)(puVar2 + 2) = (int)param_2 + 1;
      ...
      puVar2[3] = lVar3;
      if (lVar3 == 0) {
        _printk(&DAT_00100f2a,"zlog_write_internal");
        if (puVar2[3] != 0) {
          kfree();
        }
        kfree(puVar2);
      ...
      if (param_2 <= uVar5) {
        ...
        *(undefined1 *)(puVar2[3] + param_2) = 0;
        ...
        if (((DAT_00100e68 == puVar2) || ((undefined8 **)puVar2 == &DAT_00100e68)) ||
           ((undefined8 **)DAT_00100e68[1] != &DAT_00100e68)) {
          __list_add_valid_or_report(puVar2,&DAT_00100e68);
        }
        else {
          DAT_00100e68[1] = puVar2;
          *puVar2 = DAT_00100e68;
          puVar2[1] = &DAT_00100e68;
          DAT_00100e68 = puVar2;
        }
        DAT_00100eec = DAT_00100eec + 1;
        DAT_00100ee8 = 1;
        mutex_unlock(&g_zlog_info);
        __wake_up(&DAT_00100ed0,1,1,0);
        return param_2;
      }
...

{
  ...
  puVar8 = DAT_00100e68;
  mutex_unlock(&g_zlog_info);
  if ((undefined8 **)puVar8 == &DAT_00100e68) {
    DAT_00100ee8 = 0;
    local_58 = 0;
    uStack_50 = 0;
    local_68 = 0;
    ...
    while (lVar4 = prepare_to_wait_event(&DAT_00100ed0,&local_70,1), DAT_00100ee8 == 0) {
      if (lVar4 != 0) {
    ...
    finish_wait(&DAT_00100ed0,&local_70);
  }
LAB_0010061c:
  mutex_lock(&g_zlog_info);
  plVar2 = DAT_00100e70;
  if ((undefined8 **)DAT_00100e68 == &DAT_00100e68) {
    mutex_unlock(&g_zlog_info);
  }
  else {
    plVar6 = (long *)DAT_00100e70[1];
    if (((long *)*plVar6 == DAT_00100e70) &&
       (lVar4 = *DAT_00100e70, *(long **)(lVar4 + 8) == DAT_00100e70)) {
      *(long **)(lVar4 + 8) = plVar6;
      *plVar6 = lVar4;
    }
    else {
      __list_del_entry_valid_or_report(DAT_00100e70);
    }
    *plVar2 = -0x2152ffffffffff00;
    ...
    if (plVar2 != (long *)0x0) {
      ...
      if (uVar7 == 0) {
        ...
        _printk(puVar8,&DAT_00101068,"zlog_read","zlog_read");
...
LAB_00100980:
          *(undefined1 *)(puVar4[3] + param_3) = 0;
          mutex_lock(&g_zlog_info);
          if (((DAT_00100e68 == puVar4) || ((undefined8 **)puVar4 == &DAT_00100e68)) ||
             ((undefined8 **)DAT_00100e68[1] != &DAT_00100e68)) {
            __list_add_valid_or_report(puVar4,&DAT_00100e68);
          }
          else {
            DAT_00100e68[1] = puVar4;
            *puVar4 = DAT_00100e68;
            puVar4[1] = &DAT_00100e68;
            DAT_00100e68 = puVar4;
          }
          DAT_00100eec = DAT_00100eec + 1;
          DAT_00100ee8 = 1;
...
{
  _printk(&DAT_00100efc,"zlog_exit");
  return;
}
