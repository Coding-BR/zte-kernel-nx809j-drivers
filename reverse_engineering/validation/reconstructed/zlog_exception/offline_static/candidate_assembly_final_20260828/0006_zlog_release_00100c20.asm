...
00000000000008c0 <zlog_release>:
     ...
     8e4: 90000000     	adrp	x0, 0x0 <.text>
		00000000000008e4:  R_AARCH64_ADR_PREL_PG_HI21	.rodata.str1.1+0x222
     8e8: 91000000     	add	x0, x0, #0x0
		00000000000008e8:  R_AARCH64_ADD_ABS_LO12_NC	.rodata.str1.1+0x222
     8ec: b9400102     	ldr	w2, [x8]
		00000000000008ec:  R_AARCH64_LDST32_ABS_LO12_NC	g_zlog_info+0x90
     8f0: 90000001     	adrp	x1, 0x0 <.text>
		00000000000008f0:  R_AARCH64_ADR_PREL_PG_HI21	.rodata.str1.1+0x2f2
     8f4: 91000021     	add	x1, x1, #0x0
		00000000000008f4:  R_AARCH64_ADD_ABS_LO12_NC	.rodata.str1.1+0x2f2
