...
000000000000009c <zlog_create_log_dev>:
      ...
      b8: 90000000     	adrp	x0, 0x0 <.init.text>
		00000000000000b8:  R_AARCH64_ADR_PREL_PG_HI21	.rodata.str1.1+0x254
      bc: 91000000     	add	x0, x0, #0x0
		00000000000000bc:  R_AARCH64_ADD_ABS_LO12_NC	.rodata.str1.1+0x254
     ...
     128: 90000008     	adrp	x8, 0x0 <.init.text>
		0000000000000128:  R_AARCH64_ADR_PREL_PG_HI21	.rodata.str1.1+0x34a
     12c: 91000108     	add	x8, x8, #0x0
		000000000000012c:  R_AARCH64_ADD_ABS_LO12_NC	.rodata.str1.1+0x34a
