    ...
    *(undefined1 *)(piVar5 + 0x4e3b) = 0;
    ...
    if ((minors & 1) == 0) {
      ...
      if ((uVar6 < 0xfffffffffffff001) || ((int)uVar6 == 0)) {
        *piVar5 = iVar2;
        Hint_Prefetch(0x101418,2,0,1);
        do {
          cVar3 = '\x01';
          bVar4 = (bool)ExclusiveMonitorPass(0x101418,0x10);
          if (bVar4) {
        ...
        *(int **)(param_1 + 0x98) = piVar5;
        _dev_printk(&DAT_001013c3,param_1,"zte_ir->speed_hz=%d\n",iVar2);
        uVar6 = 0;
        goto LAB_00100cc0;
      }
    }
...

{
  ...
  if (-1 < (int)uVar1) {
    ...
    if (uVar2 < 0xfffffffffffff001) {
      ...
      uVar2 = uVar1 & 0xffffffff;
      if ((int)uVar1 == 0) {
        _printk(&DAT_00101392,spidev_major);
        goto LAB_00100ef0;
      }
