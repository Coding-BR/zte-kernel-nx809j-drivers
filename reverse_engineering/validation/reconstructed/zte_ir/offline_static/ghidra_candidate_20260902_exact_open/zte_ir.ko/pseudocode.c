...

{
  ...
  _printk(&DAT_00101493,"zte_ir_write");
  ...
  if (uVar10 < 0xfffffffffffff001) {
    if (3 < param_3) {
      ...
      do {
        ...
        if (0x270 < uVar14 + iVar9 >> 6) {
          _printk(&DAT_001013f6,"zte_ir_write",40000);
    ...
    uStack_c0 = 0;
    local_d0 = (undefined8 ***)0x0;
    _printk(&DAT_001013d4,"zte_ir_write");
    local_d0 = &local_b8;
    local_60 = &local_60;
    uStack_50 = 0;
    local_68 = 0;
    ...
    _printk(&DAT_001013c6,"zte_ir_write",iVar9);
  }
  else {
    iVar9 = (int)uVar10;
  }
...

{
  ...
  if ((param_2 >> 0x1e & 1) == 0) {
    ...
    if (param_2 == 0x40046931) {
      _printk(&DAT_001014da,"zte_ir_ioctl",0);
    ...
    if (uVar4 < 0x7ffffffffd) {
      ...
      uVar3 = 0xffffffffffffffe7;
      if (param_2 == 0x40046931) {
        _printk(&DAT_001014da,"zte_ir_ioctl",iVar1);
        uVar3 = 0xffffffffffffffea;
        if (iVar1 != 0) {
          uVar3 = 0;
...

{
  ...
  do {
    ...
    if (ppuVar1 == &device_list) {
      _printk(&DAT_00101421,*(uint *)(param_1 + 0x4c) & 0xfffff);
      uVar2 = 0xfffffffa;
      goto LAB_0010094c;
    }
  } while (*(int *)(ppuVar1 + -0x271b) != *(int *)(param_1 + 0x4c));
  _printk(&DAT_00101542);
...

{
  ...
  do {
    ...
    if (ppuVar3 == &device_list) goto LAB_00100d3c;
      ...
      do {
        ...
        if (499999 < (ulong)uVar5 * (ulong)(param_4 >> 4)) {
          ...
          do {
            if (lVar16 == 0) {
                    /* WARNING: Does not return */
              pcVar7 = (code *)SoftwareBreakpoint(0x5512,0x100fa8);
              (*pcVar7)();
            }
            bVar8 = lVar10 != -1;
            lVar10 = lVar10 + 1;
    ...
    *(undefined1 *)(piVar5 + 0x4e3b) = 0;
    ...
    if ((minors & 1) == 0) {
      ...
      if ((uVar6 < 0xfffffffffffff001) || ((int)uVar6 == 0)) {
        *piVar5 = iVar2;
        Hint_Prefetch(0x101b18,2,0,1);
        do {
          cVar3 = '\x01';
          bVar4 = (bool)ExclusiveMonitorPass(0x101b18,0x10);
          if (bVar4) {
        ...
        *(int **)(param_1 + 0x98) = piVar5;
        _dev_printk(&DAT_001015e0,param_1,"zte_ir->speed_hz=%d\n",iVar2);
        uVar6 = 0;
        goto LAB_00101218;
      }
    }
...

{
  ...
  if (-1 < (int)uVar1) {
    ...
    if (uVar2 < 0xfffffffffffff001) {
      ...
      uVar2 = uVar1 & 0xffffffff;
      if ((int)uVar1 == 0) {
        _printk(&DAT_001015af,spidev_major);
        goto LAB_001016d4;
      }
