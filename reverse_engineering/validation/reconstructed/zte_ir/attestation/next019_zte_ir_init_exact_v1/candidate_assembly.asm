...
0000000000000004 <init_module>:
      ...
      18: 90000000     	adrp	x0, 0x0 <.init.text>
		0000000000000018:  R_AARCH64_ADR_PREL_PG_HI21	zte_ir_exact_rodata_str_base+0x11e
      1c: 91000000     	add	x0, x0, #0x0
		000000000000001c:  R_AARCH64_ADD_ABS_LO12_NC	zte_ir_exact_rodata_str_base+0x11e
      20: 94000000     	bl	0x20 <init_module+0x1c>
		0000000000000020:  R_AARCH64_CALL26	_printk
      24: 90000003     	adrp	x3, 0x0 <.init.text>
		0000000000000024:  R_AARCH64_ADR_PREL_PG_HI21	zte_ir_exact_rodata_str_base+0xd5
      28: 91000063     	add	x3, x3, #0x0
		0000000000000028:  R_AARCH64_ADD_ABS_LO12_NC	zte_ir_exact_rodata_str_base+0xd5
      ...
      44: 90000014     	adrp	x20, 0x0 <.init.text>
		0000000000000044:  R_AARCH64_ADR_PREL_PG_HI21	spidev_major
      48: 2a0003e1     	mov	w1, w0
      4c: b9000280     	str	w0, [x20]
		000000000000004c:  R_AARCH64_LDST32_ABS_LO12_NC	spidev_major
      50: 90000000     	adrp	x0, 0x0 <.init.text>
		0000000000000050:  R_AARCH64_ADR_PREL_PG_HI21	zte_ir_exact_rodata_str_base+0x14c
      54: 91000000     	add	x0, x0, #0x0
		0000000000000054:  R_AARCH64_ADD_ABS_LO12_NC	zte_ir_exact_rodata_str_base+0x14c
      58: 94000000     	bl	0x58 <init_module+0x54>
		0000000000000058:  R_AARCH64_CALL26	_printk
      5c: 90000000     	adrp	x0, 0x0 <.init.text>
		000000000000005c:  R_AARCH64_ADR_PREL_PG_HI21	zte_ir_exact_rodata_str_base+0xc8
      60: 91000000     	add	x0, x0, #0x0
		0000000000000060:  R_AARCH64_ADD_ABS_LO12_NC	zte_ir_exact_rodata_str_base+0xc8
      ...
      7c: b9400280     	ldr	w0, [x20]
		000000000000007c:  R_AARCH64_LDST32_ABS_LO12_NC	spidev_major
      ...
      b4: 90000001     	adrp	x1, 0x0 <.init.text>
		00000000000000b4:  R_AARCH64_ADR_PREL_PG_HI21	zte_ir_spi_driver
      b8: 91000021     	add	x1, x1, #0x0
		00000000000000b8:  R_AARCH64_ADD_ABS_LO12_NC	zte_ir_spi_driver
      ...
      d4: b9400280     	ldr	w0, [x20]
		00000000000000d4:  R_AARCH64_LDST32_ABS_LO12_NC	spidev_major
      ...
      e8: 90000000     	adrp	x0, 0x0 <.init.text>
		00000000000000e8:  R_AARCH64_ADR_PREL_PG_HI21	zte_ir_exact_rodata_str_base+0x170
      ec: 91000000     	add	x0, x0, #0x0
		00000000000000ec:  R_AARCH64_ADD_ABS_LO12_NC	zte_ir_exact_rodata_str_base+0x170
