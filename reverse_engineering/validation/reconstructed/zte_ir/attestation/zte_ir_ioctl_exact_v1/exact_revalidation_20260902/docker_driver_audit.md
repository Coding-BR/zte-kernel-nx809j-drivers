...
- Gerado em: `2026-09-01T12:47:04.447371+00:00`
- Run de evidência: `C:\Users\adria\Desktop\drivers\kernel-docker-workspace\engenharia\runs\zte_ir_ioctl_audit_20260902`
- Rebuild limpo: `sim`
...
|---|---|---|---|
| `zte_ir` | `incomplete_or_failed` | `não executado` | mapping 0 is not independently reviewed<br>mapping 1 is not independently reviewed |
