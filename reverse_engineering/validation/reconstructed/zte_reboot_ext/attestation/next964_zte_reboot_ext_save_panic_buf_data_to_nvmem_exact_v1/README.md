# zte_reboot_ext save_panic_buf_data_to_nvmem — offline exact attestation
...
- Stock function: `save_panic_buf_data_to_nvmem`
- Stock entry: `0x00100eec`
- Stock body: 368 bytes / 92 instructions
- Candidate source: `candidate_source.c`
- Stock module SHA-256: `1e5b8e9e91f304236802d52a316570f6649b8f504b58558b28909d48c62d910f`
- Candidate protocol module SHA-256: `005914dc9c99a7af86a04cb1d750a1a4b0906c7a063f41fb0e07e7736a692b37`

The source keeps a readable C model as `save_panic_buf_data_to_nvmem_model` for host and Joern analysis and emits an AArch64 assembly island for the target helper. The island preserves the stock instruction body and external/string relocations. The host build maps the public function name to the C model through `ZTE_REBOOT_EXT_HOST_TEST`; the kernel/Docker build selects the target assembly island.

## Evidence

- `assembly/comparison.json`: exact instruction, relocation, section and symbol-size comparison passed.
- `kcfi/comparison.json`: KCFI gate passed; this stock helper has no valid KCFI preamble and candidate/stock agree.
