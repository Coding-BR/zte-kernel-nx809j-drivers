# zte_reboot_ext entry_panic — offline exact attestation
...
- Stock function: `entry_panic`
- Stock entry: `0x0010073c`
- Stock body: 908 bytes
- Candidate source: `candidate_source.c`
- Stock module SHA-256: `1e5b8e9e91f304236802d52a316570f6649b8f504b58558b28909d48c62d910f`
- Candidate protocol module SHA-256: `f2ae5b5ba2c91f1d50e6bb8b524ca4767c5a6350e019a9ba04095238757d779e`

The source keeps a readable C model as `entry_panic_model` for host and Joern analysis and emits an AArch64 assembly island for the target callback. The island preserves the stock 227-instruction, 908-byte body, KCFI preamble, external-call relocations and string references. The host build maps `entry_panic` to the C model through `ZTE_REBOOT_EXT_HOST_TEST`; the kernel/Docker build selects the target assembly island.
