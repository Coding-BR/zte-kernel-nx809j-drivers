...
/* 00101a18 aw22xxx_init_cfg_update_array */
...

{
  ...
  uVar1 = sp_el0;
  _printk(&DAT_00106d9e,"aw22xxx_init_cfg_update_array",0x1ca);
  return;
}



/* 00101b6c aw22xxx_set_breath_data */
...

{
  ...
  while( true ) {
    ...
    if (read_idx == write_idx) {
      ...
      _printk(&DAT_0010742e,"aw22xxx_play");
      return;
    }
    if ((kthread_status & 1) == 0) break;
    if (25000 < (uint)(read_idx * 0x19)) {
                    /* WARNING: Does not return */
      pcVar1 = (code *)SoftwareBreakpoint(0x5512,0x101dc0);
      (*pcVar1)();
    }
  ...
  _printk(&DAT_00107083,"aw22xxx_play");
  return;
}



/* 00101dc4 aw22xxx_led_imax_cfg */
...

{
  ...
  *(undefined4 *)(param_1 + 0x2f0) = 7;
  _printk(&DAT_00106c84,"aw22xxx_led_imax_cfg",
...

{
  ...
  if (iVar2 < 0) {
    ...
    _printk(&DAT_00106813,"aw22xxx_i2c_write",0,iVar2,uVar3);
    return;
  }
  lVar1 = sp_el0;
...
/* 001020a0 aw22xxx_i2c_probe */

void aw22xxx_i2c_probe(void)

{
  _printk(&DAT_0010744f,"aw22xxx_i2c_probe",0x9d9);
  return;
}
...
/* 001023b8 FUN_001023b8 */

undefined4 FUN_001023b8(void)
...
/* 0010273c aw22xxx_i2c_remove */

void aw22xxx_i2c_remove(void)

{
  _printk(&DAT_00106e6d,"aw22xxx_i2c_remove");
  return;
}



/* 00102800 aw22xxx_hw_reset */

void aw22xxx_hw_reset(void)

{
  _printk(&DAT_00106e6d,"aw22xxx_hw_reset");
  return;
}



/* 0010289c aw22xxx_read_chipid */
...

{
  ...
  if (-1 < iVar2) {
    if (local_2c[0] == 'v') {
      _printk(&DAT_00107179,"aw22xxx_read_chipid",0x76,iVar2);
      return;
    }
    _printk(&DAT_00107d37,"aw22xxx_read_chipid",local_2c[0],iVar2);
    return;
  }
...
/* 00102a68 aw22xxx_interrupt_setup */
...

{
  ...
  uVar1 = sp_el0;
  _printk(&DAT_00106e6d,"aw22xxx_interrupt_setup");
  return;
}



/* 00102b70 aw22xxx_irq_v15 */
...

{
  ...
  _printk(&DAT_00106917,"aw22xxx_irq_v15",local_44[0]);
  return;
}



/* 00102db8 aw22xxx_irq */
...

{
  ...
  uVar1 = sp_el0;
  _printk(&DAT_00106e6d,"aw22xxx_irq");
  return;
}



/* 00102ebc aw22xxx_parse_led_cdev */

void aw22xxx_parse_led_cdev(void)

{
  _printk(&DAT_00106e6d,"aw22xxx_parse_led_cdev");
  return;
}



/* 001030c4 aw22xxx_alloc_name_array */
...

{
  ...
  if (aw22xxx_cfg_name == (undefined8 *)0x0) {
    _printk(&DAT_00106873,"aw22xxx_alloc_name_array",0x687);
    return;
  }
  lVar4 = 0;
  uVar1 = sp_el0;
  do {
    ...
    if (lVar2 == 0) {
      ...
      kfree(puVar3);
      _printk(&DAT_00106873,"aw22xxx_alloc_name_array",0x692);
      return;
    }
    lVar4 = lVar4 + 1;
  } while (lVar4 != 0xb);
...

{
  ...
  *(code **)(param_1 + 0x248) = aw22xxx_cfg_work_routine;
  ...
  _printk(&DAT_001069bc,"aw22xxx_fw_init");
  return;
}



/* 001033fc aw22xxx_create_proc_entry */
...
/* 00103460 aw22xxx_brightness_work */
...

{
  ...
  uVar1 = sp_el0;
  _printk(&DAT_00106e6d,"aw22xxx_brightness_work");
  return;
}



/* 001036b0 aw22xxx_task_work */
...

{
  ...
  uVar1 = sp_el0;
  _printk(&DAT_00106e6d,"aw22xxx_task_work");
  return;
}



/* 0010394c aw22xxx_reg_show */
...

{
  ...
  uVar2 = _printk(&DAT_00106a98,"aw22xxx_reg_store",0x78b);
  return uVar2;
}



/* 00103b20 aw22xxx_hwen_show */
...

{
  ...
  if (iVar1 == 1) {
    if (local_3c < 2) {
      if (local_3c != 1) {
        uVar2 = _printk(&DAT_00106e6d,"aw22xxx_hw_off");
        return uVar2;
      }
  ...
  uVar2 = _printk(&DAT_00106a98,"aw22xxx_hwen_store",0x7b9);
  return uVar2;
}



/* 00103d08 aw22xxx_imax_show */
...

{
  ...
  if (uVar1 < 0xe) {
    ...
    return lVar5 + iVar3;
                    ...
                    /* WARNING: Does not return */
  pcVar2 = (code *)SoftwareBreakpoint(0x5512,0x103ef0);
  (*pcVar2)();
}



/* 00103ef4 aw22xxx_imax_store */
...

{
  ...
  if ((iVar1 == 2) && ((uint)local_30 < 9)) {
    *(undefined4 *)(lVar3 + (local_30 & 0xffffffff) * 4 + 0x2fc) = local_30._4_4_;
    uVar2 = _printk(&DAT_001067e4,"aw22xxx_rgb_store",0x8d3);
    return uVar2;
  }
  lVar3 = sp_el0;
  if (*(long *)(lVar3 + 0x710) == local_28) {
...

{
  ...
  if (iVar1 == 1) {
    *(char *)(lVar2 + 0x2ec) = (char)local_2c;
    _printk(&DAT_00106d6f,"aw22xxx_task0_store",0x8f4,local_2c & 0xff);
    return;
  }
  _printk(&DAT_001066eb,"aw22xxx_task0_store",0x8ef);
  return;
}



/* 00104300 aw22xxx_task1_show */
...

{
  ...
  if (iVar1 == 1) {
    *(char *)(lVar2 + 0x2ed) = (char)local_2c;
    _printk(&DAT_001065e9,"aw22xxx_task1_store",0x911,local_2c & 0xff);
    return;
  }
  _printk(&DAT_001066eb,"aw22xxx_task1_store",0x90c);
  return;
}



/* 00104400 aw22xxx_task_irq_show */
...
/* 0010443c aw22xxx_task_irq_store */
...
LAB_00104614:
                    /* WARNING: Does not return */
          pcVar1 = (code *)SoftwareBreakpoint(0x5512,0x104618);
          (*pcVar1)();
        }
        lVar3 = lVar3 + iVar2;
      }
      else if (0xc34 < uVar4 >> 3) goto LAB_00104614;
...
/* 0010461c aw22xxx_para_store */

void aw22xxx_para_store(void)

{
  _printk(&DAT_00106c78,"aw22xxx_para_store");
  return;
}



/* 00104a74 aw22xxx_multi_breath_pattern_show */
...
/* 00104ab0 aw22xxx_cfg_loaded */

void aw22xxx_cfg_loaded(void)

{
  _printk(&DAT_00108227,"aw22xxx_cfg_loaded");
  return;
}



/* 00104c90 aw22xxx_set_brightness */
...

{
  ...
  sVar2 = _printk(&DAT_00107f84);
  return sVar2;
}



/* 00104d44 aw22xxx_cfg_store */
...

{
  ...
  if (iVar1 == 1) {
    *(byte *)(lVar2 + 0x2f4) = (byte)local_2c & 0xf;
    _printk(&DAT_00107ff7,"aw22xxx_cfg_store");
    return;
  }
  _printk(&DAT_00108062,"aw22xxx_cfg_store");
  return;
}



/* 00104e00 aw22xxx_effect_show */
...

{
  ...
  if (iVar2 == 1) {
    _printk(&DAT_00108252,"aw22xxx_effect_store",local_4c);
    return;
  }
  _printk(&DAT_00108062,"aw22xxx_effect_store");
  return;
}



/* 001050c8 aw22xxx_get_fwname */
...
/* 00105244 aw22xxx_cfg_update_wait_from_dyn_name */
...

{
  ...
  uVar1 = sp_el0;
  _printk(&DAT_00108227,"aw22xxx_cfg_update_wait_from_dyn_name");
  return;
}



/* 00105470 aw22xxx_fw_show */
...
/* 00105558 aw22xxx_multi_breath_pattern_store */
  ...
  if (iVar1 == 1) {
    ...
    *(int *)(lVar5 + 0x2f8) = local_3c;
    if (local_3c == 0) {
      ...
      uVar2 = kthread_create_on_node(aw22xxx_play,lVar4,0xffffffff,&DAT_001070d2,"aw22xxx_play");
...
/* 001056ec aw22xxx_fw_timer_func */

void aw22xxx_fw_timer_func(void)

{
  _printk(&DAT_00106e6d,"aw22xxx_fw_timer_func");
  return;
}



/* 00105740 aw22xxx_fw_work_routine */

void aw22xxx_fw_work_routine(void)

{
  _printk(&DAT_00106e6d,"aw22xxx_fw_work_routine");
  return;
}



/* 001057d4 aw22xxx_cfg_work_routine */

void aw22xxx_cfg_work_routine(void)

{
  _printk(&DAT_00106e6d,"aw22xxx_cfg_work_routine");
  return;
}



/* 001058bc aw22xxx_recover_work_routine */
...

{
  ...
  uVar1 = sp_el0;
  _printk(&DAT_001070f4,"aw22xxx_recover_work_routine");
  return;
}



/* 00105ac8 aw22xxx_led_init */
...

{
  ...
  uVar1 = sp_el0;
  _printk(&DAT_00106e6d,"aw22xxx_led_init");
  return;
}



/* 00105c58 aw22xxx_cfg_recover_update_wait */
...

{
  ...
  uVar1 = sp_el0;
  _printk(&DAT_00106e6d,"aw22xxx_cfg_recover_update_wait");
  return;
}



/* 00105cd8 FUN_00105cd8 */

void FUN_00105cd8(undefined8 param_1,undefined8 param_2,ulong param_3)

{
  ...
  fan_effect = uVar1;
  _printk(&DAT_0010710f,"aw22xxx_cfg_recover_update_wait",param_3);
  return;
}



/* 00106024 get_aw22xxx_id */
...
/* 0010e7d8 init_module */

void init_module(void)

{
  _printk(&DAT_00106b0d,"v1.1.3");
  return;
}
