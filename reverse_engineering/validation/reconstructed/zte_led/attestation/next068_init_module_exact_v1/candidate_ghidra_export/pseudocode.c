...

{
  ...
  uVar1 = sp_el0;
  _printk(&DAT_00106e9d,"aw22xxx_fw_loaded");
  return;
}



/* 00101a48 aw22xxx_init_cfg_update_array */
...

{
  ...
  uVar1 = sp_el0;
  _printk(&DAT_00106dce,"aw22xxx_init_cfg_update_array",0x1ca);
  return;
}



/* 00101b9c aw22xxx_set_breath_data */
...

{
  ...
  while( true ) {
    ...
    if (read_idx == write_idx) {
      ...
      _printk(&DAT_0010745e,"aw22xxx_play");
      return;
    }
    if ((kthread_status & 1) == 0) break;
    if (25000 < (uint)(read_idx * 0x19)) {
                    /* WARNING: Does not return */
      pcVar1 = (code *)SoftwareBreakpoint(0x5512,0x101df0);
      (*pcVar1)();
    }
  ...
  _printk(&DAT_001070b3,"aw22xxx_play");
  return;
}



/* 00101df4 aw22xxx_led_imax_cfg */
...

{
  ...
  *(undefined4 *)(param_1 + 0x2f0) = 7;
  _printk(&DAT_00106cb4,"aw22xxx_led_imax_cfg",
...

{
  ...
  if (iVar2 < 0) {
    ...
    _printk(&DAT_00106843,"aw22xxx_i2c_write",0,iVar2,uVar3);
    return;
  }
  lVar1 = sp_el0;
...
/* 001020d0 aw22xxx_i2c_probe */

void aw22xxx_i2c_probe(void)

{
  _printk(&DAT_0010747f,"aw22xxx_i2c_probe",0x9d9);
  return;
}
...
/* 001023e8 FUN_001023e8 */

undefined4 FUN_001023e8(void)
...
/* 0010276c aw22xxx_i2c_remove */

void aw22xxx_i2c_remove(void)

{
  _printk(&DAT_00106e9d,"aw22xxx_i2c_remove");
  return;
}



/* 00102830 aw22xxx_hw_reset */

void aw22xxx_hw_reset(void)

{
  _printk(&DAT_00106e9d,"aw22xxx_hw_reset");
  return;
}



/* 001028cc aw22xxx_read_chipid */
...

{
  ...
  if (-1 < iVar2) {
    if (local_2c[0] == 'v') {
      _printk(&DAT_001071a9,"aw22xxx_read_chipid",0x76,iVar2);
      return;
    }
    _printk(&DAT_00107d67,"aw22xxx_read_chipid",local_2c[0],iVar2);
    return;
  }
...
/* 00102a98 aw22xxx_interrupt_setup */
...

{
  ...
  uVar1 = sp_el0;
  _printk(&DAT_00106e9d,"aw22xxx_interrupt_setup");
  return;
}



/* 00102ba0 aw22xxx_irq_v15 */
...

{
  ...
  _printk(&DAT_00106947,"aw22xxx_irq_v15",local_44[0]);
  return;
}



/* 00102de8 aw22xxx_irq */
...

{
  ...
  uVar1 = sp_el0;
  _printk(&DAT_00106e9d,"aw22xxx_irq");
  return;
}



/* 00102eec aw22xxx_parse_led_cdev */

void aw22xxx_parse_led_cdev(void)

{
  _printk(&DAT_00106e9d,"aw22xxx_parse_led_cdev");
  return;
}



/* 001030f4 aw22xxx_alloc_name_array */
...

{
  ...
  if (aw22xxx_cfg_name == (undefined8 *)0x0) {
    _printk(&DAT_001068a3,"aw22xxx_alloc_name_array",0x687);
    return;
  }
  lVar4 = 0;
  uVar1 = sp_el0;
  do {
    ...
    if (lVar2 == 0) {
      ...
      kfree(puVar3);
      _printk(&DAT_001068a3,"aw22xxx_alloc_name_array",0x692);
      return;
    }
    lVar4 = lVar4 + 1;
  } while (lVar4 != 0xb);
...

{
  ...
  *(code **)(param_1 + 0x248) = aw22xxx_cfg_work_routine;
  ...
  _printk(&DAT_001069ec,"aw22xxx_fw_init");
  return;
}



/* 0010342c aw22xxx_create_proc_entry */
...

{
  ...
  if (lVar1 == 0) {
    _printk(&DAT_0010724a);
    return;
  }
  _printk(&DAT_00107b56,"aw22xxx_create_proc_entry",0x9c3);
  return;
}



/* 00103490 aw22xxx_brightness_work */
...

{
  ...
  uVar1 = sp_el0;
  _printk(&DAT_00106e9d,"aw22xxx_brightness_work");
  return;
}



/* 001036e0 aw22xxx_task_work */
...

{
  ...
  uVar1 = sp_el0;
  _printk(&DAT_00106e9d,"aw22xxx_task_work");
  return;
}



/* 0010397c aw22xxx_reg_show */
...

{
  ...
  uVar2 = _printk(&DAT_00106ac8,"aw22xxx_reg_store",0x78b);
  return uVar2;
}



/* 00103b50 aw22xxx_hwen_show */
...

{
  ...
  if (iVar1 == 1) {
    if (local_3c < 2) {
      if (local_3c != 1) {
        uVar2 = _printk(&DAT_00106e9d,"aw22xxx_hw_off");
        return uVar2;
      }
  ...
  uVar2 = _printk(&DAT_00106ac8,"aw22xxx_hwen_store",0x7b9);
  return uVar2;
}



/* 00103d38 aw22xxx_imax_show */
...

{
  ...
  if (uVar1 < 0xe) {
    ...
    return lVar5 + iVar3;
                    ...
                    /* WARNING: Does not return */
  pcVar2 = (code *)SoftwareBreakpoint(0x5512,0x103f20);
  (*pcVar2)();
}



/* 00103f24 aw22xxx_imax_store */
...

{
  ...
  if ((iVar1 != 1) || (0xc < local_3c)) {
    uVar2 = _printk(&DAT_00106ac8,"aw22xxx_imax_store",0x8a7);
    return uVar2;
  }
...

{
  ...
  if (iVar1 == 1) {
    *(char *)(lVar2 + 0x2ec) = (char)local_2c;
    _printk(&DAT_00106d9f,"aw22xxx_task0_store",0x8f4,local_2c & 0xff);
    return;
  }
  _printk(&DAT_0010671b,"aw22xxx_task0_store",0x8ef);
  return;
}



/* 00104330 aw22xxx_task1_show */
...

{
  ...
  if (iVar1 == 1) {
    *(char *)(lVar2 + 0x2ed) = (char)local_2c;
    _printk(&DAT_00106619,"aw22xxx_task1_store",0x911,local_2c & 0xff);
    return;
  }
  _printk(&DAT_0010671b,"aw22xxx_task1_store",0x90c);
  return;
}



/* 00104430 aw22xxx_task_irq_show */
...
/* 0010446c aw22xxx_task_irq_store */
...

{
  ...
  if (iVar1 == 1) {
    *(undefined4 *)(lVar2 + 0x2e8) = local_2c;
    _printk(&DAT_001070d8,"aw22xxx_task_irq_store",0x92c);
    return;
  }
  _printk(&DAT_0010671b,"aw22xxx_task_irq_store",0x927);
  return;
}



/* 0010452c aw22xxx_para_show */
...
LAB_00104644:
                    /* WARNING: Does not return */
          pcVar1 = (code *)SoftwareBreakpoint(0x5512,0x104648);
          (*pcVar1)();
        }
        lVar3 = lVar3 + iVar2;
      }
      else if (0xc34 < uVar4 >> 3) goto LAB_00104644;
...
/* 0010464c aw22xxx_para_store */

void aw22xxx_para_store(void)

{
  _printk(&DAT_00106ca8,"aw22xxx_para_store");
  return;
}



/* 00104aa4 aw22xxx_multi_breath_pattern_show */
...
/* 00104ae0 aw22xxx_cfg_loaded */

void aw22xxx_cfg_loaded(void)

{
  _printk(&DAT_001082a2,"aw22xxx_cfg_loaded");
  return;
}



/* 00104cc0 aw22xxx_set_brightness */
...

{
  ...
  sVar2 = _printk(&DAT_00107fb4);
  return sVar2;
}



/* 00104d74 aw22xxx_cfg_store */
...

{
  ...
  if (iVar1 == 1) {
    *(byte *)(lVar2 + 0x2f4) = (byte)local_2c & 0xf;
    _printk(&DAT_0010804f,"aw22xxx_cfg_store");
    return;
  }
  _printk(&DAT_001080ba,"aw22xxx_cfg_store");
  return;
}



/* 00104e30 aw22xxx_effect_show */
...

{
  ...
  if (iVar2 == 1) {
    _printk(&DAT_001082cd,"aw22xxx_effect_store",local_4c);
    return;
  }
  _printk(&DAT_001080ba,"aw22xxx_effect_store");
  return;
}



/* 001050f8 aw22xxx_get_fwname */
...
/* 00105274 aw22xxx_cfg_update_wait_from_dyn_name */
...

{
  ...
  uVar1 = sp_el0;
  _printk(&DAT_001082a2,"aw22xxx_cfg_update_wait_from_dyn_name");
  return;
}



/* 001054a0 aw22xxx_fw_show */
...
/* 00105588 aw22xxx_multi_breath_pattern_store */
  ...
  if (iVar1 == 1) {
    ...
    *(int *)(lVar5 + 0x2f8) = local_3c;
    if (local_3c == 0) {
      ...
      uVar2 = kthread_create_on_node(aw22xxx_play,lVar4,0xffffffff,&DAT_00107102,"aw22xxx_play");
...
/* 0010571c aw22xxx_fw_timer_func */

void aw22xxx_fw_timer_func(void)

{
  _printk(&DAT_00106e9d,"aw22xxx_fw_timer_func");
  return;
}



/* 00105770 aw22xxx_fw_work_routine */

void aw22xxx_fw_work_routine(void)

{
  _printk(&DAT_00106e9d,"aw22xxx_fw_work_routine");
  return;
}



/* 00105804 aw22xxx_cfg_work_routine */

void aw22xxx_cfg_work_routine(void)

{
  _printk(&DAT_00106e9d,"aw22xxx_cfg_work_routine");
  return;
}



/* 001058ec aw22xxx_recover_work_routine */
...

{
  ...
  uVar1 = sp_el0;
  _printk(&DAT_00107124,"aw22xxx_recover_work_routine");
  return;
}



/* 00105af8 aw22xxx_led_init */
...

{
  ...
  uVar1 = sp_el0;
  _printk(&DAT_00106e9d,"aw22xxx_led_init");
  return;
}



/* 00105c88 aw22xxx_cfg_recover_update_wait */
...

{
  ...
  uVar1 = sp_el0;
  _printk(&DAT_00106e9d,"aw22xxx_cfg_recover_update_wait");
  return;
}



/* 00105d08 FUN_00105d08 */
...
/* 0010e724 init_module */

void init_module(void)

{
  _printk(&DAT_001083b4);
  return;
}



/* 0010e79c cleanup_module */
