...
/* 00101818 aw22xxx_init_cfg_update_array */
...
/* 0010196c aw22xxx_set_breath_data */
...

{
  ...
  while( true ) {
    ...
    if (25000 < (uint)(read_idx * 0x19)) {
      ...
      pcVar1 = (code *)SoftwareBreakpoint(0x5512,0x101bc0);
      (*pcVar1)();
    }
...
/* 00101c80 FUN_00101c80 */

void FUN_00101c80(long param_1)
...
/* 00102868 aw22xxx_interrupt_setup */
...
/* 00102cbc aw22xxx_parse_led_cdev */
...
/* 00102ec4 aw22xxx_alloc_name_array */
...
/* 001031fc aw22xxx_create_proc_entry */
...
/* 00103260 aw22xxx_brightness_work */
...

{
  ...
  FUN_00101db0(lVar4,0xff,local_60);
  uVar5 = 0;
  lVar3 = 0;
  do {
    if ((local_60[0] != '\0') || (((&aw22xxx_reg_access)[uVar5] & 1) != 0)) {
      FUN_00101de4(lVar4,uVar5 & 0xffffffff,local_5c);
...

{
  ...
  if ((iVar1 == 2) && ((uint)local_30 < 0x100)) {
    FUN_00101c80(lVar2 + -0x10,local_30 & 0xffffffff,local_30._4_4_);
    lVar2 = sp_el0;
...

{
  ...
  if (uVar1 < 0xe) {
    ...
    return lVar5 + iVar3;
                    ...
                    /* WARNING: Does not return */
  pcVar2 = (code *)SoftwareBreakpoint(0x5512,0x103d2c);
  (*pcVar2)();
}



/* 00103d30 aw22xxx_imax_store */
...

{
  ...
  *(uint *)(lVar3 + 0x2e0) = local_3c;
  ...
  FUN_00101c70(lVar3,0xff,0);
  FUN_00101c70(lVar3,0xb,bVar2);
  lVar3 = sp_el0;
...
/* 0010423c aw22xxx_task_irq_show */
...
/* 00104278 aw22xxx_task_irq_store */
...
LAB_00104450:
                    /* WARNING: Does not return */
          pcVar1 = (code *)SoftwareBreakpoint(0x5512,0x104454);
          (*pcVar1)();
        }
        lVar3 = lVar3 + iVar2;
      }
      else if (0xc34 < uVar4 >> 3) goto LAB_00104450;
...
/* 001048b0 aw22xxx_multi_breath_pattern_show */
...
/* 001048ec aw22xxx_cfg_loaded */

void aw22xxx_cfg_loaded(void)

{
                    /* WARNING: Subroutine does not return */
  _printk(&DAT_00107e60,"aw22xxx_cfg_loaded");
}



/* 00104acc aw22xxx_set_brightness */
...

{
  ...
  if (iVar2 == 1) {
                    /* WARNING: Subroutine does not return */
    _printk(&DAT_00107e76,"aw22xxx_effect_store",local_4c);
  }
                    /* WARNING: Subroutine does not return */
  _printk(&DAT_00107c9b,"aw22xxx_effect_store");
}



/* 00104dcc aw22xxx_get_fwname */

void aw22xxx_get_fwname(ulong param_1)

{
                    /* WARNING: Subroutine does not return */
  _printk(&DAT_00107d44,"aw22xxx_get_fwname",param_1 >> 0x18 & 0xff);
}



/* 00104f48 aw22xxx_cfg_update_wait_from_dyn_name */
...

{
  ...
  uVar1 = sp_el0;
                    /* WARNING: Subroutine does not return */
  _printk(&DAT_00107e60,"aw22xxx_cfg_update_wait_from_dyn_name");
}



/* 00105174 aw22xxx_fw_store */
...
/* 0010536c aw22xxx_multi_breath_pattern_store */
...
/* 00105500 aw22xxx_fw_timer_func */
...
/* 00105554 aw22xxx_fw_work_routine */
...
/* 001055e8 aw22xxx_cfg_work_routine */
...
/* 001056d0 aw22xxx_recover_work_routine */
...
/* 00105a6c aw22xxx_cfg_recover_update_wait */
...
/* 00105adc FUN_00105adc */

void FUN_00105adc(undefined8 param_1)
