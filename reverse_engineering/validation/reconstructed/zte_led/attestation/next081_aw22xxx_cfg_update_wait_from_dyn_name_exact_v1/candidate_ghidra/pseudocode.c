...

{
  ...
  _printk(&DAT_00106ad5,"aw22xxx_fw_loaded");
}



/* 00101740 aw22xxx_init_cfg_update_array */
...

{
  ...
  uVar1 = sp_el0;
                    /* WARNING: Subroutine does not return */
  _printk(&DAT_00106a06,"aw22xxx_init_cfg_update_array",0x1ca);
}



/* 00101894 aw22xxx_set_breath_data */
...

{
  ...
  while( true ) {
    ...
    if (read_idx == write_idx) {
      ...
      queue_work_on(0x20,_system_wq,param_1 + 0x230);
                    /* WARNING: Subroutine does not return */
      _printk(&DAT_00107096,"aw22xxx_play");
    }
    if ((kthread_status & 1) == 0) break;
    if (25000 < (uint)(read_idx * 0x19)) {
                    /* WARNING: Does not return */
      pcVar1 = (code *)SoftwareBreakpoint(0x5512,0x101ae8);
      (*pcVar1)();
    }
  ...
  aw22xxx_i2c_write(param_1,2,0);
                    /* WARNING: Subroutine does not return */
  _printk(&DAT_00106ceb,"aw22xxx_play");
}



/* 00101aec aw22xxx_led_imax_cfg */
...

{
  ...
  *(undefined4 *)(param_1 + 0x2f0) = 7;
                    /* WARNING: Subroutine does not return */
  _printk(&DAT_001068ec,"aw22xxx_led_imax_cfg",
          *(undefined8 *)(aw22xxx_cfg_name + (ulong)*(uint *)(param_1 + 0x300) * 8),7);
}



/* 00101b5c aw22xxx_i2c_write */
...

{
  ...
  if (iVar2 < 0) {
    ...
    uVar3 = gpiod_get_raw_value();
                    /* WARNING: Subroutine does not return */
    _printk(&DAT_0010647b,"aw22xxx_i2c_write",0,iVar2,uVar3);
  }
  lVar1 = sp_el0;
...

{
  ...
  if (iVar2 < 0) {
    *unaff_x19 = (char)iVar2;
                    /* WARNING: Subroutine does not return */
    _printk(&DAT_0010690f,"aw22xxx_i2c_read",iVar2);
  }
  lVar1 = sp_el0;
  if (*(long *)(lVar1 + 0x710) == in_stack_00000008) {
    return;
...
/* 00101dc8 aw22xxx_i2c_probe */

void aw22xxx_i2c_probe(void)

{
                    /* WARNING: Subroutine does not return */
  _printk(&DAT_001070b7,"aw22xxx_i2c_probe",0x9d9);
}



/* 001020b4 FUN_001020b4 */

undefined8 FUN_001020b4(void)
...
/* 001020e0 FUN_001020e0 */

undefined4 FUN_001020e0(void)
...
/* 00102464 aw22xxx_i2c_remove */

void aw22xxx_i2c_remove(void)

{
                    /* WARNING: Subroutine does not return */
  _printk(&DAT_00106ad5,"aw22xxx_i2c_remove");
}



/* 00102528 aw22xxx_hw_reset */

void aw22xxx_hw_reset(void)

{
                    /* WARNING: Subroutine does not return */
  _printk(&DAT_00106ad5,"aw22xxx_hw_reset");
}
...

{
  ...
  if (-1 < iVar2) {
    if (local_2c[0] == 'v') {
                    /* WARNING: Subroutine does not return */
      _printk(&DAT_00106de1,"aw22xxx_read_chipid",0x76,iVar2);
    }
                    /* WARNING: Subroutine does not return */
    _printk(&DAT_0010799f,"aw22xxx_read_chipid",local_2c[0],iVar2);
  }
...
/* 00102790 aw22xxx_interrupt_setup */
...

{
  ...
  uVar1 = sp_el0;
                    /* WARNING: Subroutine does not return */
  _printk(&DAT_00106ad5,"aw22xxx_interrupt_setup");
}



/* 00102898 aw22xxx_irq_v15 */
...

{
  ...
  aw22xxx_i2c_read(param_2,10,local_44);
                    /* WARNING: Subroutine does not return */
  _printk(&DAT_0010657f,"aw22xxx_irq_v15",local_44[0]);
}



/* 00102ae0 aw22xxx_irq */
...

{
  ...
  uVar1 = sp_el0;
                    /* WARNING: Subroutine does not return */
  _printk(&DAT_00106ad5,"aw22xxx_irq");
}



/* 00102be4 aw22xxx_parse_led_cdev */

void aw22xxx_parse_led_cdev(void)

{
                    /* WARNING: Subroutine does not return */
  _printk(&DAT_00106ad5,"aw22xxx_parse_led_cdev");
}



/* 00102dec aw22xxx_alloc_name_array */
...

{
  ...
  if (aw22xxx_cfg_name == (undefined8 *)0x0) {
                    /* WARNING: Subroutine does not return */
    _printk(&DAT_001064db,"aw22xxx_alloc_name_array",0x687);
  }
  lVar4 = 0;
  uVar1 = sp_el0;
  do {
    ...
    if (lVar2 == 0) {
      ...
      kfree(puVar3);
                    /* WARNING: Subroutine does not return */
      _printk(&DAT_001064db,"aw22xxx_alloc_name_array",0x692);
    }
    lVar4 = lVar4 + 1;
  } while (lVar4 != 0xb);
  ...
  *(code **)(param_1 + 0x248) = aw22xxx_cfg_work_routine;
  if (bVar1) {
    ...
    *(code **)(param_1 + 0x268) = aw22xxx_recover_work_routine;
                    ...
                    /* WARNING: Subroutine does not return */
  _printk(&DAT_00106624,"aw22xxx_fw_init");
}



/* 00103124 aw22xxx_create_proc_entry */
...

{
  ...
  if (lVar1 == 0) {
                    /* WARNING: Subroutine does not return */
    _printk(&DAT_00106e82);
  }
                    /* WARNING: Subroutine does not return */
  _printk(&DAT_0010778e,"aw22xxx_create_proc_entry",0x9c3);
}



/* 00103188 aw22xxx_brightness_work */
...

{
  ...
  uVar1 = sp_el0;
                    /* WARNING: Subroutine does not return */
  _printk(&DAT_00106ad5,"aw22xxx_brightness_work");
}



/* 001033d8 aw22xxx_task_work */
...

{
  ...
  uVar1 = sp_el0;
                    /* WARNING: Subroutine does not return */
  _printk(&DAT_00106ad5,"aw22xxx_task_work");
}
...

{
  ...
  FUN_00101cd8(lVar4,0xff,local_60);
  uVar5 = 0;
  lVar3 = 0;
  do {
    if ((local_60[0] != '\0') || (((&aw22xxx_reg_access)[uVar5] & 1) != 0)) {
      FUN_00101d0c(lVar4,uVar5 & 0xffffffff,local_5c);
...

{
  ...
  if ((iVar1 == 2) && ((uint)local_30 < 0x100)) {
    FUN_00101ba8(lVar2 + -0x10,local_30 & 0xffffffff,local_30._4_4_);
    lVar2 = sp_el0;
    ...
    __stack_chk_fail();
                    ...
                    /* WARNING: Subroutine does not return */
  _printk(&DAT_00106700,"aw22xxx_reg_store",0x78b);
}



/* 00103884 aw22xxx_hwen_show */
...

{
  ...
  if (iVar1 == 1) {
    if (local_3c < 2) {
      if (local_3c != 1) {
                    /* WARNING: Subroutine does not return */
        _printk(&DAT_00106ad5,"aw22xxx_hw_off");
      }
      FUN_001025a8(lVar2 + -0x10);
      lVar2 = sp_el0;
      ...
      __stack_chk_fail();
                    ...
                    /* WARNING: Subroutine does not return */
  _printk(&DAT_00106700,"aw22xxx_hwen_store",0x7b9);
}



/* 00103a6c aw22xxx_imax_show */
...

{
  ...
  if (uVar1 < 0xe) {
    ...
    return lVar5 + iVar3;
                    ...
                    /* WARNING: Does not return */
  pcVar2 = (code *)SoftwareBreakpoint(0x5512,0x103c54);
  (*pcVar2)();
}



/* 00103c58 aw22xxx_imax_store */
...

{
  ...
  if ((iVar1 != 1) || (0xc < local_3c)) {
                    /* WARNING: Subroutine does not return */
    _printk(&DAT_00106700,"aw22xxx_imax_store",0x8a7);
  }
  *(uint *)(lVar3 + 0x2e0) = local_3c;
  ...
  FUN_00101b98(lVar3,0xff,0);
  FUN_00101b98(lVar3,0xb,bVar2);
  lVar3 = sp_el0;
...

{
  ...
  if ((iVar1 == 2) && ((uint)local_30 < 9)) {
    *(undefined4 *)(lVar2 + (local_30 & 0xffffffff) * 4 + 0x2fc) = local_30._4_4_;
                    /* WARNING: Subroutine does not return */
    _printk(&DAT_0010644c,"aw22xxx_rgb_store",0x8d3);
  }
  lVar2 = sp_el0;
  if (*(long *)(lVar2 + 0x710) == local_28) {
...

{
  ...
  if (iVar1 == 1) {
    *(char *)(lVar2 + 0x2ec) = (char)local_2c;
                    /* WARNING: Subroutine does not return */
    _printk(&DAT_001069d7,"aw22xxx_task0_store",0x8f4,local_2c & 0xff);
  }
                    /* WARNING: Subroutine does not return */
  _printk(&DAT_00106353,"aw22xxx_task0_store",0x8ef);
}



/* 00104064 aw22xxx_task1_show */
...

{
  ...
  if (iVar1 == 1) {
    *(char *)(lVar2 + 0x2ed) = (char)local_2c;
                    /* WARNING: Subroutine does not return */
    _printk(&DAT_00106251,"aw22xxx_task1_store",0x911,local_2c & 0xff);
  }
                    /* WARNING: Subroutine does not return */
  _printk(&DAT_00106353,"aw22xxx_task1_store",0x90c);
}



/* 00104164 aw22xxx_task_irq_show */
...
/* 001041a0 aw22xxx_task_irq_store */
...

{
  ...
  if (iVar1 == 1) {
    *(undefined4 *)(lVar2 + 0x2e8) = local_2c;
                    /* WARNING: Subroutine does not return */
    _printk(&DAT_00106d10,"aw22xxx_task_irq_store",0x92c);
  }
                    /* WARNING: Subroutine does not return */
  _printk(&DAT_00106353,"aw22xxx_task_irq_store",0x927);
}



/* 00104260 aw22xxx_para_show */
...
LAB_00104378:
                    /* WARNING: Does not return */
          pcVar1 = (code *)SoftwareBreakpoint(0x5512,0x10437c);
          (*pcVar1)();
        }
        lVar3 = lVar3 + iVar2;
      }
      else if (0xc34 < uVar4 >> 3) goto LAB_00104378;
...
/* 00104380 aw22xxx_para_store */

void aw22xxx_para_store(void)

{
                    /* WARNING: Subroutine does not return */
  _printk(&DAT_001068e0,"aw22xxx_para_store");
}



/* 001047d8 aw22xxx_multi_breath_pattern_show */
...
/* 00104814 aw22xxx_cfg_loaded */

void aw22xxx_cfg_loaded(void)

{
                    /* WARNING: Subroutine does not return */
  _printk(&DAT_00107cbc,"aw22xxx_cfg_loaded");
}



/* 001049f4 aw22xxx_set_cfg_run_state */

void aw22xxx_set_cfg_run_state(ulong param_1)

{
                    /* WARNING: Subroutine does not return */
  _printk(&DAT_00107c7b,"aw22xxx_set_cfg_run_state",param_1 >> 0x18 & 0xff);
}



/* 00104b10 aw22xxx_set_brightness */
...

{
  ...
  if (uVar1 < 0xb) {
    ...
    return sVar2;
                    ...
                    /* WARNING: Subroutine does not return */
  _printk(&DAT_0010720e,"aw22xxx_cfg_show",0x812);
}



/* 00104c7c aw22xxx_cfg_store */
...

{
  ...
  if (iVar1 != 1) {
                    /* WARNING: Subroutine does not return */
    _printk(&DAT_00106700,"aw22xxx_effect_store",0x850);
  }
  mutex_lock(lVar2 + 0x2a0);
  if ((local_54[0] - 8 < 3) && (init_flag == 1)) {
                    /* WARNING: Subroutine does not return */
    _printk(&DAT_001067c8,"aw22xxx_effect_store",0x857);
  }
  *(uint *)(lVar2 + 0x2f0) = local_54[0];
  if ((local_54[0] < 4) && ((local_54[0] != 1 && ((init_flag & 1) == 0)))) {
    init_flag = 1;
                    /* WARNING: Subroutine does not return */
    _printk(&DAT_00107238,"aw22xxx_effect_store",0x869);
  }
                    /* WARNING: Subroutine does not return */
  _printk(&DAT_00107b3a,"aw22xxx_effect_store",0x86c);
}



/* 00105050 aw22xxx_get_fwname */

void aw22xxx_get_fwname(ulong param_1)

{
                    /* WARNING: Subroutine does not return */
  _printk(&DAT_00107982,"aw22xxx_get_fwname",0x821,param_1 >> 0x18 & 0xff);
}



/* 0010524c aw22xxx_cfg_update_wait_from_dyn_name */
...

{
  ...
  uVar1 = sp_el0;
                    /* WARNING: Subroutine does not return */
  _printk(&DAT_00106ad5,"aw22xxx_cfg_update_wait_from_dyn_name");
}



/* 00105354 aw22xxx_multi_breath_pattern_store */
  ...
  if (iVar1 == 1) {
    ...
    *(int *)(lVar4 + 0x2f8) = local_3c;
    if (local_3c == 0) {
      ...
      uVar2 = kthread_create_on_node(aw22xxx_play,lVar3,0xffffffff,&DAT_00106d3a,"aw22xxx_play");
...
/* 001054e8 aw22xxx_fw_timer_func */

void aw22xxx_fw_timer_func(void)

{
                    /* WARNING: Subroutine does not return */
  _printk(&DAT_00106ad5,"aw22xxx_fw_timer_func");
}



/* 0010553c aw22xxx_fw_work_routine */

void aw22xxx_fw_work_routine(void)

{
                    /* WARNING: Subroutine does not return */
  _printk(&DAT_00106ad5,"aw22xxx_fw_work_routine");
}



/* 001055d0 aw22xxx_cfg_work_routine */

void aw22xxx_cfg_work_routine(void)

{
                    /* WARNING: Subroutine does not return */
  _printk(&DAT_00106ad5,"aw22xxx_cfg_work_routine");
}



/* 001056b8 aw22xxx_recover_work_routine */
...

{
  ...
  uVar1 = sp_el0;
                    /* WARNING: Subroutine does not return */
  _printk(&DAT_00106d5c,"aw22xxx_recover_work_routine");
}



/* 001058c4 aw22xxx_led_init */
...

{
  ...
  uVar1 = sp_el0;
                    /* WARNING: Subroutine does not return */
  _printk(&DAT_00106ad5,"aw22xxx_led_init");
}



/* 001059c4 FUN_001059c4 */

void FUN_001059c4(undefined8 param_1,long param_2)

{
                    /* WARNING: Subroutine does not return */
  _printk(param_1,param_2 + 0xa14,0x1aa,0);
}



/* 00105a54 aw22xxx_cfg_recover_update_wait */
...

{
  ...
  uVar1 = sp_el0;
                    /* WARNING: Subroutine does not return */
  _printk(&DAT_00106ad5,"aw22xxx_cfg_recover_update_wait");
}



/* 00105e20 get_aw22xxx_id */
...

{
  ...
  if (*in_x3 != 0) {
    return 0;
                    ...
                    /* WARNING: Subroutine does not return */
  _printk(&DAT_00106ffe,"get_aw22xxx_id",0x9b3,g_chip_id);
}



/* 0010e138 init_module */

void init_module(void)

{
                    /* WARNING: Subroutine does not return */
  _printk(&DAT_00106775,"v1.1.3");
}



/* 0010e1b4 cleanup_module */
