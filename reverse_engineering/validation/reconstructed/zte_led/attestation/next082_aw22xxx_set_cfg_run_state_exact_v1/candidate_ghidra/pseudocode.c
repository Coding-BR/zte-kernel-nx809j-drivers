...

{
  ...
  _printk(&DAT_00106aa5,"aw22xxx_fw_loaded");
}



/* 00101708 aw22xxx_init_cfg_update_array */
...

{
  ...
  uVar1 = sp_el0;
                    /* WARNING: Subroutine does not return */
  _printk(&DAT_001069d6,"aw22xxx_init_cfg_update_array",0x1ca);
}



/* 0010185c aw22xxx_set_breath_data */
...

{
  ...
  while( true ) {
    ...
    if (read_idx == write_idx) {
      ...
      queue_work_on(0x20,_system_wq,param_1 + 0x230);
                    /* WARNING: Subroutine does not return */
      _printk(&DAT_00107066,"aw22xxx_play");
    }
    if ((kthread_status & 1) == 0) break;
    if (25000 < (uint)(read_idx * 0x19)) {
                    /* WARNING: Does not return */
      pcVar1 = (code *)SoftwareBreakpoint(0x5512,0x101ab0);
      (*pcVar1)();
    }
  ...
  aw22xxx_i2c_write(param_1,2,0);
                    /* WARNING: Subroutine does not return */
  _printk(&DAT_00106cbb,"aw22xxx_play");
}



/* 00101ab4 aw22xxx_led_imax_cfg */
...

{
  ...
  *(undefined4 *)(param_1 + 0x2f0) = 7;
                    /* WARNING: Subroutine does not return */
  _printk(&DAT_001068bc,"aw22xxx_led_imax_cfg",
          *(undefined8 *)(aw22xxx_cfg_name + (ulong)*(uint *)(param_1 + 0x300) * 8),7);
}



/* 00101b24 aw22xxx_i2c_write */
...

{
  ...
  if (iVar2 < 0) {
    ...
    uVar3 = gpiod_get_raw_value();
                    /* WARNING: Subroutine does not return */
    _printk(&DAT_0010644b,"aw22xxx_i2c_write",0,iVar2,uVar3);
  }
  lVar1 = sp_el0;
...

{
  ...
  if (iVar2 < 0) {
    *unaff_x19 = (char)iVar2;
                    /* WARNING: Subroutine does not return */
    _printk(&DAT_001068df,"aw22xxx_i2c_read",iVar2);
  }
  lVar1 = sp_el0;
  if (*(long *)(lVar1 + 0x710) == in_stack_00000008) {
    return;
...
/* 00101d90 aw22xxx_i2c_probe */

void aw22xxx_i2c_probe(void)

{
                    /* WARNING: Subroutine does not return */
  _printk(&DAT_00107087,"aw22xxx_i2c_probe",0x9d9);
}



/* 0010207c FUN_0010207c */
...
/* 001020a8 FUN_001020a8 */

undefined4 FUN_001020a8(void)
...
/* 0010242c aw22xxx_i2c_remove */

void aw22xxx_i2c_remove(void)

{
                    /* WARNING: Subroutine does not return */
  _printk(&DAT_00106aa5,"aw22xxx_i2c_remove");
}



/* 001024f0 aw22xxx_hw_reset */

void aw22xxx_hw_reset(void)

{
                    /* WARNING: Subroutine does not return */
  _printk(&DAT_00106aa5,"aw22xxx_hw_reset");
}
...

{
  ...
  if (-1 < iVar2) {
    if (local_2c[0] == 'v') {
                    /* WARNING: Subroutine does not return */
      _printk(&DAT_00106db1,"aw22xxx_read_chipid",0x76,iVar2);
    }
                    /* WARNING: Subroutine does not return */
    _printk(&DAT_0010796f,"aw22xxx_read_chipid",local_2c[0],iVar2);
  }
...
/* 00102758 aw22xxx_interrupt_setup */
...

{
  ...
  uVar1 = sp_el0;
                    /* WARNING: Subroutine does not return */
  _printk(&DAT_00106aa5,"aw22xxx_interrupt_setup");
}



/* 00102860 aw22xxx_irq_v15 */
...

{
  ...
  uVar1 = sp_el0;
                    /* WARNING: Subroutine does not return */
  _printk(&DAT_00106aa5,"aw22xxx_irq");
}



/* 00102bac aw22xxx_parse_led_cdev */

void aw22xxx_parse_led_cdev(void)

{
                    /* WARNING: Subroutine does not return */
  _printk(&DAT_00106aa5,"aw22xxx_parse_led_cdev");
}



/* 00102db4 aw22xxx_alloc_name_array */
...

{
  ...
  if (aw22xxx_cfg_name == (undefined8 *)0x0) {
                    /* WARNING: Subroutine does not return */
    _printk(&DAT_001064ab,"aw22xxx_alloc_name_array",0x687);
  }
  lVar4 = 0;
  uVar1 = sp_el0;
  do {
    ...
    if (lVar2 == 0) {
      ...
      kfree(puVar3);
                    /* WARNING: Subroutine does not return */
      _printk(&DAT_001064ab,"aw22xxx_alloc_name_array",0x692);
    }
    lVar4 = lVar4 + 1;
  } while (lVar4 != 0xb);
  ...
  *(code **)(param_1 + 0x248) = aw22xxx_cfg_work_routine;
  if (bVar1) {
    ...
    *(code **)(param_1 + 0x268) = aw22xxx_recover_work_routine;
                    ...
                    /* WARNING: Subroutine does not return */
  _printk(&DAT_001065f4,"aw22xxx_fw_init");
}



/* 001030ec aw22xxx_create_proc_entry */
...

{
  ...
  if (lVar1 == 0) {
                    /* WARNING: Subroutine does not return */
    _printk(&DAT_00106e52);
  }
                    /* WARNING: Subroutine does not return */
  _printk(&DAT_0010775e,"aw22xxx_create_proc_entry",0x9c3);
}



/* 00103150 aw22xxx_brightness_work */
...

{
  ...
  uVar1 = sp_el0;
                    /* WARNING: Subroutine does not return */
  _printk(&DAT_00106aa5,"aw22xxx_brightness_work");
}



/* 001033a0 aw22xxx_task_work */
...

{
  ...
  uVar1 = sp_el0;
                    /* WARNING: Subroutine does not return */
  _printk(&DAT_00106aa5,"aw22xxx_task_work");
}



/* 00103604 aw22xxx_fw_show */
...

{
  ...
  FUN_00101ca0(lVar4,0xff,local_60);
  uVar5 = 0;
  lVar3 = 0;
  do {
    if ((local_60[0] != '\0') || (((&aw22xxx_reg_access)[uVar5] & 1) != 0)) {
      FUN_00101cd4(lVar4,uVar5 & 0xffffffff,local_5c);
...

{
  ...
  if ((iVar1 == 2) && ((uint)local_30 < 0x100)) {
    FUN_00101b70(lVar2 + -0x10,local_30 & 0xffffffff,local_30._4_4_);
    lVar2 = sp_el0;
    ...
    __stack_chk_fail();
                    ...
                    /* WARNING: Subroutine does not return */
  _printk(&DAT_001066d0,"aw22xxx_reg_store",0x78b);
}



/* 0010384c aw22xxx_hwen_show */
...

{
  ...
  if (iVar1 == 1) {
    if (local_3c < 2) {
      if (local_3c != 1) {
                    /* WARNING: Subroutine does not return */
        _printk(&DAT_00106aa5,"aw22xxx_hw_off");
      }
      FUN_00102570(lVar2 + -0x10);
      lVar2 = sp_el0;
      ...
      __stack_chk_fail();
                    ...
                    /* WARNING: Subroutine does not return */
  _printk(&DAT_001066d0,"aw22xxx_hwen_store",0x7b9);
}



/* 00103a34 aw22xxx_imax_show */
...

{
  ...
  if (uVar1 < 0xe) {
    ...
    return lVar5 + iVar3;
                    ...
                    /* WARNING: Does not return */
  pcVar2 = (code *)SoftwareBreakpoint(0x5512,0x103c1c);
  (*pcVar2)();
}



/* 00103c20 aw22xxx_imax_store */
...

{
  ...
  if ((iVar1 != 1) || (0xc < local_3c)) {
                    /* WARNING: Subroutine does not return */
    _printk(&DAT_001066d0,"aw22xxx_imax_store",0x8a7);
  }
  *(uint *)(lVar3 + 0x2e0) = local_3c;
  ...
  FUN_00101b60(lVar3,0xff,0);
  FUN_00101b60(lVar3,0xb,bVar2);
  lVar3 = sp_el0;
...

{
  ...
  if ((iVar1 == 2) && ((uint)local_30 < 9)) {
    *(undefined4 *)(lVar2 + (local_30 & 0xffffffff) * 4 + 0x2fc) = local_30._4_4_;
                    /* WARNING: Subroutine does not return */
    _printk(&DAT_0010641c,"aw22xxx_rgb_store",0x8d3);
  }
  lVar2 = sp_el0;
  if (*(long *)(lVar2 + 0x710) == local_28) {
...

{
  ...
  if (iVar1 == 1) {
    *(char *)(lVar2 + 0x2ec) = (char)local_2c;
                    /* WARNING: Subroutine does not return */
    _printk(&DAT_001069a7,"aw22xxx_task0_store",0x8f4,local_2c & 0xff);
  }
                    /* WARNING: Subroutine does not return */
  _printk(&DAT_00106323,"aw22xxx_task0_store",0x8ef);
}



/* 0010402c aw22xxx_task1_show */
...

{
  ...
  if (iVar1 == 1) {
    *(char *)(lVar2 + 0x2ed) = (char)local_2c;
                    /* WARNING: Subroutine does not return */
    _printk(&DAT_00106221,"aw22xxx_task1_store",0x911,local_2c & 0xff);
  }
                    /* WARNING: Subroutine does not return */
  _printk(&DAT_00106323,"aw22xxx_task1_store",0x90c);
}



/* 0010412c aw22xxx_task_irq_show */
...
/* 00104168 aw22xxx_task_irq_store */
...

{
  ...
  if (iVar1 == 1) {
    *(undefined4 *)(lVar2 + 0x2e8) = local_2c;
                    /* WARNING: Subroutine does not return */
    _printk(&DAT_00106ce0,"aw22xxx_task_irq_store",0x92c);
  }
                    /* WARNING: Subroutine does not return */
  _printk(&DAT_00106323,"aw22xxx_task_irq_store",0x927);
}



/* 00104228 aw22xxx_para_show */
...
LAB_00104340:
                    /* WARNING: Does not return */
          pcVar1 = (code *)SoftwareBreakpoint(0x5512,0x104344);
          (*pcVar1)();
        }
        lVar3 = lVar3 + iVar2;
      }
      else if (0xc34 < uVar4 >> 3) goto LAB_00104340;
...
/* 00104348 aw22xxx_para_store */

void aw22xxx_para_store(void)

{
                    /* WARNING: Subroutine does not return */
  _printk(&DAT_001068b0,"aw22xxx_para_store");
}



/* 001047a0 aw22xxx_multi_breath_pattern_show */
...
/* 001047dc aw22xxx_cfg_loaded */

void aw22xxx_cfg_loaded(void)

{
                    /* WARNING: Subroutine does not return */
  _printk(&DAT_00107c25,"aw22xxx_cfg_loaded");
}



/* 001049bc aw22xxx_set_brightness */
...

{
  ...
  if (uVar1 < 0xb) {
    ...
    return sVar2;
                    ...
                    /* WARNING: Subroutine does not return */
  _printk(&DAT_001071de,"aw22xxx_cfg_show",0x812);
}



/* 00104b28 aw22xxx_cfg_store */
...

{
  ...
  if (iVar1 == 1) {
    *(byte *)(lVar2 + 0x2f4) = (byte)local_2c & 0xf;
                    /* WARNING: Subroutine does not return */
    _printk(&DAT_0010684e,"aw22xxx_cfg_store",0x7f6);
  }
                    /* WARNING: Subroutine does not return */
  _printk(&DAT_001073fb,"aw22xxx_cfg_store",0x7f0);
}



/* 00104bec aw22xxx_effect_show */
...

{
  ...
  if (iVar1 != 1) {
                    /* WARNING: Subroutine does not return */
    _printk(&DAT_001066d0,"aw22xxx_effect_store",0x850);
  }
  mutex_lock(lVar2 + 0x2a0);
  if ((local_54[0] - 8 < 3) && (init_flag == 1)) {
                    /* WARNING: Subroutine does not return */
    _printk(&DAT_00106798,"aw22xxx_effect_store",0x857);
  }
  *(uint *)(lVar2 + 0x2f0) = local_54[0];
  if ((local_54[0] < 4) && ((local_54[0] != 1 && ((init_flag & 1) == 0)))) {
    init_flag = 1;
                    /* WARNING: Subroutine does not return */
    _printk(&DAT_00107208,"aw22xxx_effect_store",0x869);
  }
                    /* WARNING: Subroutine does not return */
  _printk(&DAT_00107b0a,"aw22xxx_effect_store",0x86c);
}



/* 00104efc aw22xxx_get_fwname */

void aw22xxx_get_fwname(ulong param_1)

{
                    /* WARNING: Subroutine does not return */
  _printk(&DAT_00107952,"aw22xxx_get_fwname",0x821,param_1 >> 0x18 & 0xff);
}



/* 001050f8 aw22xxx_cfg_update_wait_from_dyn_name */
...

{
  ...
  uVar1 = sp_el0;
                    /* WARNING: Subroutine does not return */
  _printk(&DAT_00106aa5,"aw22xxx_cfg_update_wait_from_dyn_name");
}



/* 001051fc aw22xxx_set_cfg_run_state */

void aw22xxx_set_cfg_run_state(ulong param_1)

{
                    /* WARNING: Subroutine does not return */
  _printk(&DAT_00106ae9,"aw22xxx_set_cfg_run_state",0x74d,param_1 >> 0x18 & 0xff);
}



/* 00105320 aw22xxx_multi_breath_pattern_store */
  ...
  if (iVar1 == 1) {
    ...
    *(int *)(lVar4 + 0x2f8) = local_3c;
    if (local_3c == 0) {
      ...
      uVar2 = kthread_create_on_node(aw22xxx_play,lVar3,0xffffffff,&DAT_00106d0a,"aw22xxx_play");
...
/* 001054b4 aw22xxx_fw_timer_func */

void aw22xxx_fw_timer_func(void)

{
                    /* WARNING: Subroutine does not return */
  _printk(&DAT_00106aa5,"aw22xxx_fw_timer_func");
}



/* 00105508 aw22xxx_fw_work_routine */

void aw22xxx_fw_work_routine(void)

{
                    /* WARNING: Subroutine does not return */
  _printk(&DAT_00106aa5,"aw22xxx_fw_work_routine");
}



/* 0010559c aw22xxx_cfg_work_routine */

void aw22xxx_cfg_work_routine(void)

{
                    /* WARNING: Subroutine does not return */
  _printk(&DAT_00106aa5,"aw22xxx_cfg_work_routine");
}



/* 00105684 aw22xxx_recover_work_routine */
...

{
  ...
  uVar1 = sp_el0;
                    /* WARNING: Subroutine does not return */
  _printk(&DAT_00106d2c,"aw22xxx_recover_work_routine");
}



/* 00105890 aw22xxx_led_init */
...

{
  ...
  uVar1 = sp_el0;
                    /* WARNING: Subroutine does not return */
  _printk(&DAT_00106aa5,"aw22xxx_led_init");
}



/* 00105990 FUN_00105990 */

void FUN_00105990(undefined8 param_1,long param_2)

{
                    /* WARNING: Subroutine does not return */
  _printk(param_1,param_2 + 0x9e4,0x1aa,0);
}



/* 00105a20 aw22xxx_cfg_recover_update_wait */
...

{
  ...
  uVar1 = sp_el0;
                    /* WARNING: Subroutine does not return */
  _printk(&DAT_00106aa5,"aw22xxx_cfg_recover_update_wait");
}



/* 00105dec get_aw22xxx_id */
...

{
  ...
  if (*in_x3 != 0) {
    return 0;
                    ...
                    /* WARNING: Subroutine does not return */
  _printk(&DAT_00106fce,"get_aw22xxx_id",0x9b3,g_chip_id);
}



/* 0010e09c init_module */

void init_module(void)

{
                    /* WARNING: Subroutine does not return */
  _printk(&DAT_00106745,"v1.1.3");
}



/* 0010e118 cleanup_module */
