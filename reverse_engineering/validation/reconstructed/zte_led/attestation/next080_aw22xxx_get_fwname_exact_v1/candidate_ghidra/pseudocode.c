...

{
  ...
  _printk(&DAT_00106b1d,"aw22xxx_fw_loaded");
}



/* 00101770 aw22xxx_init_cfg_update_array */
...

{
  ...
  uVar1 = sp_el0;
                    /* WARNING: Subroutine does not return */
  _printk(&DAT_00106a4e,"aw22xxx_init_cfg_update_array",0x1ca);
}



/* 001018c4 aw22xxx_set_breath_data */
...

{
  ...
  while( true ) {
    ...
    if (read_idx == write_idx) {
      ...
      queue_work_on(0x20,_system_wq,param_1 + 0x230);
                    /* WARNING: Subroutine does not return */
      _printk(&DAT_001070de,"aw22xxx_play");
    }
    if ((kthread_status & 1) == 0) break;
    if (25000 < (uint)(read_idx * 0x19)) {
                    /* WARNING: Does not return */
      pcVar1 = (code *)SoftwareBreakpoint(0x5512,0x101b18);
      (*pcVar1)();
    }
  ...
  aw22xxx_i2c_write(param_1,2,0);
                    /* WARNING: Subroutine does not return */
  _printk(&DAT_00106d33,"aw22xxx_play");
}



/* 00101b1c aw22xxx_led_imax_cfg */
...

{
  ...
  *(undefined4 *)(param_1 + 0x2f0) = 7;
                    /* WARNING: Subroutine does not return */
  _printk(&DAT_00106934,"aw22xxx_led_imax_cfg",
          *(undefined8 *)(aw22xxx_cfg_name + (ulong)*(uint *)(param_1 + 0x300) * 8),7);
}



/* 00101b8c aw22xxx_i2c_write */
...

{
  ...
  if (iVar2 < 0) {
    ...
    uVar3 = gpiod_get_raw_value();
                    /* WARNING: Subroutine does not return */
    _printk(&DAT_001064c3,"aw22xxx_i2c_write",0,iVar2,uVar3);
  }
  lVar1 = sp_el0;
...

{
  ...
  if (iVar2 < 0) {
    *unaff_x19 = (char)iVar2;
                    /* WARNING: Subroutine does not return */
    _printk(&DAT_00106957,"aw22xxx_i2c_read",iVar2);
  }
  lVar1 = sp_el0;
  if (*(long *)(lVar1 + 0x710) == in_stack_00000008) {
    return;
...
/* 00101df8 aw22xxx_i2c_probe */

void aw22xxx_i2c_probe(void)

{
                    /* WARNING: Subroutine does not return */
  _printk(&DAT_001070ff,"aw22xxx_i2c_probe",0x9d9);
}



/* 001020e4 FUN_001020e4 */

undefined8 FUN_001020e4(void)
...
/* 00102110 FUN_00102110 */

undefined4 FUN_00102110(void)
...
/* 00102494 aw22xxx_i2c_remove */

void aw22xxx_i2c_remove(void)

{
                    /* WARNING: Subroutine does not return */
  _printk(&DAT_00106b1d,"aw22xxx_i2c_remove");
}



/* 00102558 aw22xxx_hw_reset */

void aw22xxx_hw_reset(void)

{
                    /* WARNING: Subroutine does not return */
  _printk(&DAT_00106b1d,"aw22xxx_hw_reset");
}



/* 001025d8 FUN_001025d8 */

void FUN_001025d8(void)
...

{
  ...
  if (-1 < iVar2) {
    if (local_2c[0] == 'v') {
                    /* WARNING: Subroutine does not return */
      _printk(&DAT_00106e29,"aw22xxx_read_chipid",0x76,iVar2);
    }
                    /* WARNING: Subroutine does not return */
    _printk(&DAT_001079e7,"aw22xxx_read_chipid",local_2c[0],iVar2);
  }
...
/* 001027c0 aw22xxx_interrupt_setup */
...

{
  ...
  uVar1 = sp_el0;
                    /* WARNING: Subroutine does not return */
  _printk(&DAT_00106b1d,"aw22xxx_interrupt_setup");
}



/* 001028c8 aw22xxx_irq_v15 */
...

{
  ...
  aw22xxx_i2c_read(param_2,10,local_44);
                    /* WARNING: Subroutine does not return */
  _printk(&DAT_001065c7,"aw22xxx_irq_v15",local_44[0]);
}



/* 00102b10 aw22xxx_irq */
...

{
  ...
  uVar1 = sp_el0;
                    /* WARNING: Subroutine does not return */
  _printk(&DAT_00106b1d,"aw22xxx_irq");
}



/* 00102c14 aw22xxx_parse_led_cdev */

void aw22xxx_parse_led_cdev(void)

{
                    /* WARNING: Subroutine does not return */
  _printk(&DAT_00106b1d,"aw22xxx_parse_led_cdev");
}



/* 00102e1c aw22xxx_alloc_name_array */
...

{
  ...
  if (aw22xxx_cfg_name == (undefined8 *)0x0) {
                    /* WARNING: Subroutine does not return */
    _printk(&DAT_00106523,"aw22xxx_alloc_name_array",0x687);
  }
  lVar4 = 0;
  uVar1 = sp_el0;
  do {
    ...
    if (lVar2 == 0) {
      ...
      kfree(puVar3);
                    /* WARNING: Subroutine does not return */
      _printk(&DAT_00106523,"aw22xxx_alloc_name_array",0x692);
    }
    lVar4 = lVar4 + 1;
  } while (lVar4 != 0xb);
  ...
  *(code **)(param_1 + 0x248) = aw22xxx_cfg_work_routine;
  if (bVar1) {
    ...
    *(code **)(param_1 + 0x268) = aw22xxx_recover_work_routine;
                    ...
                    /* WARNING: Subroutine does not return */
  _printk(&DAT_0010666c,"aw22xxx_fw_init");
}



/* 00103154 aw22xxx_create_proc_entry */
...
/* 001031b8 aw22xxx_brightness_work */
...

{
  ...
  uVar1 = sp_el0;
                    /* WARNING: Subroutine does not return */
  _printk(&DAT_00106b1d,"aw22xxx_brightness_work");
}



/* 00103408 aw22xxx_task_work */
...

{
  ...
  uVar1 = sp_el0;
                    /* WARNING: Subroutine does not return */
  _printk(&DAT_00106b1d,"aw22xxx_task_work");
}



/* 0010366c aw22xxx_fw_show */
...

{
  ...
  FUN_00101d08(lVar4,0xff,local_60);
  uVar5 = 0;
  lVar3 = 0;
  do {
    if ((local_60[0] != '\0') || (((&aw22xxx_reg_access)[uVar5] & 1) != 0)) {
      FUN_00101d3c(lVar4,uVar5 & 0xffffffff,local_5c);
...

{
  ...
  if ((iVar1 == 2) && ((uint)local_30 < 0x100)) {
    FUN_00101bd8(lVar2 + -0x10,local_30 & 0xffffffff,local_30._4_4_);
    lVar2 = sp_el0;
    ...
    __stack_chk_fail();
                    ...
                    /* WARNING: Subroutine does not return */
  _printk(&DAT_00106748,"aw22xxx_reg_store",0x78b);
}



/* 001038b4 aw22xxx_hwen_show */
...

{
  ...
  if (iVar1 == 1) {
    if (local_3c < 2) {
      if (local_3c != 1) {
                    /* WARNING: Subroutine does not return */
        _printk(&DAT_00106b1d,"aw22xxx_hw_off");
      }
      FUN_001025d8(lVar2 + -0x10);
      lVar2 = sp_el0;
      ...
      __stack_chk_fail();
                    ...
                    /* WARNING: Subroutine does not return */
  _printk(&DAT_00106748,"aw22xxx_hwen_store",0x7b9);
}



/* 00103a9c aw22xxx_imax_show */
...

{
  ...
  if (uVar1 < 0xe) {
    ...
    return lVar5 + iVar3;
                    ...
                    /* WARNING: Does not return */
  pcVar2 = (code *)SoftwareBreakpoint(0x5512,0x103c84);
  (*pcVar2)();
}



/* 00103c88 aw22xxx_imax_store */
...

{
  ...
  if ((iVar1 != 1) || (0xc < local_3c)) {
                    /* WARNING: Subroutine does not return */
    _printk(&DAT_00106748,"aw22xxx_imax_store",0x8a7);
  }
  *(uint *)(lVar3 + 0x2e0) = local_3c;
  ...
  FUN_00101bc8(lVar3,0xff,0);
  FUN_00101bc8(lVar3,0xb,bVar2);
  lVar3 = sp_el0;
...

{
  ...
  if ((iVar1 == 2) && ((uint)local_30 < 9)) {
    *(undefined4 *)(lVar2 + (local_30 & 0xffffffff) * 4 + 0x2fc) = local_30._4_4_;
                    /* WARNING: Subroutine does not return */
    _printk(&DAT_00106494,"aw22xxx_rgb_store",0x8d3);
  }
  lVar2 = sp_el0;
  if (*(long *)(lVar2 + 0x710) == local_28) {
...

{
  ...
  if (iVar1 == 1) {
    *(char *)(lVar2 + 0x2ec) = (char)local_2c;
                    /* WARNING: Subroutine does not return */
    _printk(&DAT_00106a1f,"aw22xxx_task0_store",0x8f4,local_2c & 0xff);
  }
                    /* WARNING: Subroutine does not return */
  _printk(&DAT_0010639b,"aw22xxx_task0_store",0x8ef);
}



/* 00104094 aw22xxx_task1_show */
...

{
  ...
  if (iVar1 == 1) {
    *(char *)(lVar2 + 0x2ed) = (char)local_2c;
                    /* WARNING: Subroutine does not return */
    _printk(&DAT_00106299,"aw22xxx_task1_store",0x911,local_2c & 0xff);
  }
                    /* WARNING: Subroutine does not return */
  _printk(&DAT_0010639b,"aw22xxx_task1_store",0x90c);
}



/* 00104194 aw22xxx_task_irq_show */
...
/* 001041d0 aw22xxx_task_irq_store */
...

{
  ...
  if (iVar1 == 1) {
    *(undefined4 *)(lVar2 + 0x2e8) = local_2c;
                    /* WARNING: Subroutine does not return */
    _printk(&DAT_00106d58,"aw22xxx_task_irq_store",0x92c);
  }
                    /* WARNING: Subroutine does not return */
  _printk(&DAT_0010639b,"aw22xxx_task_irq_store",0x927);
}



/* 00104290 aw22xxx_para_show */
...
LAB_001043a8:
                    /* WARNING: Does not return */
          pcVar1 = (code *)SoftwareBreakpoint(0x5512,0x1043ac);
          (*pcVar1)();
        }
        lVar3 = lVar3 + iVar2;
      }
      else if (0xc34 < uVar4 >> 3) goto LAB_001043a8;
...
/* 001043b0 aw22xxx_para_store */

void aw22xxx_para_store(void)

{
                    /* WARNING: Subroutine does not return */
  _printk(&DAT_00106928,"aw22xxx_para_store");
}



/* 00104808 aw22xxx_multi_breath_pattern_show */
...
/* 00104844 aw22xxx_cfg_loaded */

void aw22xxx_cfg_loaded(void)

{
                    /* WARNING: Subroutine does not return */
  _printk(&DAT_00107d44,"aw22xxx_cfg_loaded");
}



/* 00104a24 aw22xxx_cfg_update_wait_from_dyn_name */
...

{
  ...
  uVar1 = sp_el0;
                    /* WARNING: Subroutine does not return */
  _printk(&DAT_00107d44,"aw22xxx_cfg_update_wait_from_dyn_name");
}



/* 00104b40 aw22xxx_set_cfg_run_state */

void aw22xxx_set_cfg_run_state(ulong param_1)

{
                    /* WARNING: Subroutine does not return */
  _printk(&DAT_00107cdd,"aw22xxx_set_cfg_run_state",param_1 >> 0x18 & 0xff);
}



/* 00104c5c aw22xxx_set_brightness */
...

{
  ...
  if (uVar1 < 0xb) {
    ...
    return sVar2;
                    ...
                    /* WARNING: Subroutine does not return */
  _printk(&DAT_00107256,"aw22xxx_cfg_show",0x812);
}



/* 00104dc8 aw22xxx_cfg_store */
...

{
  ...
  if (iVar1 == 1) {
    *(byte *)(lVar2 + 0x2f4) = (byte)local_2c & 0xf;
                    /* WARNING: Subroutine does not return */
    _printk(&DAT_001068c6,"aw22xxx_cfg_store",0x7f6);
  }
                    /* WARNING: Subroutine does not return */
  _printk(&DAT_00107473,"aw22xxx_cfg_store",0x7f0);
}



/* 00104e8c aw22xxx_effect_show */
...

{
  ...
  if (iVar1 != 1) {
                    /* WARNING: Subroutine does not return */
    _printk(&DAT_00106748,"aw22xxx_effect_store",0x850);
  }
  mutex_lock(lVar2 + 0x2a0);
  if ((local_54[0] - 8 < 3) && (init_flag == 1)) {
                    /* WARNING: Subroutine does not return */
    _printk(&DAT_00106810,"aw22xxx_effect_store",0x857);
  }
  *(uint *)(lVar2 + 0x2f0) = local_54[0];
  if ((local_54[0] < 4) && ((local_54[0] != 1 && ((init_flag & 1) == 0)))) {
    init_flag = 1;
                    /* WARNING: Subroutine does not return */
    _printk(&DAT_00107280,"aw22xxx_effect_store",0x869);
  }
                    /* WARNING: Subroutine does not return */
  _printk(&DAT_00107b82,"aw22xxx_effect_store",0x86c);
}



/* 0010519c aw22xxx_get_fwname */

void aw22xxx_get_fwname(ulong param_1)

{
                    /* WARNING: Subroutine does not return */
  _printk(&DAT_001079ca,"aw22xxx_get_fwname",0x821,param_1 >> 0x18 & 0xff);
}



/* 0010539c aw22xxx_multi_breath_pattern_store */
  ...
  if (iVar1 == 1) {
    ...
    *(int *)(lVar4 + 0x2f8) = local_3c;
    if (local_3c == 0) {
      ...
      uVar2 = kthread_create_on_node(aw22xxx_play,lVar3,0xffffffff,&DAT_00106d82,"aw22xxx_play");
...
/* 00105530 aw22xxx_fw_timer_func */

void aw22xxx_fw_timer_func(void)

{
                    /* WARNING: Subroutine does not return */
  _printk(&DAT_00106b1d,"aw22xxx_fw_timer_func");
}



/* 00105584 aw22xxx_fw_work_routine */

void aw22xxx_fw_work_routine(void)

{
                    /* WARNING: Subroutine does not return */
  _printk(&DAT_00106b1d,"aw22xxx_fw_work_routine");
}



/* 00105618 aw22xxx_cfg_work_routine */

void aw22xxx_cfg_work_routine(void)

{
                    /* WARNING: Subroutine does not return */
  _printk(&DAT_00106b1d,"aw22xxx_cfg_work_routine");
}



/* 00105700 aw22xxx_recover_work_routine */
...

{
  ...
  uVar1 = sp_el0;
                    /* WARNING: Subroutine does not return */
  _printk(&DAT_00106da4,"aw22xxx_recover_work_routine");
}



/* 0010590c aw22xxx_led_init */
...

{
  ...
  uVar1 = sp_el0;
                    /* WARNING: Subroutine does not return */
  _printk(&DAT_00106b1d,"aw22xxx_led_init");
}



/* 00105a0c FUN_00105a0c */

void FUN_00105a0c(undefined8 param_1,long param_2)

{
                    /* WARNING: Subroutine does not return */
  _printk(param_1,param_2 + 0xa5c,0x1aa,0);
}



/* 00105a9c aw22xxx_cfg_recover_update_wait */
...

{
  ...
  uVar1 = sp_el0;
                    /* WARNING: Subroutine does not return */
  _printk(&DAT_00106b1d,"aw22xxx_cfg_recover_update_wait");
}



/* 00105e68 get_aw22xxx_id */
...

{
  ...
  if (*in_x3 != 0) {
    return 0;
                    ...
                    /* WARNING: Subroutine does not return */
  _printk(&DAT_00107046,"get_aw22xxx_id",0x9b3,g_chip_id);
}



/* 0010e1c0 init_module */

void init_module(void)

{
                    /* WARNING: Subroutine does not return */
  _printk(&DAT_001067bd,"v1.1.3");
}



/* 0010e23c cleanup_module */
