...

{
  ...
  uStack_80 = 0;
  local_94[0] = '\0';
  _printk(&DAT_00106fcd,"aw22xxx_fw_loaded");
  if (param_1 == (ulong *)0x0) {
    _printk(&DAT_00106d37,"aw22xxx_fw_loaded",&aw22xxx_fw_name);
    release_firmware(0);
  }
  else {
    _printk(&DAT_00106a0e,"aw22xxx_fw_loaded",&aw22xxx_fw_name,*param_1);
    uVar1 = *param_1;
    ...
    if (uVar1 < 3) {
      ...
      if (uVar15 < 2) {
        ...
        if (((uVar17 < 0x7ffffffe) && (uVar12 = 0, uVar17 < 0x7ffffffd)) && (uVar1 - 3 >> 0x20 == 0)
          ...
          if (uVar15 == uVar18) goto LAB_001012e8;
        }
      }
      do {
        iVar14 = iVar14 + 1;
...
LAB_001012e8:
    if (uVar12 == (ushort)(*puVar2 >> 8 | *puVar2 << 8)) {
      _printk(&DAT_00107054,"aw22xxx_fw_loaded");
      uVar15 = *param_1;
      uVar1 = uVar15 + 0x10;
      ...
      if (puVar7 == (uint *)0x0) {
        ...
        _printk(&DAT_00107681,"aw22xxx_fw_loaded",*(undefined1 *)(param_1[1] + 2));
        local_88 = *(undefined8 *)(param_1[1] + 3);
        uStack_80 = *(undefined8 *)(param_1[1] + 0xb);
        _printk(&DAT_00106b37,"aw22xxx_fw_loaded",&local_88);
        local_88 = *(undefined8 *)(param_1[1] + 0x13);
        _printk(&DAT_00107a79,"aw22xxx_fw_loaded",&local_88);
        if ((uVar1 < 4) || ((uVar1 & 0xfffffffffffffffc) == 4)) {
LAB_00101e28:
                    /* WARNING: Does not return */
          pcVar6 = (code *)SoftwareBreakpoint(1,0x101e2c);
          (*pcVar6)();
        }
        uVar17 = (*(uint *)(param_1[1] + 0x1b) & 0xff00ff00) >> 8 |
                 (*(uint *)(param_1[1] + 0x1b) & 0xff00ff) << 8;
        puVar7[1] = uVar17 >> 0x10 | uVar17 << 0x10;
        _printk(&DAT_00107d4f,"aw22xxx_fw_loaded");
        if ((uVar1 < 8) || ((uVar1 & 0xfffffffffffffffc) == 8)) goto LAB_00101e28;
        puVar7[2] = (uint)(*(ushort *)(param_1[1] + 0x22) >> 8) |
                    (*(ushort *)(param_1[1] + 0x22) & 0xff00ff) << 8;
        _printk(&DAT_00107998,"aw22xxx_fw_loaded");
        if ((uVar1 < 0xc) || ((uVar1 & 0xfffffffffffffffc) == 0xc)) goto LAB_00101e28;
        puVar7[3] = (uint)*(byte *)(param_1[1] + 0x24);
        _printk(&DAT_00108082,"aw22xxx_fw_loaded");
        *puVar7 = (uint)(*(ushort *)(param_1[1] + 0x26) >> 8) |
                  (*(ushort *)(param_1[1] + 0x26) & 0xff00ff) << 8;
        _printk(&DAT_00107a8f,"aw22xxx_fw_loaded");
        uVar11 = 0;
        if (0xf < uVar1) {
          uVar11 = uVar15;
        }
        ...
        release_firmware(param_1);
        FUN_00102264(param_2,1,0x55);
        usleep_range_state(2000,3000,2);
        _printk(&DAT_00107b7c,"aw22xxx_chip_enable",0x1aa,1);
        local_8c[0] = 0;
        FUN_001023a4(param_2,2,local_8c);
        local_8c[0] = local_8c[0] | 1;
        FUN_001022bc(param_2,2);
        usleep_range_state(2000,3000,2);
        local_8c[0] = 0;
        FUN_001023d8(param_2,4,local_8c);
        local_8c[0] = local_8c[0] | 1;
        aw22xxx_i2c_write(param_2,4);
        aw22xxx_i2c_write(param_2,0x22,*puVar7 + 0xffff >> 8);
        FUN_00102264(param_2,0x21,(byte)*puVar7 - 1);
        aw22xxx_i2c_write(param_2,0x24,7);
        usleep_range_state(5000,0x1964,2);
        FUN_00102458(param_2,0x24,local_94);
        if (local_94[0] == '\x05') {
          FUN_00102464(param_2,0x25,local_94);
          cVar5 = local_94[0];
          FUN_00102388(param_2,0x26,local_94);
          if ((uVar1 < 8) || ((uVar1 & 0xfffffffffffffffc) == 8)) goto LAB_00101e28;
          if ((uint)CONCAT11(local_94[0],cVar5) == puVar7[2]) {
            _printk(&DAT_00107b3a,"aw22xxx_fw_loaded",(uint)CONCAT11(local_94[0],cVar5));
            if (*(char *)((long)param_2 + 0x2ee) == '\0') {
              kfree(puVar7);
              FUN_00102664(param_2,0x24,0);
                    /* WARNING: Subroutine does not return */
              __stack_chk_fail(param_2);
            }
            if ((uVar1 & 0xfffffffffffffffc) == 4) goto LAB_00101e28;
            uVar17 = puVar7[1];
            puVar9 = &DAT_00107112;
          }
          else {
            _printk(&DAT_001079b0,"aw22xxx_fw_loaded");
            if ((uVar1 & 0xfffffffffffffffc) == 4) goto LAB_00101e28;
            uVar17 = puVar7[1];
            puVar9 = &DAT_001074a2;
          }
          ...
          _printk(&DAT_0010769c,"aw22xxx_fw_loaded");
          _printk(&DAT_00107aa6,"aw22xxx_fw_loaded");
        }
        FUN_0010265c(param_2,0x24,0);
        local_90[0] = '\0';
        FUN_00102684(param_2,0xff,0);
        FUN_00102654(param_2,1,0x55);
        usleep_range_state(2000,3000,2);
        _printk(&DAT_00107b7c,"aw22xxx_chip_enable",0x1aa,1);
        local_8c[0] = 0;
        FUN_00102784(param_2,2,local_8c);
        local_8c[0] = local_8c[0] | 1;
        FUN_0010265c(param_2,2);
        usleep_range_state(2000,3000,2);
        local_8c[0] = 0;
        FUN_00102788(param_2,4,local_8c);
        local_8c[0] = local_8c[0] | 1;
        FUN_00102664(param_2,4);
        FUN_00102654(param_2,0x80,0xec);
        FUN_00102844(param_2,0x35,0x29);
        if ((uVar1 < 0xc) || ((uVar1 & 0xfffffffffffffffc) == 0xc)) goto LAB_00101e28;
        FUN_0010265c(param_2,0x38,puVar7[3]);
        FUN_0010267c(param_2,0x22,0);
        FUN_0010267c(param_2,0x21,0);
        FUN_0010265c(param_2,0x20,3);
        FUN_0010265c(param_2,0x30,3);
        ...
        FUN_00102654(param_2,0x30,0);
        FUN_00102684(param_2,0x22,0x40);
        FUN_00102654(param_2,0x21,0);
        FUN_00102664(param_2,0x30,2);
        thunk_FUN_001027ac(param_2,0x23,0);
        usleep_range_state(6000,0x1964,2);
        FUN_0010265c(param_2,0x30,0);
        FUN_0010265c(param_2,0x22,0x42);
        FUN_0010267c(param_2,0x21,0);
        FUN_0010267c(param_2,0x30,2);
        FUN_0010265c(param_2,0x23,0);
        usleep_range_state(6000,0x1964,2);
        FUN_001026bc(param_2,0x30,0);
        FUN_001026bc(param_2,0x22,0x44);
        FUN_0010265c(param_2,0x21,0);
        FUN_0010265c(param_2,0x30,2);
        FUN_0010267c(param_2,0x23,0);
        usleep_range_state(6000,0x1964,2);
        FUN_0010265c(param_2,0x30,0);
        FUN_0010265c(param_2,0x20,0);
        FUN_0010263c(param_2,0x20,3);
        if (*puVar7 != 0) {
          uVar17 = 0;
          uVar4 = sp_el0;
          do {
            aw22xxx_i2c_write(param_2,0x22,uVar17 >> 8);
            FUN_00102264(param_2,0x21,uVar17);
            aw22xxx_i2c_write(param_2,0x11,1);
            FUN_00102444(param_2,0x30,4);
              ...
              *puVar8 = 0x23;
              if (uVar11 < uVar15) {
                ...
                if (uVar15 <= uVar18) {
                  ...
                  if (iVar14 < 0) {
                    _printk(&DAT_00107073,"aw22xxx_i2c_writes");
                  }
                  kfree(puVar8);
                  goto LAB_00101be0;
                }
            ...
            _printk(&DAT_00107235,"aw22xxx_i2c_writes");
LAB_00101be0:
            FUN_00102264(param_2,0x11,0);
        ...
        _printk(&DAT_00107b7c,"aw22xxx_chip_enable",0x1aa,1);
        local_8c[0] = 0;
        FUN_001027a4(param_2,2,local_8c);
        local_8c[0] = local_8c[0] | 1;
        FUN_001022bc(param_2,2);
        usleep_range_state(2000,3000,2);
        local_8c[0] = 0;
        FUN_001027d8(param_2,4,local_8c);
        local_8c[0] = local_8c[0] | 1;
        aw22xxx_i2c_write(param_2,4);
        aw22xxx_i2c_write(param_2,0x22,*puVar7 + 0xffff >> 8);
        FUN_00102264(param_2,0x21,(byte)*puVar7 - 1);
        aw22xxx_i2c_write(param_2,0x24,7);
        usleep_range_state(5000,0x1964,2);
        FUN_00102758(param_2,0x24,local_90);
        if (local_90[0] == '\x05') {
          FUN_00102764(param_2,0x25,local_90);
          cVar5 = local_90[0];
          FUN_00102388(param_2,0x26,local_90);
          if ((uVar1 < 8) || ((uVar1 & 0xfffffffffffffffc) == 8)) goto LAB_00101e28;
          if ((uint)CONCAT11(local_90[0],cVar5) == puVar7[2]) {
            puVar9 = &DAT_00107b3a;
            goto LAB_00101d3c;
          }
          _printk(&DAT_00106b4e,"aw22xxx_container_update",puVar7[2]);
          _printk(&DAT_00107abc,"aw22xxx_container_update");
          uVar10 = 3;
        }
        else {
          puVar9 = &DAT_0010769c;
...
/* 00101e38 aw22xxx_init_cfg_update_array */
...

{
  ...
  _printk(&DAT_00106efe,"aw22xxx_init_cfg_update_array",0x1ca);
  _printk(&DAT_00107b7c,"aw22xxx_chip_enable",0x1aa,1);
  local_2c[0] = 0;
...
/* 00101f8c aw22xxx_set_breath_data */
...

{
  ...
  while( true ) {
    ...
    if (read_idx == write_idx) {
      ...
      _printk(&DAT_0010758e,"aw22xxx_play");
    }
    if (((byte)kthread_status & 1) == 0) {
      ...
      _printk(&DAT_001071e3,"aw22xxx_play");
    }
    ...
    read_idx = read_idx + 1;
                    ...
                    /* WARNING: Does not return */
  pcVar1 = (code *)SoftwareBreakpoint(0x5512,0x1021e0);
  (*pcVar1)();
}



/* 001021e4 aw22xxx_led_imax_cfg */
...

{
  ...
  *(undefined4 *)(param_1 + 0x2f0) = 7;
  _printk(&DAT_00106de4,"aw22xxx_led_imax_cfg",
...

{
  ...
  if (iVar2 < 0) {
    ...
    _printk(&DAT_00106973,"aw22xxx_i2c_write",0,iVar2,uVar3);
    msleep(1);
    iVar2 = i2c_transfer_buffer_flags(*param_1,&uStack_3c,2,0);
    if (iVar2 < 0) {
      gpio_to_desc(*(undefined4 *)(param_1 + 0x5c));
      uVar3 = gpiod_get_raw_value();
      _printk(&DAT_00106973,"aw22xxx_i2c_write",1,iVar2,uVar3);
      uVar4 = gpio_to_desc(*(undefined4 *)(param_1 + 0x5c));
      gpiod_direction_output_raw(uVar4,1);
      _printk(&DAT_0010689b,"aw22xxx_i2c_write");
      msleep(1);
    }
  }
  lVar1 = sp_el0;
...
/* 00102264 FUN_00102264 */

void FUN_00102264(undefined8 *param_1,undefined1 param_2,undefined1 param_3)
...

{
  ...
  if ((int)uVar2 < 0) {
    ...
    if (-1 < (int)uVar3) goto LAB_001023e0;
    puVar4 = &DAT_00106e07;
    *param_3 = (char)uVar3;
...
/* 00102388 FUN_00102388 */

void FUN_00102388(undefined8 *param_1,undefined1 param_2,undefined1 *param_3)
...
/* 001023a4 FUN_001023a4 */

void FUN_001023a4(long param_1,undefined8 *param_2,undefined1 param_3)
...

{
  ...
  if ((int)uVar2 < 0) {
    *unaff_x19 = (char)uVar2;
    _printk(&DAT_00106e07,"aw22xxx_i2c_read",uVar2 & 0xffffffff);
    msleep(1);
    ...
    if ((int)uVar2 < 0) {
      ...
      if (-1 < (int)uVar2) goto LAB_001023e0;
      *unaff_x19 = (char)uVar2;
      puVar3 = &DAT_00106e07;
    }
...

{
  ...
  if ((int)uVar2 < 0) {
    *unaff_x19 = (char)uVar2;
    uVar2 = uVar2 & 0xffffffff;
    _printk(&DAT_00106e07,"aw22xxx_i2c_read",uVar2);
    msleep(1);
  }
  lVar1 = sp_el0;
  if (*(long *)(lVar1 + 0x710) == in_stack_00000008) {
...

{
  ...
  lVar8 = param_1 + 0x20;
  _printk(&DAT_001075af,"aw22xxx_i2c_probe",0x9d9);
  pcVar10 = *(code **)(*(long *)(*(long *)(param_1 + 0x18) + 0x10) + 0x20);
  if (*(int *)(pcVar10 + -4) != 0x7cc2eb16) {
                    /* WARNING: Does not return */
    pcVar10 = (code *)SoftwareBreakpoint(0x8228,0x102524);
    (*pcVar10)();
  }
  uVar4 = (*pcVar10)();
  if ((uVar4 & 1) == 0) {
  ...
  *(long **)(param_1 + 0xb8) = plVar5;
  __mutex_init(plVar5 + 0x56,"&aw22xxx->cfg_lock",&DAT_0010ecf8);
...
LAB_00102698:
    ...
    puVar6 = &DAT_0010739e;
    plVar5[0x67] = uVar4;
    if ((uVar4 == 0) || (0xfffffffffffff000 < uVar4)) goto LAB_0010261c;
    uVar4 = pinctrl_lookup_state(plVar5[0x66],"aw22xxx_led_sleep");
    puVar6 = &DAT_00106f93;
    plVar5[0x68] = uVar4;
    if ((uVar4 == 0) || (0xfffffffffffff000 < uVar4)) goto LAB_0010261c;
    if ((plVar5[0x66] == 0) || (plVar5[0x67] == 0)) {
      _printk(&UNK_0010787a,"aw22xxx_pinctrl_set_state");
      uVar4 = FUN_0010267c();
      return uVar4;
    }
    uVar1 = pinctrl_select_state();
    if (uVar1 != 0) {
      _printk(&DAT_00106e48,"aw22xxx_i2c_probe");
      goto LAB_00102690;
    }
    if (lVar11 != 0) {
...
FUN_001027ac:
      ...
      *(int *)(plVar5 + 0x5d) = iVar2;
      ...
      iVar2 = of_property_read_variable_u32_array(lVar11,"cfg_custom_en",&DAT_0010ecfc,1,0);
      if (iVar2 < 0) {
        DAT_0010ecfc = 0;
      }
...
LAB_0010295c:
      ...
      _printk(&DAT_00107fbd,"aw22xxx_i2c_probe",0xa1b,multicolor_led);
      ...
      if (-1 < (int)uVar1) {
        ...
        *(long **)(param_1 + 0xb8) = plVar5;
        ...
        uRam000000000010ed08 = 0x6e69622e7766;
        _printk(&DAT_00106ce5,"aw22xxx_load_nubia_fw_name",0x5de,(int)plVar5[0x5d],0);
        aw22xxx_fw_init(plVar5);
        _printk(&DAT_00107fec,"aw22xxx_i2c_probe",0xa56);
        uVar7 = gpio_to_desc((int)plVar5[0x5c]);
        iVar2 = gpiod_direction_output_raw(uVar7,0);
        if (iVar2 != 0) {
          _printk(&DAT_00106b8b,"aw22xxx_i2c_probe",0xa5b);
        }
        lVar8 = zlog_register_client(&zlog_aw22xxx_dev);
        plVar5[0x6a] = lVar8;
        if (lVar8 == 0) {
          _printk(&DAT_001075cb,"aw22xxx_i2c_probe",0xa61,"aw22xxx_i2c_probe");
        }
...
/* 0010265c FUN_0010265c */

void FUN_0010265c(void)
...
/* 00102664 FUN_00102664 */

void FUN_00102664(undefined8 param_1)
...
/* 00102684 FUN_00102684 */

undefined4 FUN_00102684(undefined8 param_1)
...
/* 00102758 FUN_00102758 */

int FUN_00102758(void)
...
LAB_00102a24:
          *(long *)(unaff_x21 + 0xb8) = unaff_x19;
          ...
          aw22xxx_fw_name._7_1_ = 0x5f;
          uRam000000000010ed08 = 0x6e69622e7766;
          _printk(&DAT_00106ce5,"aw22xxx_load_nubia_fw_name",0x5de,
...
/* 00102764 FUN_00102764 */

int FUN_00102764(void)
...
/* 00102784 FUN_00102784 */

int FUN_00102784(void)
...
/* 001027d8 FUN_001027d8 */

undefined4 FUN_001027d8(void)
...
LAB_00102a24:
        *(long *)(unaff_x21 + 0xb8) = unaff_x19;
        ...
        aw22xxx_fw_name._7_1_ = 0x5f;
        uRam000000000010ed08 = 0x6e69622e7766;
        _printk(&DAT_00106ce5,"aw22xxx_load_nubia_fw_name",0x5de,*(undefined4 *)(unaff_x19 + 0x2e8),
                0);
        aw22xxx_fw_init();
        _printk(&DAT_00107fec,"aw22xxx_i2c_probe",0xa56);
        uVar2 = gpio_to_desc(*(undefined4 *)(unaff_x19 + 0x2e0));
...

{
  ...
  _printk(&DAT_00106fcd,"aw22xxx_i2c_remove");
  remove_proc_entry("driver/colorleds_id",0);
  _printk(&DAT_00107090,"aw22xxx_proc_deinit",0x9ca);
...

{
  ...
  _printk(&DAT_00106fcd,"aw22xxx_hw_reset");
...

{
  ...
  if (-1 < iVar2) {
    if (local_2c[0] == 'v') {
LAB_00102d54:
      _printk(&DAT_001072d9,"aw22xxx_read_chipid",local_2c[0],iVar2);
      ...
      if (local_2c[0] == '\x18') {
        ...
        if (local_2c[0] != '\'') {
          _printk(&DAT_0010699f,"aw22xxx_read_chipid");
          goto LAB_00102e58;
        }
        uVar4 = 2;
      ...
      *(undefined1 *)(param_1 + 0x2ed) = uVar4;
      _printk(&DAT_001076f0,"aw22xxx_read_chipid");
      uVar3 = 0;
      goto LAB_00102e5c;
    }
    _printk(&DAT_00107e97,"aw22xxx_read_chipid",local_2c[0],iVar2);
    msleep(1);
    iVar2 = aw22xxx_i2c_read(param_1,1,local_2c);
    if (-1 < iVar2) {
      if (local_2c[0] == 'v') goto LAB_00102d54;
      _printk(&DAT_00107e97,"aw22xxx_read_chipid",local_2c[0],iVar2);
      msleep(1);
LAB_00102e58:
      uVar3 = 0xffffffea;
...
/* 00102e88 aw22xxx_interrupt_setup */
...

{
  ...
  _printk(&DAT_00106fcd,"aw22xxx_interrupt_setup");
  local_44[0] = 0;
  _printk(&DAT_00106fcd,"aw22xxx_interrupt_clear");
  aw22xxx_i2c_read(param_1,10,local_44);
  _printk(&DAT_00106a77,"aw22xxx_interrupt_clear",local_44[0]);
  local_40[0] = 0;
...

{
  ...
  _printk(&DAT_00106a77,"aw22xxx_irq_v15",local_44[0]);
  if ((local_44[0] & 1) != 0) {
    _printk(&DAT_00106c96,"aw22xxx_irq_v15");
    ...
    aw22xxx_i2c_write(param_2,4);
    _printk(&DAT_00107b7c,"aw22xxx_chip_enable",0x1aa,0);
    local_38[0] = 0;
    aw22xxx_i2c_read(param_2,2,local_38);
    local_38[0] = local_38[0] & 0xfe;
    aw22xxx_i2c_write(param_2,2);
    usleep_range_state(2000,3000,2);
    _printk(&DAT_00106ea1,"aw22xxx_irq_v15");
  }
  if ((local_44[0] >> 4 & 1) != 0) {
    _printk(&DAT_00106fda,"aw22xxx_irq_v15");
    aw22xxx_i2c_write(param_2,0xff,0);
    local_34[0] = 0;
...

{
  ...
  local_28 = *(long *)(lVar1 + 0x710);
  local_2c[0] = 0;
  _printk(&DAT_00106fcd,"aw22xxx_irq");
  aw22xxx_i2c_read(param_2,10,local_2c);
  _printk(&DAT_00106a77,"aw22xxx_irq",local_2c[0]);
  if ((local_2c[0] >> 4 & 1) != 0) {
    queue_work_on(0x20,_system_wq,param_2 + 0x250);
    _printk(&DAT_00106bb8,"aw22xxx_irq",0x625,*(undefined4 *)(param_2 + 0x2f8));
  ...
  _printk(&DAT_00107b13,"aw22xxx_irq");
  lVar1 = sp_el0;
  if (*(long *)(lVar1 + 0x710) == local_28) {
    return 1;
  }
...
/* 001032dc aw22xxx_parse_led_cdev */
...

{
  ...
  _printk(&DAT_00106fcd,"aw22xxx_parse_led_cdev");
...
/* 001034e4 aw22xxx_alloc_name_array */
...

{
  ...
  if (aw22xxx_cfg_name == (undefined8 *)0x0) {
    _printk(&DAT_001069d3,"aw22xxx_alloc_name_array",0x687);
  }
  else {
    lVar4 = 0;
    uVar1 = sp_el0;
    do {
      ...
      if (lVar2 == 0) {
        ...
        kfree(puVar3);
        _printk(&DAT_001069d3,"aw22xxx_alloc_name_array",0x692);
        return;
      }
      lVar4 = lVar4 + 1;
    } while (lVar4 != 0xb);
...

{
  ...
  *(code **)(param_1 + 0x248) = aw22xxx_cfg_work_routine;
  ...
  _printk(&DAT_00106b1c,"aw22xxx_fw_init");
...
/* 0010381c aw22xxx_create_proc_entry */
...

{
  ...
  if (lVar1 == 0) {
    _printk(&DAT_0010737a);
  }
  else {
    _printk(&DAT_00107c86,"aw22xxx_create_proc_entry",0x9c3);
  }
  return;
}
...
/* 00103880 aw22xxx_brightness_work */
...

{
  ...
  lVar3 = param_1 + -0x1d0;
  local_28 = *(long *)(lVar1 + 0x710);
  _printk(&DAT_00106fcd,"aw22xxx_brightness_work");
...

{
  ...
  lVar3 = param_1 + -0x1f0;
  local_38 = *(long *)(lVar1 + 0x710);
  _printk(&DAT_00106fcd,"aw22xxx_task_work");
  aw22xxx_i2c_write(lVar3,5,0xff);
  local_4c[0] = 0;
...

{
  ...
  if ((iVar1 == 2) && ((uint)local_30 < 0x100)) {
    ...
    _printk(&DAT_00106bf8,"aw22xxx_reg_store",0x78b);
...

{
  ...
  if (iVar1 == 1) {
    if (local_3c < 2) {
      if (local_3c == 1) {
        ...
        _printk(&DAT_00106fcd,"aw22xxx_hw_off");
  ...
  _printk(&DAT_00106bf8,"aw22xxx_hwen_store",0x7b9);
  param_4 = 0xffffffffffffffea;
LAB_0010406c:
  lVar3 = sp_el0;
...

{
  ...
  if (uVar1 < 0xe) {
    ...
    return lVar5 + iVar3;
                    ...
                    /* WARNING: Does not return */
  pcVar2 = (code *)SoftwareBreakpoint(0x5512,0x104310);
  (*pcVar2)();
}



/* 00104314 aw22xxx_imax_store */
...

{
  ...
  if ((iVar1 == 1) && (local_3c < 0xd)) {
    *(uint *)(lVar3 + 0x2e0) = local_3c;
    ...
    _printk(&DAT_00106bf8,"aw22xxx_imax_store",0x8a7);
    param_4 = 0xffffffffffffffea;
  }
  lVar3 = sp_el0;
  if (*(long *)(lVar3 + 0x710) == local_38) {
...

{
  ...
  lStack_28 = *(long *)(lVar1 + 0x710);
  abStack_2c[0] = 0;
  _printk(&DAT_001087bb,"aw22xxx_led_init");
  _printk(&DAT_00108339,"aw22xxx_led_init");
  aw22xxx_i2c_write(param_1,1,0x55);
  usleep_range_state(2000,3000,2);
  aw22xxx_i2c_read(param_1,2,abStack_2c);
  abStack_2c[0] = abStack_2c[0] | 1;
  aw22xxx_i2c_write(param_1,2);
  usleep_range_state(2000,3000,2);
  if (*(uint *)(param_1 + 0x2f0) < 0xd) {
    ...
    _printk(&DAT_001088c2,"aw22xxx_led_init");
    aw22xxx_i2c_read(param_1,2,abStack_2c);
    abStack_2c[0] = abStack_2c[0] & 0xfe;
    aw22xxx_i2c_write(param_1,2);
    usleep_range_state(2000,3000,2);
    _printk(&DAT_001080cc,"aw22xxx_led_init");
    uVar2 = 0;
  }
  else {
    uVar2 = 0xffffffea;
...
/* 0010455c FUN_0010455c */

void FUN_0010455c(long param_1)
...
/* 001046d4 aw22xxx_fw_work_routine */

void aw22xxx_fw_work_routine(long param_1)

{
  _printk(&DAT_001087bb,"aw22xxx_fw_work_routine");
  _printk(&DAT_001082f5);
...
/* 00104758 aw22xxx_cfg_work_routine */

void aw22xxx_cfg_work_routine(long param_1)

{
  _printk(&DAT_001087bb,"aw22xxx_cfg_work_routine");
  _printk(&DAT_001084cc);
...

{
  ...
  _printk(&DAT_001087bb,"aw22xxx_cfg_loaded");
  if (param_1 == (ulong *)0x0) {
    _printk(&DAT_0010829e);
    release_firmware(0);
  }
  else {
    _printk(&DAT_00108813,"aw22xxx_cfg_loaded",*(undefined4 *)(param_2 + 0x300),*param_1);
    if (1 < *param_1) {
      lVar8 = 0;
      bVar7 = 0;
      do {
    ...
    if (*(uint *)(param_2 + 0x2f0) < 0xd) {
      ...
      _printk(&DAT_001080cc,"aw22xxx_cfg_loaded");
    }
  }
  return;
}
...
/* 001049fc aw22xxx_recover_work_routine */
...

{
  ...
  lVar1 = param_1 + -0x250;
  local_3c[0] = 0;
  _printk(&DAT_001087bb,"aw22xxx_recover_work_routine");
  ...
  msleep(200);
  _printk(&DAT_001088f8,"aw22xxx_recover_work_routine");
...
/* 00104be4 aw22xxx_cfg_recover_update_wait */
...

{
  ...
  local_60 = (ulong *)0x0;
  _printk(&DAT_001087bb,"aw22xxx_cfg_recover_update_wait");
  _printk(&DAT_001082bc,*(undefined1 *)(param_1 + 0x2ef));
  if ((*(uint *)(param_1 + 0x300) & 0xfffffffe) == 4) {
    lamp_effect = *(uint *)(param_1 + 0x300);
  }
  _printk(&DAT_00108878,"aw22xxx_cfg_recover_update_wait",lamp_effect);
  if ((*(uint *)(param_1 + 0x300) & 0xfffffffe) == 2) {
    fan_effect = *(uint *)(param_1 + 0x300);
  }
  _printk(&DAT_0010831b,"aw22xxx_cfg_recover_update_wait",fan_effect);
  if ((*(uint *)(param_1 + 0x300) >> 2 < 0x465) && (aw22xxx_cfg_name != 0)) {
    __s = *(char **)(aw22xxx_cfg_name + (ulong)*(uint *)(param_1 + 0x300) * 8);
    _printk(&DAT_00108643,"aw22xxx_cfg_recover_update_wait",__s);
    sVar6 = strlen(__s);
    bVar10 = g_init_flg;
    if (sVar6 < 5) {
      puVar7 = &DAT_00108610;
      ...
      if (*(char *)(param_1 + 0x2ef) == '\x02') {
        *(bool *)(param_1 + 0x348) = *(int *)(param_1 + 0x300) != 2;
        ...
        if (iVar5 == 0) {
          _printk(&DAT_00108a9d);
          if (local_60 == (ulong *)0x0) {
            _printk(&DAT_0010839c);
            release_firmware(local_60);
          }
          else {
            _printk(&DAT_00108835,*local_60);
            if (1 < *local_60) {
              lVar11 = 0;
              bVar10 = 0;
              do {
            ...
            *(int *)(param_1 + 0x2f8) = *(int *)(param_1 + 0x2f8) + 1;
            _printk(&DAT_001080cc,"aw22xxx_cfg_recover_update_wait");
            _printk(&DAT_00108a5c,*(undefined4 *)(param_1 + 0x2f8));
            msleep(0x14);
          }
        }
        else {
          _printk(&DAT_001081c1,"aw22xxx_cfg_recover_update_wait",iVar5);
        }
        goto LAB_00104d14;
      }
      puVar7 = &DAT_00108a7a;
...
/* 00104f70 aw22xxx_fw_timer_func */
...
{
  _printk(&DAT_001087bb,"aw22xxx_fw_timer_func");
...
/* 00104fc4 aw22xxx_set_brightness */
...

{
  ...
  _printk(&DAT_001087bb,"get_aw22xxx_id");
...

{
  ...
  if (iVar1 == 1) {
    *(byte *)(lVar2 + 0x2f4) = (byte)local_2c & 0xf;
    _printk(&DAT_00108263,"aw22xxx_cfg_store");
  }
  else {
    _printk(&DAT_001083c1,"aw22xxx_cfg_store");
    param_4 = 0xffffffffffffffea;
  }
  lVar2 = sp_el0;
  if (*(long *)(lVar2 + 0x710) == local_28) {
...

{
  ...
  if (iVar1 == 1) {
    lVar2 = lVar3 + -0x10;
    _printk(&DAT_001087e6,"aw22xxx_effect_store",local_4c);
    mutex_lock(lVar3 + 0x2a0);
    if ((local_4c - 8 < 3) && (init_flag != 0)) {
      _printk(&DAT_001083dd,"aw22xxx_effect_store");
      *(undefined4 *)(lVar3 + 0x2f0) = 4;
      ...
      if (g_cfg_cur_state == '\0') {
        _printk(&DAT_001086fb,"aw22xxx_effect_store");
      ...
      init_flag = 0;
      _printk(&DAT_001089a6,"aw22xxx_effect_store");
    }
    *(uint *)(lVar3 + 0x2f0) = local_4c;
    _printk(&DAT_0010885b,"aw22xxx_effect_store");
    if (((local_4c < 4) && (local_4c != 1)) && ((init_flag & 1) == 0)) {
      init_flag = 1;
      _printk(&DAT_00108a1c,"aw22xxx_effect_store");
    }
    ...
    if (g_cfg_cur_state == '\0') {
      _printk(&DAT_00108793,"aw22xxx_effect_store");
      aw22xxx_i2c_read(lVar2,2,local_50);
      local_50[0] = local_50[0] & 0xfe;
      aw22xxx_i2c_write(lVar2,2);
      usleep_range_state(2000,3000,2);
    ...
    _printk(&DAT_001080cc,"aw22xxx_effect_store");
    mutex_unlock(lVar3 + 0x2a0);
  }
  else {
    _printk(&DAT_001083c1,"aw22xxx_effect_store");
    param_4 = 0xffffffffffffffea;
  }
  lVar3 = sp_el0;
...

{
  ...
  _printk(&DAT_0010853a,"aw22xxx_get_fwname",uVar8);
  _printk(&DAT_0010858e,"aw22xxx_get_fwname",uVar2);
  _printk(&DAT_00108416,"aw22xxx_get_fwname",uVar1);
  iVar5 = (int)uVar8;
  if (iVar5 == 3) {
    sprintf(aw22xxx_dyn_name,"aw_fan%x_%x.bin",(ulong)uVar2,(ulong)uVar1);
LAB_001055e4:
    _printk(&DAT_00108485,"aw22xxx_get_fwname",aw22xxx_dyn_name);
    return;
  }
  if (iVar5 == 2) {
  ...
  if (((iVar5 != 0) || (10 < uVar1)) || (aw22xxx_cfg_name == 0)) {
    _printk(&DAT_00108917,"aw22xxx_get_fwname");
    return;
  }
  ...
  pcStack_50 = __s;
  _printk(&DAT_001087bb,"aw22xxx_cfg_update_wait_from_dyn_name");
  bVar4 = g_init_flg;
  ...
  _printk(&DAT_00108172,"aw22xxx_cfg_update_wait_from_dyn_name",iVar5);
LAB_001056f0:
  lVar3 = sp_el0;
...
/* 0010563c aw22xxx_cfg_update_wait_from_dyn_name */
...

{
  ...
  _printk(&DAT_00108172,"aw22xxx_cfg_update_wait_from_dyn_name",iVar3);
LAB_001056f0:
  lVar1 = sp_el0;
  if (*(long *)(lVar1 + 0x710) == local_28) {
    return;
...
/* 00105740 aw22xxx_set_cfg_run_state */
...

{
  ...
  _printk(&DAT_00108693,"aw22xxx_set_cfg_run_state",uVar4);
  _printk(&DAT_001082da,"aw22xxx_set_cfg_run_state",uVar1);
  _printk(&DAT_001084a0,"aw22xxx_set_cfg_run_state",param_1 & 0xffffffff);
  iVar3 = (int)uVar4;
  if ((iVar3 == 1) && (uVar1 == 0)) {
  ...
  if (write_idx == 0) {
    ...
    if (write_idx * 0x19 < 1) {
      ...
      do {
        ...
        if (uVar4 == 25000) {
                    /* WARNING: Does not return */
          pcVar1 = (code *)SoftwareBreakpoint(0x5512,0x105a68);
          (*pcVar1)();
        }
...

{
  ...
  _printk(&DAT_001087bb,"aw22xxx_para_store");
  lVar10 = __kmalloc_cache_noprof(_sscanf,0xcc0,100);
  if (lVar10 == 0) {
    _printk(&DAT_00108279,"aw22xxx_para_store");
    ...
    if (iVar9 == 0x19) {
      if (write_idx < 1000) {
        ...
        do {
          if (uVar11 == uVar12) {
                    /* WARNING: Does not return */
            pcVar8 = (code *)SoftwareBreakpoint(0x5512,0x105ce0);
            (*pcVar8)();
          }
        ...
        write_idx = iVar7 + 1;
        _printk(&DAT_0010842e,"aw22xxx_para_store");
      }
      else {
        _printk(&DAT_001084f5,"aw22xxx_para_store");
        param_4 = 0xffffffffffffffe4;
      }
    }
    else {
      _printk(&DAT_0010819d,"aw22xxx_para_store");
      param_4 = 0xffffffffffffffea;
    }
    kfree(lVar10);
  }
...
/* 00105ce4 aw22xxx_multi_breath_pattern_show */
...
/* 00105d20 aw22xxx_multi_breath_pattern_store */
    ...
    *(int *)(lVar3 + 0x2f8) = local_3c;
    if (local_3c == 0) {
      ...
      if (cfg_update_kthread < 0xfffffffffffff001) {
        wake_up_process();
        kthread_status = 1;
        _printk(&DAT_0010821b);
      }
      else {
        kthread_status = 0;
        _printk(&DAT_001088a1);
      }
    }
  }
  else {
...

{
  ...
  if (iVar1 == 1) {
    *(char *)(lVar2 + 0x2ec) = (char)local_2c;
    _printk(&DAT_00108158,"aw22xxx_task0_store");
    queue_work_on(0x20,_system_wq,lVar2 + 0x1e0);
  }
  else {
    _printk(&DAT_001083c1,"aw22xxx_task0_store");
    param_4 = 0xffffffffffffffea;
  }
  lVar2 = sp_el0;
  if (*(long *)(lVar2 + 0x710) == local_28) {
...

{
  ...
  if (iVar1 == 1) {
    *(char *)(lVar2 + 0x2ed) = (char)local_2c;
    _printk(&DAT_00108520,"aw22xxx_task1_store");
  }
  else {
    _printk(&DAT_001083c1,"aw22xxx_task1_store");
    param_4 = 0xffffffffffffffea;
  }
  lVar2 = sp_el0;
  if (*(long *)(lVar2 + 0x710) == local_28) {
...
/* 00106154 aw22xxx_task_irq_show */
...
/* 00106190 aw22xxx_task_irq_store */
...

{
  ...
  if (iVar1 == 1) {
    *(undefined4 *)(lVar2 + 0x2e8) = local_2c;
    _printk(&DAT_0010898b,"aw22xxx_task_irq_store");
  }
  else {
    _printk(&DAT_001083c1,"aw22xxx_task_irq_store");
    param_4 = 0xffffffffffffffea;
  }
  lVar2 = sp_el0;
  if (*(long *)(lVar2 + 0x710) == local_28) {
