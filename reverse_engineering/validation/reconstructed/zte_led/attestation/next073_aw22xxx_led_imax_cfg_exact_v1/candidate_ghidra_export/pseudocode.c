...

{
  ...
  _printk(&DAT_00106ba5,"aw22xxx_fw_loaded");
}



/* 001018e0 aw22xxx_init_cfg_update_array */
...

{
  ...
  uVar1 = sp_el0;
                    /* WARNING: Subroutine does not return */
  _printk(&DAT_00106ad6,"aw22xxx_init_cfg_update_array",0x1ca);
}



/* 00101a34 aw22xxx_set_breath_data */
...

{
  ...
  while( true ) {
    ...
    if (read_idx == write_idx) {
      ...
      queue_work_on(0x20,_system_wq,param_1 + 0x230);
                    /* WARNING: Subroutine does not return */
      _printk(&DAT_00107166,"aw22xxx_play");
    }
    if ((kthread_status & 1) == 0) break;
    if (25000 < (uint)(read_idx * 0x19)) {
                    /* WARNING: Does not return */
      pcVar1 = (code *)SoftwareBreakpoint(0x5512,0x101c88);
      (*pcVar1)();
    }
  ...
  aw22xxx_i2c_write(param_1,2,0);
                    /* WARNING: Subroutine does not return */
  _printk(&DAT_00106dbb,"aw22xxx_play");
}



/* 00101c8c aw22xxx_led_imax_cfg */
...

{
  ...
  *(undefined4 *)(param_1 + 0x2f0) = 7;
                    /* WARNING: Subroutine does not return */
  _printk(&DAT_001069bc,"aw22xxx_led_imax_cfg",
          *(undefined8 *)(aw22xxx_cfg_name + (ulong)*(uint *)(param_1 + 0x300) * 8),7);
}



/* 00101cfc aw22xxx_i2c_write */
...

{
  ...
  if (iVar2 < 0) {
    ...
    uVar3 = gpiod_get_raw_value();
                    /* WARNING: Subroutine does not return */
    _printk(&DAT_0010654b,"aw22xxx_i2c_write",0,iVar2,uVar3);
  }
  lVar1 = sp_el0;
...
/* 00101f68 aw22xxx_i2c_probe */

void aw22xxx_i2c_probe(void)

{
                    /* WARNING: Subroutine does not return */
  _printk(&DAT_00107187,"aw22xxx_i2c_probe",0x9d9);
}
...
/* 00102280 FUN_00102280 */

undefined4 FUN_00102280(void)
...
/* 00102604 aw22xxx_i2c_remove */

void aw22xxx_i2c_remove(void)

{
                    /* WARNING: Subroutine does not return */
  _printk(&DAT_00106ba5,"aw22xxx_i2c_remove");
}



/* 001026c8 aw22xxx_hw_reset */

void aw22xxx_hw_reset(void)

{
                    /* WARNING: Subroutine does not return */
  _printk(&DAT_00106ba5,"aw22xxx_hw_reset");
}



/* 00102764 aw22xxx_read_chipid */
...

{
  ...
  if (-1 < iVar2) {
    if (local_2c[0] == 'v') {
                    /* WARNING: Subroutine does not return */
      _printk(&DAT_00106eb1,"aw22xxx_read_chipid",0x76,iVar2);
    }
                    /* WARNING: Subroutine does not return */
    _printk(&DAT_00107a6f,"aw22xxx_read_chipid",local_2c[0],iVar2);
  }
...
/* 00102930 aw22xxx_interrupt_setup */
...

{
  ...
  uVar1 = sp_el0;
                    /* WARNING: Subroutine does not return */
  _printk(&DAT_00106ba5,"aw22xxx_interrupt_setup");
}



/* 00102a38 aw22xxx_irq_v15 */
...

{
  ...
  aw22xxx_i2c_read(param_2,10,local_44);
                    /* WARNING: Subroutine does not return */
  _printk(&DAT_0010664f,"aw22xxx_irq_v15",local_44[0]);
}



/* 00102c80 aw22xxx_irq */
...

{
  ...
  uVar1 = sp_el0;
                    /* WARNING: Subroutine does not return */
  _printk(&DAT_00106ba5,"aw22xxx_irq");
}



/* 00102d84 aw22xxx_parse_led_cdev */

void aw22xxx_parse_led_cdev(void)

{
                    /* WARNING: Subroutine does not return */
  _printk(&DAT_00106ba5,"aw22xxx_parse_led_cdev");
}



/* 00102f8c aw22xxx_alloc_name_array */
...

{
  ...
  if (aw22xxx_cfg_name == (undefined8 *)0x0) {
                    /* WARNING: Subroutine does not return */
    _printk(&DAT_001065ab,"aw22xxx_alloc_name_array",0x687);
  }
  lVar4 = 0;
  uVar1 = sp_el0;
  do {
    ...
    if (lVar2 == 0) {
      ...
      kfree(puVar3);
                    /* WARNING: Subroutine does not return */
      _printk(&DAT_001065ab,"aw22xxx_alloc_name_array",0x692);
    }
    lVar4 = lVar4 + 1;
  } while (lVar4 != 0xb);
  ...
  *(code **)(param_1 + 0x248) = aw22xxx_cfg_work_routine;
  if (bVar1) {
    ...
    *(code **)(param_1 + 0x268) = aw22xxx_recover_work_routine;
                    ...
                    /* WARNING: Subroutine does not return */
  _printk(&DAT_001066f4,"aw22xxx_fw_init");
}



/* 001032c4 aw22xxx_create_proc_entry */
...

{
  ...
  if (lVar1 == 0) {
                    /* WARNING: Subroutine does not return */
    _printk(&DAT_00106f52);
  }
                    /* WARNING: Subroutine does not return */
  _printk(&DAT_0010785e,"aw22xxx_create_proc_entry",0x9c3);
}



/* 00103328 aw22xxx_brightness_work */
...

{
  ...
  uVar1 = sp_el0;
                    /* WARNING: Subroutine does not return */
  _printk(&DAT_00106ba5,"aw22xxx_brightness_work");
}



/* 00103578 aw22xxx_task_work */
...

{
  ...
  uVar1 = sp_el0;
                    /* WARNING: Subroutine does not return */
  _printk(&DAT_00106ba5,"aw22xxx_task_work");
}



/* 00103814 aw22xxx_reg_show */
...

{
  ...
  if ((iVar1 == 2) && ((uint)local_30 < 0x100)) {
    ...
    __stack_chk_fail();
                    ...
                    /* WARNING: Subroutine does not return */
  _printk(&DAT_001067d0,"aw22xxx_reg_store",0x78b);
}



/* 001039e8 aw22xxx_hwen_show */
...

{
  ...
  if (iVar1 == 1) {
    if (local_3c < 2) {
      if (local_3c != 1) {
                    /* WARNING: Subroutine does not return */
        _printk(&DAT_00106ba5,"aw22xxx_hw_off");
      }
      ...
      __stack_chk_fail();
                    ...
                    /* WARNING: Subroutine does not return */
  _printk(&DAT_001067d0,"aw22xxx_hwen_store",0x7b9);
}



/* 00103bd0 aw22xxx_imax_show */
...

{
  ...
  if (uVar1 < 0xe) {
    ...
    return lVar5 + iVar3;
                    ...
                    /* WARNING: Does not return */
  pcVar2 = (code *)SoftwareBreakpoint(0x5512,0x103db8);
  (*pcVar2)();
}



/* 00103dbc aw22xxx_imax_store */
...

{
  ...
  if ((iVar1 != 1) || (0xc < local_3c)) {
                    /* WARNING: Subroutine does not return */
    _printk(&DAT_001067d0,"aw22xxx_imax_store",0x8a7);
  }
...

{
  ...
  if ((iVar1 == 2) && ((uint)local_30 < 9)) {
    *(undefined4 *)(lVar2 + (local_30 & 0xffffffff) * 4 + 0x2fc) = local_30._4_4_;
                    /* WARNING: Subroutine does not return */
    _printk(&DAT_0010651c,"aw22xxx_rgb_store",0x8d3);
  }
  lVar2 = sp_el0;
  if (*(long *)(lVar2 + 0x710) == local_28) {
...

{
  ...
  if (iVar1 == 1) {
    *(char *)(lVar2 + 0x2ed) = (char)local_2c;
                    /* WARNING: Subroutine does not return */
    _printk(&DAT_00106321,"aw22xxx_task1_store",0x911,local_2c & 0xff);
  }
                    /* WARNING: Subroutine does not return */
  _printk(&DAT_00106423,"aw22xxx_task1_store",0x90c);
}



/* 001042c8 aw22xxx_task_irq_show */
...
/* 00104304 aw22xxx_task_irq_store */
...

{
  ...
  if (iVar1 == 1) {
    *(undefined4 *)(lVar2 + 0x2e8) = local_2c;
                    /* WARNING: Subroutine does not return */
    _printk(&DAT_00106de0,"aw22xxx_task_irq_store",0x92c);
  }
                    /* WARNING: Subroutine does not return */
  _printk(&DAT_00106423,"aw22xxx_task_irq_store",0x927);
}



/* 001043c4 aw22xxx_para_show */
...
LAB_001044dc:
                    /* WARNING: Does not return */
          pcVar1 = (code *)SoftwareBreakpoint(0x5512,0x1044e0);
          (*pcVar1)();
        }
        lVar3 = lVar3 + iVar2;
      }
      else if (0xc34 < uVar4 >> 3) goto LAB_001044dc;
...
/* 001044e4 aw22xxx_para_store */

void aw22xxx_para_store(void)

{
                    /* WARNING: Subroutine does not return */
  _printk(&DAT_001069b0,"aw22xxx_para_store");
}



/* 0010493c aw22xxx_multi_breath_pattern_show */
...
/* 00104978 aw22xxx_cfg_loaded */

void aw22xxx_cfg_loaded(void)

{
                    /* WARNING: Subroutine does not return */
  _printk(&DAT_00107f5f,"aw22xxx_cfg_loaded");
}



/* 00104b58 aw22xxx_set_brightness */
...

{
  ...
  if (uVar1 < 0xb) {
    ...
    return sVar2;
                    ...
                    /* WARNING: Subroutine does not return */
  _printk(&DAT_00107cbc);
}



/* 00104c0c aw22xxx_cfg_store */
...

{
  ...
  if (iVar1 == 1) {
    *(byte *)(lVar2 + 0x2f4) = (byte)local_2c & 0xf;
                    /* WARNING: Subroutine does not return */
    _printk(&DAT_00107d2f,"aw22xxx_cfg_store");
  }
                    /* WARNING: Subroutine does not return */
  _printk(&DAT_00107d9a,"aw22xxx_cfg_store");
}



/* 00104cc8 aw22xxx_effect_show */
...

{
  ...
  if (iVar2 == 1) {
                    /* WARNING: Subroutine does not return */
    _printk(&DAT_00107f8a,"aw22xxx_effect_store",local_4c);
  }
                    /* WARNING: Subroutine does not return */
  _printk(&DAT_00107d9a,"aw22xxx_effect_store");
}



/* 00104f90 aw22xxx_get_fwname */

void aw22xxx_get_fwname(ulong param_1)

{
                    /* WARNING: Subroutine does not return */
  _printk(&DAT_00107e43,"aw22xxx_get_fwname",param_1 >> 0x18 & 0xff);
}



/* 0010510c aw22xxx_cfg_update_wait_from_dyn_name */
...

{
  ...
  uVar1 = sp_el0;
                    /* WARNING: Subroutine does not return */
  _printk(&DAT_00107f5f,"aw22xxx_cfg_update_wait_from_dyn_name");
}
...
/* 00105420 aw22xxx_multi_breath_pattern_store */
  ...
  if (iVar1 == 1) {
    ...
    *(int *)(lVar4 + 0x2f8) = local_3c;
    if (local_3c == 0) {
      ...
      uVar2 = kthread_create_on_node(aw22xxx_play,lVar3,0xffffffff,&DAT_00106e0a,"aw22xxx_play");
...
/* 001055b4 aw22xxx_fw_timer_func */

void aw22xxx_fw_timer_func(void)

{
                    /* WARNING: Subroutine does not return */
  _printk(&DAT_00106ba5,"aw22xxx_fw_timer_func");
}



/* 00105608 aw22xxx_fw_work_routine */

void aw22xxx_fw_work_routine(void)

{
                    /* WARNING: Subroutine does not return */
  _printk(&DAT_00106ba5,"aw22xxx_fw_work_routine");
}



/* 0010569c aw22xxx_cfg_work_routine */

void aw22xxx_cfg_work_routine(void)

{
                    /* WARNING: Subroutine does not return */
  _printk(&DAT_00106ba5,"aw22xxx_cfg_work_routine");
}



/* 00105784 aw22xxx_recover_work_routine */
...

{
  ...
  uVar1 = sp_el0;
                    /* WARNING: Subroutine does not return */
  _printk(&DAT_00106e2c,"aw22xxx_recover_work_routine");
}



/* 00105990 aw22xxx_led_init */
...

{
  ...
  uVar1 = sp_el0;
                    /* WARNING: Subroutine does not return */
  _printk(&DAT_00106ba5,"aw22xxx_led_init");
}



/* 00105b20 aw22xxx_cfg_recover_update_wait */
...

{
  ...
  uVar1 = sp_el0;
                    /* WARNING: Subroutine does not return */
  _printk(&DAT_00106ba5,"aw22xxx_cfg_recover_update_wait");
}



/* 00105ba0 FUN_00105ba0 */
...

{
  ...
  if (*in_x3 != 0) {
    return 0;
                    ...
                    /* WARNING: Subroutine does not return */
  _printk(&DAT_001070ce,"get_aw22xxx_id",0x9b3,g_chip_id);
}



/* 0010e4d4 init_module */

void init_module(void)

{
                    /* WARNING: Subroutine does not return */
  _printk(&DAT_00106845,"v1.1.3");
}



/* 0010e550 cleanup_module */
