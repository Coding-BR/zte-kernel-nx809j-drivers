...

{
  ...
  _printk(&DAT_00106a55,"aw22xxx_fw_loaded");
}



/* 001016b8 aw22xxx_init_cfg_update_array */
...

{
  ...
  uVar1 = sp_el0;
                    /* WARNING: Subroutine does not return */
  _printk(&DAT_00106986,"aw22xxx_init_cfg_update_array",0x1ca);
}



/* 0010180c aw22xxx_set_breath_data */
...

{
  ...
  while( true ) {
    ...
    if (read_idx == write_idx) {
      ...
      queue_work_on(0x20,_system_wq,param_1 + 0x230);
                    /* WARNING: Subroutine does not return */
      _printk(&DAT_00107016,"aw22xxx_play");
    }
    if ((kthread_status & 1) == 0) break;
    if (25000 < (uint)(read_idx * 0x19)) {
                    /* WARNING: Does not return */
      pcVar1 = (code *)SoftwareBreakpoint(0x5512,0x101a60);
      (*pcVar1)();
    }
  ...
  aw22xxx_i2c_write(param_1,2,0);
                    /* WARNING: Subroutine does not return */
  _printk(&DAT_00106c6b,"aw22xxx_play");
}



/* 00101a64 aw22xxx_led_imax_cfg */
...

{
  ...
  *(undefined4 *)(param_1 + 0x2f0) = 7;
                    /* WARNING: Subroutine does not return */
  _printk(&DAT_0010686c,"aw22xxx_led_imax_cfg",
          *(undefined8 *)(aw22xxx_cfg_name + (ulong)*(uint *)(param_1 + 0x300) * 8),7);
}



/* 00101ad4 aw22xxx_i2c_write */
...

{
  ...
  if (iVar2 < 0) {
    ...
    uVar3 = gpiod_get_raw_value();
                    /* WARNING: Subroutine does not return */
    _printk(&DAT_001063fb,"aw22xxx_i2c_write",0,iVar2,uVar3);
  }
  lVar1 = sp_el0;
...
/* 00101b20 FUN_00101b20 */

void FUN_00101b20(long param_1)
...
/* 00101d40 aw22xxx_i2c_probe */

void aw22xxx_i2c_probe(void)

{
                    /* WARNING: Subroutine does not return */
  _printk(&DAT_00107037,"aw22xxx_i2c_probe",0x9d9);
}
...
/* 00102058 FUN_00102058 */

undefined4 FUN_00102058(void)
...
/* 001023dc aw22xxx_i2c_remove */

void aw22xxx_i2c_remove(void)

{
                    /* WARNING: Subroutine does not return */
  _printk(&DAT_00106a55,"aw22xxx_i2c_remove");
}



/* 001024a0 aw22xxx_hw_reset */

void aw22xxx_hw_reset(void)

{
                    /* WARNING: Subroutine does not return */
  _printk(&DAT_00106a55,"aw22xxx_hw_reset");
}
...
/* 00102708 aw22xxx_interrupt_setup */
...

{
  ...
  uVar1 = sp_el0;
                    /* WARNING: Subroutine does not return */
  _printk(&DAT_00106a55,"aw22xxx_interrupt_setup");
}



/* 00102810 aw22xxx_irq_v15 */
...

{
  ...
  aw22xxx_i2c_read(param_2,10,local_44);
                    /* WARNING: Subroutine does not return */
  _printk(&DAT_001064ff,"aw22xxx_irq_v15",local_44[0]);
}



/* 00102a58 aw22xxx_irq */
...

{
  ...
  uVar1 = sp_el0;
                    /* WARNING: Subroutine does not return */
  _printk(&DAT_00106a55,"aw22xxx_irq");
}



/* 00102b5c aw22xxx_parse_led_cdev */

void aw22xxx_parse_led_cdev(void)

{
                    /* WARNING: Subroutine does not return */
  _printk(&DAT_00106a55,"aw22xxx_parse_led_cdev");
}



/* 00102d64 aw22xxx_alloc_name_array */
...

{
  ...
  if (aw22xxx_cfg_name == (undefined8 *)0x0) {
                    /* WARNING: Subroutine does not return */
    _printk(&DAT_0010645b,"aw22xxx_alloc_name_array",0x687);
  }
  lVar4 = 0;
  uVar1 = sp_el0;
  do {
    ...
    if (lVar2 == 0) {
      ...
      kfree(puVar3);
                    /* WARNING: Subroutine does not return */
      _printk(&DAT_0010645b,"aw22xxx_alloc_name_array",0x692);
    }
    lVar4 = lVar4 + 1;
  } while (lVar4 != 0xb);
  ...
  *(code **)(param_1 + 0x248) = aw22xxx_cfg_work_routine;
  if (bVar1) {
    ...
    *(code **)(param_1 + 0x268) = aw22xxx_recover_work_routine;
                    ...
                    /* WARNING: Subroutine does not return */
  _printk(&DAT_001065a4,"aw22xxx_fw_init");
}



/* 0010309c aw22xxx_create_proc_entry */
...
/* 00103100 aw22xxx_brightness_work */
...

{
  ...
  uVar1 = sp_el0;
                    /* WARNING: Subroutine does not return */
  _printk(&DAT_00106a55,"aw22xxx_brightness_work");
}



/* 00103350 aw22xxx_task_work */
...

{
  ...
  uVar1 = sp_el0;
                    /* WARNING: Subroutine does not return */
  _printk(&DAT_00106a55,"aw22xxx_task_work");
}



/* 001035b4 aw22xxx_fw_show */
...

{
  ...
  FUN_00101c50(lVar4,0xff,local_60);
  uVar5 = 0;
  lVar3 = 0;
  do {
    if ((local_60[0] != '\0') || (((&aw22xxx_reg_access)[uVar5] & 1) != 0)) {
      FUN_00101c84(lVar4,uVar5 & 0xffffffff,local_5c);
...

{
  ...
  if ((iVar1 == 2) && ((uint)local_30 < 0x100)) {
    FUN_00101b20(lVar2 + -0x10,local_30 & 0xffffffff,local_30._4_4_);
    lVar2 = sp_el0;
    ...
    __stack_chk_fail();
                    ...
                    /* WARNING: Subroutine does not return */
  _printk(&DAT_00106680,"aw22xxx_reg_store",0x78b);
}



/* 001037fc aw22xxx_hwen_show */
...

{
  ...
  if (uVar1 < 0xe) {
    ...
    return lVar5 + iVar3;
                    ...
                    /* WARNING: Does not return */
  pcVar2 = (code *)SoftwareBreakpoint(0x5512,0x103bcc);
  (*pcVar2)();
}



/* 00103bd0 aw22xxx_imax_store */
...

{
  ...
  if ((iVar1 == 2) && ((uint)local_30 < 9)) {
    *(undefined4 *)(lVar2 + (local_30 & 0xffffffff) * 4 + 0x2fc) = local_30._4_4_;
                    /* WARNING: Subroutine does not return */
    _printk(&DAT_001063cc,"aw22xxx_rgb_store",0x8d3);
  }
  lVar2 = sp_el0;
  if (*(long *)(lVar2 + 0x710) == local_28) {
...

{
  ...
  if (iVar1 == 1) {
    *(char *)(lVar2 + 0x2ec) = (char)local_2c;
                    /* WARNING: Subroutine does not return */
    _printk(&DAT_00106957,"aw22xxx_task0_store",0x8f4,local_2c & 0xff);
  }
                    /* WARNING: Subroutine does not return */
  _printk(&DAT_001062d3,"aw22xxx_task0_store",0x8ef);
}



/* 00103fdc aw22xxx_task1_show */
...

{
  ...
  if (iVar1 == 1) {
    *(char *)(lVar2 + 0x2ed) = (char)local_2c;
                    /* WARNING: Subroutine does not return */
    _printk(&DAT_001061d1,"aw22xxx_task1_store",0x911,local_2c & 0xff);
  }
                    /* WARNING: Subroutine does not return */
  _printk(&DAT_001062d3,"aw22xxx_task1_store",0x90c);
}



/* 001040dc aw22xxx_task_irq_show */
...
/* 00104118 aw22xxx_task_irq_store */
...

{
  ...
  if (iVar1 == 1) {
    *(undefined4 *)(lVar2 + 0x2e8) = local_2c;
                    /* WARNING: Subroutine does not return */
    _printk(&DAT_00106c90,"aw22xxx_task_irq_store",0x92c);
  }
                    /* WARNING: Subroutine does not return */
  _printk(&DAT_001062d3,"aw22xxx_task_irq_store",0x927);
}



/* 001041d8 aw22xxx_para_show */
...
LAB_001042f0:
                    /* WARNING: Does not return */
          pcVar1 = (code *)SoftwareBreakpoint(0x5512,0x1042f4);
          (*pcVar1)();
        }
        lVar3 = lVar3 + iVar2;
      }
      else if (0xc34 < uVar4 >> 3) goto LAB_001042f0;
...
/* 001042f8 aw22xxx_para_store */

void aw22xxx_para_store(void)

{
                    /* WARNING: Subroutine does not return */
  _printk(&DAT_00106860,"aw22xxx_para_store");
}



/* 00104750 aw22xxx_multi_breath_pattern_show */
...
/* 0010478c aw22xxx_set_brightness */
...

{
  ...
  if (iVar1 == 1) {
    *(byte *)(lVar2 + 0x2f4) = (byte)local_2c & 0xf;
                    /* WARNING: Subroutine does not return */
    _printk(&DAT_001067fe,"aw22xxx_cfg_store",0x7f6);
  }
                    /* WARNING: Subroutine does not return */
  _printk(&DAT_001073ab,"aw22xxx_cfg_store",0x7f0);
}



/* 001049bc aw22xxx_effect_show */
...

{
  ...
  if (iVar1 != 1) {
                    /* WARNING: Subroutine does not return */
    _printk(&DAT_00106680,"aw22xxx_effect_store",0x850);
  }
  mutex_lock(lVar2 + 0x2a0);
  if ((local_54[0] - 8 < 3) && (init_flag == 1)) {
                    /* WARNING: Subroutine does not return */
    _printk(&DAT_00106748,"aw22xxx_effect_store",0x857);
  }
  *(uint *)(lVar2 + 0x2f0) = local_54[0];
  if ((local_54[0] < 4) && ((local_54[0] != 1 && ((init_flag & 1) == 0)))) {
    init_flag = 1;
                    /* WARNING: Subroutine does not return */
    _printk(&DAT_001071b8,"aw22xxx_effect_store",0x869);
  }
                    /* WARNING: Subroutine does not return */
  _printk(&DAT_00107aba,"aw22xxx_effect_store",0x86c);
}



/* 00104ccc aw22xxx_get_fwname */

void aw22xxx_get_fwname(ulong param_1)

{
                    /* WARNING: Subroutine does not return */
  _printk(&DAT_00107902,"aw22xxx_get_fwname",0x821,param_1 >> 0x18 & 0xff);
}



/* 00104ec8 aw22xxx_cfg_update_wait_from_dyn_name */
...

{
  ...
  uVar1 = sp_el0;
                    /* WARNING: Subroutine does not return */
  _printk(&DAT_00106a55,"aw22xxx_cfg_update_wait_from_dyn_name");
}



/* 00104fcc aw22xxx_set_cfg_run_state */

void aw22xxx_set_cfg_run_state(ulong param_1)

{
                    /* WARNING: Subroutine does not return */
  _printk(&DAT_00106a99,"aw22xxx_set_cfg_run_state",0x74d,param_1 >> 0x18 & 0xff);
}



/* 001050f0 aw22xxx_cfg_loaded */

void aw22xxx_cfg_loaded(void)

{
                    /* WARNING: Subroutine does not return */
  _printk(&DAT_00106a55,"aw22xxx_cfg_loaded");
}



/* 001052d0 aw22xxx_multi_breath_pattern_store */
  ...
  if (iVar1 == 1) {
    ...
    *(int *)(lVar4 + 0x2f8) = local_3c;
    if (local_3c == 0) {
      ...
      uVar2 = kthread_create_on_node(aw22xxx_play,lVar3,0xffffffff,&DAT_00106cba,"aw22xxx_play");
...
/* 00105464 aw22xxx_fw_timer_func */

void aw22xxx_fw_timer_func(void)

{
                    /* WARNING: Subroutine does not return */
  _printk(&DAT_00106a55,"aw22xxx_fw_timer_func");
}



/* 001054b8 aw22xxx_fw_work_routine */

void aw22xxx_fw_work_routine(void)

{
                    /* WARNING: Subroutine does not return */
  _printk(&DAT_00106a55,"aw22xxx_fw_work_routine");
}



/* 0010554c aw22xxx_cfg_work_routine */

void aw22xxx_cfg_work_routine(void)

{
                    /* WARNING: Subroutine does not return */
  _printk(&DAT_00106a55,"aw22xxx_cfg_work_routine");
}



/* 00105634 aw22xxx_recover_work_routine */
...

{
  ...
  uVar1 = sp_el0;
                    /* WARNING: Subroutine does not return */
  _printk(&DAT_00106cdc,"aw22xxx_recover_work_routine");
}



/* 00105840 aw22xxx_led_init */
...

{
  ...
  uVar1 = sp_el0;
                    /* WARNING: Subroutine does not return */
  _printk(&DAT_00106a55,"aw22xxx_led_init");
}



/* 00105940 FUN_00105940 */

void FUN_00105940(undefined8 param_1,long param_2)

{
                    /* WARNING: Subroutine does not return */
  _printk(param_1,param_2 + 0x994,0x1aa,0);
}



/* 001059d0 aw22xxx_cfg_recover_update_wait */
...

{
  ...
  uVar1 = sp_el0;
                    /* WARNING: Subroutine does not return */
  _printk(&DAT_00106a55,"aw22xxx_cfg_recover_update_wait");
}



/* 00105d9c get_aw22xxx_id */
...

{
  ...
  if (*in_x3 != 0) {
    return 0;
                    ...
                    /* WARNING: Subroutine does not return */
  _printk(&DAT_00106f7e,"get_aw22xxx_id",0x9b3,g_chip_id);
}



/* 0010dfd4 init_module */

void init_module(void)

{
                    /* WARNING: Subroutine does not return */
  _printk(&DAT_001066f5,"v1.1.3");
}



/* 0010e050 cleanup_module */
