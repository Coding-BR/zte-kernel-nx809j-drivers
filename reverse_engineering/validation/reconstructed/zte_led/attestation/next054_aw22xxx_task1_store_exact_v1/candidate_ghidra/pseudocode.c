...

{
  ...
  uStack_80 = 0;
  local_94[0] = '\0';
  _printk(&DAT_00106f05,"aw22xxx_fw_loaded");
  if (param_1 == (ulong *)0x0) {
    _printk(&DAT_00106c6f,"aw22xxx_fw_loaded",&aw22xxx_fw_name);
    release_firmware(0);
  }
  else {
    _printk(&DAT_00106946,"aw22xxx_fw_loaded",&aw22xxx_fw_name,*param_1);
    uVar1 = *param_1;
    ...
    if (uVar1 < 3) {
      ...
      if (uVar15 < 2) {
        ...
        if (((uVar17 < 0x7ffffffe) && (uVar12 = 0, uVar17 < 0x7ffffffd)) && (uVar1 - 3 >> 0x20 == 0)
          ...
          if (uVar15 == uVar18) goto LAB_001011f8;
        }
      }
      do {
        iVar14 = iVar14 + 1;
...
LAB_001011f8:
    if (uVar12 == (ushort)(*puVar2 >> 8 | *puVar2 << 8)) {
      _printk(&DAT_00106f8c,"aw22xxx_fw_loaded");
      uVar15 = *param_1;
      uVar1 = uVar15 + 0x10;
      ...
      if (puVar7 == (uint *)0x0) {
        ...
        _printk(&DAT_001075b9,"aw22xxx_fw_loaded",*(undefined1 *)(param_1[1] + 2));
        local_88 = *(undefined8 *)(param_1[1] + 3);
        uStack_80 = *(undefined8 *)(param_1[1] + 0xb);
        _printk(&DAT_00106a6f,"aw22xxx_fw_loaded",&local_88);
        local_88 = *(undefined8 *)(param_1[1] + 0x13);
        _printk(&DAT_001079b1,"aw22xxx_fw_loaded",&local_88);
        if ((uVar1 < 4) || ((uVar1 & 0xfffffffffffffffc) == 4)) goto LAB_00101d38;
        uVar17 = (*(uint *)(param_1[1] + 0x1b) & 0xff00ff00) >> 8 |
                 (*(uint *)(param_1[1] + 0x1b) & 0xff00ff) << 8;
        puVar7[1] = uVar17 >> 0x10 | uVar17 << 0x10;
        _printk(&DAT_00107c87,"aw22xxx_fw_loaded");
        if ((uVar1 < 8) || ((uVar1 & 0xfffffffffffffffc) == 8)) goto LAB_00101d38;
        puVar7[2] = (uint)(*(ushort *)(param_1[1] + 0x22) >> 8) |
                    (*(ushort *)(param_1[1] + 0x22) & 0xff00ff) << 8;
        _printk(&DAT_001078d0,"aw22xxx_fw_loaded");
        if ((uVar1 < 0xc) || ((uVar1 & 0xfffffffffffffffc) == 0xc)) goto LAB_00101d38;
        puVar7[3] = (uint)*(byte *)(param_1[1] + 0x24);
        _printk(&DAT_00107fba,"aw22xxx_fw_loaded");
        *puVar7 = (uint)(*(ushort *)(param_1[1] + 0x26) >> 8) |
                  (*(ushort *)(param_1[1] + 0x26) & 0xff00ff) << 8;
        _printk(&DAT_001079c7,"aw22xxx_fw_loaded");
        uVar11 = 0;
        if (0xf < uVar1) {
          uVar11 = uVar15;
        }
        ...
        release_firmware(param_1);
        FUN_00102174(param_2,1,0x55);
        usleep_range_state(2000,3000,2);
        _printk(&DAT_00107ab4,"aw22xxx_chip_enable",0x1aa,1);
        local_8c[0] = 0;
        FUN_001022b4(param_2,2,local_8c);
        local_8c[0] = local_8c[0] | 1;
        FUN_001021cc(param_2,2);
        usleep_range_state(2000,3000,2);
        local_8c[0] = 0;
        FUN_001022e8(param_2,4,local_8c);
        local_8c[0] = local_8c[0] | 1;
        aw22xxx_i2c_write(param_2,4);
        aw22xxx_i2c_write(param_2,0x22,*puVar7 + 0xffff >> 8);
        FUN_00102174(param_2,0x21,(byte)*puVar7 - 1);
        aw22xxx_i2c_write(param_2,0x24,7);
        usleep_range_state(5000,0x1964,2);
        FUN_00102368(param_2,0x24,local_94);
        if (local_94[0] == '\x05') {
          FUN_00102374(param_2,0x25,local_94);
          cVar5 = local_94[0];
          FUN_00102298(param_2,0x26,local_94);
          if ((uVar1 < 8) || ((uVar1 & 0xfffffffffffffffc) == 8)) goto LAB_00101d38;
          if ((uint)CONCAT11(local_94[0],cVar5) == puVar7[2]) {
            _printk(&DAT_00107a72,"aw22xxx_fw_loaded",(uint)CONCAT11(local_94[0],cVar5));
            if (*(char *)((long)param_2 + 0x2ee) == '\0') {
              kfree(puVar7);
              FUN_00102574(param_2,0x24,0);
              FUN_00104ff0(param_2);
              *(undefined1 *)((long)param_2 + 0x2ef) = 2;
              goto LAB_00101ccc;
            }
            if ((uVar1 & 0xfffffffffffffffc) == 4) goto LAB_00101d38;
            uVar17 = puVar7[1];
            puVar9 = &DAT_0010704a;
          }
          else {
          ...
          _printk(&DAT_001075d4,"aw22xxx_fw_loaded");
          _printk(&DAT_001079de,"aw22xxx_fw_loaded");
        }
        FUN_0010256c(param_2,0x24,0);
        local_90[0] = '\0';
        FUN_00102594(param_2,0xff,0);
        FUN_00102564(param_2,1,0x55);
        usleep_range_state(2000,3000,2);
        _printk(&DAT_00107ab4,"aw22xxx_chip_enable",0x1aa,1);
        local_8c[0] = 0;
        FUN_00102694(param_2,2,local_8c);
        local_8c[0] = local_8c[0] | 1;
        FUN_0010256c(param_2,2);
        usleep_range_state(2000,3000,2);
        local_8c[0] = 0;
        FUN_00102698(param_2,4,local_8c);
        local_8c[0] = local_8c[0] | 1;
        FUN_00102574(param_2,4);
        FUN_00102564(param_2,0x80,0xec);
        FUN_00102754(param_2,0x35,0x29);
        if ((uVar1 < 0xc) || ((uVar1 & 0xfffffffffffffffc) == 0xc)) {
LAB_00101d38:
                    /* WARNING: Does not return */
          pcVar6 = (code *)SoftwareBreakpoint(1,0x101d3c);
          (*pcVar6)();
        }
        FUN_0010256c(param_2,0x38,puVar7[3]);
        FUN_0010258c(param_2,0x22,0);
        FUN_0010258c(param_2,0x21,0);
        FUN_0010256c(param_2,0x20,3);
        FUN_0010256c(param_2,0x30,3);
        ...
        FUN_00102564(param_2,0x30,0);
        FUN_00102594(param_2,0x22,0x40);
        FUN_00102564(param_2,0x21,0);
        FUN_00102574(param_2,0x30,2);
        thunk_FUN_001026bc(param_2,0x23,0);
        usleep_range_state(6000,0x1964,2);
        FUN_0010256c(param_2,0x30,0);
        FUN_0010256c(param_2,0x22,0x42);
        FUN_0010258c(param_2,0x21,0);
        FUN_0010258c(param_2,0x30,2);
        FUN_0010256c(param_2,0x23,0);
        usleep_range_state(6000,0x1964,2);
        FUN_001025cc(param_2,0x30,0);
        FUN_001025cc(param_2,0x22,0x44);
        FUN_0010256c(param_2,0x21,0);
        FUN_0010256c(param_2,0x30,2);
        FUN_0010258c(param_2,0x23,0);
        usleep_range_state(6000,0x1964,2);
        FUN_0010256c(param_2,0x30,0);
        FUN_0010256c(param_2,0x20,0);
        FUN_0010254c(param_2,0x20,3);
        if (*puVar7 != 0) {
          uVar17 = 0;
          uVar4 = sp_el0;
          do {
            aw22xxx_i2c_write(param_2,0x22,uVar17 >> 8);
            FUN_00102174(param_2,0x21,uVar17);
            aw22xxx_i2c_write(param_2,0x11,1);
            FUN_00102354(param_2,0x30,4);
              ...
              *puVar8 = 0x23;
              if (uVar11 < uVar15) {
                ...
                if (uVar15 <= uVar18) {
                  ...
                  if (iVar14 < 0) {
                    _printk(&DAT_00106fab,"aw22xxx_i2c_writes");
                  }
                  kfree(puVar8);
                  goto LAB_00101af0;
                }
            ...
            _printk(&DAT_0010716d,"aw22xxx_i2c_writes");
LAB_00101af0:
            FUN_00102174(param_2,0x11,0);
        ...
        _printk(&DAT_00107ab4,"aw22xxx_chip_enable",0x1aa,1);
        local_8c[0] = 0;
        FUN_001026b4(param_2,2,local_8c);
        local_8c[0] = local_8c[0] | 1;
        FUN_001021cc(param_2,2);
        usleep_range_state(2000,3000,2);
        local_8c[0] = 0;
        FUN_001026e8(param_2,4,local_8c);
        local_8c[0] = local_8c[0] | 1;
        aw22xxx_i2c_write(param_2,4);
        aw22xxx_i2c_write(param_2,0x22,*puVar7 + 0xffff >> 8);
        FUN_00102174(param_2,0x21,(byte)*puVar7 - 1);
        aw22xxx_i2c_write(param_2,0x24,7);
        usleep_range_state(5000,0x1964,2);
        FUN_00102668(param_2,0x24,local_90);
        if (local_90[0] == '\x05') {
          FUN_00102674(param_2,0x25,local_90);
          cVar5 = local_90[0];
          FUN_00102298(param_2,0x26,local_90);
          if ((uVar1 < 8) || ((uVar1 & 0xfffffffffffffffc) == 8)) goto LAB_00101d38;
          if ((uint)CONCAT11(local_90[0],cVar5) == puVar7[2]) {
            puVar9 = &DAT_00107a72;
            goto LAB_00101c4c;
          }
          _printk(&DAT_00106a86,"aw22xxx_container_update",puVar7[2]);
          _printk(&DAT_001079f4,"aw22xxx_container_update");
          uVar10 = 3;
        }
        else {
          puVar9 = &DAT_001075d4;
...
/* 00101d48 aw22xxx_init_cfg_update_array */
...

{
  ...
  _printk(&DAT_00106e36,"aw22xxx_init_cfg_update_array",0x1ca);
  _printk(&DAT_00107ab4,"aw22xxx_chip_enable",0x1aa,1);
  local_2c[0] = 0;
...
/* 00101e9c aw22xxx_set_breath_data */
...

{
  ...
  while( true ) {
    ...
    if (read_idx == write_idx) {
      ...
      _printk(&DAT_001074c6,"aw22xxx_play");
    }
    if ((kthread_status & 1) == 0) {
      ...
      _printk(&DAT_0010711b,"aw22xxx_play");
    }
    ...
    read_idx = read_idx + 1;
                    ...
                    /* WARNING: Does not return */
  pcVar1 = (code *)SoftwareBreakpoint(0x5512,0x1020f0);
  (*pcVar1)();
}



/* 001020f4 aw22xxx_led_imax_cfg */
...

{
  ...
  *(undefined4 *)(param_1 + 0x2f0) = 7;
  _printk(&DAT_00106d1c,"aw22xxx_led_imax_cfg",
...

{
  ...
  if (iVar2 < 0) {
    ...
    _printk(&DAT_001068ab,"aw22xxx_i2c_write",0,iVar2,uVar3);
    msleep(1);
    iVar2 = i2c_transfer_buffer_flags(*param_1,&uStack_3c,2,0);
    if (iVar2 < 0) {
      gpio_to_desc(*(undefined4 *)(param_1 + 0x5c));
      uVar3 = gpiod_get_raw_value();
      _printk(&DAT_001068ab,"aw22xxx_i2c_write",1,iVar2,uVar3);
      uVar4 = gpio_to_desc(*(undefined4 *)(param_1 + 0x5c));
      gpiod_direction_output_raw(uVar4,1);
      _printk(&DAT_001067d3,"aw22xxx_i2c_write");
      msleep(1);
    }
  }
  lVar1 = sp_el0;
...
void FUN_00102174(undefined8 *param_1,undefined1 param_2,undefined1 param_3)
...

{
  ...
  if ((int)uVar2 < 0) {
    ...
    if (-1 < (int)uVar3) goto LAB_001022f0;
    puVar4 = &DAT_00106d3f;
    *param_3 = (char)uVar3;
...
/* 00102298 FUN_00102298 */

void FUN_00102298(undefined8 *param_1,undefined1 param_2,undefined1 *param_3)
...
/* 001022b4 FUN_001022b4 */

void FUN_001022b4(long param_1,undefined8 *param_2,undefined1 param_3)
...

{
  ...
  if ((int)uVar2 < 0) {
    *unaff_x19 = (char)uVar2;
    _printk(&DAT_00106d3f,"aw22xxx_i2c_read",uVar2 & 0xffffffff);
    msleep(1);
...

{
  ...
  if ((int)uVar2 < 0) {
    *unaff_x19 = (char)uVar2;
    uVar2 = uVar2 & 0xffffffff;
    _printk(&DAT_00106d3f,"aw22xxx_i2c_read",uVar2);
    msleep(1);
  }
  lVar1 = sp_el0;
  if (*(long *)(lVar1 + 0x710) == in_stack_00000008) {
...
/* 00102564 FUN_00102564 */

undefined8 FUN_00102564(void)
...
/* 0010258c FUN_0010258c */

undefined4 FUN_0010258c(void)
...
undefined4 FUN_00102594(undefined8 param_1)
...
/* 00102668 FUN_00102668 */

int FUN_00102668(void)
...
/* 00102674 FUN_00102674 */

int FUN_00102674(void)
...
/* 001026b4 FUN_001026b4 */

undefined8 FUN_001026b4(void)
...
/* 001026e8 FUN_001026e8 */

undefined4 FUN_001026e8(void)
...
LAB_00102934:
        *(long *)(unaff_x21 + 0xb8) = unaff_x19;
        ...
        aw22xxx_fw_name._7_1_ = 0x5f;
        uRam000000000010eba0 = 0x6e69622e7766;
        _printk(&DAT_00106c1d,"aw22xxx_load_nubia_fw_name",0x5de,*(undefined4 *)(unaff_x19 + 0x2e8),
                0);
        aw22xxx_fw_init();
        _printk(&DAT_00107f24,"aw22xxx_i2c_probe",0xa56);
        uVar2 = gpio_to_desc(*(undefined4 *)(unaff_x19 + 0x2e0));
...

{
  ...
  _printk(&DAT_00106f05,"aw22xxx_hw_reset");
...

{
  ...
  if (-1 < iVar2) {
    if (local_2c[0] == 'v') {
LAB_00102c64:
      _printk(&DAT_00107211,"aw22xxx_read_chipid",local_2c[0],iVar2);
      ...
      if (local_2c[0] == '\x18') {
        ...
        if (local_2c[0] != '\'') {
          _printk(&DAT_001068d7,"aw22xxx_read_chipid");
          goto LAB_00102d68;
        }
        uVar4 = 2;
      ...
      *(undefined1 *)(param_1 + 0x2ed) = uVar4;
      _printk(&DAT_00107628,"aw22xxx_read_chipid");
      uVar3 = 0;
      goto LAB_00102d6c;
    }
    _printk(&DAT_00107dcf,"aw22xxx_read_chipid",local_2c[0],iVar2);
    msleep(1);
    iVar2 = aw22xxx_i2c_read(param_1,1,local_2c);
    if (-1 < iVar2) {
      if (local_2c[0] == 'v') goto LAB_00102c64;
      _printk(&DAT_00107dcf,"aw22xxx_read_chipid",local_2c[0],iVar2);
      msleep(1);
LAB_00102d68:
      uVar3 = 0xffffffea;
...
/* 00102d98 aw22xxx_interrupt_setup */
...

{
  ...
  _printk(&DAT_00106f05,"aw22xxx_interrupt_setup");
  local_44[0] = 0;
  _printk(&DAT_00106f05,"aw22xxx_interrupt_clear");
  aw22xxx_i2c_read(param_1,10,local_44);
  _printk(&DAT_001069af,"aw22xxx_interrupt_clear",local_44[0]);
  local_40[0] = 0;
...

{
  ...
  _printk(&DAT_001069af,"aw22xxx_irq_v15",local_44[0]);
  if ((local_44[0] & 1) != 0) {
    _printk(&DAT_00106bce,"aw22xxx_irq_v15");
    ...
    aw22xxx_i2c_write(param_2,4);
    _printk(&DAT_00107ab4,"aw22xxx_chip_enable",0x1aa,0);
    local_38[0] = 0;
    aw22xxx_i2c_read(param_2,2,local_38);
    local_38[0] = local_38[0] & 0xfe;
    aw22xxx_i2c_write(param_2,2);
    usleep_range_state(2000,3000,2);
    _printk(&DAT_00106dd9,"aw22xxx_irq_v15");
  }
  if ((local_44[0] >> 4 & 1) != 0) {
    _printk(&DAT_00106f12,"aw22xxx_irq_v15");
    aw22xxx_i2c_write(param_2,0xff,0);
    local_34[0] = 0;
...

{
  ...
  local_28 = *(long *)(lVar1 + 0x710);
  local_2c[0] = 0;
  _printk(&DAT_00106f05,"aw22xxx_irq");
  aw22xxx_i2c_read(param_2,10,local_2c);
  _printk(&DAT_001069af,"aw22xxx_irq",local_2c[0]);
  if ((local_2c[0] >> 4 & 1) != 0) {
    queue_work_on(0x20,_system_wq,param_2 + 0x250);
    _printk(&DAT_00106af0,"aw22xxx_irq",0x625,*(undefined4 *)(param_2 + 0x2f8));
  ...
  _printk(&DAT_00107a4b,"aw22xxx_irq");
  lVar1 = sp_el0;
  if (*(long *)(lVar1 + 0x710) == local_28) {
    return 1;
  }
...
/* 001031ec aw22xxx_parse_led_cdev */
...

{
  ...
  _printk(&DAT_00106f05,"aw22xxx_parse_led_cdev");
...
/* 001033f4 aw22xxx_alloc_name_array */
...

{
  ...
  if (aw22xxx_cfg_name == (undefined8 *)0x0) {
    _printk(&DAT_0010690b,"aw22xxx_alloc_name_array",0x687);
  }
  else {
    lVar4 = 0;
    uVar1 = sp_el0;
    do {
      ...
      if (lVar2 == 0) {
        ...
        kfree(puVar3);
        _printk(&DAT_0010690b,"aw22xxx_alloc_name_array",0x692);
        return;
      }
      lVar4 = lVar4 + 1;
    } while (lVar4 != 0xb);
...

{
  ...
  *(code **)(param_1 + 0x248) = aw22xxx_cfg_work_routine;
  ...
  _printk(&DAT_00106a54,"aw22xxx_fw_init");
...
/* 0010372c aw22xxx_create_proc_entry */
...
/* 00103790 aw22xxx_brightness_work */
...

{
  ...
  lVar3 = param_1 + -0x1d0;
  local_28 = *(long *)(lVar1 + 0x710);
  _printk(&DAT_00106f05,"aw22xxx_brightness_work");
...

{
  ...
  lVar3 = param_1 + -0x1f0;
  local_38 = *(long *)(lVar1 + 0x710);
  _printk(&DAT_00106f05,"aw22xxx_task_work");
  aw22xxx_i2c_write(lVar3,5,0xff);
  local_4c[0] = 0;
...

{
  ...
  if ((iVar1 == 2) && ((uint)local_30 < 0x100)) {
    ...
    _printk(&DAT_00106b30,"aw22xxx_reg_store",0x78b);
...

{
  ...
  if (iVar1 == 1) {
    if (local_3c < 2) {
      if (local_3c == 1) {
        ...
        _printk(&DAT_00106f05,"aw22xxx_hw_off");
  ...
  _printk(&DAT_00106b30,"aw22xxx_hwen_store",0x7b9);
  param_4 = 0xffffffffffffffea;
LAB_00103f7c:
  lVar3 = sp_el0;
...

{
  ...
  if (uVar1 < 0xe) {
    ...
    return lVar5 + iVar3;
                    ...
                    /* WARNING: Does not return */
  pcVar2 = (code *)SoftwareBreakpoint(0x5512,0x104220);
  (*pcVar2)();
}



/* 00104224 aw22xxx_imax_store */
...

{
  ...
  if ((iVar1 == 1) && (local_3c < 0xd)) {
    *(uint *)(lVar3 + 0x2e0) = local_3c;
    ...
    _printk(&DAT_00106b30,"aw22xxx_imax_store",0x8a7);
    param_4 = 0xffffffffffffffea;
  }
  lVar3 = sp_el0;
  if (*(long *)(lVar3 + 0x710) == local_38) {
...

{
  ...
  if ((iVar1 == 2) && ((uint)local_30 < 9)) {
    *(undefined4 *)(lVar2 + (local_30 & 0xffffffff) * 4 + 0x2fc) = local_30._4_4_;
    _printk(&DAT_0010687c,"aw22xxx_rgb_store",0x8d3);
  }
  else {
    param_4 = 0xffffffffffffffea;
  }
...

{
  ...
  if (iVar1 == 1) {
    *(char *)(lVar2 + 0x2ec) = (char)local_2c;
    _printk(&DAT_00106e07,"aw22xxx_task0_store",0x8f4,local_2c & 0xff);
    queue_work_on(0x20,_system_wq,lVar2 + 0x1e0);
  }
  else {
    _printk(&DAT_00106783,"aw22xxx_task0_store",0x8ef);
    param_4 = 0xffffffffffffffea;
  }
  lVar2 = sp_el0;
  if (*(long *)(lVar2 + 0x710) == local_28) {
...

{
  ...
  if (iVar1 == 1) {
    *(char *)(lVar2 + 0x2ed) = (char)local_2c;
    _printk(&DAT_00106681,"aw22xxx_task1_store",0x911,local_2c & 0xff);
  }
  else {
    _printk(&DAT_00106783,"aw22xxx_task1_store",0x90c);
    param_4 = 0xffffffffffffffea;
  }
  lVar2 = sp_el0;
  if (*(long *)(lVar2 + 0x710) == local_28) {
...

{
  ...
  local_28 = *(long *)(lVar1 + 0x710);
  local_2c[0] = 0;
  _printk(&DAT_0010864f,"aw22xxx_led_init");
  _printk(&DAT_00108235,"aw22xxx_led_init");
  aw22xxx_i2c_write(param_1,1,0x55);
  usleep_range_state(2000,3000,2);
  aw22xxx_i2c_read(param_1,2,local_2c);
  local_2c[0] = local_2c[0] | 1;
  ...
  if (*(uint *)(param_1 + 0x2f0) < 0xd) {
    ...
    _printk(&DAT_00108756,"aw22xxx_led_init");
    aw22xxx_i2c_read(param_1,2,local_2c);
    local_2c[0] = local_2c[0] & 0xfe;
    aw22xxx_i2c_write(param_1,2);
    usleep_range_state(2000,3000,2);
    _printk(&DAT_00108004,"aw22xxx_led_init");
    uVar2 = 0;
  }
  else {
    uVar2 = 0xffffffea;
...
/* 00104830 FUN_00104830 */

void FUN_00104830(void)
...
/* 001048b8 aw22xxx_fw_work_routine */

void aw22xxx_fw_work_routine(long param_1)

{
  _printk(&DAT_0010864f,"aw22xxx_fw_work_routine");
  _printk(&DAT_001081f1);
...
/* 0010493c aw22xxx_cfg_work_routine */

void aw22xxx_cfg_work_routine(long param_1)

{
  _printk(&DAT_0010864f,"aw22xxx_cfg_work_routine");
  _printk(&DAT_001083b8);
...

{
  ...
  _printk(&DAT_0010864f,"aw22xxx_cfg_loaded");
  if (param_1 == (ulong *)0x0) {
    _printk(&DAT_0010819a);
    release_firmware(0);
  }
  else {
    _printk(&DAT_001086a7,"aw22xxx_cfg_loaded",*(undefined4 *)(param_2 + 0x300),*param_1);
    if (1 < *param_1) {
      lVar8 = 0;
      bVar7 = 0;
      do {
    ...
    if (*(uint *)(param_2 + 0x2f0) < 0xd) {
      ...
      _printk(&DAT_00108004,"aw22xxx_cfg_loaded");
    }
  }
  return;
}
...
/* 00104be0 aw22xxx_recover_work_routine */
...

{
  ...
  lVar1 = param_1 + -0x250;
  local_3c[0] = 0;
  _printk(&DAT_0010864f,"aw22xxx_recover_work_routine");
  ...
  msleep(200);
  _printk(&DAT_0010878c,"aw22xxx_recover_work_routine");
...
/* 00104dc8 aw22xxx_cfg_recover_update_wait */
...

{
  ...
  local_60 = (ulong *)0x0;
  _printk(&DAT_0010864f,"aw22xxx_cfg_recover_update_wait");
  _printk(&DAT_001081b8,*(undefined1 *)(param_1 + 0x2ef));
  if ((*(uint *)(param_1 + 0x300) & 0xfffffffe) == 4) {
    lamp_effect = *(uint *)(param_1 + 0x300);
  }
  _printk(&DAT_0010870c,"aw22xxx_cfg_recover_update_wait",lamp_effect);
  if ((*(uint *)(param_1 + 0x300) & 0xfffffffe) == 2) {
    fan_effect = *(uint *)(param_1 + 0x300);
  }
  _printk(&DAT_00108217,"aw22xxx_cfg_recover_update_wait",fan_effect);
  if ((*(uint *)(param_1 + 0x300) >> 2 < 0x465) && (aw22xxx_cfg_name != 0)) {
    __s = *(char **)(aw22xxx_cfg_name + (ulong)*(uint *)(param_1 + 0x300) * 8);
    _printk(&DAT_001084f1,"aw22xxx_cfg_recover_update_wait",__s);
    sVar6 = strlen(__s);
    bVar10 = g_init_flg;
    if (sVar6 < 5) {
      puVar7 = &DAT_001084be;
      ...
      if (*(char *)(param_1 + 0x2ef) == '\x02') {
        *(bool *)(param_1 + 0x348) = *(int *)(param_1 + 0x300) != 2;
        ...
        if (iVar5 == 0) {
          _printk(&DAT_00108931);
          if (local_60 == (ulong *)0x0) {
            _printk(&DAT_00108288);
            release_firmware(local_60);
          }
          else {
            _printk(&DAT_001086c9,*local_60);
            if (1 < *local_60) {
              lVar11 = 0;
              bVar10 = 0;
              do {
            ...
            *(int *)(param_1 + 0x2f8) = *(int *)(param_1 + 0x2f8) + 1;
            ...
            _printk(&DAT_001088f0,*(undefined4 *)(param_1 + 0x2f8));
            msleep(0x14);
          }
        }
        else {
          _printk(&DAT_001080bd,"aw22xxx_cfg_recover_update_wait",iVar5);
        }
        goto LAB_00104ef8;
      }
      puVar7 = &DAT_0010890e;
...
/* 00105154 aw22xxx_fw_timer_func */
...
{
  _printk(&DAT_0010864f,"aw22xxx_fw_timer_func");
...
/* 001051a8 aw22xxx_set_brightness */
...

{
  ...
  _printk(&DAT_0010864f,"get_aw22xxx_id");
...

{
  ...
  if (iVar1 == 1) {
    *(byte *)(lVar2 + 0x2f4) = (byte)local_2c & 0xf;
    _printk(&DAT_0010815f,"aw22xxx_cfg_store");
  }
  else {
    _printk(&DAT_001082ad,"aw22xxx_cfg_store");
    param_4 = 0xffffffffffffffea;
  }
  lVar2 = sp_el0;
  if (*(long *)(lVar2 + 0x710) == local_28) {
...

{
  ...
  if (iVar1 == 1) {
    lVar2 = lVar3 + -0x10;
    _printk(&DAT_0010867a,"aw22xxx_effect_store",local_4c);
    mutex_lock(lVar3 + 0x2a0);
    if ((local_4c - 8 < 3) && (init_flag != 0)) {
      _printk(&DAT_001082c9,"aw22xxx_effect_store");
      *(undefined4 *)(lVar3 + 0x2f0) = 4;
      ...
      init_flag = 0;
      _printk(&DAT_0010883a,"aw22xxx_effect_store");
    }
    *(uint *)(lVar3 + 0x2f0) = local_4c;
    _printk(&DAT_001086ef,"aw22xxx_effect_store");
    if (((local_4c < 4) && (local_4c != 1)) && ((init_flag & 1) == 0)) {
      init_flag = 1;
      _printk(&DAT_001088b0,"aw22xxx_effect_store");
    }
    ...
    if (g_cfg_cur_state == '\0') {
      _printk(&DAT_00108627,"aw22xxx_effect_store");
      aw22xxx_i2c_read(lVar2,2,local_50);
      local_50[0] = local_50[0] & 0xfe;
      aw22xxx_i2c_write(lVar2,2);
      usleep_range_state(2000,3000,2);
    ...
    _printk(&DAT_00108004,"aw22xxx_effect_store");
    mutex_unlock(lVar3 + 0x2a0);
  }
  else {
    _printk(&DAT_001082ad,"aw22xxx_effect_store");
    param_4 = 0xffffffffffffffea;
  }
  lVar3 = sp_el0;
...

{
  ...
  _printk(&DAT_0010840c,"aw22xxx_get_fwname",uVar8);
  _printk(&DAT_00108460,"aw22xxx_get_fwname",uVar2);
  _printk(&DAT_00108302,"aw22xxx_get_fwname",uVar1);
  iVar5 = (int)uVar8;
  if (iVar5 == 3) {
    sprintf(aw22xxx_dyn_name,"aw_fan%x_%x.bin",(ulong)uVar2,(ulong)uVar1);
LAB_001057c8:
    _printk(&DAT_00108371,"aw22xxx_get_fwname",aw22xxx_dyn_name);
    return;
  }
  if (iVar5 == 2) {
  ...
  if (((iVar5 != 0) || (10 < uVar1)) || (aw22xxx_cfg_name == 0)) {
    _printk(&DAT_001087ab,"aw22xxx_get_fwname");
    return;
  }
  ...
  pcStack_50 = __s;
  _printk(&DAT_0010864f,"aw22xxx_cfg_update_wait_from_dyn_name");
  bVar4 = g_init_flg;
  ...
  _printk(&DAT_0010806e,"aw22xxx_cfg_update_wait_from_dyn_name",iVar5);
LAB_001058d4:
  lVar3 = sp_el0;
...
/* 00105820 aw22xxx_cfg_update_wait_from_dyn_name */
...

{
  ...
  _printk(&DAT_0010806e,"aw22xxx_cfg_update_wait_from_dyn_name",iVar3);
LAB_001058d4:
  lVar1 = sp_el0;
  if (*(long *)(lVar1 + 0x710) == local_28) {
    return;
...
/* 00105924 aw22xxx_set_cfg_run_state */
...

{
  ...
  _printk(&DAT_00108541,"aw22xxx_set_cfg_run_state",uVar4);
  _printk(&DAT_001081d6,"aw22xxx_set_cfg_run_state",uVar1);
  _printk(&DAT_0010838c,"aw22xxx_set_cfg_run_state",param_1 & 0xffffffff);
  iVar3 = (int)uVar4;
  if ((iVar3 == 1) && (uVar1 == 0)) {
  ...
  if (write_idx == 0) {
    ...
    if (write_idx * 0x19 < 1) {
      ...
      do {
        ...
        if (uVar4 == 25000) {
                    /* WARNING: Does not return */
          pcVar1 = (code *)SoftwareBreakpoint(0x5512,0x105c4c);
          (*pcVar1)();
        }
...

{
  ...
  _printk(&DAT_0010864f,"aw22xxx_para_store");
  lVar10 = __kmalloc_cache_noprof(_sscanf,0xcc0,100);
  if (lVar10 == 0) {
    _printk(&DAT_00108175,"aw22xxx_para_store");
    ...
    if (iVar9 == 0x19) {
      if (write_idx < 1000) {
        ...
        do {
          if (uVar11 == uVar12) {
                    /* WARNING: Does not return */
            pcVar8 = (code *)SoftwareBreakpoint(0x5512,0x105ec4);
            (*pcVar8)();
          }
        ...
        write_idx = iVar7 + 1;
        _printk(&DAT_0010831a,"aw22xxx_para_store");
      }
      else {
        _printk(&DAT_001083e1,"aw22xxx_para_store");
        param_4 = 0xffffffffffffffe4;
      }
    }
    else {
      _printk(&DAT_00108099,"aw22xxx_para_store");
      param_4 = 0xffffffffffffffea;
    }
    kfree(lVar10);
  }
...
/* 00105ec8 aw22xxx_multi_breath_pattern_show */
...
/* 00105f04 aw22xxx_multi_breath_pattern_store */
    ...
    *(int *)(lVar3 + 0x2f8) = local_3c;
    if (local_3c == 0) {
      ...
      if (cfg_update_kthread < 0xfffffffffffff001) {
        wake_up_process();
        _kthread_status = 1;
        _printk(&DAT_00108117);
      }
      else {
        _kthread_status = 0;
        _printk(&DAT_00108735);
      }
    }
  }
  else {
...
/* 0010608c aw22xxx_task_irq_show */
...
/* 001060c8 aw22xxx_task_irq_store */
...

{
  ...
  if (iVar1 == 1) {
    *(undefined4 *)(lVar2 + 0x2e8) = local_2c;
    _printk(&DAT_0010881f,"aw22xxx_task_irq_store");
  }
  else {
    _printk(&DAT_001082ad,"aw22xxx_task_irq_store");
    param_4 = 0xffffffffffffffea;
  }
  lVar2 = sp_el0;
  if (*(long *)(lVar2 + 0x710) == local_28) {
