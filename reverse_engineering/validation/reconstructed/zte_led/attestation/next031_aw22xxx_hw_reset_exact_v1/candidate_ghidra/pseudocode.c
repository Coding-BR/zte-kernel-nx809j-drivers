...

{
  ...
  _printk(&DAT_001073f5,"aw22xxx_fw_loaded");
}



/* 00102260 aw22xxx_init_cfg_update_array */
...

{
  ...
  uVar1 = sp_el0;
                    /* WARNING: Subroutine does not return */
  _printk(&DAT_00107326,"aw22xxx_init_cfg_update_array",0x1ca);
}



/* 001023b4 aw22xxx_set_breath_data */
...

{
  ...
  while( true ) {
    ...
    if (read_idx == write_idx) {
      ...
      queue_work_on(0x20,_system_wq,param_1 + 0x230);
                    /* WARNING: Subroutine does not return */
      _printk(&DAT_001079b6,"aw22xxx_play");
    }
    if ((kthread_status & 1) == 0) break;
    if (25000 < (uint)(read_idx * 0x19)) {
                    /* WARNING: Does not return */
      pcVar1 = (code *)SoftwareBreakpoint(0x5512,0x102608);
      (*pcVar1)();
    }
  ...
  aw22xxx_i2c_write(param_1,2,0);
                    /* WARNING: Subroutine does not return */
  _printk(&DAT_0010760b,"aw22xxx_play");
}



/* 0010260c aw22xxx_led_imax_cfg */
...

{
  ...
  *(undefined4 *)(param_1 + 0x2f0) = 7;
                    /* WARNING: Subroutine does not return */
  _printk(&DAT_0010720c,"aw22xxx_led_imax_cfg",
          *(undefined8 *)(aw22xxx_cfg_name + (ulong)*(uint *)(param_1 + 0x300) * 8),7);
}



/* 0010267c aw22xxx_i2c_write */
...

{
  ...
  if (iVar2 < 0) {
    ...
    uVar3 = gpiod_get_raw_value();
                    /* WARNING: Subroutine does not return */
    _printk(&DAT_00106d9b,"aw22xxx_i2c_write",0,iVar2,uVar3);
  }
  lVar1 = sp_el0;
...
/* 001028e8 aw22xxx_i2c_probe */

void aw22xxx_i2c_probe(void)

{
                    /* WARNING: Subroutine does not return */
  _printk(&DAT_001079d7,"aw22xxx_i2c_probe",0x9d9);
}
...
/* 00102c00 FUN_00102c00 */

undefined4 FUN_00102c00(void)
...
/* 00102f84 aw22xxx_i2c_remove */

void aw22xxx_i2c_remove(void)

{
                    /* WARNING: Subroutine does not return */
  _printk(&DAT_001073f5,"aw22xxx_i2c_remove");
}



/* 00103048 aw22xxx_hw_reset */

void aw22xxx_hw_reset(void)

{
                    /* WARNING: Subroutine does not return */
  _printk(&DAT_001073f5,"aw22xxx_hw_reset");
}



/* 001030e8 aw22xxx_read_chipid */
...

{
  ...
  if (-1 < auVar3._0_4_) {
    if (local_2c[0] != 'v') {
                    /* WARNING: Subroutine does not return */
      _printk(&DAT_00108bfb,auVar3._8_8_,auVar3._0_8_ & 0xffffffff);
    }
...
/* 0010329c aw22xxx_interrupt_setup */
...

{
  ...
  uVar1 = sp_el0;
                    /* WARNING: Subroutine does not return */
  _printk(&DAT_0010919b,"aw22xxx_interrupt_setup");
}



/* 0010337c aw22xxx_irq */
...

{
  ...
  uVar1 = sp_el0;
                    /* WARNING: Subroutine does not return */
  _printk(&DAT_001090a2,"aw22xxx_irq");
}



/* 00103478 aw22xxx_irq_v15 */
...

{
  ...
  aw22xxx_i2c_read(param_2,10,local_2c);
                    /* WARNING: Subroutine does not return */
  _printk(&DAT_00108c20,"aw22xxx_irq_v15",local_2c[0]);
}



/* 00103684 aw22xxx_led_init */
...

{
  ...
  uVar1 = sp_el0;
                    /* WARNING: Subroutine does not return */
  _printk(&DAT_0010919b,"aw22xxx_led_init");
}



/* 00103804 aw22xxx_fw_init */
  ...
  *(code **)(param_1 + 0x248) = aw22xxx_cfg_work_routine;
  if (bVar1) {
    ...
    *(code **)(param_1 + 0x268) = aw22xxx_recover_work_routine;
                    ...
                    /* WARNING: Subroutine does not return */
  _printk(&DAT_001085ac,"aw22xxx_fw_init");
}



/* 001038dc aw22xxx_fw_timer_func */

void aw22xxx_fw_timer_func(void)

{
                    /* WARNING: Subroutine does not return */
  _printk(&DAT_0010919b,"aw22xxx_fw_timer_func");
}



/* 00103930 aw22xxx_fw_work_routine */

void aw22xxx_fw_work_routine(void)

{
                    /* WARNING: Subroutine does not return */
  _printk(&DAT_0010919b,"aw22xxx_fw_work_routine");
}



/* 00103984 FUN_00103984 */

void FUN_00103984(undefined8 param_1,undefined8 param_2,undefined8 param_3,undefined8 param_4)
...
/* 001039b4 aw22xxx_cfg_work_routine */

void aw22xxx_cfg_work_routine(void)

{
                    /* WARNING: Subroutine does not return */
  _printk(&DAT_0010919b,"aw22xxx_cfg_work_routine");
}



/* 00103a78 aw22xxx_recover_work_routine */
...

{
  ...
  uVar1 = sp_el0;
                    /* WARNING: Subroutine does not return */
  _printk(&DAT_0010919b,"aw22xxx_recover_work_routine");
}



/* 00103c64 aw22xxx_alloc_name_array */

void aw22xxx_alloc_name_array(void)

{
                    /* WARNING: Subroutine does not return */
  _printk(&DAT_0010919b,"aw22xxx_alloc_name_array");
}



/* 00103ee0 aw22xxx_parse_led_cdev */

void aw22xxx_parse_led_cdev(void)

{
                    /* WARNING: Subroutine does not return */
  _printk(&DAT_0010919b,"aw22xxx_parse_led_cdev");
}



/* 0010414c aw22xxx_brightness_work */
...

{
  ...
  uVar1 = sp_el0;
                    /* WARNING: Subroutine does not return */
  _printk(&DAT_0010919b,"aw22xxx_brightness_work");
}



/* 00104384 aw22xxx_task_work */
...

{
  ...
  uVar1 = sp_el0;
                    /* WARNING: Subroutine does not return */
  _printk(&DAT_0010919b,"aw22xxx_task_work");
}



/* 001045c8 aw22xxx_set_brightness */
...
/* 00104600 aw22xxx_create_proc_entry */

void aw22xxx_create_proc_entry(void)

{
                    /* WARNING: Subroutine does not return */
  _printk(&DAT_0010919b,"aw22xxx_create_proc_entry");
}



/* 00104be4 aw22xxx_cfg_show */
...

{
  ...
  if (iVar1 == 1) {
    *(byte *)(lVar2 + 0x2f4) = (byte)local_2c & 0xf;
                    /* WARNING: Subroutine does not return */
    _printk(&DAT_001087e7,"aw22xxx_cfg_store");
  }
                    /* WARNING: Subroutine does not return */
  _printk(&DAT_001089d4,"aw22xxx_cfg_store");
}



/* 00104d1c aw22xxx_effect_show */
...

{
  ...
  if (iVar2 == 1) {
                    /* WARNING: Subroutine does not return */
    _printk(&DAT_001091c6,"aw22xxx_effect_store",local_4c);
  }
                    /* WARNING: Subroutine does not return */
...
/* 00104fe4 aw22xxx_get_fwname */

void aw22xxx_get_fwname(ulong param_1)

{
                    /* WARNING: Subroutine does not return */
  _printk(&DAT_00108c3d,"aw22xxx_get_fwname",param_1 >> 0x18 & 0xff);
}



/* 00105160 aw22xxx_cfg_update_wait_from_dyn_name */
...

{
  ...
  uVar1 = sp_el0;
                    /* WARNING: Subroutine does not return */
  _printk(&DAT_0010919b,"aw22xxx_cfg_update_wait_from_dyn_name");
}



/* 00105384 aw22xxx_fw_show */
  ...
  if (iVar1 == 1) {
    if (local_2c < 2) {
      ...
      __stack_chk_fail();
                    ...
                    /* WARNING: Subroutine does not return */
  _printk(&DAT_0010946e,"aw22xxx_hwen_store");
}



/* 001055c0 aw22xxx_imax_show */
  ...
  if ((iVar2 == 1) && (local_3c < 0xd)) {
    ...
    *(uint *)(lVar4 + 0x2e0) = local_3c;
    ...
    __stack_chk_fail();
                    ...
                    /* WARNING: Subroutine does not return */
  _printk(&DAT_001085f5,"aw22xxx_imax_store");
}



/* 001058c0 aw22xxx_para_show */
  ...
  if (write_idx == 0) {
    ...
    if (write_idx * 0x19 < 1) {
      ...
      do {
        ...
        if (uVar4 == 25000) {
                    /* WARNING: Does not return */
          pcVar1 = (code *)SoftwareBreakpoint(0x5512,0x1059e0);
          (*pcVar1)();
        }
...
/* 001059e4 aw22xxx_para_store */

void aw22xxx_para_store(void)

{
                    /* WARNING: Subroutine does not return */
  _printk(&DAT_0010919b,"aw22xxx_para_store");
}



/* 00105c5c aw22xxx_multi_breath_pattern_show */
...
/* 00105c98 aw22xxx_multi_breath_pattern_store */
    ...
    *(int *)(lVar3 + 0x2f8) = local_3c;
    if (local_3c == 0) {
      ...
      if (0xfffffffffffff000 < cfg_update_kthread) {
        _kthread_status = 0;
                    /* WARNING: Subroutine does not return */
        _printk(&DAT_0010934e);
      }
      wake_up_process();
      _kthread_status = 1;
                    /* WARNING: Subroutine does not return */
      _printk(&DAT_00108778);
    }
  }
  else {
...

{
  ...
  do {
    if ((local_5c[0] != '\0') || (((&aw22xxx_reg_access)[uVar5] & 1) != 0)) {
      ...
      if (__maxlen < 0x21) goto LAB_00105ef8;
...

{
  ...
  if ((iVar1 == 2) && (local_30._4_4_ < 0x100)) {
    ...
    __stack_chk_fail();
                    ...
                    /* WARNING: Subroutine does not return */
  _printk(&DAT_0010907a,"aw22xxx_reg_store");
}



/* 00105ff0 aw22xxx_rgb_show */
...

{
  ...
  if (iVar1 == 1) {
    *(char *)(lVar2 + 0x2ec) = (char)local_2c;
                    /* WARNING: Subroutine does not return */
    _printk(&DAT_00108592,"aw22xxx_task0_store");
  }
                    /* WARNING: Subroutine does not return */
  _printk(&DAT_001089d4,"aw22xxx_task0_store");
}



/* 001062ec aw22xxx_task1_show */
...

{
  ...
  if (iVar1 == 1) {
    *(char *)(lVar2 + 0x2ed) = (char)local_2c;
                    /* WARNING: Subroutine does not return */
    _printk(&DAT_00108be1,"aw22xxx_task1_store");
  }
                    /* WARNING: Subroutine does not return */
  _printk(&DAT_001089d4,"aw22xxx_task1_store");
}



/* 001063e0 aw22xxx_task_irq_show */
...
/* 0010641c aw22xxx_task_irq_store */
...

{
  ...
  if (iVar1 == 1) {
    *(undefined4 *)(lVar2 + 0x2e8) = local_2c;
                    /* WARNING: Subroutine does not return */
    _printk(&DAT_001094d6,"aw22xxx_task_irq_store");
  }
                    /* WARNING: Subroutine does not return */
  _printk(&DAT_001089d4,"aw22xxx_task_irq_store");
}



/* 001064d4 get_aw22xxx_id */
...

{
  ...
  if (*in_x3 != 0) {
    return 0;
                    ...
                    /* WARNING: Subroutine does not return */
  _printk(&DAT_0010919b,"get_aw22xxx_id");
}



/* 0010f9fc init_module */

void init_module(void)

{
                    /* WARNING: Subroutine does not return */
  _printk(&DAT_00109517);
}



/* 0010fa74 cleanup_module */
