...

{
  ...
  _printk(&DAT_001073c5,"aw22xxx_fw_loaded");
}



/* 001021f8 aw22xxx_init_cfg_update_array */
...

{
  ...
  uVar1 = sp_el0;
                    /* WARNING: Subroutine does not return */
  _printk(&DAT_001072f6,"aw22xxx_init_cfg_update_array",0x1ca);
}



/* 0010234c aw22xxx_set_breath_data */
...

{
  ...
  while( true ) {
    ...
    if (read_idx == write_idx) {
      ...
      queue_work_on(0x20,_system_wq,param_1 + 0x230);
                    /* WARNING: Subroutine does not return */
      _printk(&DAT_00107986,"aw22xxx_play");
    }
    if (((byte)kthread_status & 1) == 0) break;
    if (25000 < (uint)(read_idx * 0x19)) {
                    /* WARNING: Does not return */
      pcVar1 = (code *)SoftwareBreakpoint(0x5512,0x1025a0);
      (*pcVar1)();
    }
  ...
  aw22xxx_i2c_write(param_1,2,0);
                    /* WARNING: Subroutine does not return */
  _printk(&DAT_001075db,"aw22xxx_play");
}



/* 001025a4 aw22xxx_led_imax_cfg */
...

{
  ...
  *(undefined4 *)(param_1 + 0x2f0) = 7;
                    /* WARNING: Subroutine does not return */
  _printk(&DAT_001071dc,"aw22xxx_led_imax_cfg",
          *(undefined8 *)(aw22xxx_cfg_name + (ulong)*(uint *)(param_1 + 0x300) * 8),7);
}



/* 00102614 aw22xxx_i2c_write */
...

{
  ...
  if (iVar2 < 0) {
    ...
    uVar3 = gpiod_get_raw_value();
                    /* WARNING: Subroutine does not return */
    _printk(&DAT_00106d6b,"aw22xxx_i2c_write",0,iVar2,uVar3);
  }
  lVar1 = sp_el0;
...
/* 00102880 aw22xxx_i2c_probe */

void aw22xxx_i2c_probe(void)

{
                    /* WARNING: Subroutine does not return */
  _printk(&DAT_001079a7,"aw22xxx_i2c_probe",0x9d9);
}
...
/* 00102b98 FUN_00102b98 */

undefined4 FUN_00102b98(void)
...
/* 00102f1c aw22xxx_i2c_remove */

void aw22xxx_i2c_remove(void)

{
                    /* WARNING: Subroutine does not return */
  _printk(&DAT_001073c5,"aw22xxx_i2c_remove");
}



/* 00102fe0 aw22xxx_hw_reset */

void aw22xxx_hw_reset(void)

{
                    /* WARNING: Subroutine does not return */
  _printk(&DAT_001073c5,"aw22xxx_hw_reset");
}



/* 0010307c aw22xxx_read_chipid */
...

{
  ...
  if (-1 < iVar2) {
    if (local_2c[0] == 'v') {
                    /* WARNING: Subroutine does not return */
      _printk(&DAT_001076d1,"aw22xxx_read_chipid",0x76,iVar2);
    }
                    /* WARNING: Subroutine does not return */
    _printk(&DAT_0010828f,"aw22xxx_read_chipid",local_2c[0],iVar2);
  }
...
/* 00103248 aw22xxx_interrupt_setup */
...

{
  ...
  uVar1 = sp_el0;
                    /* WARNING: Subroutine does not return */
  _printk(&DAT_001073c5,"aw22xxx_interrupt_setup");
}



/* 00103350 aw22xxx_irq */
...

{
  ...
  uVar1 = sp_el0;
                    /* WARNING: Subroutine does not return */
  _printk(&DAT_00108f69,"aw22xxx_irq");
}



/* 0010344c aw22xxx_irq_v15 */
...

{
  ...
  aw22xxx_i2c_read(param_2,10,local_2c);
                    /* WARNING: Subroutine does not return */
  _printk(&DAT_00108b70,"aw22xxx_irq_v15",local_2c[0]);
}



/* 00103658 aw22xxx_led_init */
...

{
  ...
  uVar1 = sp_el0;
                    /* WARNING: Subroutine does not return */
  _printk(&DAT_00109028,"aw22xxx_led_init");
}



/* 001037d8 aw22xxx_fw_init */
  ...
  *(code **)(param_1 + 0x248) = aw22xxx_cfg_work_routine;
  if (bVar1) {
    ...
    *(code **)(param_1 + 0x268) = aw22xxx_recover_work_routine;
                    ...
                    /* WARNING: Subroutine does not return */
  _printk(&DAT_0010857c,"aw22xxx_fw_init");
}



/* 001038b0 aw22xxx_fw_timer_func */

void aw22xxx_fw_timer_func(void)

{
                    /* WARNING: Subroutine does not return */
  _printk(&DAT_00109028,"aw22xxx_fw_timer_func");
}



/* 00103904 aw22xxx_fw_work_routine */

void aw22xxx_fw_work_routine(void)

{
                    /* WARNING: Subroutine does not return */
  _printk(&DAT_00109028,"aw22xxx_fw_work_routine");
}



/* 00103958 FUN_00103958 */

void FUN_00103958(undefined8 param_1,undefined8 param_2,undefined8 param_3,undefined8 param_4)
...
/* 00103988 aw22xxx_cfg_work_routine */

void aw22xxx_cfg_work_routine(void)

{
                    /* WARNING: Subroutine does not return */
  _printk(&DAT_00109028,"aw22xxx_cfg_work_routine");
}



/* 00103a4c aw22xxx_recover_work_routine */
...

{
  ...
  uVar1 = sp_el0;
                    /* WARNING: Subroutine does not return */
  _printk(&DAT_00109028,"aw22xxx_recover_work_routine");
}



/* 00103c38 aw22xxx_alloc_name_array */

void aw22xxx_alloc_name_array(void)

{
                    /* WARNING: Subroutine does not return */
  _printk(&DAT_00109028,"aw22xxx_alloc_name_array");
}



/* 00103eb4 aw22xxx_parse_led_cdev */

void aw22xxx_parse_led_cdev(void)

{
                    /* WARNING: Subroutine does not return */
  _printk(&DAT_00109028,"aw22xxx_parse_led_cdev");
}



/* 00104120 aw22xxx_brightness_work */
...

{
  ...
  uVar1 = sp_el0;
                    /* WARNING: Subroutine does not return */
  _printk(&DAT_00109028,"aw22xxx_brightness_work");
}



/* 00104358 aw22xxx_task_work */
...

{
  ...
  uVar1 = sp_el0;
                    /* WARNING: Subroutine does not return */
  _printk(&DAT_00109028,"aw22xxx_task_work");
}



/* 0010459c aw22xxx_set_brightness */
...
/* 001045d4 aw22xxx_create_proc_entry */

void aw22xxx_create_proc_entry(void)

{
                    /* WARNING: Subroutine does not return */
  _printk(&DAT_00109028,"aw22xxx_create_proc_entry");
}



/* 00104bb8 aw22xxx_cfg_show */
...

{
  ...
  if (uVar1 < 0xb) {
    ...
    return sVar2;
                    ...
                    /* WARNING: Subroutine does not return */
  _printk(&DAT_001084f2);
}



/* 00104c34 aw22xxx_cfg_store */
...

{
  ...
  if (iVar1 == 1) {
    *(byte *)(lVar2 + 0x2f4) = (byte)local_2c & 0xf;
                    /* WARNING: Subroutine does not return */
    _printk(&DAT_001087b7,"aw22xxx_cfg_store");
  }
                    /* WARNING: Subroutine does not return */
  _printk(&DAT_00108978,"aw22xxx_cfg_store");
}



/* 00104cf0 aw22xxx_effect_show */
...

{
  ...
  if (iVar2 == 1) {
                    /* WARNING: Subroutine does not return */
    _printk(&DAT_00109053,"aw22xxx_effect_store",local_4c);
  }
                    /* WARNING: Subroutine does not return */
  _printk(&DAT_00108978,"aw22xxx_effect_store");
}



/* 00104fb8 aw22xxx_get_fwname */

void aw22xxx_get_fwname(ulong param_1)

{
                    /* WARNING: Subroutine does not return */
  _printk(&DAT_00108b8d,"aw22xxx_get_fwname",param_1 >> 0x18 & 0xff);
}



/* 00105134 aw22xxx_cfg_update_wait_from_dyn_name */
...

{
  ...
  uVar1 = sp_el0;
                    /* WARNING: Subroutine does not return */
  _printk(&DAT_00109028,"aw22xxx_cfg_update_wait_from_dyn_name");
}



/* 00105358 aw22xxx_fw_show */
  ...
  if (iVar1 == 1) {
    if (local_2c < 2) {
      ...
      __stack_chk_fail();
                    ...
                    /* WARNING: Subroutine does not return */
  _printk(&DAT_001092fb,"aw22xxx_hwen_store");
}



/* 00105594 aw22xxx_imax_show */
  ...
  if ((iVar2 == 1) && (local_3c < 0xd)) {
    ...
    *(uint *)(lVar4 + 0x2e0) = local_3c;
    ...
    __stack_chk_fail();
                    ...
                    /* WARNING: Subroutine does not return */
  _printk(&DAT_001085c5,"aw22xxx_imax_store");
}



/* 00105894 aw22xxx_para_show */
  ...
  if (write_idx == 0) {
    ...
    if (write_idx * 0x19 < 1) {
      ...
      do {
        ...
        if (uVar4 == 25000) {
                    /* WARNING: Does not return */
          pcVar1 = (code *)SoftwareBreakpoint(0x5512,0x1059b4);
          (*pcVar1)();
        }
...
/* 001059b8 aw22xxx_para_store */

void aw22xxx_para_store(void)

{
                    /* WARNING: Subroutine does not return */
  _printk(&DAT_00109028,"aw22xxx_para_store");
}



/* 00105c30 aw22xxx_multi_breath_pattern_show */
...
/* 00105c6c aw22xxx_multi_breath_pattern_store */
    ...
    *(int *)(lVar3 + 0x2f8) = local_3c;
    if (local_3c == 0) {
      ...
      if (0xfffffffffffff000 < cfg_update_kthread) {
        kthread_status = 0;
                    /* WARNING: Subroutine does not return */
        _printk(&DAT_001091db);
      }
      wake_up_process();
      kthread_status = 1;
                    /* WARNING: Subroutine does not return */
      _printk(&DAT_00108748);
    }
  }
  else {
...

{
  ...
  do {
    if ((local_5c[0] != '\0') || (((&aw22xxx_reg_access)[uVar5] & 1) != 0)) {
      ...
      if (__maxlen < 0x21) goto LAB_00105ecc;
...

{
  ...
  if ((iVar1 == 2) && (local_30._4_4_ < 0x100)) {
    ...
    __stack_chk_fail();
                    ...
                    /* WARNING: Subroutine does not return */
  _printk(&DAT_00108f41,"aw22xxx_reg_store");
}



/* 00105fc4 aw22xxx_rgb_show */
...

{
  ...
  if (iVar1 == 1) {
    *(char *)(lVar2 + 0x2ec) = (char)local_2c;
                    /* WARNING: Subroutine does not return */
    _printk(&DAT_00108562,"aw22xxx_task0_store");
  }
                    /* WARNING: Subroutine does not return */
  _printk(&DAT_00108978,"aw22xxx_task0_store");
}



/* 001062c0 aw22xxx_task1_show */
...

{
  ...
  if (iVar1 == 1) {
    *(char *)(lVar2 + 0x2ed) = (char)local_2c;
                    /* WARNING: Subroutine does not return */
    _printk(&DAT_00108b56,"aw22xxx_task1_store");
  }
                    /* WARNING: Subroutine does not return */
  _printk(&DAT_00108978,"aw22xxx_task1_store");
}



/* 001063b4 aw22xxx_task_irq_show */
...
/* 001063f0 aw22xxx_task_irq_store */
...

{
  ...
  if (iVar1 == 1) {
    *(undefined4 *)(lVar2 + 0x2e8) = local_2c;
                    /* WARNING: Subroutine does not return */
    _printk(&DAT_00109363,"aw22xxx_task_irq_store");
  }
                    /* WARNING: Subroutine does not return */
  _printk(&DAT_00108978,"aw22xxx_task_irq_store");
}



/* 001064a8 get_aw22xxx_id */
...

{
  ...
  if (*in_x3 != 0) {
    return 0;
                    ...
                    /* WARNING: Subroutine does not return */
  _printk(&DAT_00109028,"get_aw22xxx_id");
}



/* 0010f854 init_module */

void init_module(void)

{
                    /* WARNING: Subroutine does not return */
  _printk(&DAT_001093a4);
}



/* 0010f8cc cleanup_module */
