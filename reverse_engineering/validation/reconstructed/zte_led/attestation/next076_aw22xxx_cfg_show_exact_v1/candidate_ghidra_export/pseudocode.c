...
/* 00101850 aw22xxx_init_cfg_update_array */
...
/* 001019a4 aw22xxx_set_breath_data */
...

{
  ...
  while( true ) {
    ...
    if (25000 < (uint)(read_idx * 0x19)) {
      ...
      pcVar1 = (code *)SoftwareBreakpoint(0x5512,0x101bf8);
      (*pcVar1)();
    }
...
/* 00101cb8 FUN_00101cb8 */

void FUN_00101cb8(long param_1)
...
/* 001021f0 FUN_001021f0 */

undefined4 FUN_001021f0(void)
...
/* 001028a0 aw22xxx_interrupt_setup */
...
/* 00102cf4 aw22xxx_parse_led_cdev */
...
/* 00102efc aw22xxx_alloc_name_array */
...
/* 00103234 aw22xxx_create_proc_entry */
...
/* 00103298 aw22xxx_brightness_work */
...

{
  ...
  FUN_00101de8(lVar4,0xff,local_60);
  uVar5 = 0;
  lVar3 = 0;
  do {
    if ((local_60[0] != '\0') || (((&aw22xxx_reg_access)[uVar5] & 1) != 0)) {
      FUN_00101e1c(lVar4,uVar5 & 0xffffffff,local_5c);
...

{
  ...
  if ((iVar1 == 2) && ((uint)local_30 < 0x100)) {
    FUN_00101cb8(lVar2 + -0x10,local_30 & 0xffffffff,local_30._4_4_);
    lVar2 = sp_el0;
...

{
  ...
  if (uVar1 < 0xe) {
    ...
    return lVar5 + iVar3;
                    ...
                    /* WARNING: Does not return */
  pcVar2 = (code *)SoftwareBreakpoint(0x5512,0x103d64);
  (*pcVar2)();
}



/* 00103d68 aw22xxx_imax_store */
...

{
  ...
  *(uint *)(lVar3 + 0x2e0) = local_3c;
  ...
  FUN_00101ca8(lVar3,0xff,0);
  FUN_00101ca8(lVar3,0xb,bVar2);
  lVar3 = sp_el0;
...
/* 00104274 aw22xxx_task_irq_show */
...
/* 001042b0 aw22xxx_task_irq_store */
...
LAB_00104488:
                    /* WARNING: Does not return */
          pcVar1 = (code *)SoftwareBreakpoint(0x5512,0x10448c);
          (*pcVar1)();
        }
        lVar3 = lVar3 + iVar2;
      }
      else if (0xc34 < uVar4 >> 3) goto LAB_00104488;
...
/* 001048e8 aw22xxx_multi_breath_pattern_show */
...
/* 00104924 aw22xxx_cfg_loaded */

void aw22xxx_cfg_loaded(void)

{
                    /* WARNING: Subroutine does not return */
  _printk(&DAT_00107ea6,"aw22xxx_cfg_loaded");
}



/* 00104b04 aw22xxx_set_brightness */
...

{
  ...
  if (iVar1 == 1) {
    *(byte *)(lVar2 + 0x2f4) = (byte)local_2c & 0xf;
                    /* WARNING: Subroutine does not return */
    _printk(&DAT_00107c76,"aw22xxx_cfg_store");
  }
                    /* WARNING: Subroutine does not return */
  _printk(&DAT_00107ce1,"aw22xxx_cfg_store");
}



/* 00104bf8 aw22xxx_effect_show */
...

{
  ...
  if (iVar2 == 1) {
                    /* WARNING: Subroutine does not return */
    _printk(&DAT_00107ed1,"aw22xxx_effect_store",local_4c);
  }
                    /* WARNING: Subroutine does not return */
  _printk(&DAT_00107ce1,"aw22xxx_effect_store");
}



/* 00104ec0 aw22xxx_get_fwname */

void aw22xxx_get_fwname(ulong param_1)

{
                    /* WARNING: Subroutine does not return */
  _printk(&DAT_00107d8a,"aw22xxx_get_fwname",param_1 >> 0x18 & 0xff);
}



/* 0010503c aw22xxx_cfg_update_wait_from_dyn_name */
...

{
  ...
  uVar1 = sp_el0;
                    /* WARNING: Subroutine does not return */
  _printk(&DAT_00107ea6,"aw22xxx_cfg_update_wait_from_dyn_name");
}



/* 00105268 aw22xxx_fw_store */
...
/* 00105b0c FUN_00105b0c */

void FUN_00105b0c(undefined8 param_1)
