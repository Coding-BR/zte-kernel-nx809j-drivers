...
/* 00101eb8 aw22xxx_init_cfg_update_array */
...

{
  ...
  uVar1 = sp_el0;
                    /* WARNING: Subroutine does not return */
  _printk(&DAT_00106f6e,"aw22xxx_init_cfg_update_array",0x1ca);
}



/* 0010200c aw22xxx_set_breath_data */
...

{
  ...
  while( true ) {
    ...
    if (read_idx == write_idx) {
      ...
      queue_work_on(0x20,_system_wq,param_1 + 0x230);
                    /* WARNING: Subroutine does not return */
      _printk(&DAT_001075fe,"aw22xxx_play");
    }
    if (((byte)kthread_status & 1) == 0) break;
    if (25000 < (uint)(read_idx * 0x19)) {
                    /* WARNING: Does not return */
      pcVar1 = (code *)SoftwareBreakpoint(0x5512,0x102260);
      (*pcVar1)();
    }
  ...
  aw22xxx_i2c_write(param_1,2,0);
                    /* WARNING: Subroutine does not return */
  _printk(&DAT_00107253,"aw22xxx_play");
}



/* 00102264 aw22xxx_led_imax_cfg */
...

{
  ...
  *(undefined4 *)(param_1 + 0x2f0) = 7;
                    /* WARNING: Subroutine does not return */
  _printk(&DAT_00106e54,"aw22xxx_led_imax_cfg",
          *(undefined8 *)(aw22xxx_cfg_name + (ulong)*(uint *)(param_1 + 0x300) * 8),7);
}



/* 001022d4 aw22xxx_i2c_write */
...

{
  ...
  if (iVar2 < 0) {
    ...
    uVar3 = gpiod_get_raw_value();
                    /* WARNING: Subroutine does not return */
    _printk(&DAT_001069e3,"aw22xxx_i2c_write",0,iVar2,uVar3);
  }
  lVar1 = sp_el0;
...
/* 00102540 aw22xxx_i2c_probe */

void aw22xxx_i2c_probe(void)

{
                    /* WARNING: Subroutine does not return */
  _printk(&DAT_0010761f,"aw22xxx_i2c_probe",0x9d9);
}
...
/* 00102858 FUN_00102858 */

undefined4 FUN_00102858(void)
...
/* 00102bdc aw22xxx_i2c_remove */

void aw22xxx_i2c_remove(void)

{
                    /* WARNING: Subroutine does not return */
  _printk(&DAT_0010703d,"aw22xxx_i2c_remove");
}



/* 00102ca0 aw22xxx_hw_reset */

void aw22xxx_hw_reset(void)

{
                    /* WARNING: Subroutine does not return */
  _printk(&DAT_0010703d,"aw22xxx_hw_reset");
}



/* 00102d3c aw22xxx_read_chipid */
...

{
  ...
  if (-1 < iVar2) {
    if (local_2c[0] == 'v') {
                    /* WARNING: Subroutine does not return */
      _printk(&DAT_00107349,"aw22xxx_read_chipid",0x76,iVar2);
    }
                    /* WARNING: Subroutine does not return */
    _printk(&DAT_00107f07,"aw22xxx_read_chipid",local_2c[0],iVar2);
  }
...
/* 00102f08 aw22xxx_interrupt_setup */
...

{
  ...
  uVar1 = sp_el0;
                    /* WARNING: Subroutine does not return */
  _printk(&DAT_0010703d,"aw22xxx_interrupt_setup");
}



/* 00103010 aw22xxx_irq_v15 */
...

{
  ...
  aw22xxx_i2c_read(param_2,10,local_44);
                    /* WARNING: Subroutine does not return */
  _printk(&DAT_00106ae7,"aw22xxx_irq_v15",local_44[0]);
}



/* 00103258 aw22xxx_irq */
...

{
  ...
  uVar1 = sp_el0;
                    /* WARNING: Subroutine does not return */
  _printk(&DAT_0010703d,"aw22xxx_irq");
}



/* 0010335c aw22xxx_parse_led_cdev */

void aw22xxx_parse_led_cdev(void)

{
                    /* WARNING: Subroutine does not return */
  _printk(&DAT_0010703d,"aw22xxx_parse_led_cdev");
}



/* 00103564 aw22xxx_alloc_name_array */
...

{
  ...
  if (aw22xxx_cfg_name == (undefined8 *)0x0) {
                    /* WARNING: Subroutine does not return */
    _printk(&DAT_00106a43,"aw22xxx_alloc_name_array",0x687);
  }
  lVar4 = 0;
  uVar1 = sp_el0;
  do {
    ...
    if (lVar2 == 0) {
      ...
      kfree(puVar3);
                    /* WARNING: Subroutine does not return */
      _printk(&DAT_00106a43,"aw22xxx_alloc_name_array",0x692);
    }
    lVar4 = lVar4 + 1;
  } while (lVar4 != 0xb);
  ...
  *(code **)(param_1 + 0x248) = aw22xxx_cfg_work_routine;
  if (bVar1) {
    ...
    *(code **)(param_1 + 0x268) = aw22xxx_recover_work_routine;
                    ...
                    /* WARNING: Subroutine does not return */
  _printk(&DAT_00106b8c,"aw22xxx_fw_init");
}



/* 0010389c aw22xxx_create_proc_entry */
...

{
  ...
  if (lVar1 == 0) {
                    /* WARNING: Subroutine does not return */
    _printk(&DAT_001073ea);
  }
                    /* WARNING: Subroutine does not return */
  _printk(&DAT_00107cf6,"aw22xxx_create_proc_entry",0x9c3);
}



/* 00103900 aw22xxx_brightness_work */
...

{
  ...
  uVar1 = sp_el0;
                    /* WARNING: Subroutine does not return */
  _printk(&DAT_0010703d,"aw22xxx_brightness_work");
}



/* 00103b50 aw22xxx_task_work */
...

{
  ...
  uVar1 = sp_el0;
                    /* WARNING: Subroutine does not return */
  _printk(&DAT_0010703d,"aw22xxx_task_work");
}



/* 00103dec aw22xxx_reg_show */
...

{
  ...
  if ((iVar1 == 2) && ((uint)local_30 < 0x100)) {
    ...
    __stack_chk_fail();
                    ...
                    /* WARNING: Subroutine does not return */
  _printk(&DAT_00106c68,"aw22xxx_reg_store",0x78b);
}



/* 00103fc0 aw22xxx_hwen_show */
...

{
  ...
  if (iVar1 == 1) {
    if (local_3c < 2) {
      if (local_3c != 1) {
                    /* WARNING: Subroutine does not return */
        _printk(&DAT_0010703d,"aw22xxx_hw_off");
      }
      ...
      __stack_chk_fail();
                    ...
                    /* WARNING: Subroutine does not return */
  _printk(&DAT_00106c68,"aw22xxx_hwen_store",0x7b9);
}



/* 001041a8 aw22xxx_imax_show */
...

{
  ...
  uVar1 = sp_el0;
                    /* WARNING: Subroutine does not return */
  _printk(&DAT_0010886c,"aw22xxx_led_init");
}



/* 00104514 aw22xxx_fw_work_routine */

void aw22xxx_fw_work_routine(void)

{
                    /* WARNING: Subroutine does not return */
  _printk(&DAT_0010886c,"aw22xxx_fw_work_routine");
}



/* 00104598 aw22xxx_cfg_work_routine */

void aw22xxx_cfg_work_routine(void)

{
                    /* WARNING: Subroutine does not return */
  _printk(&DAT_0010886c,"aw22xxx_cfg_work_routine");
}



/* 0010483c aw22xxx_recover_work_routine */
...

{
  ...
  uVar1 = sp_el0;
                    /* WARNING: Subroutine does not return */
  _printk(&DAT_0010886c,"aw22xxx_recover_work_routine");
}



/* 00104db0 aw22xxx_fw_timer_func */

void aw22xxx_fw_timer_func(void)

{
                    /* WARNING: Subroutine does not return */
  _printk(&DAT_0010886c,"aw22xxx_fw_timer_func");
}



/* 00104e04 aw22xxx_set_brightness */
...

{
  ...
  if (*in_x3 != 0) {
    return 0;
                    ...
                    /* WARNING: Subroutine does not return */
  _printk(&DAT_0010886c,"get_aw22xxx_id");
}



/* 00104f00 aw22xxx_cfg_show */
...

{
  ...
  if (iVar1 == 1) {
    *(byte *)(lVar2 + 0x2f4) = (byte)local_2c & 0xf;
                    /* WARNING: Subroutine does not return */
    _printk(&DAT_001082ef,"aw22xxx_cfg_store");
  }
                    /* WARNING: Subroutine does not return */
  _printk(&DAT_00108460,"aw22xxx_cfg_store");
}



/* 00105038 aw22xxx_effect_show */
...

{
  ...
  if (iVar2 == 1) {
                    /* WARNING: Subroutine does not return */
    _printk(&DAT_00108897,"aw22xxx_effect_store",local_4c);
  }
                    /* WARNING: Subroutine does not return */
  _printk(&DAT_00108460,"aw22xxx_effect_store");
}



/* 00105300 aw22xxx_get_fwname */

void aw22xxx_get_fwname(ulong param_1)

{
                    /* WARNING: Subroutine does not return */
  _printk(&DAT_001085eb,"aw22xxx_get_fwname",param_1 >> 0x18 & 0xff);
}



/* 0010547c aw22xxx_cfg_update_wait_from_dyn_name */
...

{
  ...
  uVar1 = sp_el0;
                    /* WARNING: Subroutine does not return */
  _printk(&DAT_0010886c,"aw22xxx_cfg_update_wait_from_dyn_name");
}



/* 001056a0 aw22xxx_fw_show */
  ...
  if ((iVar2 == 1) && (local_3c < 0xd)) {
    ...
    *(uint *)(lVar4 + 0x2e0) = local_3c;
    ...
    __stack_chk_fail();
                    ...
                    /* WARNING: Subroutine does not return */
  _printk(&DAT_001081fc,"aw22xxx_imax_store");
}



/* 00105868 aw22xxx_para_show */
  ...
  if (write_idx == 0) {
    ...
    if (write_idx * 0x19 < 1) {
      ...
      do {
        ...
        if (uVar4 == 25000) {
                    /* WARNING: Does not return */
          pcVar1 = (code *)SoftwareBreakpoint(0x5512,0x105988);
          (*pcVar1)();
        }
...
/* 0010598c aw22xxx_para_store */

void aw22xxx_para_store(void)

{
                    /* WARNING: Subroutine does not return */
  _printk(&DAT_0010886c,"aw22xxx_para_store");
}



/* 00105c04 aw22xxx_multi_breath_pattern_show */
...
/* 00105c40 aw22xxx_multi_breath_pattern_store */
    ...
    *(int *)(lVar3 + 0x2f8) = local_3c;
    if (local_3c == 0) {
      ...
      if (0xfffffffffffff000 < cfg_update_kthread) {
        kthread_status = 0;
                    /* WARNING: Subroutine does not return */
        _printk(&DAT_00108952);
      }
      wake_up_process();
      kthread_status = 1;
                    /* WARNING: Subroutine does not return */
      _printk(&DAT_001082a7);
    }
  }
  else {
...

{
  ...
  if (iVar1 == 1) {
    *(char *)(lVar2 + 0x2ec) = (char)local_2c;
                    /* WARNING: Subroutine does not return */
    _printk(&DAT_001081c8,"aw22xxx_task0_store");
  }
                    /* WARNING: Subroutine does not return */
  _printk(&DAT_00108460,"aw22xxx_task0_store");
}



/* 001060c4 aw22xxx_task1_show */
...

{
  ...
  if (iVar1 == 1) {
    *(char *)(lVar2 + 0x2ed) = (char)local_2c;
                    /* WARNING: Subroutine does not return */
    _printk(&DAT_001085d1,"aw22xxx_task1_store");
  }
                    /* WARNING: Subroutine does not return */
  _printk(&DAT_00108460,"aw22xxx_task1_store");
}



/* 001061b8 aw22xxx_task_irq_show */
...
/* 001061f4 aw22xxx_task_irq_store */
...

{
  ...
  if (iVar1 == 1) {
    *(undefined4 *)(lVar2 + 0x2e8) = local_2c;
                    /* WARNING: Subroutine does not return */
    _printk(&DAT_00108a3c,"aw22xxx_task_irq_store");
  }
                    /* WARNING: Subroutine does not return */
  _printk(&DAT_00108460,"aw22xxx_task_irq_store");
}



/* 0010eedc init_module */

void init_module(void)

{
                    /* WARNING: Subroutine does not return */
  _printk(&DAT_00108a7d);
}



/* 0010ef54 cleanup_module */
