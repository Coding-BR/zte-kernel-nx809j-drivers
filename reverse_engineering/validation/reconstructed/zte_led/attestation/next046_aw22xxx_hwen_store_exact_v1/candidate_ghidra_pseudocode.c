...

{
  ...
  uVar1 = sp_el0;
  _printk(&DAT_00107115,"aw22xxx_fw_loaded");
  return;
}



/* 00101ef0 aw22xxx_init_cfg_update_array */
...

{
  ...
  uVar1 = sp_el0;
  _printk(&DAT_00107046,"aw22xxx_init_cfg_update_array",0x1ca);
  return;
}



/* 00102044 aw22xxx_set_breath_data */
...

{
  ...
  while( true ) {
    ...
    if (read_idx == write_idx) {
      ...
      _printk(&DAT_001076d6,"aw22xxx_play");
      return;
    }
    if (((byte)kthread_status & 1) == 0) break;
    if (25000 < (uint)(read_idx * 0x19)) {
                    /* WARNING: Does not return */
      pcVar1 = (code *)SoftwareBreakpoint(0x5512,0x102298);
      (*pcVar1)();
    }
  ...
  _printk(&DAT_0010732b,"aw22xxx_play");
  return;
}



/* 0010229c aw22xxx_led_imax_cfg */
...

{
  ...
  *(undefined4 *)(param_1 + 0x2f0) = 7;
  _printk(&DAT_00106f2c,"aw22xxx_led_imax_cfg",
...

{
  ...
  if (iVar2 < 0) {
    ...
    _printk(&DAT_00106abb,"aw22xxx_i2c_write",0,iVar2,uVar3);
    return;
  }
  lVar1 = sp_el0;
...
/* 00102578 aw22xxx_i2c_probe */

void aw22xxx_i2c_probe(void)

{
  _printk(&DAT_001076f7,"aw22xxx_i2c_probe",0x9d9);
  return;
}
...
/* 00102890 FUN_00102890 */

undefined4 FUN_00102890(void)
...
/* 00102c14 aw22xxx_i2c_remove */

void aw22xxx_i2c_remove(void)

{
  _printk(&DAT_00107115,"aw22xxx_i2c_remove");
  return;
}



/* 00102cd8 aw22xxx_hw_reset */

void aw22xxx_hw_reset(void)

{
  _printk(&DAT_00107115,"aw22xxx_hw_reset");
  return;
}



/* 00102d74 aw22xxx_read_chipid */
...

{
  ...
  if (-1 < iVar2) {
    if (local_2c[0] == 'v') {
      _printk(&DAT_00107421,"aw22xxx_read_chipid",0x76,iVar2);
      return;
    }
    _printk(&DAT_00107fdf,"aw22xxx_read_chipid",local_2c[0],iVar2);
    return;
  }
...
/* 00102f40 aw22xxx_interrupt_setup */
...

{
  ...
  uVar1 = sp_el0;
  _printk(&DAT_00107115,"aw22xxx_interrupt_setup");
  return;
}



/* 00103048 aw22xxx_irq_v15 */
...

{
  ...
  _printk(&DAT_00106bbf,"aw22xxx_irq_v15",local_44[0]);
  return;
}



/* 00103290 aw22xxx_irq */
...

{
  ...
  uVar1 = sp_el0;
  _printk(&DAT_00107115,"aw22xxx_irq");
  return;
}



/* 00103394 aw22xxx_parse_led_cdev */

void aw22xxx_parse_led_cdev(void)

{
  _printk(&DAT_00107115,"aw22xxx_parse_led_cdev");
  return;
}



/* 0010359c aw22xxx_alloc_name_array */
...

{
  ...
  if (aw22xxx_cfg_name == (undefined8 *)0x0) {
    _printk(&DAT_00106b1b,"aw22xxx_alloc_name_array",0x687);
    return;
  }
  lVar4 = 0;
  uVar1 = sp_el0;
  do {
    ...
    if (lVar2 == 0) {
      ...
      kfree(puVar3);
      _printk(&DAT_00106b1b,"aw22xxx_alloc_name_array",0x692);
      return;
    }
    lVar4 = lVar4 + 1;
  } while (lVar4 != 0xb);
...

{
  ...
  *(code **)(param_1 + 0x248) = aw22xxx_cfg_work_routine;
  ...
  _printk(&DAT_00106c64,"aw22xxx_fw_init");
  return;
}



/* 001038d4 aw22xxx_create_proc_entry */
...

{
  ...
  if (lVar1 == 0) {
    _printk(&DAT_001074c2);
    return;
  }
  _printk(&DAT_00107dce,"aw22xxx_create_proc_entry",0x9c3);
  return;
}



/* 00103938 aw22xxx_brightness_work */
...

{
  ...
  uVar1 = sp_el0;
  _printk(&DAT_00107115,"aw22xxx_brightness_work");
  return;
}



/* 00103b88 aw22xxx_task_work */
...

{
  ...
  uVar1 = sp_el0;
  _printk(&DAT_00107115,"aw22xxx_task_work");
  return;
}



/* 00103e24 aw22xxx_reg_show */
...

{
  ...
  uVar2 = _printk(&DAT_00106d40,"aw22xxx_reg_store",0x78b);
  return uVar2;
}



/* 00103ff8 aw22xxx_hwen_show */
...

{
  ...
  if (iVar1 == 1) {
    if (local_3c < 2) {
      if (local_3c != 1) {
        uVar2 = _printk(&DAT_00107115,"aw22xxx_hw_off");
        return uVar2;
      }
  ...
  uVar2 = _printk(&DAT_00106d40,"aw22xxx_hwen_store",0x7b9);
  return uVar2;
}



/* 001041e0 aw22xxx_led_init */
...

{
  ...
  uVar1 = sp_el0;
  _printk(&DAT_00108a14,"aw22xxx_led_init");
  return;
}



/* 001041f0 FUN_001041f0 */
...

{
  ...
  lVar1 = sp_el0;
  uStack0000000000000008 = *(undefined8 *)(lVar1 + 0x710);
...
/* 00104360 aw22xxx_fw_work_routine */

void aw22xxx_fw_work_routine(void)

{
  _printk(&DAT_00108a14,"aw22xxx_fw_work_routine");
  return;
}



/* 001043e4 aw22xxx_cfg_work_routine */

void aw22xxx_cfg_work_routine(void)

{
  _printk(&DAT_00108a14,"aw22xxx_cfg_work_routine");
  return;
}



/* 00104688 aw22xxx_recover_work_routine */
...

{
  ...
  uVar1 = sp_el0;
  _printk(&DAT_00108a14,"aw22xxx_recover_work_routine");
  return;
}



/* 00104bfc aw22xxx_fw_timer_func */

void aw22xxx_fw_timer_func(void)

{
  _printk(&DAT_00108a14,"aw22xxx_fw_timer_func");
  return;
}



/* 00104c50 aw22xxx_set_brightness */
...

{
  ...
  uVar1 = _printk(&DAT_00108a14,"get_aw22xxx_id");
  return uVar1;
}



/* 00104d4c aw22xxx_cfg_show */
...

{
  ...
  if (iVar1 == 1) {
    *(byte *)(lVar2 + 0x2f4) = (byte)local_2c & 0xf;
    _printk(&DAT_0010841e,"aw22xxx_cfg_store");
    return;
  }
  _printk(&DAT_001085b2,"aw22xxx_cfg_store");
  return;
}



/* 00104e84 aw22xxx_effect_show */
...

{
  ...
  if (iVar2 == 1) {
    _printk(&DAT_00108a3f,"aw22xxx_effect_store",local_4c);
    return;
  }
  _printk(&DAT_001085b2,"aw22xxx_effect_store");
  return;
}



/* 0010514c aw22xxx_get_fwname */

void aw22xxx_get_fwname(ulong param_1)

{
  _printk(&DAT_0010875d,"aw22xxx_get_fwname",param_1 >> 0x18 & 0xff);
  return;
}



/* 001052c8 aw22xxx_cfg_update_wait_from_dyn_name */
...

{
  ...
  uVar1 = sp_el0;
  _printk(&DAT_00108a14,"aw22xxx_cfg_update_wait_from_dyn_name");
  return;
}



/* 001054ec aw22xxx_fw_show */
...

{
  ...
  if ((iVar2 == 1) && (local_3c < 0xd)) {
    lVar4 = lVar5 + -0x10;
    *(uint *)(lVar5 + 0x2e0) = local_3c;
    aw22xxx_i2c_write(lVar4,0xff,0);
    aw22xxx_i2c_write(lVar4,0xb,(&aw22xxx_imax_code)[uVar1]);
    lVar5 = sp_el0;
  ...
  uVar3 = _printk(&DAT_001082e5,"aw22xxx_imax_store");
  return uVar3;
}



/* 001058d4 aw22xxx_para_show */
  ...
  if (write_idx == 0) {
    ...
    if (write_idx * 0x19 < 1) {
      ...
      do {
        ...
        if (uVar4 == 25000) {
                    /* WARNING: Does not return */
          pcVar1 = (code *)SoftwareBreakpoint(0x5512,0x1059f4);
          (*pcVar1)();
        }
...
/* 001059f8 aw22xxx_para_store */

void aw22xxx_para_store(void)

{
  _printk(&DAT_00108a14,"aw22xxx_para_store");
  return;
}



/* 00105c70 aw22xxx_multi_breath_pattern_show */
...
/* 00105cac aw22xxx_multi_breath_pattern_store */
  ...
  if (iVar1 == 1) {
    ...
    *(int *)(lVar4 + 0x2f8) = local_3c;
    if (local_3c == 0) {
      ...
      cfg_update_kthread = kthread_create_on_node(aw22xxx_play,lVar3,0xffffffff,"aw22xxx_play");
      if (0xfffffffffffff000 < cfg_update_kthread) {
        kthread_status = 0;
        uVar2 = _printk(&DAT_00108b2c);
        return uVar2;
      }
      wake_up_process();
      kthread_status = 1;
      uVar2 = _printk(&DAT_001083d6);
      return uVar2;
    }
  }
  else {
...

{
  ...
  if (iVar1 == 1) {
    *(char *)(lVar2 + 0x2ec) = (char)local_2c;
    _printk(&DAT_001082a0,"aw22xxx_task0_store");
    return;
  }
  _printk(&DAT_001085b2,"aw22xxx_task0_store");
  return;
}



/* 00106130 aw22xxx_task1_show */
...

{
  ...
  if (iVar1 == 1) {
    *(char *)(lVar2 + 0x2ed) = (char)local_2c;
    _printk(&DAT_00108743,"aw22xxx_task1_store");
    return;
  }
  _printk(&DAT_001085b2,"aw22xxx_task1_store");
  return;
}



/* 00106224 aw22xxx_task_irq_show */
...
/* 00106260 aw22xxx_task_irq_store */
...

{
  ...
  if (iVar1 == 1) {
    *(undefined4 *)(lVar2 + 0x2e8) = local_2c;
    _printk(&DAT_00108c28,"aw22xxx_task_irq_store");
    return;
  }
  _printk(&DAT_001085b2,"aw22xxx_task_irq_store");
  return;
}



/* 0010f0c4 init_module */

void init_module(void)

{
  _printk(&DAT_00108c69);
  return;
}



/* 0010f13c cleanup_module */
