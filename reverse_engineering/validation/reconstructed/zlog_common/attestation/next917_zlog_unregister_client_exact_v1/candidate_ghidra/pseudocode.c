  ...
  if ((DAT_00104014 & 1) == 0) {
    ...
    if (param_1 != 0) {
      ...
      if (*(ulong *)(param_1 + 0xf8) < 0x800) {
        ...
        uVar9 = (ulong)uVar6;
        if ((int)uVar6 < 0) {
          _printk(&DAT_00101286,"zlog_client_record","zlog_client_record");
        }
        else {
        ...
        _printk(&DAT_0010125d,"zlog_client_record","zlog_client_record");
        uVar9 = 0;
      }
...
/* 00100794 zlog_unregister_client */
...

{
  ...
  if ((DAT_00104014 & 1) == 0) {
    _printk(&DAT_001016bd,"zlog_unregister_client","zlog_unregister_client");
  }
  else {
    iVar2 = *param_1;
    if (iVar2 < 0) {
...

{
  ...
  _printk(&DAT_00101347,"zlog_handle_work","zlog_handle_work");
  uVar10 = 0;
  puVar11 = &DAT_00101c00;
  uVar5 = sp_el0;
  do {
    if (puVar11[0x68] != '\0') {
      mutex_lock(puVar11);
      puVar15 = puVar11 + -0xac;
      _printk(&DAT_00101315,"zlog_handle_work",uVar10 & 0xffffffff,puVar15,
      ...
      if (((uint)uVar13 >> 3 & 1) != 0) {
        ...
        if (__s == (char *)0x0) {
          _printk(&DAT_001017ed,"zlog_create_event");
          _printk(&DAT_00101451,"zlog_report_event");
        }
        else {
          local_f0[0x70] = '\0';
          local_f0[0x71] = '\0';
          ...
          iVar9 = iVar9 + iVar8;
          if (0 < (int)uVar7) {
            if (0x7f < uVar7) goto LAB_00100cd4;
            local_f0[uVar7] = '\0';
...
LAB_00100cd4:
            ...
            pcVar6 = (code *)SoftwareBreakpoint(0x5512,0x100cd8);
            (*pcVar6)();
          }
          ...
          if (iVar9 < 0) {
            _printk(&DAT_0010166b,"zlog_report_event");
          }
          kfree(__s);
        }
        _printk(&DAT_001015bc,"zlog_handle_work",puVar15);
    ...
    if (uVar10 == 0x20) {
      _printk(&DAT_001017d3,"zlog_handle_work","zlog_handle_work");
      lVar12 = sp_el0;
  ...
  if ((DAT_00104014 & 1) == 0) {
    ...
    if (param_1 != 0) {
      ...
      *(undefined4 *)(param_1 + 0xe4) = param_2;
      ...
      mutex_unlock(param_1 + 0xb0);
      cancel_delayed_work(&DAT_00103f58);
      queue_delayed_work_on(0x20,DAT_00103f50,&DAT_00103f58,0x32);
      return;
    }
    puVar4 = &DAT_0010198b;
  }
...

{
  ...
  if ((DAT_00104014 & 1) == 0) {
    _printk(&DAT_00101a55,"zlog_reset_client","zlog_reset_client");
  }
  else if (param_1 == 0) {
    _printk(&DAT_001018b0,"zlog_reset_client");
  }
  else {
    mutex_lock(param_1 + 0xb0);
...

{
  ...
  if (param_3 == 0x10) {
        ...
        do {
          if ((((*(char *)(puVar8 + 0x46) != '\0') && (puVar8[0x38] == iVar1)) &&
            ...
            if (*(int *)(pcVar4 + -4) != -0x3d5937bb) {
                    /* WARNING: Does not return */
              pcVar4 = (code *)SoftwareBreakpoint(0x8228,0x100fa4);
              (*pcVar4)();
            }
    ...
    _printk(&DAT_00101939,"zlog_comm_write");
    uVar7 = 0xfffffffffffffff4;
  }
  else {
    _printk(&DAT_00101aae,"zlog_comm_write",param_3,0x10);
...
/* 00104124 zlog_comm_create_ctrl_dev */
