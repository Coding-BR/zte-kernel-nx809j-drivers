# zlog_unregister_client — atestação offline exact v1

Status: `CORE_GATES_PASS` / offline-only.

Esta unidade consolida `zlog_unregister_client@00100984` contra
...
`00100794`; essa diferença de layout está registrada nos relatórios de
