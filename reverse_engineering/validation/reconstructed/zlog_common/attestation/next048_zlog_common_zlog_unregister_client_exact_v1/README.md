# zlog_common — zlog_unregister_client

Function-level offline exact attestation for the stock client unregister helper `zlog_unregister_client` at `0x00100984`.

## Result

- Ghidra stock pseudocode/P-Code was reviewed.
- Stock and reconstructed candidate matched at 78 AArch64 instructions and 312 bytes.
...
- The host harness passed reproducibly, including unregister, dangling-buffer and duplicate-clear paths.

This is static/offline evidence only. It does not claim hardware execution or prove concurrent client ownership and live buffer lifetime behavior.
