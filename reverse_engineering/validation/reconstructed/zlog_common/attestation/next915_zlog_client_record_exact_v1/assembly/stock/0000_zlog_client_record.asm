...
00000000000000cc <zlog_client_record>:
     ...
     12c: 910023eb     	add	x11, sp, #0x8
     130: 910083aa     	add	x10, x29, #0x20
     134: f9407e6d     	ldr	x13, [x19, #0xf8]
     138: 9100c16b     	add	x11, x11, #0x30
     13c: f85e83ac     	ldur	x12, [x29, #-0x18]
     140: aa2803e8     	mvn	x8, x8
     144: a93dafaa     	stp	x10, x11, [x29, #-0x28]
     148: 128005e9     	mov	w9, #-0x30              // =-48
     14c: 9100e3e3     	add	x3, sp, #0x38
     150: a903afea     	stp	x10, x11, [sp, #0x38]
     154: a9502a6b     	ldp	x11, x10, [x19, #0x100]
     158: aa1403e2     	mov	x2, x20
     15c: f81f03a9     	stur	x9, [x29, #-0x10]
     160: a904a7ec     	stp	x12, x9, [sp, #0x48]
     164: 8b0d0140     	add	x0, x10, x13
     168: 8b080161     	add	x1, x11, x8
     ...
     1d8: 90000000     	adrp	x0, 0x0 <.text>
		00000000000001d8:  R_AARCH64_ADR_PREL_PG_HI21	.rodata.str1.1+0x581
     1dc: 91000000     	add	x0, x0, #0x0
		00000000000001dc:  R_AARCH64_ADD_ABS_LO12_NC	.rodata.str1.1+0x581
     1e0: 14000003     	b	0x1ec <zlog_client_record+0x120>
     1e4: 90000000     	adrp	x0, 0x0 <.text>
		00000000000001e4:  R_AARCH64_ADR_PREL_PG_HI21	.rodata.str1.1+0x3ed
     1e8: 91000000     	add	x0, x0, #0x0
		00000000000001e8:  R_AARCH64_ADD_ABS_LO12_NC	.rodata.str1.1+0x3ed
