# zlog_handle_work — atestação offline exact v1

Status: `CORE_GATES_PASS` / offline-only.

Esta unidade consolida `zlog_handle_work@00100b80` contra
...
`001008d0`; essa diferença de layout está registrada nos relatórios de
