...
0000000000000d9c <zlog_comm_open>:
     ...
     db0: 90000009     	adrp	x9, 0x0 <.text>
		0000000000000db0:  R_AARCH64_ADR_PREL_PG_HI21	g_zlog_server+0x24c0
     db4: 91000129     	add	x9, x9, #0x0
		0000000000000db4:  R_AARCH64_ADD_ABS_LO12_NC	g_zlog_server+0x24c0
     db8: b828013f     	stadd	w8, [x9]
     dbc: 90000008     	adrp	x8, 0x0 <.text>
		0000000000000dbc:  R_AARCH64_ADR_PREL_PG_HI21	g_zlog_server+0x24c0
     dc0: 90000000     	adrp	x0, 0x0 <.text>
		0000000000000dc0:  R_AARCH64_ADR_PREL_PG_HI21	.rodata.str1.1+0x8b6
     dc4: 91000000     	add	x0, x0, #0x0
		0000000000000dc4:  R_AARCH64_ADD_ABS_LO12_NC	.rodata.str1.1+0x8b6
     dc8: b9400102     	ldr	w2, [x8]
		0000000000000dc8:  R_AARCH64_LDST32_ABS_LO12_NC	g_zlog_server+0x24c0
     dcc: 90000001     	adrp	x1, 0x0 <.text>
		0000000000000dcc:  R_AARCH64_ADR_PREL_PG_HI21	.rodata.str1.1+0x9a2
     dd0: 91000021     	add	x1, x1, #0x0
		0000000000000dd0:  R_AARCH64_ADD_ABS_LO12_NC	.rodata.str1.1+0x9a2
     ...
     de8: 90000008     	adrp	x8, 0x0 <.text>
		0000000000000de8:  R_AARCH64_ADR_PREL_PG_HI21	g_zlog_server+0x24c0
     dec: 91000108     	add	x8, x8, #0x0
		0000000000000dec:  R_AARCH64_ADD_ABS_LO12_NC	g_zlog_server+0x24c0
