...
Gerado em: `2026-07-16T15:26:15.528972+00:00`

| Driver | Veredito offline | Gates PASS | Bloqueadores |
|---|---|---:|---|
| `zlog_common` | `INCOMPLETE` | 8/10 | offline parity failed: assembly<br>parity report status is not PASS<br>missing independent_review.json |
