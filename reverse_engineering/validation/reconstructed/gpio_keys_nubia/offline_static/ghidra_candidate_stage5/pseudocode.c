  ...
  if (((*(ushort *)(param_1 + 0x10c) & 1) == 0) || (*(long *)(param_1 + 0x148) == 0)) {
    ...
    if ((*(int *)(lVar5 + 0x228) != 0) &&
      ...
      if (*(int *)(pcVar4 + -4) != 0x6c81b8c8) {
        ...
        pcVar4 = (code *)SoftwareBreakpoint(0x8228,0x1002f4);
        (*pcVar4)();
      }
    ...
    if (*(int *)(lVar5 + 0x228) != 0) {
      ...
      if (pcVar2 != (code *)0x0) {
        if (*(int *)(pcVar2 + -4) != 0x2a703c0b) {
                    /* WARNING: Does not return */
          pcVar2 = (code *)SoftwareBreakpoint(0x8229,0x100514);
          (*pcVar2)();
        }
...
/* 0010061c gpio_keys_attr_show_helper */
...

{
  ...
  if ((param_3 & 0xfffffffb) != 1) {
                    /* WARNING: Does not return */
    pcVar1 = (code *)SoftwareBreakpoint(0x800,0x10075c);
    (*pcVar1)();
  }
  uVar4 = 0x300;
  if (param_3 != 1) {
  ...
  _printk(&gpio_keys_attr_show_helper_log,uVar4);
...
/* 0010075c gpio_keys_attr_store_helper */
...

{
  ...
  if ((param_3 & 0xfffffffb) != 1) {
                    /* WARNING: Does not return */
    pcVar4 = (code *)SoftwareBreakpoint(0x800,0x100a7c);
    (*pcVar4)();
  }
  uVar8 = 0x300;
  if (param_3 != 1) {
...
LAB_001008c0:
    if ((uVar8 & 0x11) != 0) {
      ...
      if ((puVar6[lVar11] & uVar9 & (puVar1[lVar11] ^ 0xffffffffffffffff)) != 0) goto LAB_001008ec;
    }
    _printk(&gpio_keys_attr_store_helper_log,uVar8,param_3);
    ...
    if (0 < (int)*(uint *)(*param_1 + 8)) {
      ...
      do {
        if (((*(uint *)(plVar10[-3] + 0x18) == param_3) &&
           ...
           (*(char *)(plVar10[-3] + 0x28) != '\x01')) goto LAB_001008ec;
        uVar9 = uVar9 - 1;
...
/* 00100ab0 gpio_keys_show_switches */
...
/* 00100ae0 gpio_keys_show_disabled_keys */
...
/* 00100b10 gpio_keys_show_disabled_switches */
...
/* 00100b40 gpio_keys_store_disabled_keys */
...
/* 00100b80 gpio_keys_store_disabled_switches */
...

{
  ...
  lVar1 = FUN_00100b5c(*(undefined8 *)(param_1 + 0x98),param_3,5);
  if (lVar1 != 0) {
    param_4 = lVar1;
  }
  return param_4;
...
/* 00100bc0 gpio_keys_show_GamekeyStatus */
...

{
  ...
  uVar3 = 0xffffffff;
LAB_00100c50:
  _printk(&gpio_keys_show_GamekeyStatus_log,uVar3);
...
/* 00100c90 gpio_keys_store_GamekeyStatus */
...

{
  ...
  _printk(&gpio_keys_store_GamekeyStatus_log);
  return in_x3;
}



/* 00100cc8 gpio_keys_shutdown */
...

{
  ...
  if (pcVar3 != (code *)0x0) {
    if (*(int *)(pcVar3 + -4) != 0x2a703c0b) {
                    /* WARNING: Does not return */
      pcVar3 = (code *)SoftwareBreakpoint(0x8229,0x100d50);
      (*pcVar3)();
    }
...

{
  ...
  if (pcVar1 != (code *)0x0) {
    if (*(int *)(pcVar1 + -4) != 0x6c81b8c8) {
                    /* WARNING: Does not return */
      pcVar1 = (code *)SoftwareBreakpoint(0x8228,0x100e0c);
      (*pcVar1)();
    }
...
/* 00100e1c gpio_keys_gpio_report_event */
...

{
  ...
  if (-1 < (int)param_1[0x19]) {
    ...
    if ((iVar6 == 0) == (iVar7 == 0)) {
      _printk(&DAT_001025ea,"nb_key_is_need_report",iVar6 == 0);
      return;
    }
...
LAB_00100f4c:
    ...
    if (uVar3 != 3) goto LAB_00100f4c;
    if (uVar8 == 0) goto LAB_00100ed4;
...
/* 00100fb4 gpio_keys_gpio_work_func */
...

{
  ...
  if ((*(int *)((long)param_2 + 0xbc) != param_1) && (*(int *)(param_2 + 0x18) != param_1)) {
                    /* WARNING: Does not return */
    pcVar2 = (code *)SoftwareBreakpoint(0x800,0x1010bc);
    (*pcVar2)();
  }
...

{
  ...
  if (*(int *)((long)param_2 + 0xbc) != param_1) {
                    /* WARNING: Does not return */
    pcVar1 = (code *)SoftwareBreakpoint(0x800,0x101260);
    (*pcVar1)();
  }
  lVar4 = param_2[1];
  ...
  else if ((int)param_2[9] == 0) goto LAB_00101238;
  lVar4 = _jiffies;
...
/* 00101264 gpio_keys_quiesce_key */
      ...
      do {
        ...
        if (iVar10 != 0) {
          ...
          if (((uVar17 < 0xfffffffffffff001) && (*(long *)(uVar17 + 8) != 0)) &&
            ...
            if (*(int *)(pcVar21 + -4) != -0x26580391) {
                    /* WARNING: Does not return */
              pcVar21 = (code *)SoftwareBreakpoint(0x8228,0x101fac);
              (*pcVar21)();
            }
            (*pcVar21)(uVar17);
          }
        ...
        if (iVar10 != 0) {
          if (((((long)(uVar18 - 0x18) < 0) || (uVar20 <= uVar18 - 0x18)) ||
              ((long)(uVar18 - 0x18) < 0)) || (uVar20 <= uVar18 - 0x18)) goto LAB_00102098;
          *puVar24 = 1;
        }
        ...
        if ((((long)(uVar18 - 0x14) < 0) || (uVar20 < uVar18 - 0x14)) ||
           (((long)(uVar18 - 0x14) < 0 || (uVar20 < uVar18 - 0x14)))) goto LAB_00102098;
        *(uint *)((long)plVar23 + (uVar18 - 0x14)) = uVar8 & 1;
        ...
        if ((((long)(uVar18 - 8) < 0) || (uVar20 <= uVar18 - 8)) ||
           (((long)(uVar18 - 8) < 0 || (uVar20 <= uVar18 - 8)))) goto LAB_00102098;
        ...
        *(byte *)((long)plVar23 + (uVar18 - 8)) = bVar7 & 1;
        ...
        if (iVar10 != 0) {
          uVar16 = uVar18 - 0xc;
          if (((uVar20 < uVar16) || ((long)uVar16 < 0)) || (uVar20 < uVar16)) goto LAB_00102098;
          *puVar24 = 5;
        }
...
LAB_00102098:
                    /* WARNING: Does not return */
    pcVar21 = (code *)SoftwareBreakpoint(1,0x10209c);
    (*pcVar21)();
  }
  puVar12[1] = plVar14;
  ...
  *(int *)((long)plVar14 + 0xd4) = (int)plVar23[1];
  ...
  if ((int)plVar23[1] < 1) {
    ...
    if ((int)uVar20 != 0) goto LAB_00101ec0;
LAB_00101e50:
    ...
    do {
      ...
      if (((long)(lVar13 + 0x50U) < 0) || (uVar17 < lVar13 + 0x50U)) goto LAB_00102098;
      uVar20 = lVar13 + 0x48;
      puVar3 = puVar12 + local_88 * 0x22 + 9;
      puVar3[1] = plVar14;
      if (((long)uVar20 < 0) || ((uVar17 < uVar20 || (uVar17 - uVar20 < 8)))) goto LAB_00102098;
      *puVar3 = puVar24;
      uVar20 = lVar13 + 0x14c;
      if (((long)uVar20 < 0) || ((uVar17 < uVar20 || (uVar17 - uVar20 < 4)))) goto LAB_00102098;
      *(undefined4 *)((long)puVar3 + 0x104) = 0;
      if (uVar18 == 0) {
        ...
        if ((int)uVar8 < 0) {
          ...
          if ((((long)uVar20 < 0) || (uVar17 < uVar20)) || (uVar17 - uVar20 < 8)) goto LAB_00102098;
          puVar3[2] = lVar15;
          if (lVar15 != 0) goto LAB_001015e0;
          uVar20 = 0xffffffea;
        }
        _printk(&DAT_001025be,"gpio_keys_probe");
        goto LAB_0010205c;
      }
      uVar20 = devm_fwnode_gpiod_get_index(plVar1,uVar18,0,0,1,pcVar19);
      uVar16 = lVar13 + 0x58;
      if ((((long)uVar16 < 0) || (uVar17 < uVar16)) || (uVar17 - uVar16 < 8)) goto LAB_00102098;
      puVar3[2] = uVar20;
      if (uVar20 < 0xfffffffffffff001) {
LAB_001015dc:
        if (uVar20 == 0) goto LAB_0010184c;
LAB_001015e0:
        lVar22 = param_1[0x5f];
        local_70 = (char *)0x0;
...
LAB_00101648:
        ...
        if (puVar24[9] != 0) {
          ...
          if (iVar10 < 0) {
            if (((long)(lVar13 + 0x100U) < 0) || (uVar17 < lVar13 + 0x100U)) goto LAB_00102098;
...
LAB_001016d8:
          uVar16 = lVar13 + 0x104;
          if ((((long)uVar16 < 0) || (uVar17 < uVar16)) || (uVar17 - uVar16 < 4)) goto LAB_00102098;
          *(int *)((long)puVar3 + 0xbc) = iVar10;
          uVar2 = lVar13 + 0x98;
          if ((((long)uVar2 < 0) || (uVar17 < uVar2)) || (uVar17 - uVar2 < 8)) goto LAB_00102098;
          puVar3[10] = 0xfffffffe00000;
          puVar3[0xb] = puVar3 + 0xb;
          puVar3[0xc] = puVar3 + 0xb;
          if (((long)(lVar13 + 0xb0U) < 0) || (uVar17 < lVar13 + 0xb0U)) goto LAB_00102098;
          puVar3[0xd] = gpio_keys_gpio_work_func;
          init_timer_key(puVar3 + 0xe,&delayed_work_timer_fn,0x200000,0,0);
          if ((uVar17 < uVar16) || (uVar17 - uVar16 < 4)) goto LAB_00102098;
          uVar16 = lVar13 + 0x108;
          if ((((long)uVar16 < 0) || (uVar17 < uVar16)) || (uVar17 - uVar16 < 4)) goto LAB_00102098;
          _printk(&DAT_0010272e,uVar20,*(undefined4 *)((long)puVar3 + 0xbc),
...
LAB_00101820:
          ...
          uVar20 = 3;
LAB_001018c4:
          if (((long)(lVar13 + 0x60U) < 0) || (uVar17 < lVar13 + 0x60U)) goto LAB_00102098;
          lVar15 = puVar12[8];
          ...
          if (-1 < (int)uVar8) {
            ...
            if (lVar15 != 0) {
              ...
              do {
                ...
                if ((uVar17 < uVar16 || uVar17 - uVar16 < 4) || (long)uVar16 < 0) goto LAB_00102098;
                *(undefined4 *)((long)puVar3 + 0xc4) = uVar11;
                uVar11 = of_get_named_gpio(lVar15,"gpion",0);
                if ((long)(lVar13 + 0x110U) < 0 || uVar17 < lVar13 + 0x110U) goto LAB_00102098;
                *(undefined4 *)(puVar3 + 0x19) = uVar11;
                lVar15 = of_get_next_child(lVar22,lVar15);
              } while (lVar15 != 0);
            }
            uVar16 = lVar13 + 0x110;
            if (((long)uVar16 < 0) || (uVar17 < uVar16)) goto LAB_00102098;
            ...
            if ((((-1 < (long)uVar2) && (uVar2 <= uVar17)) && (3 < uVar17 - uVar2)) &&
               (uVar16 <= uVar17)) {
              _printk(&DAT_00102575,"nb_setup_secondary",*(undefined4 *)((long)puVar3 + 0xc4),
              ...
              if (((-1 < (long)uVar16) && (uVar16 <= uVar17)) && (3 < uVar17 - uVar16)) {
                if ((*(int *)(puVar3 + 0x18) != 0) &&
                   ...
                   , iVar9 < 0)) {
                  _printk(&DAT_00102116,"gpio_keys_setup_key");
                }
                goto LAB_00101ae4;
              }
            }
...
LAB_00101ff0:
        ...
        if (((uVar18 != 0) && ((uVar18 < 0xfffffffffffff001 && (*(long *)(uVar18 + 8) != 0)))) &&
          ...
          if (*(int *)(pcVar21 + -4) != -0x26580391) {
                    /* WARNING: Does not return */
            pcVar21 = (code *)SoftwareBreakpoint(0x8228,0x10203c);
            (*pcVar21)();
          }
          (*pcVar21)();
        }
...
LAB_00101ae4:
    ...
    if ((((uVar18 != 0) && (uVar18 < 0xfffffffffffff001)) && (*(long *)(uVar18 + 8) != 0)) &&
      ...
      if (*(int *)(pcVar21 + -4) != -0x26580391) {
                    /* WARNING: Does not return */
        pcVar21 = (code *)SoftwareBreakpoint(0x8228,0x101e18);
        (*pcVar21)();
      }
      (*pcVar21)(uVar18);
    }
