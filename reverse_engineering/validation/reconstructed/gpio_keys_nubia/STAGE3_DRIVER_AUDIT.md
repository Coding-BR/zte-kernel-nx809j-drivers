...
- Gerado em: `2026-07-16T02:12:21.058229+00:00`
...
|---|---|---|---|
| `gpio_keys_nubia` | `incomplete_or_failed` | `não executado` | module parity check failed: vermagic_accepted<br>module parity check failed: candidate_matches_fresh<br>mapping 0 is not independently reviewed |
