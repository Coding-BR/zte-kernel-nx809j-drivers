#!/usr/bin/env python3
"""Build and run the gpio_keys_gpio_work_func host harness twice in Docker."""
...
EXPECTED_STDOUT = "PASS gpio_keys_gpio_work_func host tests (2 scenarios)\n"
...
def main() -> int:
    ...
    parser.add_argument(
        ...
        default=pathlib.Path(__file__).with_name(
            "gpio_keys_gpio_work_func_host_test.c"
        ),
    )
    ...
    for cycle in (1, 2):
        ...
        command = [
            ...
            "-frandom-seed=gpio-keys-nubia-work-func",
    ...
    report = {
        ...
        "mode": "offline_direct_source_gpio_keys_gpio_work_func_asan_ubsan",
        "driver": "gpio_keys_nubia",
        "target": "gpio_keys_gpio_work_func",
        "covered_functions": ["gpio_keys_gpio_work_func"],
        "source": str(source),
