#!/usr/bin/env python3
"""Build and run the gpio_keys_resume host harness twice in Docker."""
...
EXPECTED_STDOUT = "PASS gpio_keys_resume host tests (6 scenarios)\n"
...
def main() -> int:
    ...
    report = {
        ...
        "mode": "offline_direct_source_gpio_keys_resume_asan_ubsan",
        "driver": "gpio_keys_nubia", "target": "gpio_keys_resume",
        "covered_functions": ["gpio_keys_resume"],
        ...
        "limitations": [
            "The harness uses stand-ins for kernel devices, input mutexes and IRQ APIs.",
