#!/usr/bin/env python3
"""Build and run the gpio_keys_show_switches host harness twice in Docker."""
...
EXPECTED_STDOUT = "PASS gpio_keys_show_switches host tests (2 scenarios)\n"
...
def main() -> int:
    ...
    parser.add_argument("--source", type=pathlib.Path,
                        default=pathlib.Path(__file__).with_name(
                            "gpio_keys_show_switches_host_test.c"))
    ...
    for cycle in (1, 2):
        ...
        command = [
            ...
            "-frandom-seed=gpio-keys-nubia-show-switches",
    ...
    report = {
        ...
        "mode": "offline_direct_source_gpio_keys_show_switches_asan_ubsan",
        "driver": "gpio_keys_nubia", "target": "gpio_keys_show_switches",
        "covered_functions": ["gpio_keys_show_switches"],
        ...
        "limitations": [
            "The harness uses a stand-in for gpio_keys_attr_show_helper.",
