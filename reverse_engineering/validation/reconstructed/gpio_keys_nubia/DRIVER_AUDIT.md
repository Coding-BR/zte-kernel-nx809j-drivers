...
- Gerado em: `2026-07-16T00:29:40.639909+00:00`
...
|---|---|---|---|
| `gpio_keys_nubia` | `incomplete_or_failed` | `não executado` | current reconstructed .ko is missing<br>module parity check failed: undefined_symbols_match<br>module parity check failed: candidate_matches_fresh |
