...

{
  ...
  if (iVar2 == 1) {
    _printk(&DAT_001011e5,"zlog_enable_test_set",local_4c != 0);
    uVar4 = (uint)(local_4c != 0);
    if (zlog_enable_test_flag == uVar4) {
      _printk(&DAT_0010143d,"zlog_enable_test_set");
      uVar3 = 0;
    }
    else {
      ...
      if (local_4c == 0) {
        ...
        if (client_1 == 0) {
          _printk(&DAT_00101472,"zlog_enable_test_set");
        }
        client_2 = zlog_register_client(&test_dev_2);
        if (client_2 == 0) {
          _printk(&DAT_001015dd,"zlog_enable_test_set");
        }
        client_3 = zlog_register_client(&test_dev_3);
        if (client_3 == 0) {
          _printk(&DAT_0010108f,"zlog_enable_test_set");
        }
        client_4 = zlog_register_client(&test_dev_4);
        if (client_4 == 0) {
          _printk(&DAT_001012c7,"zlog_enable_test_set");
        }
        client_5 = zlog_register_client(&test_dev_5);
        if (client_5 == 0) {
          _printk(&DAT_00100f72,"zlog_enable_test_set");
        }
    ...
    _printk(&DAT_00101276,"zlog_enable_test_set");
    uVar3 = 0xffffffea;
  }
  lVar1 = sp_el0;
...

{
  ...
  _printk(&DAT_00101392,&DAT_001010b1,&DAT_001010b1,uVar1,iVar2);
  return iVar2;
}
...

{
  ...
  _printk(&DAT_001013f7,"zlog_test1_thread",client_1 + 4);
...

{
  ...
  _printk(&DAT_001013f7,"zlog_test2_thread",client_2 + 4);
...

{
  ...
  _printk(&DAT_001013f7,"zlog_test3_thread",client_3 + 4);
...

{
  ...
  _printk(&DAT_001013f7,"zlog_test4_thread",client_4 + 4);
...

{
  ...
  _printk(&DAT_001013f7,"zlog_test5_thread",client_5 + 4);
...
{
  _printk(&DAT_00101298,"zlog_test_exit");
  return;
}
