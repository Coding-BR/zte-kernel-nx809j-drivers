...
Function-level offline exact attestation for `poll` at `0x001006e8`.

## Result

- Ghidra stock pseudocode/P-Code was reviewed.
- Stock and reconstructed candidate matched at 21 AArch64 instructions and 84 bytes.
...
This is static/offline evidence only. The target has no dedicated host harness in the reconstructed tree; random-branch runtime behavior and hardware execution remain unverified.
