...
Gerado em: `2026-07-16T16:25:02.715266+00:00`

| Driver | Veredito offline | Gates PASS | Bloqueadores |
|---|---|---:|---|
| `zlog_test` | `INCOMPLETE` | 9/10 | missing report field: commands<br>missing report field: reviewer<br>report status is not PASS |
