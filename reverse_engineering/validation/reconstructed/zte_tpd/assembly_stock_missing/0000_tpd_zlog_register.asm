...
0000000000000004 <cleanup_module>:
      ...
      14: 94000000     	bl	0x14 <cleanup_module+0x10>
		0000000000000014:  R_AARCH64_CALL26	.text+0x7848
      18: 90000000     	adrp	x0, 0x0 <.exit.text>
		0000000000000018:  R_AARCH64_ADR_PREL_PG_HI21	.data+0x150
      1c: 91000000     	add	x0, x0, #0x0
		000000000000001c:  R_AARCH64_ADD_ABS_LO12_NC	.data+0x150
