...

{
  ...
  if (param_1 == 0) {
    _printk(&DAT_00164a42,"syna_tcm_run_production_test");
    uVar4 = 0xffffff0f;
  }
    ...
    if (param_4 == 0) {
      if ((*(byte *)(*(long *)(param_1 + 0x48) + 0x14) & 1) == 0) {
        ...
        _printk(&DAT_00168057,"syna_tcm_run_production_test");
      }
      else {
        param_4 = 0;
      }
    ...
    if (*(int *)(*(code **)(param_1 + 0x398) + -4) != 0x24203a8e) {
      ...
      pcVar2 = (code *)SoftwareBreakpoint(0x8228,0x14cbf8);
      (*pcVar2)();
    }
    uVar4 = (**(code **)(param_1 + 0x398))(param_1,0x2a,local_3c,1,0,param_4);
    if ((int)uVar4 < 0) {
      uVar4 = uVar4 & 0xffffffff;
      _printk(&DAT_00167702,"syna_tcm_run_production_test",local_3c[0],0x2a);
    }
    else if (param_3 != 0) {
      uVar3 = syna_tcm_buf_copy(param_3,param_1 + 0x148);
      if ((int)uVar3 < 0) {
        uVar4 = (ulong)uVar3;
        _printk(&DAT_00166336,"syna_tcm_run_production_test");
      }
      else {
        uVar4 = 0;
      }
    ...
    _printk(&DAT_00164e53,"syna_tcm_run_production_test");
    uVar4 = 0xffffff0f;
  }
  lVar1 = sp_el0;
