...

{
  ...
  if (param_1 == (long *)0x0) {
    ...
    if (iVar2 < 0) {
      _printk(&DAT_0016692e,"syna_dev_do_reflash","syna_firmware.img");
    }
    else {
      iVar2 = syna_tcm_do_fw_update(lVar1,*(undefined8 *)(local_30 + 2),*local_30,0,param_2 & 1);
      if (iVar2 < 0) {
        _printk(&DAT_0016402d,"syna_dev_do_reflash");
      }
      _printk(&DAT_001651b1,"syna_dev_do_reflash",*(undefined1 *)(lVar1 + 9));
