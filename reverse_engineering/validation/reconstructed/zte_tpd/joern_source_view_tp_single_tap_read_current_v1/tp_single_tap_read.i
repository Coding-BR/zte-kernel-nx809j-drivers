...
#line 1 "tp_single_tap_read.c"
struct ztp_device;
typedef int (*tp_single_tap_read_callback_t)(struct ztp_device *cdev);

ssize_t tp_single_tap_read(struct file *file, char __user *buffer,
                           size_t count, loff_t *offset)
{
  ...
  __int64 v5; // x8
  __int64 v8; // x22
  tp_single_tap_read_callback_t v10; // x8
  int v12; // w0
  ...
  *(_QWORD *)s = 0;
  ...
  {
    v8 = tpd_cdev;
  v10 = *(tp_single_tap_read_callback_t *)(tpd_cdev + 0xeb8);
    if ( v10 )
    {
      /* CFI check removed */
      v10((struct ztp_device *)tpd_cdev);
    }
    printk(unk_34061, "tp_single_tap_read", *(unsigned int *)(v8 + 1100));
