...

{
  ...
  if (lVar4 == 0) {
    _printk(&DAT_00165936,"syna_testing_pt05_zte");
    uVar6 = 0xfffffff4;
  }
  else {
    if ((*(byte *)((long)param_1 + 0x582) & 1) == 0) {
      ...
      if (puVar5 != (undefined4 *)0x0) {
        ...
        __mutex_init(&local_a0,"(struct mutex *)ptr",&syna_testing_pt05_zte___key);
        ...
        *(undefined1 ***)(puVar5 + 0x10) = &local_d0;
        if (*(int *)(*(code **)(puVar5 + 6) + -4) != -0x7e3fb56e) {
          ...
          pcVar2 = (code *)SoftwareBreakpoint(0x8228,0x1561fc);
          (*pcVar2)();
        }
        iVar3 = (**(code **)(puVar5 + 6))(*param_1,puVar5,0);
        if (iVar3 < 0) {
          _printk(&DAT_0016613c,"syna_testing_pt05_zte",*(undefined8 *)(puVar5 + 2));
          puVar8 = &DAT_00164073;
        }
        else {
          puVar8 = &DAT_00164887;
        ...
        if ((iStack_a4 != 0) && (puVar5[8] != 0)) {
          ...
          do {
            if (puVar5[9] != 0) {
              uVar10 = 0;
              do {
                iVar3 = scnprintf(lVar4 + uVar6,0x1000 - uVar6,&DAT_00165352,
                                  *(undefined2 *)
            ...
            iVar3 = scnprintf(lVar4 + uVar6,0x1000 - uVar6,&DAT_001641eb);
            uVar9 = uVar9 + 1;
            uVar6 = (ulong)(uint)(iVar3 + (int)uVar6);
        ...
        if ((char)local_70 != '\0') {
          _printk(&DAT_00162633,"syna_tcm_buf_release");
        }
        lVar1 = local_b0;
        lVar7 = syna_request_managed_device();
        if (lVar7 == 0) {
          _printk(&DAT_00165910,"syna_pal_mem_free");
        }
        else if (lVar1 != 0) {
