...
- Candidate SHA-256: `6bd9588301a6f56e23de34f6687f7b13d27c3234dd9942236b54f0c05fbb959f`
...
| hash-attested direct-test subset | `PASS` | microtask_progress.json records 160/367 current-source PASS tasks; this scoped run promoted 1 task(s) from 1 sanitizer-backed host report(s), with zero stale PASS demotions Note: This PASS covers only the attested subset; 207 functions remain unvalidated |
...
- O6 has 160 hash-attested PASS microtasks and 207 tasks still requiring direct evidence
