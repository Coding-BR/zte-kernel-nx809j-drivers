...
| hash-attested direct-test subset | `PASS` | microtask_progress.json records 163/367 current-source PASS tasks; this scoped run promoted 1 task(s) from 1 sanitizer-backed host report(s), with zero stale PASS demotions Note: This PASS covers only the attested subset; 204 functions remain unvalidated |
...
- O6 has 163 hash-attested PASS microtasks and 204 tasks still requiring direct evidence
