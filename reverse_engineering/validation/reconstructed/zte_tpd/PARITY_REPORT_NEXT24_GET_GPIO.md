...
- Candidate SHA-256: `d7267e60da8fef2ea6b217fdc9b27952afbbb9e292bf91be2105c34630efd8e6`
...
| hash-attested direct-test subset | `PASS` | microtask_progress.json records 164/367 current-source PASS tasks; this scoped run promoted 1 task(s) from 1 sanitizer-backed host report(s), with zero stale PASS demotions Note: This PASS covers only the attested subset; 203 functions remain unvalidated |
...
- O6 has 164 hash-attested PASS microtasks and 203 tasks still requiring direct evidence
