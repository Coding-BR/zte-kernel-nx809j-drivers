...
- Candidate SHA-256: `f828a61670510ed2da430a80ced9d6858a3d5b8807af96391fba14bef0e8358b`
...
| hash-attested direct-test subset | `PASS` | microtask_progress.json records 165/367 current-source PASS tasks; this scoped run promoted 1 task(s) from 1 sanitizer-backed host report(s), with zero stale PASS demotions Note: This PASS covers only the attested subset; 202 functions remain unvalidated |
...
- O6 has 165 hash-attested PASS microtasks and 202 tasks still requiring direct evidence
