...
Gerado em: `2026-07-23T03:06:41.444933+00:00`

| Driver | Veredito offline | Gates PASS | Bloqueadores |
|---|---|---:|---|
| `zte_tpd` | `INCOMPLETE` | 7/10 | report status is not PASS<br>offline parity failed: complete recoverable KCFI surface<br>parity report status is not PASS<br>parity report targets another candidate SHA-256 |
