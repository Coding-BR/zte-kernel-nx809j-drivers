...
int main(void)
{
    ...
    expected_offset = (((long)vma.vm_pgoff * 0x100000L) +
                       ((long)(uintptr_t)buffer * 0x100L)) >> 8;
    expected_pfn = (((long)(memstart_addr >> PAGE_SHIFT) * 0x40L) +
                    ((expected_offset + 0x8000000000L) >> 6)) >> 6;
