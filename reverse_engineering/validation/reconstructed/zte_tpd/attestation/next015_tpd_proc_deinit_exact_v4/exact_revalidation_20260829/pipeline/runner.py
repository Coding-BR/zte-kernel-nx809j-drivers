#!/usr/bin/env python3
"""Run the dedicated offline ASAN/UBSAN harness for zte_tpd microtask 015."""
...
HARNESS_NAME = "next015_tpd_proc_deinit_harness.c"
EXPECTED_TESTS = 3
...
def main() -> int:
    ...
    source = source_dir / "tpd_proc_deinit.c"
    ...
    for index in range(args.repetitions):
        ...
        execution_passed = (
            ...
            and not failed
            and summary == "SUMMARY 3/3 passed"
        )
        executions.append({
            "index": index + 1,
    ...
    report = {
        "schema_version": "1.0",
        "mode": "offline_direct_source_proc_deinit_host_harness_asan_ubsan",
        "generated_utc": datetime.now(timezone.utc).isoformat(),
        "driver": "zte_tpd",
        "microtask_id": "015_tpd_proc_deinit",
        "function": "tpd_proc_deinit",
        "passed": all(item["passed"] for item in executions),
        "repetitions": args.repetitions,
        "expected_tests": EXPECTED_TESTS,
        "coverage": {
            "direct_source_function": "tpd_proc_deinit",
            "null_directory_guard": True,
            "all_proc_entries": 30,
            "removal_order": True,
            "parent_pointer_propagation": True,
            "touchscreen_root_parent_null": True,
        ...
        "limitations": [
            "The harness models proc-entry removal and printk in user space.",
            "No physical NX809J, Android procfs implementation or scheduler path is exercised.",
        ],
    }
