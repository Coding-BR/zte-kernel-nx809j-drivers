# `syna_tcm_set_data_duplicator` exact revalidation

This package records the Docker-backed revalidation of microtask `291_syna_tcm_set_data_duplicator`.
...
- AArch64 function comparison: PASS; 19 instructions, 76-byte symbol, and equivalent relocations for stock entry `0x001240d4`.
- KCFI: PASS; type ID `0x6f1c1b70`, `.text`, 76 bytes.
...
This is an offline/static promotion. No device, ADB, `insmod`, firmware interaction, or hardware behavior was available. The host oracle validates indexed callback/context stores and null-handle logging; transport and MMIO remain outside its scope.
