#!/usr/bin/env python3
"""Build and run the syna_sysfs_debug_store harness twice with sanitizers."""
...
EXPECTED_STDOUT = "PASS syna_sysfs_debug_store host tests (9 cases)\n"
...
def main() -> int:
    ...
    parser.add_argument(
        ...
        default=pathlib.Path(__file__).with_name(
            "syna_sysfs_debug_store_host_test.c"
        ),
    )
    ...
    for cycle in (1, 2):
        ...
        command = [
            ...
            "-fno-pie",
            "-no-pie",
            "-frandom-seed=zte-tpd-next28-debug",
    ...
    report = {
        ...
        "mode": "offline_direct_source_next28_sysfs_debug_store_asan_ubsan",
        "driver": "zte_tpd",
        "target": "syna_sysfs_debug_store",
        "source": str(source),
        ...
        "limitations": [
            "The harness stubs parsing, kobject, sysfs and printk APIs.",
            "It proves offsets, branches, call order, cleanup, logs and returns.",
