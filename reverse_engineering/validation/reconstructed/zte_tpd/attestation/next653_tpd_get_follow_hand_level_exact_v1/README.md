# `tpd_get_follow_hand_level` offline exact attestation

This package records the function-level reconstruction of
`tpd_get_follow_hand_level` at stock entry `0x0012c26c` for the ZTE NX809J /
...
The exact assembly source is emitted by `tpd_get_follow_hand_level_exact.S`.
