#!/usr/bin/env python3
"""Run the isolated array-check host contract under ASan and UBSan."""
...
HOST_SOURCE = Path("kernel_development/drivers/validation/zte_tpd/host/syna_tcm_testing_check_array_data_host_test.c")
DRIVER_SOURCE = Path("kernel_development/drivers/reconstructed/zte_tpd/syna_tcm_testing_check_array_data.c")
...
EXPECTED = "PASS syna_tcm_testing_check_array_data host tests (4 cases)\n"
...
def main() -> int:
    ...
    for cycle in range(1, 3):
        ...
        compile_command = [
            ...
            "-frandom-seed=zte-tpd-next535-syna-tcm-testing-check-array-data",
    ...
    report = {
        ...
        "mode": "offline_direct_source_next535_syna_tcm_testing_check_array_data_asan_ubsan",
        "driver": "zte_tpd", "target": "syna_tcm_testing_check_array_data",
        "covered_functions": ["syna_tcm_testing_check_array_data"],
        ...
        "inputs": [
            ...
            {"path": str(REPO_ROOT / DRIVER_SOURCE), "size": (REPO_ROOT / DRIVER_SOURCE).stat().st_size,
        ...
        "limitations": [
            "The harness exercises the normalized reconstructed C contract with a deterministic checker stub.",
