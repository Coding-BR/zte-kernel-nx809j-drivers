#!/usr/bin/env python3
"""Run the tpd_init_tpinfo contract twice with sanitizers in Docker."""
...
HOST_SOURCE = Path(
    ...
    "tpd_init_tpinfo_contract_test.c"
)
...
def main() -> int:
    ...
    for cycle in (1, 2):
        ...
        binary = "/out/tpd_init_tpinfo_contract_asan_ubsan"
        compile_command = [
            "docker", "run", "--rm",
        ...
        binary_path = cycle_root / "tpd_init_tpinfo_contract_asan_ubsan"
        passed = (
    ...
    report = {
        ...
        "limitations": [
            "The harness validates the observed offsets, stores and byte-order conversion with fake memory.",
