# `syna_dev_set_stability_level` offline exact attestation

This package records the reconstruction of stock `zte_tpd` function
`syna_dev_set_stability_level` at entry `0x001118a4` for the NX809J.
...
- Exact linked Assembly source: `syna_dev_set_stability_level_exact.S`
