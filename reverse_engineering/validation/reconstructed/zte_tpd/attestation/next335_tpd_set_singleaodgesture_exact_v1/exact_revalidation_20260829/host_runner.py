#!/usr/bin/env python3
"""Build and run the tpd_set_singleaodgesture contract oracle twice in Docker."""
...
def main() -> int:
    ...
    test_source = source.with_name("tpd_set_singleaodgesture_contract_test.c")
    driver_source = repo / "kernel_development" / "drivers" / "reconstructed" / "zte_tpd" / "tpd_set_singleaodgesture.c"
    ...
    for number in (1, 2):
        ...
        cycle.mkdir()
        binary = cycle / "tpd_set_singleaodgesture_contract_asan_ubsan"
        compile_command = [
            ...
            "-frandom-seed=zte-tpd-tpd-set-singleaodgesture",
            "-ffile-prefix-map=/drivers=<drivers>",
            "/drivers/validation/zte_tpd/host/tpd_set_singleaodgesture_contract_test.c",
    ...
    report = {
        ...
        "mode": "offline_direct_source_tpd_set_singleaodgesture_docker_asan_ubsan",
        "driver": "zte_tpd",
        "target": "tpd_set_singleaodgesture",
        "function": "tpd_set_singleaodgesture",
