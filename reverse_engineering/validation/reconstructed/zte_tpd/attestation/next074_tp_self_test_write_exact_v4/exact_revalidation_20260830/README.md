# `tp_self_test_write` — offline exact revalidation v4

This package records the Docker-backed revalidation of the atomic `zte_tpd`
function `tp_self_test_write` at stock entry `0x0010cc50`.
...
cycles. Stock and candidate both contain 37 AArch64 instructions and 148 ELF
