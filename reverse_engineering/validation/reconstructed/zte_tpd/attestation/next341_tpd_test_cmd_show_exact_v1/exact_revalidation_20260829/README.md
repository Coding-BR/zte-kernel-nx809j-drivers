...
The host oracle validates the exact formatted output, `snprintf` return length and diagnostic `printk` invocation. The module was built from the Docker-curated snapshot with image `nubia-sm8850-kernel-builder:latest`, toolchain `clang-r536225`, and two canonical build cycles.
