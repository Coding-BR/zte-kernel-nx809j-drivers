# `tp_test_read` — offline exact revalidation v4

This package records the Docker-backed revalidation of the atomic `zte_tpd`
function `tp_test_read` at stock entry `0x0010dbd0`.
...
build passed in two cycles. Stock and candidate both contain 66 AArch64
instructions and 264 ELF bytes; the relocation-aware comparator passed. KCFI
