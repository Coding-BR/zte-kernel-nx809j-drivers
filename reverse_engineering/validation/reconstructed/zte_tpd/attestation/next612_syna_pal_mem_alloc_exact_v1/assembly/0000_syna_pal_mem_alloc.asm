...
0000000000005e1c <syna_pal_mem_alloc>:
    ...
    5e5c: 90000000     	adrp	x0, 0x5000 <syna_tcm_read_cs_data+0x1700>
		0000000000005e5c:  R_AARCH64_ADR_PREL_PG_HI21	.rodata.str1.1+0xafb2
    5e60: 91000000     	add	x0, x0, #0x0
		0000000000005e60:  R_AARCH64_ADD_ABS_LO12_NC	.rodata.str1.1+0xafb2
    5e64: 14000003     	b	0x5e70 <syna_pal_mem_alloc+0x54>
    5e68: 90000000     	adrp	x0, 0x5000 <syna_tcm_read_cs_data+0x1700>
		0000000000005e68:  R_AARCH64_ADR_PREL_PG_HI21	.rodata.str1.1+0x70ae
    5e6c: 91000000     	add	x0, x0, #0x0
		0000000000005e6c:  R_AARCH64_ADD_ABS_LO12_NC	.rodata.str1.1+0x70ae
    5e70: 90000001     	adrp	x1, 0x5000 <syna_tcm_read_cs_data+0x1700>
		0000000000005e70:  R_AARCH64_ADR_PREL_PG_HI21	.rodata.str1.1+0x4bf8
    5e74: 91000021     	add	x1, x1, #0x0
		0000000000005e74:  R_AARCH64_ADD_ABS_LO12_NC	.rodata.str1.1+0x4bf8
