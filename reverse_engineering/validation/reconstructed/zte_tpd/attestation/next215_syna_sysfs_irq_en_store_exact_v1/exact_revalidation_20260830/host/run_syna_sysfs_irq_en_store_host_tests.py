#!/usr/bin/env python3
"""Run the syna_sysfs_irq_en_store contract under ASan and UBSan."""
...
HOST_SOURCE = Path("kernel_development/drivers/validation/zte_tpd/host/syna_sysfs_irq_en_store_host_test.c")
DRIVER_SOURCE = Path("kernel_development/drivers/reconstructed/zte_tpd/syna_sysfs_irq_en_store.c")
EXACT_SOURCE = Path("kernel_development/drivers/reconstructed/zte_tpd/syna_sysfs_irq_en_store_exact.S")
...
EXPECTED = "PASS syna_sysfs_irq_en_store host tests (10 cases)\n"
...
def main() -> int:
    ...
    for cycle in (1, 2):
        ...
        compile_command = [
            ...
            "-frandom-seed=zte-tpd-next707-syna-sysfs-irq-en-store",
    ...
    report = {
        ...
        "mode": "offline_direct_source_syna_sysfs_irq_en_store_asan_ubsan",
        "driver": "zte_tpd", "target": "syna_sysfs_irq_en_store",
        "source": str(source), "source_sha256": sha256(source),
        "sanitizers": ["address", "undefined"], "expected_cases": 10, "repetitions": 2,
        ...
        "limitations": [
            "The harness stubs kstrtouint, printk, SP_EL0 and the interrupt callback.",
            "It proves input, state, callback and return-value branches without a real kobject or touch controller.",
