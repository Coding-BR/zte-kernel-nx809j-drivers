# `syna_dev_get_frame_data` — offline-exact promotion v2

This package records the validated reconstruction of stock entry `00111d48`.

The candidate matches the stock body at 30 AArch64 instructions/120 bytes and
