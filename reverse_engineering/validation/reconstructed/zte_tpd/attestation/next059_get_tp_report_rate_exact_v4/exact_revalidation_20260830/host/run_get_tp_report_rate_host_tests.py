#!/usr/bin/env python3
"""Build and run the get_tp_report_rate contract harness twice in Docker."""
...
EXPECTED = "PASS get_tp_report_rate host tests (4 cases)\n"
...
def main() -> int:
    ...
    harness = ROOT / "kernel_development/drivers/validation/zte_tpd/host/get_tp_report_rate_host_test.c"
    source = ROOT / "kernel_development/drivers/reconstructed/zte_tpd/get_tp_report_rate.c"
    ...
    for number in (1, 2):
        ...
        cycle.mkdir()
        binary = cycle / "get_tp_report_rate_host_test_asan_ubsan"
        compile_command = [
            ...
            "/drivers/validation/zte_tpd/host/get_tp_report_rate_host_test.c",
            "-o", "/out/get_tp_report_rate_host_test_asan_ubsan",
        ]
        ...
        if compiled.returncode == 0:
            executed = subprocess.run(
                ["docker", "run", "--rm", "--network", "none", "-e",
                 ...
                 f"{cycle.resolve()}:/out:ro", IMAGE, "/out/get_tp_report_rate_host_test_asan_ubsan"],
    ...
    report = {
        "schema_version": 1,
        "driver": "zte_tpd",
        "target": "get_tp_report_rate",
        "function": "get_tp_report_rate",
