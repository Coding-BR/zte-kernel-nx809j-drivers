#!/usr/bin/env python3
"""Run the get_tp_noise_show host contract twice with ASan/UBSan."""
...
EXPECTED = "PASS get_tp_noise_show host tests (3 cases)\n"
...
def main() -> int:
    ...
    harness = drivers / "validation/zte_tpd/host/get_tp_noise_show_host_test.c"
    source = drivers / "reconstructed/zte_tpd/get_tp_noise_show.c"
    ...
    for cycle in (1, 2):
        ...
        command = [
            ...
            "-frandom-seed=zte-tpd-get-tp-noise-show",
            "-ffile-prefix-map=/drivers=<drivers>",
            "-fsanitize=address,undefined", "-Wl,--build-id=none",
            "/drivers/validation/zte_tpd/host/get_tp_noise_show_host_test.c",
