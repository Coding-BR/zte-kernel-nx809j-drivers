#!/usr/bin/env python3
"""Run the isolated syna_request_managed_device host contract under sanitizers."""
...
HOST_SOURCE = Path("kernel_development/drivers/validation/zte_tpd/host/syna_request_managed_device_host_test.c")
DRIVER_SOURCE = Path("kernel_development/drivers/reconstructed/zte_tpd/syna_request_managed_device.c")
...
EXPECTED = "PASS syna_request_managed_device host tests (3 cases)\n"
...
def main() -> int:
    ...
    for cycle in range(1, 3):
        ...
        compile_command = [
            ...
            "-frandom-seed=zte-tpd-next88-syna-request-managed-device",
    ...
    report = {
        ...
        "mode": "offline_direct_source_next88_syna_request_managed_device_asan_ubsan",
        "driver": "zte_tpd",
        "target": "syna_request_managed_device",
        "covered_functions": ["syna_request_managed_device"],
        "source": str(source),
        ...
        "limitations": [
            "The harness proves the null-context and +0x70 managed-device contract.",
