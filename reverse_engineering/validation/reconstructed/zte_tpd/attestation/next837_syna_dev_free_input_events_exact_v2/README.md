# `syna_dev_free_input_events` — offline-exact promotion v2

This package records the validated reconstruction of stock entry `001110f0`.

The candidate matches the stock body at 70 AArch64 instructions/280 bytes and
8 normalized relocations. KCFI type `0x3175607e` matches in reports regenerated
