...
000000000002a040 <tp_single_aod_write>:
   ...
   2a074: 90000008     	adrp	x8, 0x2a000 <tp_single_aod_read+0xb4>
   ...
   2a080: 94000000     	bl	0x2a080 <tp_single_aod_write+0x40>
		000000000002a080:  R_AARCH64_CALL26	kstrtouint_from_user
   2a084: 340001a0     	cbz	w0, 0x2a0b8 <tp_single_aod_write+0x78>
   ...
   2a09c: 540003a1     	b.ne	0x2a110 <tp_single_aod_write+0xd0>
   ...
   2a0bc: 90000000     	adrp	x0, 0x2a000 <tp_single_aod_read+0xb4>
   ...
   2a0c4: 90000001     	adrp	x1, 0x2a000 <tp_single_aod_read+0xb4>
		000000000002a0c4:  R_AARCH64_ADR_PREL_PG_HI21	.rodata.str1.1+0xa78a
   2a0c8: 91000021     	add	x1, x1, #0x0
		000000000002a0c8:  R_AARCH64_ADD_ABS_LO12_NC	.rodata.str1.1+0xa78a
   2a0cc: 7100011f     	cmp	w8, #0x0
   2a0d0: 528000a8     	mov	w8, #0x5                // =5
   2a0d4: 1a8803e2     	csel	w2, wzr, w8, eq
   2a0d8: b90007e2     	str	w2, [sp, #0x4]
   2a0dc: 94000000     	bl	0x2a0dc <tp_single_aod_write+0x9c>
		000000000002a0dc:  R_AARCH64_CALL26	_printk
   2a0e0: f9476a88     	ldr	x8, [x20, #0xed0]
   2a0e4: b4fffd48     	cbz	x8, 0x2a08c <tp_single_aod_write+0x4c>
   ...
   2a100: 54000040     	b.eq	0x2a108 <tp_single_aod_write+0xc8>
   2a104: d4304500     	brk	#0x8228
   2a108: d63f0100     	blr	x8
   2a10c: 17ffffe0     	b	0x2a08c <tp_single_aod_write+0x4c>
   2a110: 94000000     	bl	0x2a110 <tp_single_aod_write+0xd0>
