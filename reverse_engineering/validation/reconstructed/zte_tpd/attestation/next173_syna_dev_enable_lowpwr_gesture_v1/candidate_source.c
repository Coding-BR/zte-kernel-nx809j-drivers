int __fastcall syna_dev_enable_lowpwr_gesture(_QWORD *a1, unsigned long a2, unsigned int a3)
{
  _QWORD *v4; // x23
  unsigned int v5; // w20
  char v6; // w24
...
LABEL_8:
    ...
    printk(v8, "syna_dev_enable_lowpwr_gesture");
    a1 = v4;
    *((_BYTE *)v4 + 756) = v9;
  }
LABEL_10:
  ...
  else
  {
    ...
    {
      v13 = v14;
      printk(unk_3B058, "syna_dev_enable_lowpwr_gesture");
    }
    else
    {
      printk(unk_329E0, "syna_dev_enable_lowpwr_gesture",
             *((unsigned int *)v4 + 364), *((unsigned int *)v4 + 369));
      if ( *((_DWORD *)v4 + 366) )
        v16 = 3;
      else
        v16 = 0;
