# tpd_get_fake_sleep — exact offline revalidation v5

This package records the 2026-08-31 offline revalidation of `tpd_get_fake_sleep` from stock entry `0012ca00`.
...
The source preserves the observed context load at `cdev + 0xdb8`, the 32-bit read at context offset `0x5e8`, the 32-bit store at `cdev + 0x480`, and the zero return. Android runtime and NX809J hardware behavior remain out of scope.
