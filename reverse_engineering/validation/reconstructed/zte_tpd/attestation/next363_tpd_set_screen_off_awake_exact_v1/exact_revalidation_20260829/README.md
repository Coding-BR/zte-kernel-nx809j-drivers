# `tpd_set_screen_off_awake` exact revalidation

This package records the offline exact revalidation of microtask `363_tpd_set_screen_off_awake` for `zte_tpd`.
...
- AArch64 function comparison: PASS; 22 instructions and 88 bytes at stock entry `0x0012ca1c`.
