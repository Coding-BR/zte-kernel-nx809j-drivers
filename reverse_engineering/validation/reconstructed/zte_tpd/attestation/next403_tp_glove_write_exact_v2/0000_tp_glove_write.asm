...
000000000002a044 <tp_glove_write>:
   ...
   2a078: 90000008     	adrp	x8, 0x2a000 <tp_glove_read+0xb0>
   ...
   2a084: 94000000     	bl	0x2a084 <tp_glove_write+0x40>
		000000000002a084:  R_AARCH64_CALL26	kstrtouint_from_user
   2a088: 340001a0     	cbz	w0, 0x2a0bc <tp_glove_write+0x78>
   ...
   2a0a0: 54000381     	b.ne	0x2a110 <tp_glove_write+0xcc>
   ...
   2a0c0: 90000000     	adrp	x0, 0x2a000 <tp_glove_read+0xb0>
   ...
   2a0c8: 90000001     	adrp	x1, 0x2a000 <tp_glove_read+0xb0>
		000000000002a0c8:  R_AARCH64_ADR_PREL_PG_HI21	.rodata.str1.1+0x1a827
   2a0cc: 91000021     	add	x1, x1, #0x0
		000000000002a0cc:  R_AARCH64_ADD_ABS_LO12_NC	.rodata.str1.1+0x1a827
   2a0d0: 7100011f     	cmp	w8, #0x0
   2a0d4: 1a9f07e2     	cset	w2, ne
   2a0d8: b90007e2     	str	w2, [sp, #0x4]
   2a0dc: 94000000     	bl	0x2a0dc <tp_glove_write+0x98>
		000000000002a0dc:  R_AARCH64_CALL26	_printk
   2a0e0: f9472a88     	ldr	x8, [x20, #0xe50]
   2a0e4: b4fffd68     	cbz	x8, 0x2a090 <tp_glove_write+0x4c>
   ...
   2a100: 54000040     	b.eq	0x2a108 <tp_glove_write+0xc4>
   2a104: d4304500     	brk	#0x8228
   2a108: d63f0100     	blr	x8
   2a10c: 17ffffe1     	b	0x2a090 <tp_glove_write+0x4c>
   2a110: 94000000     	bl	0x2a110 <tp_glove_write+0xcc>
