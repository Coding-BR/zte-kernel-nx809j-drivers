#!/usr/bin/env python3
"""Build and run the syna_sysfs_create_dir harness twice with sanitizers."""
...
EXPECTED_STDOUT = "PASS syna_sysfs_create_dir host tests (5 cases)\n"
...
def main() -> int:
    ...
    parser.add_argument(
        ...
        default=pathlib.Path(__file__).with_name(
            "syna_sysfs_create_dir_host_test.c"
        ),
    )
    ...
    report = {
        ...
        "mode": "offline_direct_source_next25_sysfs_create_asan_ubsan",
        "driver": "zte_tpd",
        "target": "syna_sysfs_create_dir",
        "source": str(source),
        ...
        "limitations": [
            ...
            "It proves offset, branch, call-order, cleanup, argument, return and log behavior.",
