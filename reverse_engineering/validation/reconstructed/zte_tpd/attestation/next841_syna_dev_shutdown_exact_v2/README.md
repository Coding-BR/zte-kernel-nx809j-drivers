# `syna_dev_shutdown` — offline-exact promotion v2

This package records the validated reconstruction of stock entry `001126f4`.

The candidate matches the stock body at 7 AArch64 instructions/28 bytes and
0 normalized relocations. KCFI type `0x24a11bb9` matches in reports regenerated
