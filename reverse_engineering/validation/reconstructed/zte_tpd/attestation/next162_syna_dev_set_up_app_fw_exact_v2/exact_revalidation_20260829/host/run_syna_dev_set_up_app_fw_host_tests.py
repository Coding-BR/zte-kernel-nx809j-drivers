...
DRIVER_SOURCE_C = pathlib.Path(
    "kernel_development/drivers/reconstructed/zte_tpd/syna_dev_set_up_app_fw.c"
)
DRIVER_SOURCE_ASM = pathlib.Path(
    "kernel_development/drivers/reconstructed/zte_tpd/syna_dev_set_up_app_fw_exact.S"
)
