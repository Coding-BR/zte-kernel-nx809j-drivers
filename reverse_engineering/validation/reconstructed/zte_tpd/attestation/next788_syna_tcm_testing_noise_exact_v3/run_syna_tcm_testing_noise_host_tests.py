#!/usr/bin/env python3
"""Run the target-229 noise-test contract under ASan and UBSan."""
...
HOST = Path("kernel_development/drivers/validation/zte_tpd/host/syna_tcm_testing_noise_host_test.c")
...
EXPECTED = "PASS syna_tcm_testing_noise host tests (4 cases)\n"
...
def main() -> int:
    ...
    report = {"schema_version": 1, "generated_at_utc": datetime.now(timezone.utc).isoformat(),
              "mode": "offline_direct_source_next229_syna_tcm_testing_noise_asan_ubsan",
              "driver": "zte_tpd", "target": "syna_tcm_testing_noise",
              "covered_functions": ["syna_tcm_testing_noise"], "source": str(source),
              ...
              "limitations": ["Production-test, dual-firmware and bounds paths use deterministic stubs.",
