...
000000000002a024 <tp_smart_cover_read>:
   ...
   2a084: d65f03c0     	ret
   2a088: 90000008     	adrp	x8, 0x2a000 <tp_wake_gesture_read+0xd0>
   ...
   2a09c: f9471ec8     	ldr	x8, [x22, #0xe38]
   2a0a0: b4000128     	cbz	x8, 0x2a0c4 <tp_smart_cover_read+0xa0>
   ...
   2a0b8: 54000040     	b.eq	0x2a0c0 <tp_smart_cover_read+0x9c>
   2a0bc: d4304500     	brk	#0x8228
   2a0c0: d63f0100     	blr	x8
   2a0c4: b94006c2     	ldr	w2, [x22, #0x4]
   2a0c8: 90000000     	adrp	x0, 0x2a000 <tp_wake_gesture_read+0xd0>
   ...
   2a0d0: 90000001     	adrp	x1, 0x2a000 <tp_wake_gesture_read+0xd0>
		000000000002a0d0:  R_AARCH64_ADR_PREL_PG_HI21	.rodata.str1.1+0x17f87
   2a0d4: 91000021     	add	x1, x1, #0x0
		000000000002a0d4:  R_AARCH64_ADD_ABS_LO12_NC	.rodata.str1.1+0x17f87
   2a0d8: 94000000     	bl	0x2a0d8 <tp_smart_cover_read+0xb4>
		000000000002a0d8:  R_AARCH64_CALL26	_printk
   2a0dc: b94006c3     	ldr	w3, [x22, #0x4]
   2a0e0: 90000002     	adrp	x2, 0x2a000 <tp_wake_gesture_read+0xd0>
   ...
   2a0f0: 94000000     	bl	0x2a0f0 <tp_smart_cover_read+0xcc>
   ...
   2a108: 94000000     	bl	0x2a108 <tp_smart_cover_read+0xe4>
		000000000002a108:  R_AARCH64_CALL26	simple_read_from_buffer
   2a10c: 17ffffd4     	b	0x2a05c <tp_smart_cover_read+0x38>
   2a110: 94000000     	bl	0x2a110 <tp_smart_cover_read+0xec>
