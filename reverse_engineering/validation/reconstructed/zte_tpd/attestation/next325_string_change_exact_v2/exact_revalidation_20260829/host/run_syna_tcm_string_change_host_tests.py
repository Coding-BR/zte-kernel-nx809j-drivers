#!/usr/bin/env python3
"""Run the isolated string_change contract twice with ASan and UBSan."""
...
HOST_SOURCE = Path(
    ...
    "syna_tcm_string_change_host_test.c"
)
DRIVER_SOURCE = Path(
    "kernel_development/drivers/reconstructed/zte_tpd/string_change.c"
)
...
EXPECTED = "PASS string_change host tests (7 cases)\n"
...
def main() -> int:
    ...
    for cycle in range(1, 3):
        ...
        compile_command = [
            ...
            "-frandom-seed=zte-tpd-next325-string-change",
    ...
    report = {
        ...
        "mode": "offline_direct_source_next325_string_change_asan_ubsan",
        "driver": "zte_tpd",
        "target": "string_change",
        "covered_functions": ["string_change"],
        "source": str(source),
        ...
        "limitations": [
            "The harness covers allocation failures, empty input, hexadecimal prefix parsing, coordinate parsing, and rotations 0, 1 and 3.",
            "Assembly, KCFI and whole-module link remain independent gates.",
