#!/usr/bin/env python3
"""Build and run the set_tp_report_rate contract harness twice in Docker."""
...
EXPECTED = "PASS set_tp_report_rate host tests (4 cases)\n"
...
def main() -> int:
    ...
    harness = ROOT / "kernel_development/drivers/validation/zte_tpd/host/set_tp_report_rate_host_test.c"
    source = ROOT / "kernel_development/drivers/reconstructed/zte_tpd/set_tp_report_rate.c"
    ...
    for number in (1, 2):
        ...
        cycle.mkdir()
        binary = cycle / "set_tp_report_rate_host_test_asan_ubsan"
        command = [
            ...
            "/drivers/validation/zte_tpd/host/set_tp_report_rate_host_test.c",
            "-o", "/out/set_tp_report_rate_host_test_asan_ubsan",
        ]
        ...
        if compiled.returncode == 0:
            executed = subprocess.run(
                ["docker", "run", "--rm", "--network", "none", "-e",
                 ...
                 f"{cycle.resolve()}:/out:ro", IMAGE, "/out/set_tp_report_rate_host_test_asan_ubsan"],
    ...
    report = {
        ...
        "target": "set_tp_report_rate", "function": "set_tp_report_rate",
