# `set_tp_report_rate` offline-exact revalidation

This package records the reproducible offline revalidation of `zte_tpd::set_tp_report_rate` at stock entry `0x0010bec4`.
