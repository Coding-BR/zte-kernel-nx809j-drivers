# `set_follow_hand_level` offline-exact revalidation

This package records the reproducible offline revalidation of `zte_tpd::set_follow_hand_level` at stock entry `0x0010c080`.
