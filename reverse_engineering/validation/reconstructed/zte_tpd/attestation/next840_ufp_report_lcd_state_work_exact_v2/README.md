# `ufp_report_lcd_state_work` — offline-exact promotion v2

This package records the validated reconstruction of stock entry `001107f0`.

The candidate matches the stock body at 7 AArch64 instructions/28 bytes and
0 normalized relocations. KCFI type `0xa607748c` matches in reports regenerated
