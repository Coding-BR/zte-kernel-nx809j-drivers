#!/usr/bin/env python3
"""Build and run the clear-command-processing host oracle twice in Docker."""
...
EXPECTED = "PASS syna_tcm_clear_command_processing host tests (3 cases)\n"
...
def main() -> int:
    ...
    test_source = source.with_name("syna_tcm_clear_command_processing_host_test.c")
    driver_source = drivers / "reconstructed" / "zte_tpd" / "syna_tcm_clear_command_processing.c"
    ...
    for number in (1, 2):
        ...
        compile_command = [
            ...
            "/drivers/validation/zte_tpd/host/syna_tcm_clear_command_processing_host_test.c",
    ...
    report = {
        ...
        "mode": "offline_direct_source_syna_tcm_clear_command_processing_docker_asan_ubsan",
        "driver": "zte_tpd",
        "target": "syna_tcm_clear_command_processing",
        ...
        "limitations": [
            "The harness validates null-handle, null-callback and valid-callback contracts.",
            "It does not execute the invalid KCFI branch or exercise transport, IRQ, MMIO, flash hardware or module loading.",
        ],
    }
