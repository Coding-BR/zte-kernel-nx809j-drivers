...
#include "/drivers/reverse_engineering/validation/reconstructed/zte_tpd/attestation/syna_tcm_buf_lock_exact_v2/exact_revalidation_20260902/source/syna_tcm_buf_lock.c"
