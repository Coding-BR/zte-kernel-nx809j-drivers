#!/usr/bin/env python3
"""Run the syna_tcm_sleep host contract twice with sanitizers."""
...
def main() -> int:
    ...
    compile_command = (
        ...
        "attestation/syna_tcm_sleep_exact_v2/exact_revalidation_20260902/host/"
        "host_test.c "
        "-o /out/syna_tcm_sleep_host_test && /out/syna_tcm_sleep_host_test"
    )
    cycles = []
    for cycle in (1, 2):
        output_dir = build_root / f"cycle{cycle}"
        output_dir.mkdir(parents=True, exist_ok=True)
        binary = output_dir / "syna_tcm_sleep_host_test"
