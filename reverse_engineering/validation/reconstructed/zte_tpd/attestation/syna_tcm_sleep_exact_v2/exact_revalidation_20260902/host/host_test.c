...
#include "/drivers/kernel_development/drivers/reconstructed/zte_tpd/zte_tpd_tcm_layout.h"
...
#include "/drivers/kernel_development/drivers/reconstructed/zte_tpd/syna_tcm_sleep.c"
