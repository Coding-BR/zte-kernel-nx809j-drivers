# `tp_test_read` — offline-exact promotion v2

This package records the validated reconstruction of stock entry `0010dbd0`.

The candidate matches the stock body at 66 AArch64 instructions/264 bytes and
12 normalized relocations. KCFI type `0xf4e9d97c` also matches. The host
harness covers ready-success, ready-not-enabled, probe-failed and EOF/short-read
cases in two runs.
