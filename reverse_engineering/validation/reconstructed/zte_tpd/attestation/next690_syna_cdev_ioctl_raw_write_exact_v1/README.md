# `syna_cdev_ioctl_raw_write` offline exact attestation

This package records the function-level reconstruction of `syna_cdev_ioctl_raw_write`
at stock entry `0x001178d8` for the ZTE NX809J / RedMagic 11 Pro+ target.

## Decision

`PROMOTED_OFFLINE_EXACT` at function level. The candidate matches the stock
function at 237 AArch64 instructions and 948 bytes, including relocation sites,
