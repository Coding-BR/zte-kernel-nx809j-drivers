void syna_dev_reflash_startup_work(struct work_struct *work)
{
  ...
  if ( (*(_BYTE *)(a1 + 443) & 1) == 0 )
  {
    printk(unk_36640, "syna_dev_reflash_startup_work");
    return;
  }
  pm_stay_awake(*(_QWORD *)(a1 - 960) + 16LL);
  if ( (syna_dev_do_reflash((struct syna_tcm *)tcm, false) & 0x80000000) == 0 )
  {
    if ( (syna_dev_set_up_app_fw((struct syna_tcm *)tcm) & 0x80000000) != 0 )
    {
      v5 = unk_3B114;
    }
    else
    {
      if ( (syna_dev_set_up_input_device((struct syna_tcm *)tcm) & 0x80000000) == 0 )
      {
        printk(unk_3C4B0, "syna_dev_reflash_startup_work");
        ...
        v7 = syna_dev_set_tp_report_rate((struct syna_tcm *)tcm,
                                         *(_DWORD *)(a1 + 560), 0);
        printk(unk_3A2DA, "syna_dev_reflash_startup_work",
