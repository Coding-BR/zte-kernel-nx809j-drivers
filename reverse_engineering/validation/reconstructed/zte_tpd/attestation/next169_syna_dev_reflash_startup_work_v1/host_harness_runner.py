#!/usr/bin/env python3
"""Run the offline ASan/UBSan harness for syna_dev_reflash_startup_work."""
...
def main() -> int:
    ...
    harness = root / "kernel_development" / "drivers" / "validation" / "zte_tpd" / "host" / "syna_dev_reflash_startup_work_host_test.c"
    source = root / "kernel_development" / "drivers" / "reconstructed" / "zte_tpd" / "syna_dev_reflash_startup_work.c"
    evidence_root = root / "reverse_engineering" / "validation" / "reconstructed" / "zte_tpd" / "offline_static"
    evidence = [
        evidence_root / "ghidra_stock" / "decompiled" / "0168_00113b40_syna_dev_reflash_startup_work.c",
        evidence_root / "ghidra_stock" / "pcode" / "0168_00113b40_syna_dev_reflash_startup_work.jsonl",
        evidence_root / "stock_assembly" / "0168_syna_dev_reflash_startup_work_00113b40.asm",
    ]
    ...
    for cycle in range(1, args.repetitions + 1):
        ...
        compile_command = [
            ...
            "-frandom-seed=zte-tpd-target169-reflash-startup",
    ...
    report = {
        ...
        "mode": "offline_direct_source_reflash_startup_asan_ubsan",
        "driver": "zte_tpd",
        ...
        "limitations": [
            "The harness directly executes the recovered source with deterministic mocks for power, firmware, input and logging calls.",
            "It does not prove firmware transport, scheduler behavior, workqueue lifetime, Android integration, or hardware behavior.",
