# `tpd_get_rotation_limit_level` offline exact attestation

This package records the function-level reconstruction of
`tpd_get_rotation_limit_level` at stock entry `0x0012c424` for the ZTE NX809J /
...
The exact assembly source is emitted by `tpd_get_rotation_limit_level_exact.S`.
