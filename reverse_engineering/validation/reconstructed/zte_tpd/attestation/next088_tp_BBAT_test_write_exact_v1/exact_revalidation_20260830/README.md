# `tp_BBAT_test_write` exact revalidation

- Target: `tp_BBAT_test_write` at stock entry `0x0010db98`.
...
This package replaces the older conflicting documentation for this target and claims function-level `OFFLINE_EXACT` evidence only. It does not claim complete driver or smartphone equivalence.
