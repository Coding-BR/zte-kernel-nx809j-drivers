#!/usr/bin/env python3
"""Build and run the syna_sysfs_pwr_store harness twice with sanitizers."""
...
EXPECTED_STDOUT = "PASS syna_sysfs_pwr_store host tests (10 cases)\n"
...
def main() -> int:
    ...
    parser.add_argument(
        ...
        default=pathlib.Path(__file__).with_name(
            "syna_sysfs_pwr_store_host_test.c"
        ),
    )
    ...
    for cycle in (1, 2):
        ...
        command = [
            ...
            "-fno-pie",
            "-no-pie",
            "-frandom-seed=zte-tpd-next31-pwr",
    ...
    report = {
        ...
        "mode": "offline_direct_source_next31_sysfs_pwr_store_asan_ubsan",
        "driver": "zte_tpd",
        "target": "syna_sysfs_pwr_store",
        "source": str(source),
        ...
        "limitations": [
            "The harness stubs kobject ancestry and printk.",
            "It proves offsets, command branches, callback arguments, logs and returns.",
