#!/usr/bin/env python3
"""Build and run the zte_touch_init host harness twice in Docker."""
...
EXPECTED_STDOUT = "PASS zte_touch_init host tests (1 case)\n"
...
def main() -> int:
    ...
    for cycle in (1, 2):
        ...
        compile_command = [
            ...
            "-frandom-seed=zte-tpd-target161-init", "-ffile-prefix-map=/drivers=<drivers>",
    ...
    report = {
        ...
        "limitations": [
            "The harness covers printk formatting and platform-driver registration failure propagation.",
