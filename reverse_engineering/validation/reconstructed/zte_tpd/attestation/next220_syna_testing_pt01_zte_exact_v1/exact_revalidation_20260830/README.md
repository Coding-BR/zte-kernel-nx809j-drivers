# `syna_testing_pt01_zte` — offline exact revalidation

This package records the independent offline revalidation of stock function
`syna_testing_pt01_zte` at `0011bb70` (640 bytes) for `zte_tpd`.
...
AArch64 assembly/relocation comparison (173 instructions, 692 bytes, PASS),
