#!/usr/bin/env python3
"""Run the display_rotation_show host contract twice with ASan/UBSan."""
...
EXPECTED = "PASS display_rotation_show host tests (2 cases)\n"
...
def main() -> int:
    ...
    harness = drivers / "validation/zte_tpd/host/display_rotation_show_host_test.c"
    source = drivers / "reconstructed/zte_tpd/display_rotation_show.c"
    ...
    for cycle in (1, 2):
        ...
        command = ["docker", "run", "--rm", "-v", f"{drivers}:/drivers:ro",
            ...
            "-frandom-seed=zte-tpd-display-rotation-show", "-ffile-prefix-map=/drivers=<drivers>",
            "-fsanitize=address,undefined", "-Wl,--build-id=none",
            "/drivers/validation/zte_tpd/host/display_rotation_show_host_test.c",
    ...
    report = {"schema_version": 1, "driver": "zte_tpd", "target": "display_rotation_show",
