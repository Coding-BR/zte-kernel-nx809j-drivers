ssize_t get_follow_hand_level(struct file *file, char __user *buffer, size_t count, loff_t *offset)
{
  ...
  *(_QWORD *)s = 0;
  ...
  {
    v8 = tpd_cdev;
    v10 = *(void (__fastcall **)(_QWORD))(tpd_cdev + 3440);
    if ( v10 )
    {
      v11 = tpd_cdev;
      /* CFI check removed */
    ...
    printk(unk_3A127, "get_follow_hand_level", *(unsigned int *)(v8 + 1128));
