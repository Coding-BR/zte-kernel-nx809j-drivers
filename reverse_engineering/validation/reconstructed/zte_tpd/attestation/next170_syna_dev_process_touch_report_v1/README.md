...
The eleven cases cover null context, invalid event, parser failure, the
no-input device early return, empty report, FIFO/report copying, active
contact reporting, one-key contact reporting, released contact reporting,
low-power gesture delivery and UFP report events. The runner compiles and executes two cycles in
