#!/usr/bin/env python3
"""Build and run the PT05 testing harness twice with sanitizers."""
...
EXPECTED_STDOUT = "PASS syna_testing_pt05_zte host tests (12 cases)\n"
...
def main() -> int:
    ...
    parser.add_argument(
        ...
        default=pathlib.Path(__file__).with_name(
            "syna_testing_pt05_zte_host_test.c"
        ),
    )
    ...
    for cycle in (1, 2):
        ...
        command = [
            ...
            "-fno-pie",
            "-no-pie",
            "-frandom-seed=zte-tpd-next48-pt05",
    ...
    report = {
        ...
        "mode": "offline_direct_source_next48_pt05_asan_ubsan",
        "driver": "zte_tpd",
        "target": "syna_testing_pt05_zte",
        "covered_functions": ["syna_testing_pt05_zte"],
        "source": str(source),
        ...
        "limitations": [
            ...
            "It proves AArch64 layout assumptions, branches, formatting and cleanup.",
            "The two stock allocation leaks are asserted, then reclaimed by the harness.",
