#!/usr/bin/env python3
"""Run the isolated buffer-copy host contract under ASan and UBSan."""
...
HOST_SOURCE = Path("kernel_development/drivers/validation/zte_tpd/host/syna_tcm_buf_copy_0_host_test.c")
DRIVER_SOURCE = Path("kernel_development/drivers/reconstructed/zte_tpd/syna_tcm_buf_copy_0.c")
...
def main() -> int:
    ...
    for cycle in range(1, 3):
        ...
        compile_command = [
            ...
            "-frandom-seed=zte-tpd-next534-syna-tcm-buf-copy-0",
    ...
    report = {
        ...
        "mode": "offline_direct_source_next534_syna_tcm_buf_copy_0_asan_ubsan",
        "driver": "zte_tpd", "target": "syna_tcm_buf_copy_0",
        "covered_functions": ["syna_tcm_buf_copy_0"],
        ...
        "limitations": [
            "The harness exercises the reconstructed C contract with deterministic managed-device and mutex stubs.",
