# `zte_reset_frame_list` — offline-exact promotion v2

This package records the validated reconstruction of stock entry `00111f64`.

The candidate matches the stock body at 25 AArch64 instructions/100 bytes and
4 normalized relocations. KCFI type `0x3175607e` matches in reports regenerated
