# `tpd_id4_report_work` offline exact attestation

This package records the current function-level reconstruction of
`tpd_id4_report_work` at stock entry `0x0010fd58` for the ZTE NX809J /
RedMagic 11 Pro+ target.

The exact linked source is `tpd_id4_report_work_exact.S`; the readable C
