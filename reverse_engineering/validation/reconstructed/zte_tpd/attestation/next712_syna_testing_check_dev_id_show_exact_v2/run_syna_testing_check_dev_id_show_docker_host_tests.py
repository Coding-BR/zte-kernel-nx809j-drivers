#!/usr/bin/env python3
"""Run the existing check-device-ID host contract in the builder container."""
...
HOST_SOURCE = Path("kernel_development/drivers/validation/zte_tpd/host/syna_testing_check_dev_id_show_host_test.c")
DRIVER_SOURCE = Path("kernel_development/drivers/reconstructed/zte_tpd/syna_testing_check_dev_id_show.c")
...
EXPECTED = "PASS syna_testing_check_dev_id_show host tests (7 cases)\n"
...
def main() -> int:
    ...
    for cycle in (1, 2):
        ...
        compile_command = [
            ...
            "-frandom-seed=zte-tpd-next709-testing-check-dev-id",
    ...
    report = {
        ...
        "mode": "offline_direct_source_syna_testing_check_dev_id_show_asan_ubsan",
        "driver": "zte_tpd", "target": "syna_testing_check_dev_id_show",
        ...
        "limitations": [
            ...
            "It proves sysfs lookup offsets, disconnected and null-item branches, callback setup, output and cleanup.",
