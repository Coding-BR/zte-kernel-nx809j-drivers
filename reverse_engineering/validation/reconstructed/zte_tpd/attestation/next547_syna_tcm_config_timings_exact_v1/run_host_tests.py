#!/usr/bin/env python3
"""Run the timing-field configuration oracle in the project Docker image."""
...
def main() -> int:
    ...
    compile_command = (
        ...
        "syna_tcm_config_timings_host_test.c "
        "-o /out/config_timings_host_test && /out/config_timings_host_test"
    )
    cycles = []
    for cycle in (1, 2):
        output_dir = build_root / f"cycle{cycle}"
        output_dir.mkdir(parents=True, exist_ok=True)
        binary = output_dir / "config_timings_host_test"
    ...
    report = {
        "schema_version": 1,
        "target": "syna_tcm_config_timings",
        "mode": "direct_source_asan_ubsan_host_oracle",
        "stock_contract": "Ghidra Assembly 00121034",
        "expected_cases": 8,
        "cycles": cycles,
