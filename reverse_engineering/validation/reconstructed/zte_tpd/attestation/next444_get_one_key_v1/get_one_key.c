ssize_t get_one_key(struct file *file, char __user *buffer, size_t count, loff_t *offset)
{
  ...
  *(_QWORD *)s = 0;
  ...
  {
    v8 = tpd_cdev;
    v10 = *(void (__fastcall **)(_QWORD))(tpd_cdev + 3384);
    if ( v10 )
    {
      v11 = tpd_cdev;
      /* CFI check removed */
    ...
    printk(unk_3A127, "get_one_key", *(unsigned int *)(v8 + 1112));
