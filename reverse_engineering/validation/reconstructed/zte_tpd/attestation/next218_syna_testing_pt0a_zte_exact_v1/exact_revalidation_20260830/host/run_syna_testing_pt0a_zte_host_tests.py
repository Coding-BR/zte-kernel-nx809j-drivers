#!/usr/bin/env python3
"""Build and run the PT0A testing harness twice with sanitizers."""
...
EXPECTED_STDOUT = "PASS syna_testing_pt0a_zte host tests (12 cases)\n"
...
def main() -> int:
    ...
    parser.add_argument(
        ...
        default=pathlib.Path(__file__).with_name(
            "syna_testing_pt0a_zte_host_test.c"
        ),
    )
    ...
    for cycle in (1, 2):
        ...
        command = [
            ...
            "-fno-pie",
            "-no-pie",
            "-frandom-seed=zte-tpd-next47-pt0a",
    ...
    report = {
        ...
        "mode": "offline_direct_source_next47_pt0a_asan_ubsan",
        "driver": "zte_tpd",
        "target": "syna_testing_pt0a_zte",
        "covered_functions": ["syna_testing_pt0a_zte"],
        "source": str(source),
