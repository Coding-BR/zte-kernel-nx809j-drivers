#!/usr/bin/env python3
"""Build and run the set-post-reset-callback host oracle twice in Docker."""
...
EXPECTED = "PASS syna_tcm_set_post_reset_callback host tests (2 cases)\n"
...
def main() -> int:
    ...
    test_source = source.with_name("syna_tcm_set_post_reset_callback_host_test.c")
    driver_source = drivers / "reconstructed" / "zte_tpd" / "syna_tcm_set_post_reset_callback.c"
    ...
    report = {
        ...
        "mode": "offline_direct_source_syna_tcm_set_post_reset_callback_docker_asan_ubsan",
        "driver": "zte_tpd",
