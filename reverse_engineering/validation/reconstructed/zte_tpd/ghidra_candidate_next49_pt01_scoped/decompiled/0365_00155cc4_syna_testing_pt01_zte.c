...

{
  ...
  uStack_70 = 0;
  local_80 = 0;
  lVar5 = __kmalloc_cache_noprof(_strchr,0xdc0,0x1000);
  if (lVar5 == 0) {
    _printk(&DAT_001659cd,"syna_testing_pt01_zte");
    uVar7 = 0xfffffff4;
  }
  else {
    ...
    if (puVar6 == (undefined4 *)0x0) {
      ...
      *(undefined1 ***)(puVar6 + 0xe) = &local_a0;
      ...
      if (*(int *)(*(code **)(puVar6 + 6) + -4) != -0x7e3fb56e) {
        ...
        pcVar3 = (code *)SoftwareBreakpoint(0x8229,0x155d9c);
        (*pcVar3)();
      }
      iVar4 = (**(code **)(puVar6 + 6))(*param_1,puVar6,0);
      if (iVar4 < 0) {
        _printk(&DAT_001661d3,"syna_testing_pt01_zte",*(undefined8 *)(puVar6 + 2));
        puVar9 = &DAT_00164103;
      }
      else {
        puVar9 = &DAT_00164917;
      ...
      if (uStack_84 != 0) {
        ...
        iVar4 = scnprintf(lVar5 + uVar7,0x1000 - uVar7,&DAT_0016427b);
        uVar7 = (ulong)(iVar4 + uVar1);
      }
      tpd_copy_to_tp_firmware_data(lVar5);
      if ((char)local_50 != '\0') {
        _printk(&DAT_001626c3,"syna_tcm_buf_release");
      }
      lVar2 = local_90;
      lVar8 = syna_request_managed_device();
      if (lVar8 == 0) {
        _printk(&DAT_001659a7,"syna_pal_mem_free");
      }
      else if (lVar2 != 0) {
