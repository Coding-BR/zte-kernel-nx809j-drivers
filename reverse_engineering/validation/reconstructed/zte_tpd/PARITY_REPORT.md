...
- Candidate SHA-256: `2befd21fc877b1083eb805e709c49690266cf5f483154dc535af36a02839fdc9`
...
| verified callback KCFI | `PASS` | KCFI section and type IDs match for 164/164 selected functions, including 143/143 callbacks in 8 recovered families Note: Function size is non-gating because the OEM LTO pipeline is unavailable |
| complete recoverable KCFI surface | `INCOMPLETE` | kcfi_full_surface.json matches 239/322 stock functions with recoverable preambles Note: 83 signatures differ and 46 stock functions require separate preamble review |
...
| hash-attested direct-test subset | `PASS` | microtask_progress.json promotes 136/367 current-source tasks from 9 sanitizer-backed host reports with zero stale PASS demotions Note: This PASS covers only the attested subset; 231 functions remain unvalidated |
...
- Full KCFI surface has 83 mismatched function signatures
- O6 has 136 hash-attested PASS microtasks and 231 tasks still requiring direct evidence
