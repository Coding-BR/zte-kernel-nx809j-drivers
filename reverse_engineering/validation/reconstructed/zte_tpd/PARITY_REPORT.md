...
| hash-attested direct-test subset | `PASS` | microtask_progress.json promotes 91/367 current-source tasks from 5 sanitizer-backed host reports with zero stale PASS demotions Note: This PASS covers only the attested subset; 276 functions remain unvalidated |
...
- O6 has 91 hash-attested PASS microtasks and 276 tasks still requiring direct evidence
