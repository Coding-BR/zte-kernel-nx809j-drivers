...
- Candidate SHA-256: `83e8cd91f60a7bfcae11c02b56f61008649dd9b39ddcd480dbd15def09081806`
...
| verified callback KCFI | `PASS` | KCFI section and type IDs match for 160/160 selected functions, including 143/143 callbacks in 8 recovered families Note: Function size is non-gating because the OEM LTO pipeline is unavailable |
| complete recoverable KCFI surface | `INCOMPLETE` | kcfi_full_surface.json matches 235/322 stock functions with recoverable preambles Note: 87 signatures differ and 46 stock functions require separate preamble review |
...
| hash-attested direct-test subset | `PASS` | microtask_progress.json promotes 132/367 current-source tasks from 8 sanitizer-backed host reports with zero stale PASS demotions Note: This PASS covers only the attested subset; 235 functions remain unvalidated |
...
- Full KCFI surface has 87 mismatched function signatures
- O6 has 132 hash-attested PASS microtasks and 235 tasks still requiring direct evidence
