...
| complete recoverable KCFI surface | `INCOMPLETE` | kcfi_full_surface.json matches 154/322 stock functions with recoverable preambles Note: 168 signatures differ and 46 stock functions require separate preamble review |
...
- Full KCFI surface has 168 mismatched function signatures
