...
| complete recoverable KCFI surface | `INCOMPLETE` | kcfi_full_surface.json matches 245/322 stock functions with recoverable preambles Note: 77 signatures differ and 46 stock functions require separate preamble review |
...
- Full KCFI surface has 77 mismatched function signatures
