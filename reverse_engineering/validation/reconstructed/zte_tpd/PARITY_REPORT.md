...
| complete recoverable KCFI surface | `INCOMPLETE` | kcfi_full_surface.json matches 226/322 stock functions with recoverable preambles Note: 96 signatures differ and 46 stock functions require separate preamble review |
...
- Full KCFI surface has 96 mismatched function signatures
