...
- Candidate SHA-256: `bd3c4ea07621254483410d37760017d5b1ef3b00d087cb9e0240b8d64b979f46`
...
| verified callback KCFI | `PASS` | KCFI section and type IDs match for 156/156 selected functions, including 143/143 callbacks in 8 recovered families Note: Function size is non-gating because the OEM LTO pipeline is unavailable |
| complete recoverable KCFI surface | `INCOMPLETE` | kcfi_full_surface.json matches 231/322 stock functions with recoverable preambles Note: 91 signatures differ and 46 stock functions require separate preamble review |
...
| hash-attested direct-test subset | `PASS` | microtask_progress.json promotes 128/367 current-source tasks from 7 sanitizer-backed host reports with zero stale PASS demotions Note: This PASS covers only the attested subset; 239 functions remain unvalidated |
...
- Full KCFI surface has 91 mismatched function signatures
- O6 has 128 hash-attested PASS microtasks and 239 tasks still requiring direct evidence
