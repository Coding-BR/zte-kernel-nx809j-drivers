...
- Candidate SHA-256: `2eba92f2f3b95b556b19c336b0369e3150080cf0275889b54d864c497b7678b8`
...
| complete recoverable KCFI surface | `INCOMPLETE` | kcfi_full_surface.json matches 251/322 stock functions with recoverable preambles Note: 71 signatures differ and 46 stock functions require separate preamble review |
...
| hash-attested direct-test subset | `PASS` | microtask_progress.json promotes 146/367 current-source tasks from 13 sanitizer-backed host reports with zero stale PASS demotions Note: This PASS covers only the attested subset; 221 functions remain unvalidated |
...
- Full KCFI surface has 71 mismatched function signatures
- O6 has 146 hash-attested PASS microtasks and 221 tasks still requiring direct evidence
