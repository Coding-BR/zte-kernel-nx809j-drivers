...
| complete recoverable KCFI surface | `INCOMPLETE` | kcfi_full_surface.json matches 207/322 stock functions with recoverable preambles Note: 115 signatures differ and 46 stock functions require separate preamble review |
...
- Full KCFI surface has 115 mismatched function signatures
