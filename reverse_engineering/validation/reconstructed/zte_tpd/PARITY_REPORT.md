...
| complete recoverable KCFI surface | `INCOMPLETE` | kcfi_full_surface.json matches 165/322 stock functions with recoverable preambles Note: 157 signatures differ and 46 stock functions require separate preamble review |
...
- Full KCFI surface has 157 mismatched function signatures
