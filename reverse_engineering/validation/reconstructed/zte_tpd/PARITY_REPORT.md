...
- Candidate SHA-256: `34877123f6b30268189d3bbaf3e849cc78311941ceb558ce64b5737e425183bd`
...
| verified callback KCFI | `PASS` | KCFI section and type IDs match for 167/167 selected functions, including 143/143 callbacks in 8 recovered families Note: Function size is non-gating because the OEM LTO pipeline is unavailable |
| complete recoverable KCFI surface | `INCOMPLETE` | kcfi_full_surface.json matches 242/322 stock functions with recoverable preambles Note: 80 signatures differ and 46 stock functions require separate preamble review |
...
| hash-attested direct-test subset | `PASS` | microtask_progress.json promotes 139/367 current-source tasks from 10 sanitizer-backed host reports with zero stale PASS demotions Note: This PASS covers only the attested subset; 228 functions remain unvalidated |
...
- Full KCFI surface has 80 mismatched function signatures
- O6 has 139 hash-attested PASS microtasks and 228 tasks still requiring direct evidence
