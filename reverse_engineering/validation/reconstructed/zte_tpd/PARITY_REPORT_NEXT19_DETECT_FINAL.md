...
- Candidate SHA-256: `1a38c3abf7ce760d3ece5427105d864ffd977fbf011fbb1f966e65956f8cdf9f`
...
| complete recoverable KCFI surface | `INCOMPLETE` | kcfi_full_surface.json matches 304/322 stock functions with recoverable preambles Note: 18 signatures differ and 46 stock functions require separate preamble review |
...
| hash-attested direct-test subset | `PASS` | microtask_progress.json records 159/367 current-source PASS tasks; this scoped run promoted 1 task(s) from 1 sanitizer-backed host report(s), with zero stale PASS demotions Note: This PASS covers only the attested subset; 208 functions remain unvalidated |
...
- Full KCFI surface has 18 mismatched function signatures
- O6 has 159 hash-attested PASS microtasks and 208 tasks still requiring direct evidence
