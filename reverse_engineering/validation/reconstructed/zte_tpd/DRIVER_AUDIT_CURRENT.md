...
- Gerado em: `2026-07-12T02:53:07.803449+00:00`
...
|---|---|---|---|
| `zte_tpd` | `incomplete_or_failed` | `não executado` | module parity check failed: vermagic_match<br>module parity check failed: alias_match<br>module parity check failed: undefined_symbols_match |
