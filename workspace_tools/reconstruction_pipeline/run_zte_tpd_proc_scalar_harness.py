#!/usr/bin/env python3
"""Compile and execute the direct-source zte_tpd scalar proc harness."""
...
SOURCE_FILES = (
    "display_rotation_show.c",
    "set_display_rotation.c",
    "get_fake_sleep.c",
    "set_fake_sleep.c",
    "get_finger_lock_flag.c",
    "set_finger_lock_flag.c",
    "get_follow_hand_level.c",
    "set_follow_hand_level.c",
    "get_one_key.c",
    "set_one_key.c",
    "get_play_game.c",
    "set_play_game.c",
    "get_rotation_limit_level.c",
    "set_rotation_limit_level.c",
    "get_screen_off_awake.c",
    "set_screen_off_awake.c",
    "get_stability_level.c",
    "set_stability_level.c",
    "get_tp_report_rate.c",
    "set_tp_report_rate.c",
    "headset_state_show.c",
...
def main() -> int:
    ...
    output = (args.output or harness_dir.parent / "proc_scalar_harness_report.json").resolve()
    (harness_dir / "build").mkdir(parents=True, exist_ok=True)
    harness_source = harness_dir / "proc_scalar_callbacks_harness.c"
    ...
    shell_command = (
        ...
        f"-I{container_source} proc_scalar_callbacks_harness.c "
        f"-o build/proc_scalar_callbacks_harness "
        "&& ASAN_OPTIONS=detect_leaks=1:halt_on_error=1 "
        "UBSAN_OPTIONS=halt_on_error=1 ./build/proc_scalar_callbacks_harness"
    )
    command = [
        "docker", "run", "--rm",
    ...
    report = {
        "schema_version": "1.0",
        "mode": "offline_direct_source_proc_scalar_host_harness_asan_ubsan",
        ...
        "limitations": [
            ...
            "Indirect callbacks use typed fixture functions; hardware transport is not exercised.",
            "suspend_store is excluded because its recovered inline KCFI preamble needs a dedicated fixture.",
