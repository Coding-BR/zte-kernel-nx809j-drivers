...
- Gerado em: `2026-07-30T23:07:23.396934+00:00`
- Run de evidência: `F:\drivers\workspaces\zte-tpd-next104-pal-mem-free-base-canonical-20260730\runs\public-replay-next104`
- Rebuild limpo: `sim`
...
|---|---|---|---|
| `zte_tpd` | `incomplete_or_failed` | `não executado` | mapping 0 is not independently reviewed<br>mapping 1 is not independently reviewed<br>mapping 2 is not independently reviewed |
