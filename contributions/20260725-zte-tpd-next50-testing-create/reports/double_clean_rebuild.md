...
- Gerado em: `2026-07-25T21:42:13.915450+00:00`
- Run de evidência: `C:\Users\adriano\Desktop\emulador\kernel-docker-workspace\engenharia\validation\next50_testing_create_final`
- Rebuild limpo: `sim`
- Manifesto do kernel alvo: `C:\Users\adriano\Desktop\emulador\kernel-docker-workspace\engenharia\config\target_kernel.json`

| Driver | Resultado estático | Hardware | Evidência que falta |
|---|---|---|---|
| `zte_tpd` | `incomplete_or_failed` | `não executado` | acquired stock module is missing from the engineering run<br>Ghidra export missing: manifest.json<br>Ghidra export missing: functions.jsonl |
